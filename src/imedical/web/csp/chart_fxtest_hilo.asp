...
Chart1.OpenDataEX COD_VALUES,4,6
'For j = 0 to 5
...
'PULSE
Chart1.Series(1).Gallery = HILOWCLOSE
Chart1.Series(1).Color = RGB(0, 200, 200)

'TEMP
Chart1.Chart3D = false
Chart1.Series(2).Gallery = HILOWCLOSE
