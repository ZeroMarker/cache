...
function InitPatDg() {
   ...
   $HUI.datagrid("#chkpatdg",{
       ...
       data: [],
       columns:[[
           {field:'TabRegNo',title:'登记号',width:120,align:'left'},
           {field:'TabPatName',title:'姓名',width:100},
           {field:'TabCTDesc',title:'病房描述',width:150},
           {field:'TabPatType',title:'病人类型',width:100,align:'center'},
           ...
           {field:'TabAuditFlag',title:'审核标记',width:80,align:'center'},
           {field:'TabAuditUserName',title:'审核人',width:120,align:'center'},
           ...
           {field:'TabTolAmount',title:'总金额',width:100},
...
function InitPatOrdDg()
{
   ...
   $HUI.datagrid("#chkpatOrddg",{
       ...
       columns:[[
           ...
           {field:'TQty',title:'数量',width:80,align:'center'},
           ...
           {field:'TOrderDate',title:'医嘱日期',width:90,align:'center'},
           {field:'TOrderTime',title:'医嘱时间',width:80,align:'center'},
           {field:'TDocName',title:'医嘱录入人',width:90,align:'center'},
           {field:'Tybbz',title:'限制信息',width:130},
           {field:'TUomDesc',title:'单位',width:60},
           {field:'TDemo',title:'备注',width:100},
...
function InitPatDiagDg(rowData)
{
   ...
   $HUI.datagrid("#patdiagdg",{
       ...
       singleSelect: true,
       columns:[[
           {field:'DiagnosNum',title:'序号',width:60,align:'center'},
           {field:'DiagName',title:'诊断名称',width:150},
...
function InitPatOrdLstDg(rowData)
{
   ...
   $HUI.datagrid("#patordlstdg",{
       ...
       columns:[[
           ...
           {field:'Txmdj',title:'项目等级',width:100},
           {field:'TPrice',title:'单价',width:60,align:'center'},
           {field:'TQty',title:'数量',width:60,align:'center'},
           {field:'TAmount',title:'金额',width:80,align:'center'},
           {field:'TInsuFlag',title:'调整为自费',width:100,align:'center',
            formatter:function(val,rowData,rowIndex){
                  return (val=="Y") ? "是" : "否";
                },
           ...
           {field:'TOeordDate',title:'医嘱日期',width:90,align:'center'},
           {field:'TOeordTime',title:'医嘱时间',width:80,align:'center'},
