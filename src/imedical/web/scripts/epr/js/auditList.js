...
function eprAudit(userLevel, docEprNumList)
{
	...
	function ajaxLogin()
	{
        ...
        Ext.Ajax.request({
            ...
            params: { episodeID: _EpisodeID, EPRDocIDs: docEprNumList, userName: userName, pwd: pwd, userLevel: userLevel},
            success: function(response, opts) 
            {
                ...
                {       
					invokeMultiPreviewList(_PatientID, _EpisodeID, _UserID, docEprNumList);
