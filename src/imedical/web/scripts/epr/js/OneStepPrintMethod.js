...
function print01(para) {
    ...
    try{
		...
		openWindow = window.showModalDialog("dhcrisreport.print.csp",para,"dialogHeight:10000px;dialogLeft:10000px;dialogTop:0px;dialogWidth:0px;dialogHide:no;");
	}catch(e){
		alert(e.message)
	}
}
...
function print02(para) {
    ...
    try{
        openWindow = window.showModalDialog("dhclabprintresultemr.csp",para,"dialogHeight:800px;dialogLeft:600px;dialogTop:0px;dialogWidth:0px;dialogHide:no;");
    }catch(e){
        alert(e.message)
    }
}
...
function print03(para) {
    ...
    try{
        openWindow = window.showModalDialog("dhcnurseipcommordprint.csp",para,"dialogHeight:10000px;dialogLeft:10000px;dialogTop:0px;dialogWidth:0px;dialogHide:no;");
    }catch(e){
        alert(e.message)
    }
}
...
function print05(para) {
	...
	//websys_createWindow('DHCDocIPBookNew.Print.csp?EpisodeID='+episodeID,'DocIPBook',"top=10000,left=10000,width=0,height=0");
        openWindow = window.showModalDialog("DHCDocIPBookNew.Print.csp",para,"dialogHeight:10000px;dialogLeft:10000px;dialogTop:0px;dialogWidth:0px;dialogHide:no;");
    }catch(e){
        alert(e.message)
    }
}
...
function print06(para) {
	...
	try{
        openWindow = window.showModalDialog("dhcnuremrprint.csp",para,"dialogHeight:10000px;dialogLeft:10000px;dialogTop:0px;dialogWidth:0px;dialogHide:no;");
    }catch(e){
        alert(e.message)
    }
}
...
function print07(para) {
    try {
        ...
        openWindow = window.showModalDialog("dhc.epr.onestepprintepr.csp",para,"dialogHeight:300px;dialogLeft:200px;dialogTop:200px;dialogWidth:500px;center:no;dialogHide:no;edge:sunken;help:yes;resizable:no;scroll:no;status:no;unadorned:no;");
    } catch (e) {
        alert(e.message);
    }    
}
...
function print71(para) {
    try {
        ...
        for (var i = 0; i < categoryDetailArray.length; i++) {
        	...
        	openWindow = window.showModalDialog("emr.interface.print.csp?EpisodeID=" + para.EpisodeID + "&PatientID=" + para.PatientID + "&CatalogID=" + para.CategoryDetail,para,"dialogHeight:300px;dialogLeft:200px;dialogTop:200px;dialogWidth:500px;center:no;dialogHide:no;edge:sunken;help:yes;resizable:no;scroll:no;status:no;unadorned:no;");
        }
    } catch (e) {
        alert(e.message);
    }    
...
function print09(para) {
	...
	try{
		...
		openWindow = window.showModalDialog("dhcpisreport.print.csp",para,"dialogHeight:300px;dialogLeft:200px;dialogTop:200px;dialogWidth:500px;dialogHide:no;");		
	}catch(e){
		alert(e.message)
	}
}
...
//23.	输血单
function print23(para) {
	try{
		openWindow = window.showModalDialog("dhcbldtransrecordprint.csp",para,"dialogHeight:300px;dialogLeft:200px;dialogTop:200px;dialogWidth:500px;dialogHide:no;");		
	}catch(e){
		alert(e.message)
	}
}
...
function print10(para){
    try{
		openWindow = window.showModalDialog("EKGAkeyPrint.EPROneStepPrint.csp",para,"dialogHeight:300px;dialogLeft:200px;dialogTop:200px;dialogWidth:500px;dialogHide:no;");		
	}catch(e){
		alert(e.message)
	}
}
