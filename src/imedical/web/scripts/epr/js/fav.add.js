...
﻿$(function(){
    ...
    var info = '<div class="contantdiv"><span>&emsp;病人ID：</span><span id="PatientNo">'+PatientNo+'</span></div>';
    info = info + '<div class="contantdiv"><span>&emsp;&emsp;姓名：</span><span id="Name">'+Name+'</span></div>';
    info = info + '<div class="contantdiv"><span>&emsp;&emsp;性别：</span><span id="Gender">'+Gender+'</span></div>';
    info = info + '<div class="contantdiv"><span>出生日期：</span><span id="BOD">'+BOD+'</span></div>';
    $("#content").append(info);
    //初始化收藏位置
