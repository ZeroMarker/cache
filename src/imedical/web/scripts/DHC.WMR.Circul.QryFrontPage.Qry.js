...
function btnFind_onclick()
{
	...
	var lnk="websys.default.csp?WEBSYS.TCOMPONENT=DHC.WMR.Circul.QryFrontPage.List" + "&AdmLoc=" + Loc + "&AdmWard=" + Ward + "&AdmDoc=" + Doc + "&DateFrom=" + DateFrom + "&DateTo=" + DateTo;
...
function btnPrint_onclick()
{
	...
	var cArguments=AdmLoc+"^"+AdmWard+"^"+AdmDoc+"^"+DateFrom+"^"+DateTo;
	//var flg=PrintDataByExcel("MethodGetServer","MethodGetData","DHCWMRCirculQryFrontPage.xls",cArguments);
	var flg=ExportDataToExcel("MethodGetServer","MethodGetData","DHCWMRCirculQryFrontPage.xls",cArguments);
}
