...
function SetHandsum(value)
{
	...
	/////s myOthPayInfo=myOthPayInfo_"^"_myXRYBNum_"^"_$fn(myXRYBSum,"",2)
	/////_"^"_myCPPNum_"^"_$fn(myCPPSum,"",2)
	////s myOthPayInfo=myOthPayInfo_"^"_myGFJZNum_"^"_$fn(myGFJZSum,"",2)
	////_"^"_myTJNum_"^"_$fn(myTJSum,"",2)
	////s myOthPayInfo=myOthPayInfo_"^"_myHTDWNum_"^"_$fn(myHTDWSum,"",2)
	////_"^"_YBCash_"^"_$fn(YBCashnum,"",2)
	///s myOthPayInfo=myOthPayInfo_"^"_myYBNum_"^"_$fn(myYBSum,"",2)
	
	DHCWebD_SetObjValueB("XRYBNum",Split_Value[25]);
	DHCWebD_SetObjValueB("XRYBSum",Split_Value[26]);
	DHCWebD_SetObjValueB("CPPNum",Split_Value[27]);
	DHCWebD_SetObjValueB("CPPSum",Split_Value[28]);
	DHCWebD_SetObjValueB("GFJZNum",Split_Value[29]);
	DHCWebD_SetObjValueB("GFJZSum",Split_Value[30]);
	DHCWebD_SetObjValueB("TJNum",Split_Value[31]);
	DHCWebD_SetObjValueB("TJSum",Split_Value[32]);
	DHCWebD_SetObjValueB("HTDWNum",Split_Value[33]);
	DHCWebD_SetObjValueB("HTDWSum",Split_Value[34]);
	DHCWebD_SetObjValueB("YBINVNum",Split_Value[35]);
	DHCWebD_SetObjValueB("YBSelfPay",Split_Value[36]);
	DHCWebD_SetObjValueB("YBCardPay",Split_Value[38]);
	///DHCWebD_SetObjValueB("",Split_Value[39]);
	////DHCWebD_SetObjValueB("",Split_Value[40]);
...
function BClear_Click(){
	...
	var lnk="websys.default.csp?WEBSYS.TCOMPONENT=udhcOPHandin.DTSYMZRep";
