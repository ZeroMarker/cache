...
{
	var objtbl=document.getElementById('tDHCPEPreGEndanger_Item');	//取表格元素?名称
	...
	for (var i=1;i<rows;i++)
	{
		...
		if (obj&&obj.checked){
			...
			if (obj){
				...
				var flag=cspRunServerMethod(encmeth,PreIADM, "TEAM",PreOrAdd,ID, SetsID,UserID)
				if (flag=="Notice"){
