...
============================================*/
function QueryDicItemByTypeFlag(methodControl, Type, Flag)
{
	var strMethod = document.getElementById(methodControl).value;
	var ret = cspRunServerMethod(strMethod, Type, Flag);
	return BuildObjArry(ret, CHR_1, BuildDHCMedDictionaryItem);
}

function QueryDicItemByTypeFlagDic(methodControl, Type, Flag)
{
	var arry = QueryDicItemByTypeFlag(methodControl, Type, Flag);
	var obj = null;
...
function QueryPathogenDic(methodControl1, methodControl2, Code, Desc, ActiveFlag)
{
	...
	*/
	...
	do
	{
		...
		if (tmp!=="") {
			str += tmp + CHR_1; //Add By LiYang 2009-11-21
...
function  GetMic(methodControl, TestSetRow)
{
	...
	//Query DHCMedIPBKTempItem by RowID
	function GetMedIPBKTempItemByID(methodControl, rowID)
{
	...
	//add by lxf 2008-10-28
	//Query DHCMedIPBKTemplate by RowID
...
function GetDHCMedIPBKTempDtlListArry(MethodControl, TempID)
{
	var strMethod = document.getElementById(MethodControl).value;
...
//Save DHCMedIPBooking
//By LiYang 2008-10-24
//s val=##Class(%CSP.Page).Encrypt($LB("web.DHCMedIPBookingCtl.Update"))
function SaveDHCMedIPBooking(methodControl, obj) {

    var strMethod = document.getElementById(methodControl).value;
    var objStr = SerializeDHCMedIPBooking(obj);
...
//s val=##Class(%CSP.Page).Encrypt($LB("web.DHCMedIPBookingCtl.GetIPBookByID"))
function GetDHCMedIPBooking(methodControl, BookID) {
    var strMethod = document.getElementById(methodControl).value;
    var ret = cspRunServerMethod(strMethod, BookID)
    var obj = BuildDHCMedIPBooking(ret);
    return obj;
}
...
//by LiYang 2008-10-25
//s val=##Class(%CSP.Page).Encrypt($LB("web.DHCMedIPBookingCtl.GetIPBookByPaadm"))
function GetDHCMedIPBookingByPaadm(methodControl, Paadm) {
    var strMethod = document.getElementById(methodControl).value;
    var ret = cspRunServerMethod(strMethod, Paadm)
    var obj = BuildDHCMedIPBooking(ret);
    return obj;
...
//Save DHCMedIPBooking
//By LiYang 2008-10-24
//s val=##Class(%CSP.Page).Encrypt($LB("web.DHCMedIPBookingCtl.UpdateBookState"))
function SaveDHCMedIPBKState(methodControl, obj) {

    var strMethod = document.getElementById(methodControl).value;
    var objStr = SerializeDHCMedIPBKState(obj);
    var ret = cspRunServerMethod(strMethod, objStr);
    obj.RowID = ret;
    return ret;
}
...
//Save DHCMedIPBooking
//By LiYang 2008-10-24
//s val=##Class(%CSP.Page).Encrypt($LB("web.DHCMedIPBookingCtl.UpdateDetail"))
function SaveDHCMedIPBKDetail(methodControl, obj) {

    var strMethod = document.getElementById(methodControl).value;
    var objStr = SerializeDHCMedIPBKDetail(obj);
    var ret = cspRunServerMethod(strMethod, objStr);
    obj.RowID = ret;
    return ret;
}
...
//s val=##Class(%CSP.Page).Encrypt($LB("web.DHCMedIPBookTempCtl.GetTemplateArry"))
function GetDHCMedIPBookingTemplateArry(methodControl) {
    var strMethod = document.getElementById(methodControl).value;
    var ret = cspRunServerMethod(strMethod);
    return BuildObjArry(ret, CHR_1, BuildDHCMedIPBKTemplate);
}

//Save Base info(update paperson)
//s val=##Class(%CSP.Page).Encrypt($LB("web.DHCMedIPBookingCtl.UpdatePatientBaseInfo"))
...
/*===========================================
Name:QueryAntiDicByPy
Author: Cjb, Microsoft
Param:
methodControl:Method name
Code: AntiCode, 
Type: Anti Type, 
Comment:Query Anti
s val=##Class(%CSP.Page).Encrypt($LB(web.DHCMedInfDictionaryCtl.QueryAntiDicByPy"))
s val=##Class(%CSP.Page).Encrypt($LB(web.DHCMedInfDictionaryCtl.GetAntiDicByPyList"))
============================================*/
function QueryAntiDicByPy(methodControl1, methodControl2, Code, Type, ActiveFlag)
{
	var strMethod1 = document.getElementById(methodControl1).value;
	var strMethod2 = document.getElementById(methodControl2).value;
	var pid = cspRunServerMethod(strMethod1, Code, Type, ActiveFlag);
	var str = "";
	var tmp = "";
	/*
	tmp = cspRunServerMethod(strMethod2, "", pid);
...
/*===========================================
Name:GetDrugSenTestMapping
Author: LiYang, Microsoft
Date: 2009-11-21
Param:
methodControl:
TestSetRow: Lab Test No
Get Mapping of Drug test result(germ and anti)
s val=##Class(%CSP.Page).Encrypt($LB("web.DHCMedDrugSen.GetTestRest"))
============================================*/
function GetDrugSenTestMapping(methodControl, TestSetRow) {
    var strMethod = document.getElementById(methodControl).value;
    var ret = cspRunServerMethod(strMethod, TestSetRow);
    return ret;
}
