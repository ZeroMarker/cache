function InitViewScreenEvent(obj)
{
	...
	obj.retGridPanel_rowclick = function()
	{
	  ...
	  if (rc){ 
	    ...
	    obj.icucvscDesc.setValue(rc.get("tIcucvscId"));
	    obj.icucvscDesc.setRawValue(rc.get("tIcucvscDesc"));
	    ...
	    obj.icucvcSummaryType.setRawValue(rc.get("tIcucvcSummaryTypeDesc"));
	...
	obj.addbutton_click = function()
	{
		...
		var icucvcSummaryType=obj.icucvcSummaryType.getValue();       
		...
		else 
		{
			...
			obj.RowId.setValue("");
	  	  	...
	  	  	obj.icucvcDisplayByCat.setValue("");
