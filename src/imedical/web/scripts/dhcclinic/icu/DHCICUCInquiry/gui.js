	...
	*/
	...
	obj.retGridPanelStore = new Ext.data.Store({
	    ...
	    [
			...
			,{name: 'TICUCIUpdateTime', mapping: 'TICUCIUpdateTime'}
    ...
    obj.retGridPanel = new Ext.grid.EditorGridPanel({
		...
		,{header: '更新时间', width: 150, dataIndex: 'TICUCIUpdateTime', sortable: true}
...
//		}
	...
	obj.retGridPanelStoreProxy.on('beforeload', function(objProxy, param){
		...
		param.Arg1=obj.ICUCIDesc.getValue();
		param.Arg2=obj.ICUCICtlocDr.getValue();
		param.ArgCnt = 2;
	});
...
/*	obj.ICUCIIFromTime = new Ext.form.TextField({
	...
	obj.retGridPanelitemStore = new Ext.data.Store({
	    ...
	    [
			...
			,{name: 'TICUCIICodeDesc', mapping: 'TICUCIICodeDesc'}
    ...
    obj.retGridPanelitem = new Ext.grid.EditorGridPanel({
		...
		,columns: [
			...
			,{header: '代码Code', width: 100, dataIndex: 'TICUCIICode', sortable: true}
			,{header: '代码描述', width: 100, dataIndex: 'TICUCIICodeDesc', sortable: true}
			...
			,{header: '开始时间类型', width: 150, dataIndex: 'TICUCIIStartDateTime', sortable: true}
			...
			,{header: '起始秒数', width: 150, dataIndex: 'TICUCIIFromTime', sortable: true}
			,{header: '终止秒数', width: 150, dataIndex: 'TICUCIIToTime', sortable: true}
