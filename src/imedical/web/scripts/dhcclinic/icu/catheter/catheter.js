$(function(){
	...
	var catheterDatagrid=$("#catheter_datagrid").datagrid({	///列表数据
        ...
        columns:[[
        	...
        	{ field: "CategoryDesc", title: "导管分类", width: 120, sortable: true },
        	...
        	{ field: "LinkRecordItemCatID", title: "显示分类ID", width: 80, sortable: true },
        	{ field: "LinkRecordItemCat", title: "显示分类", width: 150, sortable: true },
