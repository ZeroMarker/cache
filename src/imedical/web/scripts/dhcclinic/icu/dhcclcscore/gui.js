...
function InitViewScreen(){
	...
	obj.retGridPanelStore = new Ext.data.Store({
	    ...
	    [
			...
			,{name: 'TCLCSComOrdCode', mapping: 'TCLCSComOrdCode'}
    ...
    obj.retGridPanel = new Ext.grid.EditorGridPanel({
		...
		,{header: '代码', width: 100, dataIndex: 'TCLCSCode', sortable: true}
		,{header: '描述', width: 120, dataIndex: 'TCLCSDesc', sortable: true}
		...
		,{header: 'uom指向', width: 60, dataIndex: 'TCLCSUomdr', sortable: true}
		,{header: '关联医嘱项', width: 120, dataIndex: 'TCLCSComOrd', sortable: true}
		,{header: '常用医嘱项Code', width: 100, dataIndex: 'TCLCSComOrdCode', sortable: true}
		,{header: '常用医嘱项Id', width: 30, dataIndex: 'TCLCSComOrdDr', sortable: true}
