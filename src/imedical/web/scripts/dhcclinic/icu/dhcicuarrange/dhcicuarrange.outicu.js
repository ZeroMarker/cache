$(function(){
        ...
        columns:[[
            { field:"operator" ,title: "操作", width: 120 ,align:'center',
				formatter:function(value, row, index){
					...
					var str = '<a href="#" name="监护回顾" onclick="onClickRowButton(\''+row.icuaId+'\')" class="easyui-linkbutton" >监护回顾</a>';
					return str;
				}},
            { field: "tStartDateTime", title: "开始日期", width: 120, sortable: true},
            { field: "leaveDateTime", title: "转归日期", width: 120,formatter:function(value,row,index){  
            if(value != null && '' != value)
	...
	$("#ICUArrangeConfig").datagrid({
	sortName:'leaveDateTime',
	sortOrder:'desc'
	})
