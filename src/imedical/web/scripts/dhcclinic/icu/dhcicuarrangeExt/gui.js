...
function InitViewScreen(){
	...
	obj.retGridPanelStore = new Ext.data.Store({
	    ...
	    [
			...
			,{name: 'limitedTreatment', mapping: 'limitedTreatment'}
		])
	});
    ...
    obj.retGridPanel = new Ext.grid.GridPanel({
		...
		,columns: [
			...
			,{header: '病人状态', width: 60, dataIndex: 'statusDesc', sortable: true}
			...
			,{header: '限制治疗', width: 100, dataIndex: 'limitedTreatment', sortable: true}
...
//////////////////////////////////////////////////////	
    ...
    obj.retGridPanelequip = new Ext.grid.EditorGridPanel({
		...
		,columns: [
			...
			,{header: 'ID', width: 50, dataIndex: 'TRowid', sortable: true}
			...
			,{header: '床位ID', width: 100, dataIndex: 'TBedRowid', sortable: true}
			,{header: '设备ID', width: 100, dataIndex: 'TEquipRowid', sortable: true}
			...
			,{header: '采集类型ID', width: 150, dataIndex: 'TInterfaceProgramID', sortable: true}
			,{header: '状态', width: 50, dataIndex: 'TStat', sortable: true}
		]});
