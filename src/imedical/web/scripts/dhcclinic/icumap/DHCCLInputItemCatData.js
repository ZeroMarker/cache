$(document).ready(function () {	
	...
	$("#itemcatdatagrid").datagrid({
        ...
        columns:[[
            ...
            {field:'ARCICCode',title:'代码',width:150},    
            {field:'ARCICDesc',title:'描述',width:150},
            {field:'ARCICOrderType',title:'医嘱类型',width:150},
            {field:'ARCICOrdCat',title:'医嘱分类',width:150},
            {field:'ARCICCalcQtyFlag',title:'计算标志',width:150}
        ]],
        pagination:true,
        pageSize:15,
        pageNumber:1,
	...
	$("#BtnFind").click(function(){	
     ...
     $("#BtnClear").click(function(){
	     $.messager.confirm('请确认', '您确定要清空医嘱子类相关数据？', function (b) { 
         if (b==false)
         {
             return;
         }
     ...
     for(var i=2;i<(rows+1);i++)
     {
		 ...
		 $.ajax({
            ...
            if (data==0) {
	            ...
	            failStr=failStr+"第"+i+"行代码为"+oSheet.Cells(i,1).value+",描述为"+oSheet.Cells(i,2).value+"的医嘱子类数据插入失败，原因："+data+'\n';
                failnum=failnum+1;
            }
           }
