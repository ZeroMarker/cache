...
function BPrint_click()
{
	...
	//alert(Depart)
	var Depart=$("#Depart").combogrid("getValues");
	//alert(Depart)
	debugger; //
	...
	var opType=5;
	var fileType = "word";
	// var execParam=gid+":"+opType+":"+fileType+":2";
	...
	var execParam ={
		...
		opType : opType,
		printType : "2"  ,
		extStr : "DepartID:"+Depart+",ContrackID:"+iContractID+",LocID:"+LocID
	};
...
function InitCombobox()
{
	...
	//合同
	    ...
	    var Contract=rowData.TID;
	    /***************部门重新加载*************************/
		var Departurl=$URL+"?ClassName=web.DHCPE.PreGTeam&QueryName=SearchGDepart&ResultSetType=array"+"&GID="+"&Contract="+Contract;
		$('#Depart').combobox('reload',Departurl);
		},
        columns:[[
	...
	var GroupNameObj = $HUI.combogrid("#GDesc",{
	    ...
	    var GID=rowData.TRowId;
	    /***************部门重新加载*************************/
		var Departurl=$URL+"?ClassName=web.DHCPE.PreGTeam&QueryName=SearchGDepart&ResultSetType=array"+"&GID="+GID;
		$('#Depart').combobox('reload',Departurl);
		},
		columns:[[
		...
		//部门
		//站点
	var DepartObj = $HUI.combobox("#Depart",{
