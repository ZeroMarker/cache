...
var Columns=getCurColumnsInfo('EM.G.ResearchA','','','')  //modified by zy ZY0291 20220120
...
function initDocument()
{
	...
	//modified by ZY 20220809 2706914
	if(getElementValue("RFunProFlag")=="2")
...
function SaveData()
{
	...
	for (var i = 0; i < rows.length; i++) 
	{
        ...
        rows[i].RType=RFunProFlag	//modified by ZY20221206 bug:3133008
		...
		var oneRow=rows[i]
        ///modified by ZY 20221107  2952360
        /*
        //modified by WY 2022-9-27 2970015
        if (RTypeDesc=="")
        {
