...
function InitWinControlEvent(obj){
	...
	obj.btnNewICUReport_onclick = function(EpisodeID,TransLoc){
		var url="dhcmed.ninf.rep.infreport.csp?1=1&ReportType=ICU&EpisodeID="+EpisodeID+"&TransID="
		+""+"&TransLoc="+TransLoc+"&AdminPower="+""+"&ReportID=&2=2";
	...
	obj.btnNewNICUReport_onclick = function(EpisodeID,TransLoc){
		var url="dhcmed.ninf.rep.infreport.csp?1=1&ReportType=NICU&EpisodeID="+EpisodeID+"&TransID="
		+""+"&TransLoc="+TransLoc+"&AdminPower="+""+"&ReportID=&2=2";
		var oWin = window.open(url,'',"height=" + (window.screen.availHeight - 100) + ",width=" + (window.screen.availWidth - 100) + ",top=20,left=50,resizable=no");
	}
	
	obj.btnNewOPRReport_onclick = function(EpisodeID,TransLoc){
		var url="dhcmed.ninf.rep.infreport.csp?1=1&ReportType=OPR&EpisodeID="+EpisodeID+"&TransID="
		+""+"&TransLoc="+TransLoc+"&AdminPower="+""+"&ReportID=&2=2";
		var oWin = window.open(url,'',"height=" + (window.screen.availHeight - 100) + ",width=" + (window.screen.availWidth - 100) + ",top=20,left=50,resizable=no");
	}
}