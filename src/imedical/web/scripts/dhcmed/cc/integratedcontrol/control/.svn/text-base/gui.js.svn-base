...
function InitWinControl(SubjectID)
{
					 ...
					 '<div class="t-header-left">',
						'<div class="t-header-text">{FireCatFlag}&nbsp;&nbsp;{PatName}&nbsp;&nbsp;{PapmiNo}&nbsp;&nbsp;{Sex}&nbsp;&nbsp;{Age}&nbsp;&nbsp;{AdmitDate}&nbsp;&nbsp;{AdmWard}&nbsp;&nbsp;{AdmDoc}&nbsp;&nbsp;',
							'<div class="ButtonGroup">',
								...
								//'<a href="#" onclick="return objScreen.btnReject_onclick({LastSummaryID},\'{LnkSummaryIDs}\')"><img src="../scripts/dhcmed/img/cc/reject.png" alt="排除" /></a>',
							'</div>',
						'</div>',
					 '</div>',
				'</div>',
	...
	obj.objLocBedTpl = new Ext.XTemplate(
		...
		'</div>',
		{
			...
			FormatHTML : function(values,colCount)
			{
				...
				ret += '<a href="#" onclick="objScreen.DisplayControlPatientDetail(\''+values.WardID + '\',\'' +values.AdmWard +'\',\'\',\''+values.Paadm + '\');" >'
        ...
        tpl  : new Ext.XTemplate(
			...
			'</tbody></table>',
			{
				...
				FormatHTML : function(values,colCount)
				{
					...
					//ret += '<a href="#" onclick="objScreen.DisplayControlPatientDetail(\''+values.WardID + '\',\'' +values.WardDesc +'\',\'\',\'\');" >'
	...
	obj.FloorplanPanel = new Ext.Panel({
		region : 'center'
		,autoScroll : true
		//,style : 'overflow-x:hidden; overflow-y:scroll'
		,title : '病区床位图'
