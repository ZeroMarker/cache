...
{
	//新生儿体重
	obj.NBINF_cboBornWeightCat = Common_ComboToDic("NBINF_cboBornWeightCat","<span><b><font color='red'>*</font>体重</b></span>","NINFInfNICUBornWeight","","100%");
	//感染日期
	obj.NBINF_txtInfDate = Common_DateFieldToDate("NBINF_txtInfDate","<span><b><font color='red'>*</font>感染日期</b></span>","100%");
	//感染诊断
	obj.NBINF_cbgInfDiagnos = Common_CheckboxGroupToDic("NBINF_cbgInfDiagnos","<span><b><font color='red'>*</font>感染诊断</b></span>","NINFInfNICUInfDiag",3);
	//易感因素
	obj.NBINF_cbgInfFactors = Common_CheckboxGroupToDic("NBINF_cbgInfFactors","<span><b><font color='red'>*</font>易感因素</b></span>","NINFInfNICUInfFactors",3);
	...
	obj.NBINF_ViewPort = {
		...
		height : 320,
		anchor : '-20',
		tbar : ['<img SRC="../scripts/dhcmed/img/DiseaseInfo.png"><b style="font-size:16px;">新生儿感染信息</b>'],
		items : [
			{
				layout : 'form',
				frame : true,
	...
	obj.NBINF_SaveData = function(){
		...
		if (InfDate!=='') {
			...
			if (Common_ComputeDays("NBINF_txtInfDate")<0) errinfo = errinfo + '感染日期不能大于当前日期!<br>'
		}
