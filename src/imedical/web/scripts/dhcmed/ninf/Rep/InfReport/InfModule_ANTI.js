...
function InitANTI(obj)
{
	...
	obj.ANTI_gridAnti_RowEditer = function(objRec) {
		...
		if (!winGridRowEditer)
		{
			obj.ANTI_gridAnti_RowEditer_cboArcim = Common_ComboToArcim("ANTI_gridAnti_RowEditer_cboArcim","<span><b><font color='red'>*</font>药品医嘱</b></span>","R","ANTI_gridAnti_RowEditer_cboDoseUnit");
			obj.ANTI_gridAnti_RowEditer_txtDoseQty = Common_NumberField("ANTI_gridAnti_RowEditer_txtDoseQty","<span><b><font color='red'>*</font>剂量</b></span>",0,1,10);
			obj.ANTI_gridAnti_RowEditer_cboDoseUnit = Common_ComboToDoseUnit("ANTI_gridAnti_RowEditer_cboDoseUnit","<span><b><font color='red'>*</font>剂量单位</b></span>","ANTI_gridAnti_RowEditer_cboArcim");
			obj.ANTI_gridAnti_RowEditer_cboPhcFreq = Common_ComboToFreq("ANTI_gridAnti_RowEditer_cboPhcFreq","<span><b><font color='red'>*</font>频次</b></span>");
			obj.ANTI_gridAnti_RowEditer_txtStartDateTime = Common_DateFieldToDateTime("ANTI_gridAnti_RowEditer_txtStartDateTime","<span><b><font color='red'>*</font>开始时间</b></span>");
			obj.ANTI_gridAnti_RowEditer_txtEndDateTime = Common_DateFieldToDateTime("ANTI_gridAnti_RowEditer_txtEndDateTime","<span><b><font color='red'>*</font>结束时间</b></span>");
			obj.ANTI_gridAnti_RowEditer_cboMedUsePurpose = Common_ComboToDic("ANTI_gridAnti_RowEditer_cboMedUsePurpose","<span><b><font color='red'>*</font>用途</b></span>","NINFInfMedUsePurpose");
			obj.ANTI_gridAnti_RowEditer_cboAdminRoute = Common_ComboToDic("ANTI_gridAnti_RowEditer_cboAdminRoute","<span><b><font color='red'>*</font>给药途径</b></span>","NINFInfAdminRoute");
			obj.ANTI_gridAnti_RowEditer_cboMedPurpose = Common_ComboToDic("ANTI_gridAnti_RowEditer_cboMedPurpose","<span><b><font color='red'>*</font>目的</b></span>","NINFInfMedPurpose");
			obj.ANTI_gridAnti_RowEditer_cboTreatmentMode = Common_ComboToDic("ANTI_gridAnti_RowEditer_cboTreatmentMode","<span><b><font color='red'>*</font>治疗用药方式</b></span>","NINFInfTreatmentMode");
			obj.ANTI_gridAnti_RowEditer_cboPreMedIndicat = Common_ComboToDic("ANTI_gridAnti_RowEditer_cboPreMedIndicat","<span><b><font color='red'>*</font>预防用药指征</b></span>","NINFInfPreMedIndicat");
			obj.ANTI_gridAnti_RowEditer_cboPreMedEffect = Common_ComboToDic("ANTI_gridAnti_RowEditer_cboPreMedEffect","<span><b><font color='red'>*</font>预防用药效果</b></span>","NINFInfPreMedEffect");
			obj.ANTI_gridAnti_RowEditer_cboCombinedMed = Common_ComboToDic("ANTI_gridAnti_RowEditer_cboCombinedMed","<span><b><font color='red'>*</font>联合用药</b></span>","NINFInfCombinedMed");
			obj.ANTI_gridAnti_RowEditer_txtPreMedTime = Common_TextFieldToFormat("ANTI_gridAnti_RowEditer_txtPreMedTime","<span><b><font color='red'>*</font>术前用药时间</b></span>","小时:分钟");
			obj.ANTI_gridAnti_RowEditer_txtPostMedDays = Common_TextFieldToFormat("ANTI_gridAnti_RowEditer_txtPostMedDays","<span><b><font color='red'>*</font>术后用药天数</b></span>","天");
					...
					new Ext.Toolbar.Button({
						...
						listeners : {
							'click' : function(){
								...
								//修改TD-Bug:1999 抗菌用药编辑界面和院感包提交时提示必填信息不一致问题
								var errInfo = '';
								if (ArcimDesc == '') {
								...
								if ((MedUsePurposeID == '')||((MedUsePurposeDesc == ''))) {
									...
									if (MedUsePurposeDesc.indexOf('术前') > -1) {
										if (!PreMedTime) {
											errInfo = errInfo + '术前用药时间为空!<br>;'
										}
									}
									if (MedUsePurposeDesc.indexOf('术后') > -1) {
										if (!PostMedDays) {
											errInfo = errInfo + '术后用药天数为空!<br>;'
										}
									}
								}
								...
								if (MedPurposeDesc) {
									if (MedPurposeDesc.indexOf('治疗') > -1) {
										if (!TreatmentModeDesc) {
											errInfo = errInfo + '治疗用药方式为空!<br>;'
										}
									}
									if (MedPurposeDesc.indexOf('预防') > -1) {
										if (!PreMedIndicatDesc) {
											errInfo = errInfo + '预防用药指征为空!<br>;'
										}
										if (!PreMedEffectDesc) {
											errInfo = errInfo + '预防用药效果为空!<br>;'
										}
									}
								}
								if (errInfo != '') {
	...
	obj.ANTI_gridAnti_btnDel = new Ext.Button({
		...
		,listeners : {
			'click' :  function(){
				...
				if(obj.CurrReport)
				{
					// FixBug:公共卫生事件-医院感染报告-报告没有提交成功，通过【删除】按钮删除已录入的数据时，提示"“提交"状态的报告不能再删除数据”
	...
	obj.ANTI_gridAnti_iniFun = function() {
		var tmpGridPanel = new Ext.grid.GridPanel({
			...
			,columns: [
				new Ext.grid.RowNumberer()
				,{header: '药品医嘱', width: 300, dataIndex: 'ArcimDesc', sortable: false, menuDisabled:true, align:'center' }
				,{header: '用途', width: 80, dataIndex: 'MedUsePurposeDesc', sortable: false, menuDisabled:true, align:'center' }
				,{header: '给药<br>途径', width: 70, dataIndex: 'AdminRouteDesc', sortable: false, menuDisabled:true, align:'center' }
				...
				,{header: '目的', width: 70, dataIndex: 'MedPurposeDesc', sortable: false, menuDisabled:true, align:'center' }
				,{header: '治疗<br>用药<br>方式', width: 60, dataIndex: 'TreatmentModeDesc', sortable: false, menuDisabled:true, align:'center' }
				,{header: '预防<br>用药<br>指征', width: 60, dataIndex: 'PreMedIndicatDesc', sortable: false, menuDisabled:true, align:'center' }
				,{header: '预防<br>用药<br>效果', width: 60, dataIndex: 'PreMedEffectDesc', sortable: false, menuDisabled:true, align:'center' }
				,{header: '联合<br>用药', width: 60, dataIndex: 'CombinedMedDesc', sortable: false, menuDisabled:true, align:'center' }
	...
	obj.ANTI_ViewPort = {
		...
		height : 300,
		anchor : '-20',
		tbar : ['<img SRC="../scripts/dhcmed/img/Anti.png"><b style="font-size:16px;">抗菌用药</b><span style="color:red">(请选择用于此次感染的抗菌用药...)</span></font>'],
		items : [
			{
				layout : 'border',
				frame : true,
				items : [
					{
						...
						buttons : [obj.ANTI_gridAnti_btnGet,obj.ANTI_gridAnti_btnAdd,obj.ANTI_gridAnti_btnDel,'->','…']
					}
				]
			}
		]
			...
			for (var indRec = 0; indRec < objStore.getCount(); indRec++) {
				...
				if (objAnti) {
					...
					if (!objAnti.ArcimDesc) {
						rowerrinfo = rowerrinfo + '药品医嘱&nbsp;'	//“药品名称”改为“药品医嘱”
					}
