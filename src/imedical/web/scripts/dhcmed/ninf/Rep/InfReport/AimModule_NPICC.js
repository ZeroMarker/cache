...
function InitNPICC(obj)
{
	...
	obj.NPICC_GridRowDataCheck = function(objRec){
		...
		if (NPICC_txtIntubateDateTime != '') {
			...
			if (NPICC_txtExtubateDateTime != '') {
				...
				if (Common_ComputeDays("NPICC_txtExtubateDateTime")<0) errInfo = errInfo + '拔管日期大于当前日期!<br>'
	...
	obj.NPICC_ViewPort = {
		...
		height : 200,
		anchor : '-20',
		tbar : ['<img SRC="../scripts/dhcmed/img/picc.png"><b style="font-size:16px;">NICU-中央导管</b>'],
		items : [
			obj.NPICC_gridNPICC
		]
	}
