...
function InitOPR(obj)
{
	...
	obj.OPR_gridOpr_RowEditer = function(objRec) {
		...
		if (!winGridRowEditer)
		{
			obj.OPR_gridOpr_RowEditer_cboOperation = Common_ComboToORCOperation("OPR_gridOpr_RowEditer_cboOperation","<span><b><font color='red'>*</font>手术名称</b></span>");
			obj.OPR_gridOpr_RowEditer_txtStartDateTime = Common_DateFieldToDateTime("OPR_gridOpr_RowEditer_txtStartDateTime","<span><b><font color='red'>*</font>开始时间</b></span>");
			obj.OPR_gridOpr_RowEditer_txtEndDateTime = Common_DateFieldToDateTime("OPR_gridOpr_RowEditer_txtEndDateTime","<span><b><font color='red'>*</font>结束时间</b></span>");
			obj.OPR_gridOpr_RowEditer_cboOperDoc = Common_ComboToSSUser("OPR_gridOpr_RowEditer_cboOperDoc","<span><b><font color='red'>*</font>手术医生</b></span>");
			obj.OPR_gridOpr_RowEditer_cboOperationType = Common_ComboToDic("OPR_gridOpr_RowEditer_cboOperationType","<span><b><font color='red'>*</font>手术类型</b></span>","NINFInfOperationType");
			obj.OPR_gridOpr_RowEditer_cboAnesthesia = Common_ComboToDic("OPR_gridOpr_RowEditer_cboAnesthesia","<span><b><font color='red'>*</font>麻醉方式</b></span>","NINFInfAnesthesia");
			obj.OPR_gridOpr_RowEditer_cboCuteType = Common_ComboToDic("OPR_gridOpr_RowEditer_cboCuteType","<span><b><font color='red'>*</font>切口类型</b></span>","NINFInfCuteType");
			obj.OPR_gridOpr_RowEditer_cboCuteHealing = Common_ComboToDic("OPR_gridOpr_RowEditer_cboCuteHealing","<span><b><font color='red'>*</font>愈合情况</b></span>","NINFInfCuteHealing");
					...
					new Ext.Toolbar.Button({
						...
						listeners : {
							'click' : function(){
								...
								if (StartDate>EndDate) errInfo = errInfo + '手术开始时间大于手术结束时间!<br>';
							    ...
							    //add by pylian 20150619 修复111427手术切口监测手术的【开始时间】大于【结束时间】，可以保存
								if(dt2 < dt1)
									errInfo = errInfo + '“手术结束时间”应大于“手术开始时间”!<br>';
								var ms = dt2 - dt1;
								...
								*/
								...
								if(StartDateTime==EndDateTime) errInfo = errInfo + '手术开始时间和手术结束时间不能完全相同!<br>'
								var dt1 = Common_DateParse(StartDateTime);
								var dt2 = Common_DateParse(EndDateTime);
								if(dt2 < dt1)
									errInfo = errInfo + '“手术结束时间”应大于“手术开始时间”!<br>';
								var ms = dt2 - dt1;
								var days = ms / 1000 / 60 / 60 /24;
								if (days > 2) errInfo = errInfo + '“手术结束时间”与“开始时间”之差应小于等于48小时!<br>'
								var disDateTime = Common_GetValue('BASE_txtDisDate');
								var dt3 = Common_DateParse(disDateTime);
								if((disDateTime != "")&&(dt1 > dt3))
									errInfo = errInfo + '“手术开始时间”应小于出院时间!<br>';
								if((disDateTime != "")&&(dt2 > dt3))
									errInfo = errInfo + '“手术结束时间”应小于出院时间!<br>';	
								
								var AdmDate = Common_GetValue('BASE_txtAdmDate');
								var dt3 = Common_DateParse(AdmDate);
								if((AdmDate != "")&&(dt1 < dt3))
									errInfo = errInfo + '“手术开始时间”应大于住院时间!<br>';
								if((AdmDate != "")&&(dt2 < dt3))
									errInfo = errInfo + '“手术结束时间”应大于住院时间!<br>';
	...
	obj.OPR_gridOpr_iniFun = function() {
		var tmpGridPanel = new Ext.grid.GridPanel({
			...
			,columns: [
				new Ext.grid.RowNumberer()
				,{header: '手术名称', width: 220, dataIndex: 'OperationDesc', sortable: false, menuDisabled:true, align:'center' }
				,{header: '手术类型', width: 90, dataIndex: 'OperationTypeDesc', sortable: false, menuDisabled:true, align:'center' }
				,{header: '手术开始时间', width : 100, sortable: false, menuDisabled:true, align:'center'
					, renderer: function(v, m, rd, r, c, s){
						if (rd.get("OperStartDate") != '') {
							return rd.get("OperStartDate") + ' ' + rd.get("OperStartTime");
				...
				,{header: '手术医生', width: 100, dataIndex: 'OperDocDesc', sortable: false, menuDisabled:true, align:'center' }
				,{header: '麻醉方法', width: 120, dataIndex: 'AnesthesiaDesc', sortable: false, menuDisabled:true, align:'center' }
				,{header: '切口类型', width: 90, dataIndex: 'CuteTypeDesc', sortable: false, menuDisabled:true, align:'center' }
				,{header: '愈合情况', width: 90, dataIndex: 'CuteHealingDesc', sortable: false, menuDisabled:true, align:'center' }
				,{header: '切口感染', width: 90, dataIndex: 'CuteInfFlagDesc', sortable: false, menuDisabled:true, align:'center' }
				,{header: '感染类型', width: 100, dataIndex: 'OperInfTypeDesc', sortable: false, menuDisabled:true, align:'center' }
				,{header: '引起院<br>内感染', width: 110, dataIndex: 'InHospInfFlagDesc', sortable: false, menuDisabled:true, align:'center' }
				//,{header: '数据<br>来源', width: 50, dataIndex: 'DataSource', sortable: false, menuDisabled:true, align:'center' }
			],
			viewConfig : {
				forceFit : false
	...
	obj.OPR_ViewPort = {
		...
		height : 300,
		anchor : '-20',
		tbar : ['<img SRC="../scripts/dhcmed/img/OPR.png"><b style="font-size:16px;">手术部位</b>'],
		items : [
			{
				layout : 'border',
				frame : true,
				items : [
					{
						...
						buttons : [obj.OPR_gridOpr_btnGet,obj.OPR_gridOpr_btnAdd,obj.OPR_gridOpr_btnDel,'->','…']
					}
				]
			}
		]
