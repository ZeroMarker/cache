...
function InitViewport1Event(obj) {
	...
	obj.gridHandHyReport_rowclick = function() {
		...
		if (objRec.get("ReportID") == obj.RecRowID) {
			...
			Common_SetValue("cbgStIdentity",objRec.get("StIdentityID"));
			Common_SetValue("txtStName",objRec.get("StName"));    
			Common_SetValue("cbgPoint",objRec.get("PointID"));
			Common_SetValue("cbgAction",objRec.get("ActionID"));
			Common_SetValue("cbgActionRit",objRec.get("ActionRitID"));
			Common_SetValue("txtResume",objRec.get("RepResume"));
			if (objRec.get("RepStatusDesc")=="删除"){
