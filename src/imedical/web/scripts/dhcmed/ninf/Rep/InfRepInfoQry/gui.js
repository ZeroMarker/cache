...
function InitViewport()
{
	...
	obj.cboDateType = Common_ComboToDateType1("cboDateType","日期类型","报告日期","COMP");
	...
	obj.txtRegNo = new Ext.form.TextField({
		...
		,fieldLabel : '登记号'
		,anchor : '100%'
		,listeners : {  //fix bug 114199 感染报告查询登记号回车后不能自动补零
	...
	*/
	...
	obj.gridInfReport = new Ext.grid.GridPanel({
		...
		'->','-',obj.btnQuery,'-',obj.btnExport,'-',obj.btnExportInterface]
		,columns: [
