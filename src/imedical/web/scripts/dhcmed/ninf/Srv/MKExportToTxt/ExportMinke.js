function ExportMinke(){
	...
	obj.ExportMinkeData = function(ReportID, ExportPath,ReportType)
	{
		var strTmp = ExtTool.RunServerMethod("DHCMed.NINFService.Srv.ExportMinkeSrv", "ExportReport", ReportID,ReportType);
	...
	obj.ExportMinkeDataICU = function(ReportID, ExportPath)
	{
		...
		obj.WriteFile(strPath + "\\ICU插管情况.txt", arryFile[3]);
