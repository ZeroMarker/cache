...
function InitCSSReport(){
	...
	var htmlMainPanel = ''
		...
		+ '			<table><tr>'
		+ '				<td><div style="width:100px;text-align:right;overflow:hidden;"><font color="red">*</font>病人编号</div></td><td><div id="TD-txtPatNo" style="width:150px;overflow:hidden;"></div></td>'
		...
		+ '				<td><div style="width:60px;text-align:right;overflow:hidden;"><font color="red">*</font>病历号</div></td><td><div id="TD-txtMRNo" style="width:150px;overflow:hidden;"></div></td>'
		+ '			</tr></table>'
		+ '			<table><tr>'
		+ '				<td><div style="width:100px;text-align:right;overflow:hidden;"><font color="red">*</font>姓名</div></td><td><div id="TD-txtName" style="width:150px;overflow:hidden;"></div></td>'
		+ '				<td><div style="width:60px;text-align:right;overflow:hidden;"><font color="red">*</font>性别</div></td><td><div id="TD-cbgSex" style="width:150px;overflow:hidden;"></div></td>'
		...
		+ '		<tr class="defaulttitle"><td width="100%"><div>'
		+ '		<span style="font-size:16px;"><b>手术情况</b></span>'
		+ '		<span onclick="objScreen.OperInfoDiv_expand();" style="font-size:14px;color:red;">显示本次住院手术情况</span>'
		+ '		</div></td></tr>'
		+ '		<tr><td width="100%"><div id="div-OperInfo" style="width=100%;heigth=50px;"></div></td></tr>'
		+ '		<tr><td width="100%"><div style="width=100%;">'
		+ '			<table><tr>'
		+ '				<td><div style="width:120px;text-align:right;overflow:hidden;"><font color="red">*</font>手术</div></td><td><div id="TD-cbgOper1" style="width:200px;overflow:hidden;"></div></td>'
		+ '			</tr></table>'
		+ '			<table><tr>'
		...
		+ '		<tr class="defaulttitle"><td width="100%"><div>'
		+ '		<span style="font-size:16px;"><b>感染情况（包括医院感染与社区感染）</b></span>'
		+ '		<span onclick="objScreen.LabInfoDiv_expand();" style="font-size:14px;color:red;">显示本次住院病原体检查菌情况</span>'
		+ '		</div></td></tr>'
		+ '		<tr><td width="100%"><div id="div-LabInfo" style="width=100%;heigth=200px;"></div></td></tr>'
		+ '		<tr><td width="100%"><div style="width=100%;">'
		+ '			<table><tr>'
		+ '				<td><div style="width:120px;text-align:right;overflow:hidden;"><font color="red">*</font>感染</div></td><td><div id="TD-cbgIsInfection" style="width:150px;overflow:hidden;"></div></td>'
		+ '			</tr></table>'
		+ '			<table><tr>'
		+ '				<td><div style="width:120px;text-align:right;overflow:hidden;">感染分类</div></td><td><div id="TD-cbgInfCategory" style="width:200px;overflow:hidden;"></div></td>'
		+ '			</tr></table>'
		+ '			<table><tr>'
		...
		+ '			</tr></table>'
		+ '			<table><tr>'
		+ '				<td><div style="width:120px;text-align:right;overflow:hidden;">社区感染部位：</div></td>'
		+ '				<td><div style="width:120px;text-align:right;overflow:hidden;">病原体：</div></td>'
		+ '			</tr></table>'
		+ '			<table><tr>'
		...
		+ '		<tr class="defaulttitle"><td width="100%"><div>'
		+ '		<span style="font-size:16px;"><b>细菌耐药情况</b></span>'
		+ '		<span onclick="objScreen.BugsInfoDiv_expand();" style="font-size:14px;color:red;">显示本次住院细菌耐药情况</span>'
		+ '		</div></td></tr>'
		+ '		<tr><td width="100%"><div id="div-BugsInfo" style="width=100%;heigth=200px;"></div></td></tr>'
		+ '		<tr><td width="100%"><div style="width=100%;">'
		+ '			<table>'
		+ '				<tr>'
		+ '					<td><div style="width:140px;text-align:right;overflow:hidden;">金黄色葡萄球菌：</div></td>'
		+ '						<td><div style="width:120px;text-align:right;overflow:hidden;">苯唑西林</div></td>'
		+ '						<td><div id="TD-cbgAntiSen11" style="width:210px;overflow:hidden;"></div></td>'
		+ '						<td><div style="width:120px;text-align:right;overflow:hidden;">头孢西丁</div></td>'
		+ '						<td><div id="TD-cbgAntiSen12" style="width:210px;overflow:hidden;"></div></td>'
		+ '				</tr>'
		+ '				<tr>'
		+ '					<td><div style="width:140px;text-align:right;overflow:hidden;">凝固酶阴性葡萄球菌：</div></td>'
		+ '						<td><div style="width:120px;text-align:right;overflow:hidden;">苯唑西林</div></td>'
		+ '						<td><div id="TD-cbgAntiSen21" style="width:210px;overflow:hidden;"></div></td>'
		+ '						<td><div style="width:120px;text-align:right;overflow:hidden;">头孢西丁</div></td>'
		+ '						<td><div id="TD-cbgAntiSen22" style="width:210px;overflow:hidden;"></div></td>'
		+ '				</tr>'
		+ '				<tr>'
		+ '					<td><div style="width:140px;text-align:right;overflow:hidden;">粪肠球菌：</div></td>'
		+ '						<td><div style="width:120px;text-align:right;overflow:hidden;">氨苄西林</div></td>'
		+ '						<td><div id="TD-cbgAntiSen31" style="width:210px;overflow:hidden;"></div></td>'
		+ '						<td><div style="width:120px;text-align:right;overflow:hidden;">万古霉素</div></td>'
		+ '						<td><div id="TD-cbgAntiSen32" style="width:210px;overflow:hidden;"></div></td>'
		+ '				</tr>'
		+ '				<tr>'
		+ '					<td><div style="width:140px;text-align:right;overflow:hidden;">屎肠球菌：</div></td>'
		+ '						<td><div style="width:120px;text-align:right;overflow:hidden;">氨苄西林</div></td>'
		+ '						<td><div id="TD-cbgAntiSen41" style="width:210px;overflow:hidden;"></div></td>'
		+ '						<td><div style="width:120px;text-align:right;overflow:hidden;">万古霉素</div></td>'
		+ '						<td><div id="TD-cbgAntiSen42" style="width:210px;overflow:hidden;"></div></td>'
		+ '				</tr>'
		+ '				<tr>'
		+ '					<td><div style="width:140px;text-align:right;overflow:hidden;">肺炎链球菌：</div></td>'
		+ '						<td><div style="width:120px;text-align:right;overflow:hidden;">青霉素</div></td>'
		+ '						<td><div id="TD-cbgAntiSen51" style="width:210px;overflow:hidden;"></div></td>'
		+ '				</tr>'
		+ '				<tr>'
		+ '					<td><div style="width:140px;text-align:right;overflow:hidden;">大肠埃希菌：</div></td>'
		+ '						<td><div style="width:120px;text-align:right;overflow:hidden;">头孢他啶</div></td>'
		+ '						<td><div id="TD-cbgAntiSen61" style="width:210px;overflow:hidden;"></div></td>'
		+ '						<td><div style="width:120px;text-align:right;overflow:hidden;">亚胺/美罗培南</div></td>'
		+ '						<td><div id="TD-cbgAntiSen62" style="width:210px;overflow:hidden;"></div></td>'
		+ '				</tr>'
		+ '				<tr>'
		+ '					<td><div style="width:140px;text-align:right;overflow:hidden;"></div></td>'
		+ '						<td><div style="width:120px;text-align:right;overflow:hidden;">左氧氟沙星</div></td>'
		+ '						<td><div id="TD-cbgAntiSen63" style="width:210px;overflow:hidden;"></div></td>'
		+ '				</tr>'
		+ '				<tr>'
		+ '					<td><div style="width:140px;text-align:right;overflow:hidden;">肺炎克雷伯菌：</div></td>'
		+ '						<td><div style="width:120px;text-align:right;overflow:hidden;">头孢他啶</div></td>'
		+ '						<td><div id="TD-cbgAntiSen71" style="width:210px;overflow:hidden;"></div></td>'
		+ '						<td><div style="width:120px;text-align:right;overflow:hidden;">亚胺/美罗培南</div></td>'
		+ '						<td><div id="TD-cbgAntiSen72" style="width:210px;overflow:hidden;"></div></td>'
		+ '				</tr>'
		+ '				<tr>'
		+ '					<td><div style="width:140px;text-align:right;overflow:hidden;"></div></td>'
		+ '						<td><div style="width:120px;text-align:right;overflow:hidden;">左氧氟沙星</div></td>'
		+ '						<td><div id="TD-cbgAntiSen73" style="width:210px;overflow:hidden;"></div></td>'
		+ '				</tr>'
		+ '				<tr>'
		+ '					<td><div style="width:140px;text-align:right;overflow:hidden;">铜绿假单胞菌：</div></td>'
		+ '						<td><div style="width:120px;text-align:right;overflow:hidden;">环丙沙星</div></td>'
		+ '						<td><div id="TD-cbgAntiSen81" style="width:210px;overflow:hidden;"></div></td>'
		+ '						<td><div style="width:120px;text-align:right;overflow:hidden;">哌拉西林/他唑巴坦</div></td>'
		+ '						<td><div id="TD-cbgAntiSen82" style="width:210px;overflow:hidden;"></div></td>'
		+ '				</tr>'
		+ '				<tr>'
		+ '					<td><div style="width:140px;text-align:right;overflow:hidden;"></div></td>'
		+ '						<td><div style="width:120px;text-align:right;overflow:hidden;">亚胺培南/美罗培南</div></td>'
		+ '						<td><div id="TD-cbgAntiSen83" style="width:210px;overflow:hidden;"></div></td>'
		+ '						<td><div style="width:120px;text-align:right;overflow:hidden;">头孢他啶</div></td>'
		+ '						<td><div id="TD-cbgAntiSen84" style="width:210px;overflow:hidden;"></div></td>'
		+ '				</tr>'
		+ '				<tr>'
		+ '					<td><div style="width:140px;text-align:right;overflow:hidden;"></div></td>'
		+ '						<td><div style="width:120px;text-align:right;overflow:hidden;">头孢吡肟</div></td>'
		+ '						<td><div id="TD-cbgAntiSen85" style="width:210px;overflow:hidden;"></div></td>'
		+ '						<td><div style="width:120px;text-align:right;overflow:hidden;">阿米卡星</div></td>'
		+ '						<td><div id="TD-cbgAntiSen86" style="width:210px;overflow:hidden;"></div></td>'
		+ '				</tr>'
		+ '				<tr>'
		+ '					<td><div style="width:140px;text-align:right;overflow:hidden;">鲍曼不动杆：</div></td>'
		+ '						<td><div style="width:120px;text-align:right;overflow:hidden;">亚胺培南/美罗培南</div></td>'
		+ '						<td><div id="TD-cbgAntiSen91" style="width:210px;overflow:hidden;"></div></td>'
		+ '						<td><div style="width:120px;text-align:right;overflow:hidden;">头孢哌酮/舒巴坦</div></td>'
		+ '						<td><div id="TD-cbgAntiSen92" style="width:210px;overflow:hidden;"></div></td>'
		+ '				</tr>'
		+ '			</table>'
		+ '		</div></td></tr>'
		...
		+ '		<span onclick="objScreen.AntiInfoDiv_expand();" style="font-size:14px;color:red;">显示本次住院抗菌药物使用情况</span>'
		+ '		</div></td></tr>'
		+ '		<tr><td width="100%"><div id="div-AntiInfo" style="width=100%;heigth=200px;"></div></td></tr>'
		+ '		<tr><td width="100%"><div style="width=100%;">'
		+ '			<table><tr>'
		+ '				<td><div style="width:160px;text-align:right;overflow:hidden;"><font color="red">*</font>抗菌药物使用</div></td><td><div id="TD-cbgAnti1" style="width:200px;overflow:hidden;"></div></td>'
		+ '			</tr></table>'
		+ '			<table><tr>'
		+ '				<td><div style="width:160px;text-align:right;overflow:hidden;">目的</div></td><td><div id="TD-cbgAnti2" style="width:300px;overflow:hidden;"></div></td>'
		+ '			</tr></table>'
		+ '			<table><tr>'
		+ '				<td><div style="width:160px;text-align:right;overflow:hidden;">联用</div></td><td><div id="TD-cbgAnti3" style="width:380px;overflow:hidden;"></div></td>'
		+ '			</tr></table>'
		+ '			<table><tr>'
		+ '				<td><div style="width:160px;text-align:right;overflow:hidden;">治疗用药已送细菌培养</div></td><td><div id="TD-cbgAnti4" style="width:200px;overflow:hidden;"></div></td>'
		+ '			</tr></table>'
		+ '		</div></td></tr>'
		...
		+ '			<table><tr>'
		+ '             <td width="50%"> </td>'
		+ '				<td class="td_button"><div id="TD-btnReport" style="width:80px;overflow:hidden;"></div></td>'
		+ '				<td class="td_button"><div id="TD-btnPrint" style="width:80px;overflow:hidden;"></div></td>'
		+ '				<td class="td_button"><div id="TD-btnClose" style="width:80px;overflow:hidden;"></div></td>'
		+ '             <td width="50%"> </td>'
		+ '			</tr></table>'
		+ '		</div></td></tr>'
