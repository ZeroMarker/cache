...
function InitCasesXCtl(){
	...
	var htmlNorthPanel = ''
		...
		+ '</div></td>'
		+ '<td width="9%"><div style="border:1px solid #58D3F7;width=350px;height=92px;">'
		...
		+ '<table><tr><td><div id="cboSSHospTD" style="width:160px;overflow:hidden;"></div></td></tr></table>'
		+ '<table><tr><td><div id="cbgViewTypeTD" style="width:160px;overflow:hidden;"></div></td></tr></table>'
		+ '</div></td>'
		+ '</tr></table>'
					...
					'<div class="subtotal">', 
						'<table width="100%">',
							'<tr>',
								 ...
								 '<td width="95%" class="subtotal_td">{LocDesc}&nbsp;&nbsp;待处理病例：&nbsp;&nbsp;<span class="subtotal_number">共{LocCount}个</span></td>',
							'</tr>',
						'</table>',
					'</div>',
					'<tpl for="PatList">',
