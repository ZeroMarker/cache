...
function InitViewport(){
	...
	obj.ReportQueryTreePanel = new Ext.tree.TreePanel({
		useArrows: true,
		autoScroll: true,
		animate: true,
		enableDD: true,
	...
	obj.cboAdmLoc = Common_ComboToLoc("cboAdmLoc","科室","E","cboAdmWard");
