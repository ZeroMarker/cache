...
function InitLAB(obj)
{
	...
	obj.LAB_gridLab_RowEditer = function(objRec) {
		...
		if (!winGridRowEditer)
		{
			obj.LAB_gridLab_RowEditer_cboArcim = Common_ComboToArcim("LAB_gridLab_RowEditer_cboArcim","<span style='color:red'><b>检验医嘱</b></span>","L");
			obj.LAB_gridLab_RowEditer_cboSpecimen = Common_ComboToDic("LAB_gridLab_RowEditer_cboSpecimen","<span style='color:red'><b>标本</b></span>","NINFInfSpecimen");
			obj.LAB_gridLab_RowEditer_cboInfectionPos = Common_ComboToInfPos("LAB_gridLab_RowEditer_cboInfectionPos","<span style='color:red'><b>感染部位</b></span>");
			obj.LAB_gridLab_RowEditer_txtSubmissionDate = Common_DateFieldToDate("LAB_gridLab_RowEditer_txtSubmissionDate","<span style='color:red'><b>送检日期</b></span>");
			obj.LAB_gridLab_RowEditer_cboAssayMethod = Common_ComboToDic("LAB_gridLab_RowEditer_cboAssayMethod","<span style='color:red'><b>检验方法</b></span>","NINFInfAssayMethod");
			obj.LAB_gridLab_RowEditer_cboPathogenTest = Common_ComboToDic("LAB_gridLab_RowEditer_cboPathogenTest","<span style='color:red'><b>检验结果</b></span>","NINFInfPathogenTest");
				...
				items: [
					{
						...
						bbar : [obj.LAB_gridLab_RowEditer_gridPyAnti_btnAdd,obj.LAB_gridLab_RowEditer_gridPyAnti_btnDel,'->','…']
					}
				],
				bbar : [
					'->',
	...
	obj.LAB_ViewPort = {
		...
		height : 300,
		anchor : '-20',
		tbar : ['<font size=2><b>病原学检验</b><span style="color:red">(请选择与此次感染相关的病原菌送检结果...)</span></font>'],
		items : [
			{
				layout : 'border',
				frame : true,
				items : [
					{
						...
						bbar : [obj.LAB_gridLab_btnGet,obj.LAB_gridLab_btnAdd,obj.LAB_gridLab_btnDel,'->','…']
					}
				]
			}
		]
