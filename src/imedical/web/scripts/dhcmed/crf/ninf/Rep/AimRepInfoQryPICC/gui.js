...
function InitViewport()
{
	...
	obj.cboDateType = Common_ComboToDateType("cboDateType","日期类型","PICC","填报日期" + CHR_1 + "报告日期");
	...
	obj.QueryGridPanelStore = new Ext.data.Store({
		...
		[
			...
			,{name: 'TransDiagnos', mapping: 'TransDiagnos'}
	...
	obj.QueryGridPanel = new Ext.grid.GridPanel({
		...
		,columns: [
			...
			,{header: '入科来源', width: 100, dataIndex: 'TransFromLocDesc', sortable: false, menuDisabled:true, align:'center' }
			,{header: '转入日期', width: 100, dataIndex: 'TransStartDate', sortable: false, menuDisabled:true, align:'center' }
			,{header: '诊断', width: 130, dataIndex: 'MrDiag', sortable: false, menuDisabled:true, align:'center' }
			,{header: '置管日期', width: 100, dataIndex: 'IntubateDate', sortable: false, menuDisabled:true, align:'center' }
			...
			,{header: '拔管日期', width: 100, dataIndex: 'ExtubateDate', sortable: false, menuDisabled:true, align:'center' }
			,{header: '拔管原因', width: 60, dataIndex: 'ExtubateReasonDesc', sortable: false, menuDisabled:true, align:'center' }
			,{header: '出科去向', width: 100, dataIndex: 'TransToLocDesc', sortable: false, menuDisabled:true, align:'center' }
			,{header: '转出日期', width: 100, dataIndex: 'TransEndDate', sortable: false, menuDisabled:true, align:'center' }			
			,{header: '出院日期', width: 100, dataIndex: 'DischDate', sortable: false, menuDisabled:true, align:'center' }
			,{header: '住院<br>天数', width: 50, dataIndex: 'TransDays', sortable: false, menuDisabled:true, align:'center' }
