...
function InitViewport()
{
	...
	obj.cboDateType = Common_ComboToDateType("cboDateType","日期类型","UC","填报日期" + CHR_1 + "报告日期");
	...
	obj.QueryGridPanel = new Ext.grid.GridPanel({
		...
		,columns: [
			...
			,{header: '置管/转入日期', width: 100, dataIndex: 'IntubateDate', sortable: false, menuDisabled:true, align:'center' }
			...
			,{header: '拔管/转出日期', width: 100, dataIndex: 'ExtubateDate', sortable: false, menuDisabled:true, align:'center' }
