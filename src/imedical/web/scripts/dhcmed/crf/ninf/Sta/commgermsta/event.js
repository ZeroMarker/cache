...
function InitWinControlEvent(obj){
	...
	obj.LoadEvent = function(args){
		...
		obj.radioDateType1.fireEvent("check");
		//obj.dfDateFrom.setValue("2012-01-01");
		obj.btnQuery_click();
	}
	
	obj.radioDateType1.on("check", 
		function(){
	...
	obj.btnQuery_click = function(){
		...
		var strUrl = "./dhccpmrunqianreport.csp?reportName=DHCMed.NINF.Rep.InfSta015.raq" +
