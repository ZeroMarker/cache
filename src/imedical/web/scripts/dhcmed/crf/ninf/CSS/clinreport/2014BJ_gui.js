...
function InitCSSReport(){
	...
	var htmlMainPanel = ''
		...
		+ '				<td><div style="width:60px;text-align:right;overflow:hidden;">病例号：</div></td><td><div id="TD-txtMRNo" style="width:150px;overflow:hidden;"></div></td>'
		+ '				<td><div style="width:70px;text-align:right;overflow:hidden;">入院日期：</div></td><td><div id="TD-txtAdmDate" style="width:150px;overflow:hidden;"></div></td>'
		+ '			</tr></table>'
		+ '			<table><tr>'
		...
		+ '			</tr></table>'
		+ '			<table><tr>'
		+ '				<td><div style="width:100px;text-align:right;overflow:hidden;">基础疾病诊断：</div></td>'
		...
		+ '			</tr></table>'
		+ '			<table><tr>'
		+ '				<td><div style="width:210px;text-align:right;overflow:hidden;">过去24小时内是否有≥3次的腹泻：</div></td><td><div id="TD-cbgAddOns4" style="width:150px;overflow:hidden;"></div></td>'
		+ '			</tr></table>'
		+ '		</div></td></tr>'
		
		+ '		<tr><td width="100%"><div style="width=100%;background-color:#84C1FF;">'
		+ '		<span style="font-size:20px;"><b>感染情况</b></span>'
		...
		+ '		<tr><td width="100%"><div style="width=100%;">'
		+ '			<table><tr>'
		+ '				<td><div style="width:85px;text-align:right;overflow:hidden;">医院感染：</div></td><td><div id="TD-cbgIsInfection" style="width:150px;overflow:hidden;"></div></td>'
		+ '			</tr></table>'
		+ '			<table><tr>'
		+ '				<td><div style="width:140px;text-align:right;overflow:hidden;">医院感染部位：</div></td>'
		+ '				<td><div style="width:155px;text-align:right;overflow:hidden;">感染日期(年月日)：</div></td>'
		...
		+ '		<tr><td width="100%"><div style="width=100%;">'
		+ '			<table><tr>'
		+ '				<td><div style="width:190px;text-align:right;overflow:hidden;">抗菌药物使用：</div></td><td><div id="TD-cbgAnti1" style="width:170px;overflow:hidden;"></div></td>'
		+ '			</tr></table>'
		+ '			<table><tr>'
		+ '				<td><div style="width:190px;text-align:right;overflow:hidden;">目的：</div></td><td><div id="TD-cbgAnti2" style="width:260px;overflow:hidden;"></div></td>'
		+ '			</tr></table>'
		+ '			<table><tr>'
		+ '				<td><div style="width:190px;text-align:right;overflow:hidden;">联用：</div></td><td><div id="TD-cbgAnti3" style="width:350px;overflow:hidden;"></div></td>'
		+ '			</tr></table>'
		+ '			<table><tr>'
		...
		+ '		<tr><td width="100%"><div style="width=100%;background-color:#84C1FF;">'
		+ '		<span style="font-size:20px;"><b>手术相关情况</b></span>'
		...
		+ '		<tr><td width="100%"><div style="width=100%;">'
		+ '			<table><tr>'
		+ '				<td><div style="width:190px;text-align:right;overflow:hidden;">手术：</div></td><td><div id="TD-cbgOper1" style="width:170px;overflow:hidden;"></div></td>'
		+ '			</tr></table>'
		+ '			<table><tr>'
		...
		+ '		<tr><td width="100%"><div style="width=100%;background-color:#84C1FF;">'
		+ '		<span style="font-size:20px;"><b>侵袭性操作相关情况</b></span>'
		+ '		</div></td></tr>'
		+ '		<tr><td width="100%"><div style="width=100%;">'
		+ '			<table><tr>'
