function InitviewScreen() {
	...
	//Add By LiYang 2015-05-14 导出传染病接口
	...
	obj.btnExportWord = new Ext.Button({
				//id : 'btnExportWord',
				iconCls : 'icon-export',
				text : '导出报告'
			});
	...
	obj.ConditionPanel = new Ext.form.FormPanel({
				...
				,buttons : [
					...
					,obj.btnExportAll
					,obj.btnExportWord
					,obj.btnExportInterface //Add By LiYang 2015-05-14 导出传染病接口
				]
			});
	// ****************************** End ****************************
				...
				columns : [obj.DataRowNumberer, obj.DataCheckColumn, {
						...
						, {
							...
							renderer : function(v, m, rd, r, c, s){
								...
								return " <a href='#' onclick='DisplayHIVRep(\""+v+"\",\""+EpisodeID+"\",\""+PatientID+"\");'>"+v+"</a>";
							}
						}, {
							header : '现住址',
							width : 250,
