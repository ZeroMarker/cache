...
{
	var ClsCaseFollow = ExtTool.StaticServerObject("DHCMed.EPD.CaseFollow");
		var objCaseSrv = ExtTool.StaticServerObject("DHCMed.EPDService.CaseFollowSrv");
		...
		var flg=objCaseSrv.ExportHIVCaseRep("fillxlSheet",strArguments);
