...
function BFind_Click()
{
	...
	window.location.href="websys.default.csp?WEBSYS.TCOMPONENT=DHCEQCManufacturer"+val;
}
...
function BDelete_Click() 
{
	...
	if (result>0) { window.location.href="websys.default.csp?WEBSYS.TCOMPONENT=DHCEQCManufacturer";} //modified by GR 2014-09-24 缺陷号2995 删除厂商记录，部分查询条件未自动清空 	
}
function BUpdate_Click() 
{
	...
	{
		alertShow("保存成功!");
		window.location.href="websys.default.csp?WEBSYS.TCOMPONENT=DHCEQCManufacturer";	//modified by GR 2014-09-24 缺陷号2995 删除厂商记录，部分查询条件未自动清空
	}
}
