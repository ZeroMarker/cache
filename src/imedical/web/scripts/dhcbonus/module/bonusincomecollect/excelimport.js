...
var importExcel = function() {
	...
	fileTypeDs.on('beforeload', function(ds, o){
		ds.proxy=new Ext.data.HttpProxy({
			url:'../csp/dhc.bonus.bonustargetcollectexe.csp?action=TargetFileType&modeType=1&targetTable=dhc_bonus_module.BonusIncomeCollect&userCode='+session['LOGON.USERCODE'],method:'POST'})
	});
