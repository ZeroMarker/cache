...
var importExcel = function() {
	...
	fileTypeDs.on('beforeload', function(ds, o){
		ds.proxy=new Ext.data.HttpProxy({
			url:'../csp/dhc.bonus.bonustargetcollectexe.csp?action=TargetFileType&modeType=1&targetTable=dhc_bonus_module.DrgsItemCollect&userCode='+session['LOGON.USERCODE'],method:'POST'})
	});
			...
			function callback(id) {
				if (id == "yes") {
					...
					if (excelName == "") {
						...
						var uploadUrl = dhcbaUrl+"/dhcBonusImp8.1/commonImportExcel";
