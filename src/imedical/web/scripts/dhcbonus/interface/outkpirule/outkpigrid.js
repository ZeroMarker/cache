...
var delButton = new Ext.Toolbar.Button({
	...
	handler:function(){
		...
		var len = rowObj.length;
		if(len < 1){
			Ext.Msg.show({title:'注意',msg:'请选择需要删除的奖金指标记录!',buttons: Ext.Msg.OK,icon:Ext.MessageBox.WARNING});
			return false;
		}else{
...
var outKpiFilterItem = new Ext.Toolbar.MenuButton({
	...
	menu: {items: [
		...
		new Ext.menu.CheckItem({ text: '名称',value: 'name',checked: true,group: 'outKpiFilter',checkHandler: onBusItemItemCheck })
	]}
});
