...
var cValue = new Array(
	{header:'',dataIndex:'BonusSubDoctorGroupMapID'},										//0
	{header:'',dataIndex:'BonusSubDoctorGroupID'}, 		//1
	{header:'',dataIndex:'BonusUnit'},         		//2
	{header:'医生编码',dataIndex:'BonusUnitCode'},			//3
	{header:'医生名称',dataIndex:'BonusUnitName'} ,       	//4
	{header:'',dataIndex:'BonusUnitTypeID'},			//5
	{header:'',dataIndex:'UnitTypeName'}        	//6
);

var cUrl = 'dhc.bonus.bonussubdoctorgroupexe.csp';
...
cDs.setDefaultSort('BonusSubDoctorGroupMapID', 'Desc');
	...
	handler: function(){
		...
		if(len < 1){
			...
			Ext.MessageBox.confirm(
				...
				function(btn){
					if(btn == 'yes'){
						myId = rowObj[0].get("BonusSubDoctorGroupMapID");
						Ext.Ajax.request({
