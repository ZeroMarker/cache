...
var importExcel = function(){
	...
	cDs.on('beforeload', function(ds, o){
		ds.proxy=new Ext.data.HttpProxy({url:'dhc.pa.paauditexe.csp?action=cycle&str='+Ext.getCmp('cycle').getRawValue()+'&active=Y',method:'POST'})
	});
			...
			function callback(id){
				if(id=="yes"){
					...
					if(excelName==""){
						...
						//var uploadUrl = "http://127.0.0.1:8088/uploadexcel/importexcel";
						var uploadUrl = "http://127.0.0.1:8088/uploadexcel/importzyyexcel";
						//var uploadUrl = "http://127.0.0.1:8088/uploadexcel/importzyybasedataexcel";
