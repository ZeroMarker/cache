addCostDeptsFun = function(dataStore,grid,pagingTool,parRef,type,costCombo,recCombo,layerDr,deptLevelSetsDr) {
	if(type=="")
	{
    ...
    buttons: [{
		...
		handler: function() {
        	if (formPanel.form.isValid()) {
						Ext.Ajax.request({
							url: costDistSetsUrl+'?action=addCostDepts&id='+parRef+'&deptDr='+items.getValue()+'&type='+type+'&rate='+rateField.getValue(),
							waitMsg:'保存中...',
