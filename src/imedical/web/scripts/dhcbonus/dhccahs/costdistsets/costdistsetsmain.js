...
var costDistSetsCm = new Ext.grid.ColumnModel([new Ext.grid.RowNumberer(), {
    ...
    //    return "<a href=javascript:addFun(" + rec.data.rowid + ");>" + s + "</a>";
    //}
...
var costDistSetsMain = new Ext.grid.GridPanel({//表格
    ...
    loadMask: true,
    tbar: [addDataTypesButton, '-', editDataTypesButton, '-', costDistMethodsButton, '-', examinButton, '-', costDistButton, '-', costResultButton],
