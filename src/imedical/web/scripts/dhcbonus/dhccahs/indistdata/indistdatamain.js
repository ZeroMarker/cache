	...
	handler: function(){ 
			if(months.getValue()==""){
				Ext.Msg.alert("提示","请选择核算周期");
						...
						location.href = 'http://172.26.201.66:1969/outload/InDistData?outType=xls&months='+months.getValue();
...
var inDistDataMain = new Ext.grid.GridPanel({//表格
    ...
    loadMask: true,
    tbar: ['核算周期:', months, '-', addDataTypesButton, '-', delDataTypesButton, '-', totalButton,'-',countButton,'-',excelButton],
