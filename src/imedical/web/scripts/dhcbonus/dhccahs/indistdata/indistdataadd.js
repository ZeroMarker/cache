        ...
        buttons: [{
            ...
            handler: function() {
                ...
                if (formPanel.form.isValid()) {
                    Ext.Ajax.request({
                        url: inDistDataUrl + '?action=add&intervalDr=' + intervalDr + '&itemTypes=' + itemTypes + '&itemDr=' + itemDr + '&deptDr=' + deptDr + '&flag=' + flag + '&fee=' + fee + '&inType=' + inType + '&remark=' + remark,
                        waitMsg: '保存中...',
