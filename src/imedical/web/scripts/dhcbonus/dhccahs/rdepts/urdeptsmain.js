...
var mainSearchField = 'deptName';

var mainFilterItem = new Ext.Toolbar.MenuButton({
		text: '过滤器',
		tooltip: '关键字所属类别',
		menu: {items: [
			new Ext.menu.CheckItem({ text: '部门顺序',value: 'order',checked: false,group: 'MainFilterGroup',checkHandler: onMainItemCheck }),
			new Ext.menu.CheckItem({ text: '部门名称',value: 'deptName',checked: true,group: 'MainFilterGroup',checkHandler: onMainItemCheck })
		]}
});
