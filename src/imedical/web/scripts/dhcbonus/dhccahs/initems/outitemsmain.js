...
//外部项目从一个核算项目转换到另一个核算项目
var changeButton  = new Ext.Toolbar.Button({
		text:'移动接口项目',        
		tooltip:'移动接口项目',
		iconCls:'remove',        
		handler: function(){
			...
			{
				changeOutFun(outItemsDs,outItemsGrid,outItemsPagingToolbar);
			}
		}
});
...
var outItemsGrid = new Ext.grid.GridPanel({
	...
	//tbar: ['接口项目:',outItemSetSelecter,'-',addButton,'-',editButton,'-',delButton],
	tbar: [addButton,'-',editButton,'-',delButton,'-',changeButton],
