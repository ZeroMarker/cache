									...
									Ext.Ajax.request({
										...
										success: function(result, request) {
											...
											if (jsonData.success=='true') {		
												...
												inDataCardingds.load({params:{start:0, limit:inDataCardingPagingToolbar.pageSize}});
	...
	inDataCardingRulesfilteritem = new Ext.Toolbar.MenuButton({
						...
						tooltip: '关键字所属类别',
						menu: {items: [
							new Ext.menu.CheckItem({ text: '组名', value: 'code', checked: false, group: 'filter',checkHandler: inDataCardingRulesonItemCheck }),
							new Ext.menu.CheckItem({ text: '是否有效', value: 'name', checked: true, group: 'filter', checkHandler: inDataCardingRulesonItemCheck })
						]}
  });
...
////
	...
	inDataCardingPanel.on('rowclick',function(grid,rowIndex,e){
		...
		}else if(inDataCardingCode==RULETWO){
