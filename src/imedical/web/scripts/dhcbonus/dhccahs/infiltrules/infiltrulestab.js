    ...
    var specialParamds = new Ext.data.Store({
        ...
        proxy: new Ext.data.HttpProxy({
            url: 'dhc.ca.infiltrulesexe.csp?action=listrule'
        }),
						...
						Ext.MessageBox.confirm('提示', 
							...
							function(btn) {
								...
								{		
									...
									Ext.Ajax.request({
										url:'dhc.ca.infiltrulesexe.csp?action=delparam&id='+tmpRowid,
										waitMsg:'删除中...',
...
////
	...
	specialParamPanel.on('rowclick',function(grid,rowIndex,e){
		...
		inFiltPatDeptsDs.load({params:{start:0, limit:inFilttDeptsPagingToolbar.pageSize,parRef:inFiltRulesId}});
	});
specialParamds.load({params:{start:0, limit:specialParamPagingToolbar.pageSize}});
