			...
			buttons: [{
				...
				handler: function() {
					...
					if (formPanel.form.isValid()) {
						Ext.Ajax.request({
							url: encodeURI(outDeptsUrl+'?action=editOutDept&inDeptId='+parRef+'&id='+rowId+'&code='+code+'&name='+name+'&remark='+remark+'&inDeptSetsId='+inDeptSetsId+'&order='+orderField.getValue()+'&patType='+formComm.getValue()),
							waitMsg:'保存中...',
							...
							success: function(result, request) {
								...
								if (jsonData.success=='true') {
									...
									{
										var message="";
										message = "该科室已经在"+jsonData.info+"添加";
