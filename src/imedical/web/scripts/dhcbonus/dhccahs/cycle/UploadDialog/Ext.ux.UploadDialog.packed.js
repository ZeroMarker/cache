...
Ext.ux.UploadDialog.BrowseButton = Ext
		.extend(
				Ext.Button,
				{
					...
					autoWidth : function() {
						Ext.ux.UploadDialog.BrowseButton.superclass.autoWidth
								.call(this);
						this.adjustInputFileBox()
					},
		...
		.extend(
				...
				Ext.Window,
				{
					...
					fireBeforeFileUploadStartEvent : function(record) {
						return this.fireEvent("beforefileuploadstart", this,
								record.get("filename"), record) !== false
					},
					...
					fireUploadCanceledEvent : function(record) {
						this.fireEvent("uploadcanceled", this, record
								.get("filename"), record)
					},
					...
					fireUploadSuccessEvent : function(data) {
						this.fireEvent("uploadsuccess", this, data.record
								.get("filename"), data.response, data.record)
					},
