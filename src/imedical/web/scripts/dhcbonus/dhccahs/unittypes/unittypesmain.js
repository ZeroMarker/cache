...
var unittypesProxy = new Ext.data.HttpProxy({url: unittypesUrl + '?action=list'});
...
var unittypesFilterItem = new Ext.Toolbar.MenuButton({
		...
		tooltip: '关键字所属类别',
		menu: {items: [
				new Ext.menu.CheckItem({ text: '代码',value: 'code',checked: false,group: 'UnittypesFilter',checkHandler: onUnittypesItemCheck }),
				new Ext.menu.CheckItem({ text: '名称',value: 'name',checked: true,group: 'UnittypesFilter',checkHandler: onUnittypesItemCheck }),
				//new Ext.menu.CheckItem({ text: '快捷码',value: 'shortcut',checked: true,group: 'UnittypesFilter',checkHandler: onUnittypesItemCheck }),
				new Ext.menu.CheckItem({ text: '备注',value: 'remark',checked: false,group: 'UnittypesFilter',checkHandler: onUnittypesItemCheck }),
				new Ext.menu.CheckItem({ text: '标志',value: 'flag',checked: false,group: 'UnittypesFilter',checkHandler: onUnittypesItemCheck }),
				new Ext.menu.CheckItem({ text: '有效',value: 'active',checked: false,group: 'UnittypesFilter',checkHandler: onUnittypesItemCheck })
		]}
});
...
var unittypesSearchBox = new Ext.form.TwinTriggerField({//查找按钮
		...
		onTrigger1Click: function() {
				if(this.getValue()) {
							this.setValue('');    
							unittypesDs.proxy = new Ext.data.HttpProxy({url: unittypesUrl + '?action=list'});
