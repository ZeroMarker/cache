        ...
        buttons: [{
            ...
            handler: function() {
                ...
                if (formPanel.form.isValid()) {
                    Ext.Ajax.request({
                        url: salaryUrl + '?action=add&intervalDr=' + intervalDr + '&dataTypeDr=' + ITEMTYPEID + '&itemDr=' + itemDr + '&servedDeptDr=' + servedDeptDr + '&receiverDr=' + receiverDr + '&fee=' + fee + '&operDr=' + operDr + '&remark=' + remark,
                        waitMsg: '保存中...',
                        ...
                        success: function(result, request) {
                            ...
                            if (jsonData.success == 'true') {
                                ...
                                salaryDs.setDefaultSort('rowid', 'desc');
