        ...
        buttons: [{
            ...
            handler: function() {
                ...
                if (formPanel.form.isValid()) {
                    Ext.Ajax.request({
                        url: salaryUrl + '?action=edit&id=' + myRowid + '&itemCode=' + itemCode + '&itemName=' + itemName + '&servedDeptCode=' + servedDeptCode + '&servedDeptName=' + servedDeptName + '&receiverCode=' + receiverCode + '&fee=' + fee + '&receiverName=' + receiverName + '&remark=' + remark + '&operDr=' + userDr,
                        waitMsg: '保存中...',
