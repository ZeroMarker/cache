...
var importExcel = function() {
	...
	fileTypeDs.on('beforeload', function(ds, o){
		ds.proxy=new Ext.data.HttpProxy({
			url:'../csp/dhc.bonus.bonustargetcollectexe.csp?action=TargetFileType&modeType=1&targetTable=dhc_bonus_subs.BonusSubExpendCollect&userCode='+session['LOGON.USERCODE'],method:'POST'})
	});
				...
				if (id == "yes") {
					...
					if (excelName == "") {
					  ...
					  var fileRowID=fileTypeVale.split(",")[0];
						...
						var uploadUrl = dhcbaUrl+"/ImportRBRVS";
