...
dhc.herp.Grid = Ext.extend(Ext.grid.EditorGridPanel, {
	...
	save : function() {
		...
		Ext.each(records, function(r) {
			...
			// alert(saveUrl)
			//dhcbaUrl
			//var urll=dhcbaUrl+'/Sync-1.0-SNAPSHOT/keys.html?code='+r.data['Code'];
		/*	var urll=dhcbaUrl+'/DataSync/CreateKey.html?code='+r.data['Code'];
			
			//$.ajax({url:urll,async:false});
			
			//var dhcbaUrl='http://localhost:8080'		
			//var urll=dhcbaUrl+'/DataSync/CreateKey.html?code='+r.data['Code'];
			//alert(urll);
						Ext.Ajax.request({
						url : urll,
