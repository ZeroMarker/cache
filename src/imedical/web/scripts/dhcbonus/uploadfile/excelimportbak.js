...
var importExcel = function() {
	...
	periodType.on("select", function(cmb, rec, id) {
		if (cmb.getValue() == "M") {
			data2 = [['M01', '01月'], ['M02', '02月'], ['M03', '03月'], ['M04', '04月'],
					['M05', '05月'], ['M06', '06月'], ['M07', '07月'], ['M08', '08月'],
					['M09', '09月'], ['M10', '10月'], ['M11', '11月'], ['M12', '12月']];
		}
		if (cmb.getValue() == "Q") {
			data2 = [['Q01', '01季度'], ['Q02', '02季度'], ['Q03', '03季度'], ['Q04', '04季度']];
		}
		if (cmb.getValue() == "H") {
			...
			function callback(id) {
				if (id == "yes") {
					...
					if (excelName == "") {
						...
						// alert( window.parent.location.host)

						var uploadUrl = "http://localhost:8090/dhcba/uploadDataExcel";
						var upUrl = uploadUrl + "?bYear=" + bYear
								+ "&bPeriod=" + bPeriod;
