			...
			function callback(id) {
				if (id == "yes") {
					...
					if (excelName == "") {
						...
						var upUrl = uploadUrl+"?bYear="+bYear+"&bPeriod="+bPeriod+"&configFile="+configFile+"&fileTypeID="+fileTypeID;
			...
			function callback(id) {
				if (id == "yes") {
					...
					if (excelName == "") {
						...
						var uploadUrl = "http://192.168.1.81:8080/dhchxbonus/targetCalculateRateServlet";
						var uploadUrl2 = "http://192.168.1.81:8080/dhchxbonus/targetCollect";
						var uploadUrl3 = "http://192.168.1.81:8080/dhchxbonus/targetJCJ";
