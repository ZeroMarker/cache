...
============================================================================ */
	...
	function SaveToObject()
	{
		...
		obj.StrB = document.getElementById("StrB").checked;
		if(obj.StrB==true){
			obj.StrB="Y";	
		}else{
			obj.StrB="N";	
	...
	function DisplayDictionaryInfo(objDic)
	{
		...
		else
		{
			...
			if(objDic.StrB=="Y"){objDic.StrB=true;}
			else{objDic.StrB=false;}
			document.getElementById("StrB").checked = objDic.StrB;
		}
	}
