...
var frm = document.forms["fCTCarPrvRecPref_Edit"];
...
function ReadOnly() {
	DisableField("ORPRecovText");
	DisableField("RecOperDesc"); DisableField("ld2113iRecOperDesc");
	DisableField("RecStPPPDesc"); DisableField("ld2113iRecStPPPDesc");
	DisableField("Update");
