    ...
    $HUI.datagrid("#tDHCEQProxyAuthorizationList",{
        ...
        columns:[[
                ...
                */
                ...
                {field:'Product',title:'产品',width:100,align:'left',rowspan:2},
                {field:'Level',hidden:true,rowspan:2},
                {title:'授权信息',colspan:6}],
                [{field:'PALevel',title:'授权级别',width:60,align:'left',rowspan:1},
                {field:'PARowID',hidden:true,rowspan:1},
                {field:'PAAuthorizer',title:'授权者',width:200,align:'left',rowspan:1},
                {field:'PAAuthorized',title:'被授权者',width:200,align:'left',rowspan:1},
                {field:'PADesc',title:'证书描述',width:100,align:'left',rowspan:1},
                {field:'PAAvailableDate',title:'有效期',width:200,align:'left',rowspan:1},
                {field:'PALimitFlag',title:'限定产品',width:60,align:'center',rowspan:1}
            ]],
