...
function InitQualityList()
{
	...
	if('undefined' != typeof websys_getMWToken)
	{
		var outPat = '<iframe id = "frameoutPat" frameborder="0" style="width:100%; height:100%;scrolling:no;" src="dhc.emr.quality.entrygrid.csp?Title='+ outPatTabTitle +'&EpisodeID='+EpisodeID+'&action='+action+'&MWToken='+websys_getMWToken()+'"</iframe>';
	}
	else
	{
		var outPat = '<iframe id = "frameoutPat" frameborder="0" style="width:100%; height:100%;scrolling:no;" src="dhc.emr.quality.entrygrid.csp?Title='+ outPatTabTitle +'&EpisodeID='+EpisodeID+'&action='+action+'"</iframe>';
	}
