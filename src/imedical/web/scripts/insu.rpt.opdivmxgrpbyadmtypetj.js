 ...
 */
 var INSURPT_CONSTANT = {
	...
	IFRAME: {
		//定义报表URL+报表文件
		SRC: 'dhccpmrunqianreport.csp?reportName=InsuOPDivMXGrpByAdmTypeTJ.rpx'
	}
};
...
function scanReport() {
	...
	var url = INSURPT_CONSTANT.IFRAME.SRC + '&StDate=' + StDate + '&EndDate=' + EndDate+ '&InsuType=' + InsuType
		url += '&InsuAdmType=' + InsuAdmType+'&InsuTypeDesc=' + InsuTypeDesc + '&HOSPID=' + INSURPT_CONSTANT.SESSION.HOSP_ROWID;
	$('#report').attr('src', url);
