...
var lstItems=document.getElementById('MSGMessageType');
var outAry = new Array();
Init();

function Init() {
	var obj=document.getElementById('HL7MSGType'); if (obj) obj.onfocus=HL7MSGTypeFocusHandler;
...
function BodyLoadHandler() {
	...
	//
	// Load strAry (built in web.SSHL7MessageType.GetMessages) into REAL array.
...
function HL7MSGTypeFocusHandler() {
