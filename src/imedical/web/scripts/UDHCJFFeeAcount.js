...
function BodyLoadHandler() {
    ...
    //document.getElementById('stdate').value=cspRunServerMethod(encmeth,"FEEACOUNT")
	var stdate=cspRunServerMethod(encmeth,"FEEACOUNT")
    lastenddate=stdate
	...
	if (obj) obj.onclick=PrintFeeAcount_click;
...
{	var getstdate=document.getElementById('getstdate');
    if (getstdate) {var encmeth=getstdate.value} else {var encmeth=''};
    stdate=cspRunServerMethod(encmeth,"FEEACOUNT")
    lastenddate=stdate
    document.getElementById('stdate').value=stdate
    //Find_click()
}
...
{   jsflag=""
    ...
    var laststr1=(cspRunServerMethod(encmeth,"FEEACOUNT",stdate,enddate))
