...
function btnFind_onclick()
{
	...
	var lnk="websys.default.csp?WEBSYS.TCOMPONENT=DHC.WMR.Circul.StatDischInfo.List" + "&AdmLoc=" + Loc + "&AdmWard=" + Ward + "&AdmDoc=" + Doc + "&DateFrom=" + DateFrom + "&DateTo=" + DateTo;
...
function btnPrint_onclick()
{
	...
	var flg=PrintDataByExcel("MethodGetServer","MethodGetData","DHCWMRCirculStatDischPatient.xls",cArguments);
}
