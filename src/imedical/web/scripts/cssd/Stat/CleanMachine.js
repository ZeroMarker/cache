...
var init = function() {
	...
	function CheckedUrl(Checked,Params,Conditions){
		//入库单列表
		if('FlagStatCleanMachine'==Checked){
			p_URL = PmRunQianUrl+'?reportName=CSSD_HUI_StatCleanMachine.raq&Params='+Params+'&Conditions='+Conditions;
		}else if('FlagStatCleanMachineDetail'==Checked){
			p_URL = PmRunQianUrl+'?reportName=CSSD_HUI_StatCleanMachineDetail.raq&Params='+Params+'&Conditions='+Conditions;
		}
