...
var gGridHeight = $(window).height() * 0.3;
var PrintMethod=0;  //普通单据打印方式 0-Lodop 1-RQ
var HVBarcodePrintMethod=1;  //高值条码打印方式 0-Lodop 1-XML
/**
 ...
 */
function GetAppPropValue(AppName){
	//if(isEmpty(LocId)){
...
function Common_PrintLog(Type, Pointer, AutoFlag,PrintNum){
	...
	var Ret = tkMakeServerCall('web.CSSDHUI.Common.UtilCommon', 'BillPrintLog', Type, Pointer, AutoFlag, gUserId,PrintNum);
	if(Ret !== '0'){
