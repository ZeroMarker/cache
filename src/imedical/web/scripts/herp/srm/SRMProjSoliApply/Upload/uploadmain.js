uploadMainFun=function(itemGrid,rowidIndex,SysNo,ColNum){
	...
	itemGrid.on('cellclick',function( g, rowIndex, columnIndex, e ){
		...
		var RecDr=tmpRec.data[rowidIndex];   //上传记录ID
		 ...
		 var AuditStatus1=tmpRec.data['AuditStatus'];
		 
			if((AuditStatus1=='通过')||(AuditStatus1=='不通过')){
					Ext.Msg.show({title:'提示',msg:'数据已经审核不允许上传!',buttons: Ext.Msg.OK,icon:Ext.MessageBox.WARNING});
					return;
			};
