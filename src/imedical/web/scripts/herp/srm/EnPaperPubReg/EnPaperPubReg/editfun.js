...
formPanel.on('afterlayout', function(panel, layout) {
			...
			RecordType.setRawValue(rowObj[0].get("RecordType"));//被收录数据库
...
var allcorrauthorinfo = "";
        ...
        var RecordTypes = RecordType.getValue();//被收录数据库
        ...
        var enPaperTypes=rowObj[0].get("PaperType");  //刘小明
        ...
        var invoiceCode=rowObj[0].get("InvoiceCode");  //刘小明
        ...
        if(enPaperTypes==EnPaperTypes){EnPaperTypes="";}  ///刘小明
        ...
        if(iff==IFs){IFs="";}        
        if(invoiceCode==InvoiceCodes){InvoiceCodes="";}   //刘小明
        if(invoiceNo==InvoiceNos){InvoiceNos="";}   //刘小明
