...
/////********************************************************************
	...
	if (len < 1) {
		...
		var mainusercode = session['LOGON.USERCODE'];
		DetailGrid.load({params:{start:0, limit:12,rowid:mainrowid,applydr:mainusercode}});	
	}
...
//////*******************************************************************
		...
		var detailsm=DetailGrid.getSelectionModel();
		var records=detailsm.getSelections()//表示选中的很多行，得到的是一个数组。form.getForm().reset();
