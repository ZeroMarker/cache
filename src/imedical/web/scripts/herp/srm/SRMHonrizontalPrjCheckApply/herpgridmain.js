...
dhc.herp.Gridmain = Ext.extend(Ext.grid.EditorGridPanel, {
	edit : true,
	trackMouseOver : true,
	stripeRows : true,
	cm : colModel,
	...
	initComponent : function() {
		...
		dhc.herp.Gridmain.superclass.initComponent.call(this);
	},
	createPlugins : function() {
		...
		plugins.push(dhc.herp.GridmainTip);
	...
	save : function() {
	  ...
	  var state = rowObj[0].get("ChkResult");
	  var projstatus = rowObj[0].get("ProjStatusID");
	//alert(state);			
	  if(!((state=="1")&&(projstatus=="2"))){	
     Ext.Msg.show({title:'警告',msg:'数据已提交，不可再修改！',buttons: Ext.Msg.OK,icon:Ext.MessageBox.WARNING});
     return;
     }
