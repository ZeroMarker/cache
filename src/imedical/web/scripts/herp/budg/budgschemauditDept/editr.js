editrFun = function(itemGrid,schid) {
	...
	var editrUrl ='../csp/herp.budg.budgschemauditdeptexe.csp';
...
unituserDs.on('beforeload', function(ds, o){
	...
	url:commonboxURL+'?action=username&flag=1&str='+encodeURIComponent(Ext.getCmp('unituserField2').getRawValue()),method:'POST'});
});
var unituserField2 = new Ext.form.ComboBox({
	...
	deptTypeDs.on('beforeload', function(ds, o){
		...
		ds.proxy=new Ext.data.HttpProxy({url:commonboxURL+'?action=deptType1',method:'POST'});
