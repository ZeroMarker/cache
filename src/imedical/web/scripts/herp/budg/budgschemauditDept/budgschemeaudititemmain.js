...
deptDs.on('beforeload', function(ds, o){
	...
	url:commonboxURL+'?action=dept&flag=1&str='+encodeURIComponent(Ext.getCmp('deptField').getRawValue()),method:'POST'});
});
...
var schemeaudititemMain = new dhc.herp.Grid({
	...
	new Ext.grid.CheckboxSelectionModel({editable:false}),
		...
		tbar:['科室名称:',DnameField,'-',searchNbotton,'-',editrrButton],
