editrrFun = function(itemGrid,deptname) {
  ...
  var window = new Ext.Window({
    ...
    buttons: [{
		...
		handler: function() {
      		...
      		Ext.Ajax.request({
	      		timeout : 30000000,
				url: editrUrl+'?action=editr&&year='+year+'&dtype='+dtype+'&Itype='+Itype+'&splitmeth='+splitmeth+'&rate='+rate+'&flag=3',
				...
				success: function(result, request) {
					...
					if (jsonData.success=='true') {
						...
						itemGrid.load({params:{start:0, limit:25,deptname:deptname}});
						window.close();
					}
					else {
