  ...
  var window = new Ext.Window({
    ...
    buttons: [{
		...
		handler: function() {
      		...
      		for(var i = 0; i < len; i++){
						Ext.Ajax.request({
							url: 'herp.budg.budgschsplitymexe.csp?action=SplitEdit&&rowid='+rowObj[i].get("rowid")+'&isLast='+rowObj[i].get("isLast")+'&code='+rowObj[i].get("code")+'&year='+rowObj[i].get("year")+'&SplitMeth='+SplitMeth+'&Dname='+Dname,
