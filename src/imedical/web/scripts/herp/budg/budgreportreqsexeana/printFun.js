...
ShowPrintReportFun = function(year,itemType,itemLevel,budgAll,schemeMainDr){
	...
	var p_URL = 'dhccpmrunqianreport.csp?reportName=HERPBUDGHosBudgExeAnaprint.raq&year='+year+'&itemType='+itemType+'&itemLevel='+itemLevel+'&budgAll='+budgAll+'&reportType='+'&dept=-1'+'&itemCode='+'&schemeMainDr='+schemeMainDr;
