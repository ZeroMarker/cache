...
var URL='herp.budg.budgreportreqsexe.csp'
...
var printBT = new Ext.Toolbar.Button({
				...
				handler : function() {
					...
					fileName="{HERPBUDGHosInOutBudgReqprint.raq(year="+year+";itemType="+itemType+";itemLevel="+itemLevel+";budgAll="+budgAll+";reportType="+";dept=-1"+";itemCode="+";schemeMainDr="+schemeMainDr+";USERNAME="+username+")}";
...
function ShowReport()
{
	...
	var p_URL = 'dhccpmrunqianreport.csp?reportName=HERPBUDGHosInOutBudgReq.raq&year='+year+'&itemType='+itemType+'&itemLevel='+itemLevel+'&budgAll='+budgAll+'&reportType='+'&dept=-1'+'&itemCode='+'&schemeMainDr='+schemeMainDr; 
