...
var instructionURL='herp.budg.budgadjustinstructionexe.csp';
budginstructionFun = function(adjid,Year,adjustno, memo){
	...
	schemeDs.on('beforeload', function(ds, o){
		...
		url:commonboxURL+'?action=bsm&flag=2&year='+Year+'&start='+0+'&limit='+25+'&str='+encodeURIComponent(Ext.getCmp('schemeField').getRawValue()),method:'POST'});
	});
