...
dhc.herp.Gridsch = Ext.extend(Ext.grid.EditorGridPanel, {
	edit : true,
	trackMouseOver : true,
	stripeRows : true,
	cm : colModel,
	...
	initComponent : function() {
		...
		dhc.herp.Gridsch.superclass.initComponent.call(this);
	},
	createPlugins : function() {
		...
		plugins.push(dhc.herp.GridschTip);
	...
	save : function() {
		...
		Ext.each(records, function(r) {
			...
			data.push(o);
			var records1 = itemGrid.getSelectionModel().getSelections();
			var adjid  = records1[0].get("rowid");
			var saveUrl = this.url + '?action=' + recordType + stro.toString()
					+ "&" + tmpstro.toString() + "&adjid="+adjid+"&"
