...
// 年度///////////////////////////////////
var projUrl = 'herp.budg.budgctrlchequeaffordexe.csp';
			...
			items : [
					{
						...
						items : [ {
							xtype : 'displayfield',
							value : '<center><p style="font-weight:bold;font-size:120%">一般支出资金申请支票发放</p></center>',
							columnWidth : 1,
							height : '32'
						} ]
					}, {
...
var itemGrid = new dhc.herp.Grid(
		{
			atload : true,
			region : 'center',
			url : 'herp.budg.budgctrlchequeaffordexe.csp',
			listeners : {
