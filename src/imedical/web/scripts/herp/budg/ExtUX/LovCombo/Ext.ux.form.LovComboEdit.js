...
/**
 * Ext.ux.form.LovComboEdit, List of Values Combo
 *
 * @author    Ing. Jozef Sakáloš
 * @copyright (c) 2008, by Ing. Jozef Sakáloš
 * @date      16. April 2008
 * @version   $Id: Ext.ux.form.LovComboEdit.js 285 2008-06-06 09:22:20Z jozo $
 *
 * @license Ext.ux.form.LovComboEdit.js is licensed under the terms of the Open Source
...
/**
 *
 * @class Ext.ux.form.LovComboEdit
 * @extends Ext.form.ComboBox
 */
Ext.ux.form.LovComboEdit = Ext.extend(Ext.form.ComboBox, {
    ...
    ,initComponent:function() {
        ...
        if(!this.tpl) {
            this.tpl = 
                ...
                +'class="ux-LovComboEdit-icon ux-LovComboEdit-icon-'
                //+'{[values.' + this.checkField + '?"checked":values.' + this.checkField + '===null?"mixed":"unchecked"' + ']}">'
                +'{[values.' + this.checkField + '?"checked":"unchecked"' + ']}">'
                +'<div class="ux-LovComboEdit-item-text">{' + (this.displayField || 'text' )+ '}</div>'
                +'</div>'
                +'</tpl>'
            ;
        }
        ...
        // call parent
        Ext.ux.form.LovComboEdit.superclass.initComponent.apply(this, arguments);
     ...
     */
    ,initEvents:function() {
        Ext.ux.form.LovComboEdit.superclass.initEvents.apply(this, arguments);
    ...
    // {{{
    /**
     * Sets the value of the LovComboEdit
     * @param {Mixed} v value
     */
    ,setValue:function(v) {
        if(v) {
...
// register xtype
Ext.reg('LovComboEdit', Ext.ux.form.LovComboEdit); 
