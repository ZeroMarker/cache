...
var stateitemGrid = new dhc.herp.Grid({
				width : 400,
				region : 'center',
				url : 'herp.budg.budgauditfundapplystate.csp',
				fields : [
				{
							header : 'ID',
							width : 30,
	...
	stateitemGrid.btnAddHide();    //隐藏增加按钮
   	stateitemGrid.btnSaveHide();   //隐藏保存按钮
    stateitemGrid.btnResetHide();  //隐藏重置按钮
    stateitemGrid.btnDeleteHide(); //隐藏删除按钮
    stateitemGrid.btnPrintHide();  //隐藏打印按钮
