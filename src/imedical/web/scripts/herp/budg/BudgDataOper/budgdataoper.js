...
var schemmainURL ='herp.budg.budgschemmainexe.csp';
...
var queryPanel = new Ext.FormPanel({
	...
	items : [{
		...
		items : [{
			xtype : 'displayfield',
			value : '<center><p style="font-weight:bold;font-size:150%">预算数据操作</p></center>',
			columnWidth : 1,
			height : '30'
		}]
	}, {
...
//			ds.proxy = new Ext.data.HttpProxy({
//						url : schemmainURL+ '?action=BudgItem&str='+ encodeURIComponent(Ext.getCmp('budgItem').getRawValue())
