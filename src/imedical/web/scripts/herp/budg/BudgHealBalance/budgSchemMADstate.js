...
var findButton = new Ext.Toolbar.Button({
	...
	handler: function(){
	      	...
	      	var year = yearCombo.getValue();
				...
				//alert(type);
				itemGridD.load({params : {start : 0,limit : 25,year : year,type : type}});
	}
});
...
/*
itemGridD.on('rowclick',function(grid,rowIndex,e){	
	var schemeDr='';
    //alert(rowIndex);
	var selectedRow = itemGridD.getSelectionModel().getSelections();
    //alert(selectedRow);
