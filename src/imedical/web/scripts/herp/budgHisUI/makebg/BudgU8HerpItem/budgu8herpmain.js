...
Description:全面预算管理-预算执行管理-科目对照关系
CSPName:herp.budg.hisui.budgu8herpitem.csp
...
// 科目类别
	var ItemTypeObj = $HUI.combobox("#ItemTypebox",{
...
//  预算科目的下拉框
    var BudgItemObj = $HUI.combobox("#BudgItembox",{
    ...
    MainColumns=[[  
                ...
                {field:'TypeU',title:'对照类别',align:'left',width:120},
                {field:'CodeU',title:'对照科目编码',width:150,allowBlank:false,align:'right',
                ...
                {field:'NameU',title:'对照科目名称',width:150,allowBlank:false,
                styler: function (value,row,index){
                ...
                {field:'TypeH',title:'预算科目类别',width:120,
                	formatter: function(value,row,index){
	                return row.typename;
	                }
	            },
                {field:'CodeH',title:'预算科目编码',width:120,align:'right'},
                {field:'NameH',title:'预算科目名称',width:120,allowBlank:false,
                    editor:{
                        type:'combobox',
                        options:{
                            valueField:'code',
    ...
    var FindBtn= function()
    {
        ...
        var TypeH = $('#ItemTypebox').combobox('getValue');
        var CodeH = $('#BudgItembox').combobox('getValue');
        var SYSNo = $('#Databox').combobox('getValue');
        //console.log(String(TypeH))
        MainGridObj.load({
                ClassName:"herp.budg.hisui.udata.uU8Herp",
                MethodName:"List2",
                hospid :    hospid, 
