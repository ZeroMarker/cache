...
Creator: 
CreatDate: 
Description: 全面预算管理-基础信息-资金来源维护
CSPName: herp.budg.hisui.budgfundtype.csp
...
function Init(){
    ...
    MainColumns=[[  
                ...
                {field:'CompName',title:'医疗单位',width:150,hidden: true},
                {field:'code',title:'资金类型编码',width:150,
                   editor: { 
                        type: 'text', 
                        options: { 
                            required: true,
                ...
                {field:'name',title:'资金类型名称',width:150,
                   editor: { 
                        type: 'text', 
                        options: { 
                            required: true,
