var projUrl = '../csp/herp.acct.acctsubjstructureanalysexe.csp';
...
function Query() {
	...
	SchemGrid.addButton('-');
	// SchemGrid.addButton('<div style="color:red">说明：科目结构分析的方案编号以AN0105开头。</div>');
	...
	var frm = new Ext.form.FormPanel({
			...
			items: [{
					...
					items: [SubjCodeName1, SubjCodeName2,
						SubjLevel, AnalyType, YearMonth1]
				}, {
					xtype: 'button',
					style: "marginLeft:40%",
					iconCls: 'find',
	...
	function FindQuery() {
		...
		// yearmonth2, level, AnalysisType, AnalysisTypeDis, userdr
		//alert(999);
		p_URL = 'dhccpmrunqianreport.csp?reportName=herp.acct.AcctSubjStructureAnalys.raq&&SubjCode1=' + SubjCode1 +
			'&SubjName1=' + SubjName1 + '&SubjCode2=' + SubjCode2 + '&SubjName2=' + SubjName2 +
			'&yearmonth=' + yearmonth1 + '&level=' + level +
