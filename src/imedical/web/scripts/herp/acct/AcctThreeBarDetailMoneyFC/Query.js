var projUrl = '../csp/herp.acct.AcctThreeBarDetailMoneyFCexe.csp';
...
function Query() {
	...
	function FindQuery() {
		...
		p_URL = 'dhccpmrunqianreport.csp?reportName=herp.acct.AcctThreeBarDetailMoneyFC.raq&&sjcode1=' + sjcode1 +
