...
dhc.herp.Grid = Ext.extend(Ext.grid.EditorGridPanel, {
	...
	save : function() {
        ...
        var acctsubj=Ext.getCmp('AcctSubj').getRawValue();
        var checktype=Ext.getCmp('CheckType').getRawValue();
		var checkitem1=Ext.getCmp('CheckItem1').getRawValue();
     	var checkitem2=Ext.getCmp('CheckItem2').getRawValue();
		...
		var newdesc=startdate+';'+enddate+';'+acctsubj+';'+checktype+';'+checkitem1+';'+checkitem2+';'+AnalysisType+';'+AnalysisTypeDs+';'+iszero;
		var flag=false;
		if(newdesc===desc){
		flag=true;
		}
