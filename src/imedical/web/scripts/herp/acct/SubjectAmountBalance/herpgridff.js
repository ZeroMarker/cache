	...
	save : function() {
		...
		this.focus();
		    ...
		    var VouchState=VouchStateField.getValue();
			  if(VouchState=="") VouchState=0;
			  else VouchState=1;
			  var EndSumFlag=EndSumFlagField.getValue();
			  if(EndSumFlag=="") EndSumFlag=0;
			  else EndSumFlag=1;*/
		    ...
		    var newdesc=SubjCode1+';'+SubjCode2+';'+level+';'+year+';'+month1+';'+month2+';'+VouchState+';'+EndSumFlag+';'+lastLevel+';'+accumulative;
			var flag=false;
