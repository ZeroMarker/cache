	...
	function callback(id){
	   // alert("22");
		if(id=="yes"){
			...
			if(excelName==""){
				Ext.Msg.show({title:'提示',msg:'请选择Excel文件! ',buttons: Ext.Msg.OK,icon:Ext.MessageBox.INFO});
				return;
			}else{ 
				var array=new Array();
				...
				//var uploadUrl="http://192.168.5.4:8080/herp.acct.importExcel/AcctCashFlowItemServlet";
				var uploadUrl="http://"+URL+"/herp.acct.importExcel/AcctDepartContrastServlet";
				//这里应该有一个传参数的动作。
