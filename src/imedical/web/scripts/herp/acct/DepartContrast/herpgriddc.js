		...
		Ext.MessageBox.confirm('提示', '确定要删除选定的行吗？ ', function(btn) {
			if (btn == 'yes') {
				Ext.each(records, function(record) {
							...
							/* if (Ext.isEmpty(record.get("AcctBusiDeptMapID"))) {
								// record.reject(true);
 ...
 */
							...
							Ext.Ajax.request({
										url : tmpUrl + '?action=del&AcctBusiDeptMapID='
												+ record.get("AcctBusiDeptMapID"),
										waitMsg : '删除中...',
	...
	save : function() {
		...
		Ext.each(records, function(r) {
			...
			var o = {};
			var tmpstro = "&AcctBusiDeptMapID=" + r.data['AcctBusiDeptMapID'];
