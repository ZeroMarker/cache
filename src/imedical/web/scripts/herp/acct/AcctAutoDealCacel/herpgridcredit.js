...
dhc.herp.GridCredit = Ext.extend(Ext.grid.EditorGridPanel, {
	edit : true,
	trackMouseOver : true,
	stripeRows : true,
	cm : colModel,
	...
	initComponent : function() {
		...
		dhc.herp.GridCredit.superclass.initComponent.call(this);
	},
	createPlugins : function() {
		...
		plugins.push(dhc.herp.GridDebitTip);
	...
	createBbar : function() {
		this.bbar = new Ext.PagingToolbar({// 分页工具栏
			...
			store : this.store,
			displayInfo : true,
			plugins : new dhc.herp.PageSizePluginCredit(),
	...
	load : function(param) {
		var limits=Ext.getCmp("PageSizePluginCredit").getValue();
			 //alert(limits);
	         if(!limits){limits=25};
		if (!Ext.isEmpty(param))
...
dhc.herp.PageSizePluginCredit = function() {
	dhc.herp.PageSizePluginCredit.superclass.constructor.call(this, {
...
Ext.extend(dhc.herp.PageSizePluginCredit, Ext.form.ComboBox, {
