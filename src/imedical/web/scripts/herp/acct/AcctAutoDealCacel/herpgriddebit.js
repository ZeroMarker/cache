...
dhc.herp.GridDebit = Ext.extend(Ext.grid.EditorGridPanel, {
	edit : true,
	trackMouseOver : true,
	stripeRows : true,
	cm : colModel,
	...
	initComponent : function() {
		...
		dhc.herp.GridDebit.superclass.initComponent.call(this);
	},
	...
	createBbar : function() {
		this.bbar = new Ext.PagingToolbar({// 分页工具栏
			...
			store : this.store,
			displayInfo : true,
			plugins : new dhc.herp.PageSizePluginDebit(),
	...
	load : function(param) {
		var limits=Ext.getCmp("PageSizePluginDebit").getValue();
			 //alert(limits);
	         if(!limits){limits=25};
		if (!Ext.isEmpty(param))
...
dhc.herp.PageSizePluginDebit = function() {
	dhc.herp.PageSizePluginDebit.superclass.constructor.call(this, {
...
Ext.extend(dhc.herp.PageSizePluginDebit, Ext.form.ComboBox, {
