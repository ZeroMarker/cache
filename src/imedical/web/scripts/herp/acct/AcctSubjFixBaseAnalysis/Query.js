...
function Query() {
	...
	// SchemGrid.addButton('-');
	// SchemGrid.addButton('<div style="color:red">说明：科目定基分析的方案编号以AN0101开头。</div>');
	SchemGrid.btnResetHide();
	SchemGrid.btnPrintHide();
	...
	var frm = new Ext.form.FormPanel({
			...
			items : [{
					xtype : 'fieldset',
					style:"padding:5px;",
					items : [SubjCodeNameField1, SubjCodeNameField2, AcctYearMonthField1, AcctYearMonthField2, SubjLevelField, AnalysisTypeField]
	...
	function FindQuery() {
		...
		var AcctYearMonth1 = AcctYearMonthField1.getRawValue();
		var AcctYearMonth2 = AcctYearMonthField2.getRawValue();
		...
		var p_URL = "";
		p_URL = 'dhccpmrunqianreport.csp?reportName=herp.acct.AcctSubjFixBaseAnalysis.raq&SubjCode1=' + AcctSubjCode1 + '&SubjCode2=' + AcctSubjCode2 + '&SubjName1=' + AcctSubjName1 + '&SubjName2=' + AcctSubjName2 + '&yearmonth1=' + AcctYearMonth1 + '&yearmonth2=' + AcctYearMonth2 + '&level=' + SubjLevel + '&AnalysisType=' + AnalysisType + '&AnalysisTypeDis=' + AnalysisTypeDis + '&userdr=' + UserID;
