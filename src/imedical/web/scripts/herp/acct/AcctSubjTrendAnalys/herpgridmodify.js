...
dhc.herp.Grid = Ext.extend(Ext.grid.EditorGridPanel, {
	...
	save : function() {
		...
		var subjCode1=Ext.getCmp('SubjCodeName1').getRawValue();
		var subjCode2=Ext.getCmp('SubjCodeName2').getRawValue();
		...
		var subjlevel=Ext.getCmp('SubjLevel').getValue();
		
		var analytype=Ext.getCmp('AnalyType').getValue();
		var analytypeDis=Ext.getCmp('AnalyType').getRawValue();
		
		var newdesc=subjCode1+';'+subjCode2+';'+yearmonth1+';'+yearmonth2+';'
		+subjlevel+';'+analytype+';'+analytypeDis;
		var flag=false;
		if(newdesc===desc){
		flag=true;
		}
