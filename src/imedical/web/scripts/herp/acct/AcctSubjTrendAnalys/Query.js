var projUrl = '../csp/herp.acct.acctsubjtrendanalysexe.csp';
...
function Query() {
	...
	SchemGrid.addButton('-');
	// SchemGrid.addButton('<div style="color:red">说明：科目趋势分析的方案编号以AN0104开头。</div>');
	...
	function FindQuery() {
		...
		// yearmonth2, level, AnalysisType, AnalysisTypeDis, userdr
		//alert(999);
		p_URL = 'dhccpmrunqianreport.csp?reportName=herp.acct.AcctSubjTrendAnalys.raq&&SubjCode1=' + SubjCode1 +
