...
dhc.herp.Griddetail = Ext.extend(Ext.grid.EditorGridPanel, {
	edit : true,
	trackMouseOver : true,
	stripeRows : true,
	cm : colModel,
	...
	initComponent : function() {
		...
		dhc.herp.Griddetail.superclass.initComponent.call(this);
	},
	createPlugins : function() {
		...
		plugins.push(dhc.herp.GridapplydetailTip);
	...
	btnAddHide : function() {
		...
		var tbar = this.getTopToolbar();
		var tbutton = tbar.get('detailAdd');
		tbutton.hide();
		},
	//隐藏保存按钮
	btnSaveHide : function() {
		...
		var tbar = this.getTopToolbar();
		var tbutton = tbar.get('detailSave');
		tbutton.hide();
		},
		//隐藏重置按钮
	btnResetHide : function() {
		var tbar = this.getTopToolbar();
		var tbutton = tbar.get('detailReset');
		tbutton.hide();
		},
	//隐藏删除按钮
	btnDeleteHide : function() {
		...
		var tbar = this.getTopToolbar();
		var tbutton = tbar.get('detailDelete');
		tbutton.hide();
		},
		//隐藏打印按钮
	btnPrintHide : function() {
		...
		var tbar = this.getTopToolbar();
		var tbutton = tbar.get('detailPrint');
		tbutton.hide();
		},
	...
	save : function() {
		...
		Ext.each(records, function(r) {
			...
			var ReportTempletId=selectedRow[0].data['rowid'];
			var tmpstro = "&rowid=" + r.data['rowid']+'&ReportTempletId='+ReportTempletId;
