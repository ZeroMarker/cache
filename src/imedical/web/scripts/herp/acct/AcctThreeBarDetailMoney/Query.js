var projUrl = '../csp/herp.acct.AcctThreeBarDetailMoneyexe.csp';
...
function Query() {
	...
	function FindQuery() {
		...
		p_URL = 'dhccpmrunqianreport.csp?reportName=herp.acct.AcctThreeBarDetailMoney.raq&&sjcode1=' + sjcode1 +
