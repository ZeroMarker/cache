var LinkNotPassVouch = function (data) {
	var NotPassVouchGrid = new dhc.herp.GridNotPass({
			region: 'center',
			url: projUrl,
			viewConfig: {
				forceFit: true
	...
	NotPassVouchGrid.on('cellclick', function (g, rowIndex, columnIndex, e) {
		if (columnIndex == 3) {
			var records = NotPassVouchGrid.getSelectionModel().getSelections();
