...
dhc.herp.Gridlyf = Ext.extend(Ext.grid.EditorGridPanel, {
	...
	createBbar : function() {
		this.bbar = new Ext.PagingToolbar({// 分页工具栏
			...
			store : this.store,
			displayInfo : true,
			plugins : new dhc.herp.PageSizePluginlf(),
...
dhc.herp.PageSizePluginlf = function() {
	dhc.herp.PageSizePluginlf.superclass.constructor.call(this, {
...
Ext.extend(dhc.herp.PageSizePluginlf, Ext.form.ComboBox, {
