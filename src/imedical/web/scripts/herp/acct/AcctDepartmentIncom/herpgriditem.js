...
dhc.herp.Gridff = Ext.extend(Ext.grid.EditorGridPanel, {
	edit : true,
	trackMouseOver : true,
	stripeRows : true,
	cm : colModel,
	...
	initComponent : function() {
		...
		dhc.herp.Gridff.superclass.initComponent.call(this);
	},
	createPlugins : function() {
		...
		plugins.push(dhc.herp.GridffTip);
	...
	createBbar : function() {
		this.bbar = new Ext.PagingToolbar({// 分页工具栏
			...
			displayInfo : true,
			atLoad : true,
			plugins : new dhc.herp.PageSizePluginitem(),
...
/*
	...
	load : function(param) {
		var limits=Ext.getCmp("PageSizePluginitem").getValue();
			 //alert(limits);
	         if(!limits){limits=25};
		if (!Ext.isEmpty(param))
...
dhc.herp.PageSizePluginitem = function() {
	dhc.herp.PageSizePluginitem.superclass.constructor.call(this, {
...
Ext.extend(dhc.herp.PageSizePluginitem, Ext.form.ComboBox, {
