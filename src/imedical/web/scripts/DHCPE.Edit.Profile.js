...
var f=document.fDHCPE_Edit_Profile;
var frm=document.forms['fDHCPE_Edit_Profile'];
Init();
function Init() {
	//alert("ttttttttt");
}
...
function GetStationDesc_changehandler(encmeth) {
	var objStationDesc=frm.elements['StationDesc'];
...
function DHCHealthCheckStation(str)	{
	var arr=str.split('^');
	var objStationID=frm.elements['StationID'];
	var objStationDesc=frm.elements['StationDesc'];
