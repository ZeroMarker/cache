...
function changeAccount()
{
    ...
    showWindow(url,"调帐信息","","","icon-w-paper","modal","","","verylarge",refreshWindow);  //modify by lmm 2019-02-20
}
...
function inspect()
{
	...
	showWindow(url,"检查记录","","458px","icon-w-paper","modal","","","large");		// MZY0151	2023-02-01
}
...
function productPicture()
{
	...
	if (list[0]==0)
	{
		...
		showWindow(url,"产品授权书信息","","","icon-w-paper","modal","","","large");
