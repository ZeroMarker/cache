...
function BuildFootInfo(){
	...
	myList[22]=DHCWebD_GetObjValue("FBWCSum");
...
function SetHandsum(value)
{
	...
	DHCWebD_SetObjValueA("POSNum",Split_Value[21]);
	DHCWebD_SetObjValueA("POSSum",Split_Value[22]);
	///s ret=ret_"^"_myTALLNum_"^"_myTALLSum_"^"_myYLNum_"^"_myYLSum	;39-42
	///s ret=ret_"^"_myRefTALLNum_"^"_myRefTALLSum_"^"_myRefYLNum_"^"_myRefYLSum	;43-46
	
	
	
	/////Add Later
	DHCWebD_SetObjValueA("PONum",Split_Value[39]);
	DHCWebD_SetObjValueA("POSum",Split_Value[40]);
	DHCWebD_SetObjValueA("YLNum",Split_Value[41]);
	DHCWebD_SetObjValueA("YLSum",Split_Value[42]);
	
	DHCWebD_SetObjValueA("ACASHSum",Split_Value[47]);
	DHCWebD_SetObjValueA("ACheckSum",Split_Value[48]);
	DHCWebD_SetObjValueA("POSum",Split_Value[49]);
	DHCWebD_SetObjValueA("POSSum",Split_Value[50]);
	DHCWebD_SetObjValueA("YLSum",Split_Value[51]);
	DHCWebD_SetObjValueA("JZSum",Split_Value[52]);
	
	DHCWebD_SetObjValueA("FBWCSum",Split_Value[53]);
	var sUser=document.getElementById("sUser");
...
function BClear_Click(){
	var lnk="websys.default.csp?WEBSYS.TCOMPONENT=udhcOPHandin.SHHSYYRep";
