	...
	function initForm()
	{
		...
		//Display "DateTypeID" property list.select * from DHC_MedDictory  where MDIC_Type='IPBookingDataType'
		DisplayDictionaryList("MethodGetDicList", "DateTypeID", "IPBookingDataType", "Y", false,"RowID");
		//Display "DictionaryName" property list.select * from DHC_MedDictory  where MDIC_Type='SYS'
	...
	//If RowID!="",display DHCMedIPBKTempItem
	...
	function SaveToObject()
	{
		...
		obj.DateTypeID = document.getElementById("DateTypeID").value;
		obj.DictionaryName = document.getElementById("DictionaryName").value;
