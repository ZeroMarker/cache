...
function BFind_Click()
{
	...
	window.location.href="websys.default.csp?WEBSYS.TCOMPONENT=DHCEQCTypeEmployee"+val;
}
...
function SelectRowHandler()
{
	...
	var objtbl=document.getElementById('tDHCEQCTypeEmployee');//+组件名 就是你的组件显示 Query 结果的部分
