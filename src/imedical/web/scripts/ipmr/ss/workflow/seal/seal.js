...
function InitGridWorkList(){
	var columns = [[
		...
		{field:'HappenDate',title:'借出时间',width:180,align:'left',hidden:true,
			formatter: function(value,row,index){
				return row.HappenDate+ ' ' + row.HappenTime;
			}
		},
		{field:'HappenUserDesc',title:'借出人员',width:100,align:'left',hidden:true}
	]];
...
function SaveOpera(Step){
	...
	var WFDetail = Seal_ArgsObj.SealInfo;	 // 附加信息
	var flg = $m({
