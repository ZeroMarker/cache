...
// /编写者：	wangjiabin
// /编写日期: 2015-08-28
var SelInIsTrfOut2 = function(SupplyLocId,Fn) {
	...
	// 查询请求单按钮
	var SearchBTOut = new Ext.ux.Button({
				id : "SearchBTOut",
				text : '查询',
				tooltip : '点击查询请求单',
				width : 70,
	...
	// 保存按钮
	var SaveBTOut = new Ext.Toolbar.Button({
				id : "SaveBTOut",
				text : '保存',
				tooltip : '点击生成转入单',
				width : 70,
	...
	function save() {
		...
		if(HVFlag=="Y"){
			Msg.info("warning","高值出库单,请选择高值退库操作界面!");
			return;
		}
	...
	MasterOutCm.defaultSortable = true;
