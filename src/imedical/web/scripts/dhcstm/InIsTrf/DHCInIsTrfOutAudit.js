...
Ext.onReady(function() {
	...
	function ChartInfoAddFun() {
		...
		*/
		...
		"status","RpAmt","SpAmt","MarginAmt","Remark","StatusCode","OperType"];
		// 支持分页显示的读取方式
 ...
 function MgSelect(sm,rowIndex,r){
	...
	DetailStore.load({params:{start:0,limit:GridDetailPagingToolbar.pageSize,Parref:InIt}});
		...
		var fields = ["initi", "inrqi", "inci","inciCode",
				...
				"spAmt", "rp","rpAmt", "ConFac", "BUomId", "inclbDirtyQty", "inclbAvaQty","TrUomDesc","SterilizedBat"];
		// 支持分页显示的读取方式
		var reader = new Ext.data.JsonReader({
					root : 'rows',
					totalProperty : "results",
