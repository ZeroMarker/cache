...
FindINPo=function(fn) {
	...
	var fields = ["PoItmId", "IncId", "IncCode","IncDesc","PurUomId", "PurUom", "NotImpQty", "Rp","PurQty","ImpQty","Cancleflag"];
	// 支持分页显示的读取方式
	var reader = new Ext.data.JsonReader({
		root : 'rows',
		totalProperty : "results",
	...
	var HisListTab = new Ext.form.FormPanel({
			...
			labelAlign : 'right',
			frame : true,
			tbar : [SearchBT, '-',  ClearBT,'-',cancelBt],
			//height: 160,
			autoHeight:true,
			layout:'fit',
