...
function IntDoc(){
	var objtbl=document.getElementById("tDHCOPFin_AHSL_FootINVCAV");
...
function PrintClickHandlerINVRep(){
	...
	try {
	    ...
	    var Template=TemplatePath+"DHCHospOPINVFootCFV.xls";
	    var UserCode=""
