	...
	{	
		if (rowData.TRowID!="")
		{
			if (getElementValue("ClassFlag")=="N")
			{
				...
				showWindow(str,"简易台账","","14row","icon-w-paper","modal","","","large")     // MZY0150	2023-01-17
			}
			else
			{
				var str="dhceq.em.equipclass.csp?RowID="+rowData.TRowID+"&ReadOnly=";
				showWindow(str,"泛类台账","","315px","icon-w-paper","modal","","","small")     //modify by CSJ 2020-08-19 需求号：1463646   //modify by txr 2023-01-18 UI
			}
		}
	},
...
function BAdd_Clicked()
{
	...
	showWindow(url,"简易台账","","14row","icon-w-paper","modal","","","large")     // MZY0150	2023-01-17
	}
	else
	{
		var url='dhceq.em.equipclass.csp?RowID=';
		showWindow(url,"泛类台帐","","315px","icon-w-paper","modal","","","small")     //modify by lmm 2020-06-01 UI  //modify by txr 2023-01-18 UI
...
//modify by zc0125 2022-11-09 增加导入功能 begin
