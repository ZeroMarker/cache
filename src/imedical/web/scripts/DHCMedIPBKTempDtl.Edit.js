/* ======================================================================
NAME: DHCMedIPBKTempDtl.Edit.js
AUTHOR: lxf
DATE  : 2008-10-27
========================================================================= */
...
function DisplayExtraItemList()
{
	...
	var ret = cspRunServerMethod(strMethod, "Y");
 	var arry = GetDHCMedIPBKTempItemArray(ret);
 	var objTemplateItm = null;
...
function SaveTemplateDetailList()
{
	...
	return SaveDHCMedIPBKTempDtlListArry(
		"MethodSaveListItem", 
...
{
	var arry = GetDHCMedIPBKTempDtlListArry("MethodGetSavedList", Parref);
	var objDetail = null; 			
...
function ProcessRequest()
{
	...
	{
		document.getElementById("txtTemplate").innerText = objItm.TempDesc;//display the DHC_MedIPBKTemplate item 
	}
...
/*===========================================
Name:SaveDHCMedIPBKTempDtlListArry
Author: lxf
Date: 2008-10-27
Param:
methodControl:
arry:The collection of TemplateItemList
Comment: Save to Table DHC_MedIPBKTempDtl
============================================*/
function SaveDHCMedIPBKTempDtlListArry(MethodControl, MethodControlDel, TemplateID, arry)
{
	...
	{
		tmp = "";
		tmp = SerializeDHCMedIPBKTempDtlList(arry[i]);//in DHC.Med.Serialize.js
