...
function AddBeforeUpdate(dataObj){
	...
	if (PatientID==""){
		...
		if (dataObj["TAPPTRowID"]==""){
			...
			if (myoptval==1){
				var ContinueReg=dhcsys_confirm(("患者在"+dataObj["CurrentMarkDesc"]+"有未取号预约记录,是否继续增加"),false);
...
function BRegExpClickHandle(PatientNo){
	...
	createModalDialog("CardReg","建卡", PageLogicObj.dw+160, PageLogicObj.dh+200,"icon-w-edit","",$code,"");
}
