...
function InitRegQueryTabDataGrid(){
	...
	var Columns=[[ 
		...
		{field:'PAPMIDVAnumber',title:'证件号码',width:180},
		{field:'TRegLoc',title:'科室',width:120},
		{field:'TRegDoc',title:'号别',width:140},
		{field:'TArriveDoc',title:'看诊医生',width:100},
		{field:'TRegDate',title:'就诊日期',width:100,sortable:true,sorter:Sort_int},
		{field:'TAdmReasonDesc',title:'费别',width:60},
		...
		{field:'TRegTime',title:'挂号时间',width:150,sortable:true,sorter:Sort_int},
		{field:'TRefUsr',title:'退号员',width:80},
		{field:'TRefUsrname',title:'退号员姓名',width:90},
		{field:'TRefTime',title:'退号时间',width:150},
		...
		{field:'TRegSource',title:'挂号渠道',width:90},
		{field:'TRCDDesc',title:'挂号优惠',width:90}
    ]]
