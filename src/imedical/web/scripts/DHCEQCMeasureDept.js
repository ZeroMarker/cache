...
function BFind_Click()
{
	...
	window.location.href="websys.default.csp?WEBSYS.TCOMPONENT=DHCEQCMeasureDept"+val;
}
...
function SelectRowHandler()	{
	...
	var objtbl=document.getElementById('tDHCEQCMeasureDept');//+组件名 就是你的组件显示 Query 结果的部分
