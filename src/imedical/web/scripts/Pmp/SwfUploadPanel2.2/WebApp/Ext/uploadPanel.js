...
keel.UploadPanel = function(cfg){  
    ...
    keel.UploadPanel.superclass.constructor.call(this,{               
        tbar : [  
            {text:'添加文件',iconCls:'btn-add',icon:'../scripts/Pmp/Image/add.png',ref:'../addBtn'},'-',  
            {text:'上传',icon:'../scripts/Pmp/Image/upload-start.gif',iconCls:'btn-up',ref:'../uploadBtn',handler:this.startUpload,scope:this},'-',  
            {text:'停止上传',icon:'../scripts/Pmp/Image/upload-stop.gif',iconCls:'btn-cancel',ref:'../stopBtn',handler:this.stopUpload,scope:this,disabled:true},'-',  
            {text:'删除所有',icon:'../scripts/Pmp/Image/delete.png',ref:'../deleteBtn',iconCls:'btn-clear',handler:this.deleteAll,scope:this},'-'  
        ],  
        layout : 'fit',  
        items : [this.gp],  
        listeners : {  
