$(function(){
	...
	$("#authorizesrequest").click(function(){
		...
		else
		{
			...
			var returnValues = window.open("emr.authappoint.request.csp?EpisodeID="+SelectedRow.EpisodeID+"&PatientID="+patientID,"requestWin","resizable:no;status:no,width=700,height=470");
		}
