...
function setDataGrid(interface)
{
	...
	$('#narcosis').datagrid({
	    ...
	    loadMsg:'数据装载中......',
	    autoRowHeight: true,
	    url:'../EMRservice.Ajax.narcosis.cls?Interface='+encodeURI(encodeURI(interface)), 
	    rownumbers:true,
	    pagination:false,
	    singleSelect:false,
	    queryParams:param,
...
function getData()
{
	...
	var checkedItems = $('#narcosis').datagrid('getChecked');
