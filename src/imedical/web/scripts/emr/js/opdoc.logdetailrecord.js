...
//	var result=window.showModalDialog('emr.signDetail.csp?SignID='+signID, window, 'dialogHeight:500px;dialogWidth:600px;resizable:no;status:no');	
	//HISUI模态框
	var	iframeContent = '<iframe id="ShowSignDetail" scrolling="auto" frameborder="0" src="emr.signDetail.csp?SignID='+signID+'" style="width:100%;height:100%;display:block;"></iframe>'
