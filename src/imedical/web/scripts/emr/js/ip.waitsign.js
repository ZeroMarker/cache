			...
			onExpandRow: function(index,row){
				$('#Sub-'+index).datagrid({
					...
					columns:[[  
						...
						{field:'record',title:'电子病历',width:70,sortable:true},
						...
						{field:'status',title:'病历状态',width:110,sortable:true,formatter: StatusOperate}
					]],
					onResize:function(){
...
document.getElementById("GroupSign").onclick = function(){
 	window.open("emr.ip.group.sign.csp?DocID="+docID+ "&SignType=Doc", "GroupSign", "channelmode,scrollbars=yes,resizable=yes,status=no,center=yes,minimize=no,maximize=yes");	
};
