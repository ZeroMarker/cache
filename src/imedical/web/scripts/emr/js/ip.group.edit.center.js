...
function getpagenum(pagecount)
{
	var page = "";
	if ((pagecount == "")||(typeof(pagecount) == "")) return page;
...
function eventDeleteDocument(commandJson)
{
	if (commandJson["args"]["result"] == "OK")
	{
		...
		deleteListRecord(instanceId,"InstanceTree");
...
function eventSendCopyCutData(commandJson)
{
	...
	window.frames["framclipboard"].setContent(commandJson.args.Value);
