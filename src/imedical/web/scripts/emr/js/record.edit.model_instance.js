...
function init() {   ///iEditor/iGridEditor
	...
	ajaxGETSync(data, function (ret) {
		if (ret==='') return;
		modelInfo = $.parseJSON(ret);
		if ('DOC'===modelInfo.pluginType) {
...
function setProperty() {
	...
	if ((''===elementContext)||(elementContext=="NONE")) return;
