...
function QuoteClick(id)
{
    ...
    if (row)
    {
        ...
        var iframeContent = "<iframe id='iframeQuotation' scrolling='auto' frameborder='0' src='emr.ip.quotation.csp?EpisodeID="+gl.episodeId+"&PatientID="+gl.patientId+"&DocID="+docId+"' style='width:100%; height:100%; display:block;overflow:hidden'></iframe>"
...
function operateRecord(tempParam)
{
    ...
    top.frames["TRAK_main"].switchTabByEMRAndOpt(tabName,tabOption,cfg);
    top.frames["TRAK_main"].websys_showModal("close");
}
