			...
			success: function (data){
				...
				{ 
					...
					if (isEnableRevokeComplete == "N")
					{
						...
						$("#confirmRecordCompleted span .l-btn-text").text(emrTrans("已送病案室"));
						$("#confirmRecordCompleted").css("width","105px");
					}
					else
					{
						$("#confirmRecordCompleted").attr("title","撤销送病案室");
						$("#confirmRecordCompleted span .l-btn-text").text(emrTrans("撤销送病案室"));
						$("#confirmRecordCompleted").css("width","125px");
					}
					...
					$("#confirmRecordCompleted span .l-btn-text").text(emrTrans("送病案室"));
...
function setPatDiseases()
{
	...
	parent.createModalDialog("admPatType","设置患者病种","410","410","iframeAdmPatType",tempFrame,"","",true,false);
