...
$(function(){
	...
	if ((authLevelTop == "A")||(authLevelTop == "B")||(authLevelTop == "C"))
	{
		$('#cbxAuthLevel').combobox('disable');
...
function initDataGrid()
{
	...
	$("#dgResultGrid").datagrid({ 
		...
		columns:[[
			...
			{field:'AppointUser',title:emrTrans('授权医师1'),width:100},
			{field:'AppointStatus1',title:emrTrans('授权状态1'),width:100,formatter:rendererAppointStatus},
			{field:'OperDateTime1',title:emrTrans('授权时间1'),width:150,formatter:rendererAppointDateTime},
			
			{field:'AppointUser2',title:emrTrans('授权医师2'),width:100},
			{field:'AppointStatus2',title:emrTrans('授权状态2'),width:100,formatter:rendererAppointStatus},
			{field:'OperDateTime2',title:emrTrans('授权时间2'),width:150,formatter:rendererAppointDateTime},
			
			{field:'AppointUser3',title:emrTrans('授权医师3'),width:100},
			{field:'AppointStatus3',title:emrTrans('授权状态3'),width:100,formatter:rendererAppointStatus},
			{field:'OperDateTime3',title:emrTrans('授权时间3'),width:150,formatter:rendererAppointDateTime},
...
function rendererAppointStatus(val){
    var retStr = "";
    if (val == 'N') {
        retStr = emrTrans('未授权');
    }else if (val == 'F') {
...
function refuseAppoint(){
	...
	var RefuseReasonFrame = "<iframe id='iframeRefuseReason' scrolling='auto' frameborder='0' src='emr.auth.authorize.refusereason.csp' style='width:400px; height:238px; display:block;'></iframe>";
