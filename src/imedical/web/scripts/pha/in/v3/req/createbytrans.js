...
var GRIDID = 'gridTrans';
var BARID = '#gridTransBar'
...
function SetPanel(){
	$('#panelTrans').panel({
		title: PHA_COM.IsTabsMenu() !== true ? '辅助请求(依据转移入库)' : '',
...
function InitGridTrans(){
	...
	var columns = [
        [
            ...
            { field: 'transQty', 	title: '转移总量', 			width: 100, 	align: 'right'	},
            ...
            { field: 'proAvaQty', 	title: '供应方可用库存', 		width: 120, 	align: 'right'	},
        ]
    ];
