...
function InitGrid(){
	var columns = [
        [
            ...
            { field: 'ipblCode', 		title: '代码',  		align: 'left',		width: 100,		editor: {type: 'validatebox',options: {required: true}}},  
            { field: 'ipblDesc', 		title: '名称',  		align: 'left',		width: 200,		editor: {type: 'validatebox',options: {required: true}}},  
            { field: 'startDate', 		title: '开始日期',  	align: 'left',		width: 170,		editor: PHA_GridEditor.DateBox({})}, 
            { field: 'endDate', 		title: '截止日期',  	align: 'left',		width: 170,		editor: PHA_GridEditor.DateBox({})}, 
