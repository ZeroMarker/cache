...
var hospWidth = 360;
var TABLENAME = 'DHC_StkRefuseRetReason';

var GRIDID = 'gridReason';
var GRIDBARID = '#gridReasonBar';
var APINAME = 'PHA.IN.Refretreason.Api';
...
function InitGrid(){
	var columns = [
        [
            { field: 'rrId', 		title: 'rrId', 		hidden: true },
            { field: 'rrDesc', 		title: '名称',  		align: 'left',		width: 1100,		editor: {type: 'validatebox',options: {required: true}}},  
        ]
    ];
    var dataGridOption = {
        url: PHA.$URL,
...
function GetIpblId(){
    ...
    if (gridSelect) return gridSelect.rrId;
    return '';
}
