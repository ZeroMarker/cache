...
var hospWidth = 360;
var TABLENAME = 'DHC_ReasonForAdjustPrice';

var GRIDID = 'gridReason';
var GRIDBARID = '#gridReasonBar';
var APINAME = 'PHA.IN.Aspreason.Api';
...
function InitGrid(){
	var columns = [
        [
            { field: 'aspId', 		title: 'aspId', 		hidden: true },
            { field: 'aspCode', 	title: '代码',  		align: 'left',		width: 150,		editor: {type: 'validatebox',options: {required: true}}},  
            { field: 'aspDesc', 	title: '名称',  		align: 'left',		width: 900,		editor: {type: 'validatebox',options: {required: true}}},  
        ]
    ];
    var dataGridOption = {
        url: PHA.$URL,
...
function GetIpblId(){
    ...
    if (gridSelect) return gridSelect.aspId;
    return '';
}
