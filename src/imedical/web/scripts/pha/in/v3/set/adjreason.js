...
var APINAME = 'PHA.IN.Adjreason.Api';
...
function InitGrid(){
	var columns = [
        [
            { field: 'adjId', 		title: 'adjId', 		hidden: true },
            { field: 'adjCode', 	title: '代码',  		align: 'left',		width: 150,		editor: {type: 'validatebox',options: {required: true}}},  
            { field: 'adjDesc', 	title: '名称',  		align: 'left',		width: 900,		editor: {type: 'validatebox',options: {required: true}}},  
        ]
    ];
    var dataGridOption = {
        url: PHA.$URL,
...
function GetIpblId(){
    ...
    if (gridSelect) return gridSelect.adjId;
    return '';
}
