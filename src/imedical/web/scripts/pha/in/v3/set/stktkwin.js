...
function InitGridStktkWin(){
	var columns = [
        [
            ...
            { field: 'sttkwCode', 	title: '代码',  		align: 'left',		width: 250,		editor: {type: 'validatebox',options: {required: true}}},  
            { field: 'sttkwDesc', 	title: '名称',  		align: 'left',		width: 550,		editor: {type: 'validatebox',options: {required: true}}}
        ]
    ];
    var dataGridOption = {
        url: PHA.$URL,
