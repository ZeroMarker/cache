...
var HERB = ({
    Session: {
        More: function(_locId) {
            $.cm({
                ...
                HERB.Session.HOSPDESC = jsonData.HOSPDESC;
                HERB.Session.CTLOCDESC = jsonData.CTLOCDESC;
            });
        },
        HOSPDESC: "",
        CTLOCDESC: ""
    ...
    ComboBox: {
        Init: function(_cOptions, _options) {
            DHCPHA_HUI_COM.ComboBox.Init(_cOptions, _options, "HERB");
        },
        // 设置选择第几条记录
        ...
        // 药房科室
        HerbLoc: {
            ClassName: "web.PHAHERB.Dictionary",
            QueryName: "HERBLoc",
    ...
    GridComboBox: {
        Init: function(_cOptions, _options) {
            return DHCPHA_HUI_COM.GridComboBox.Init(_cOptions, _options, "HERB");
        }
    },
    GridComboGrid: {
        Init: function(_cOptions, _options) {
            return DHCPHA_HUI_COM.GridComboGrid.Init(_cOptions, _options, "HERB");
        }
    },
    // 初始化业务界面各种下拉Grid
    ...
    ComboGrid: {
        Init: function(_cOptions, _options) {
            DHCPHA_HUI_COM.ComboGrid.Init(_cOptions, _options, "HERB");
        },
    },    
    // 初始化日期
    Date: {
