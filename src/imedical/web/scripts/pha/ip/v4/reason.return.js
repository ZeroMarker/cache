 ...
 */
 ...
 PHA_COM.App.Csp = 'pha.ip.v4.reason.return.csp';
 PHA_COM.App.Name = '';
 $(function () {
     InitHosp();
     InitGridReason();
     ...
     PHA_UX.Translate({ buttonID: 'btnTranslate', gridID: 'gridReason', idField: 'rowID', sqlTableName: 'BLC_ReasonForRefund' });
 });
 ...
 function InitGridReason() {
     ...
     var dataGridOption = {
         url: $URL,
         queryParams: {
             ClassName: 'PHA.IP.Reason.Return',
     ...
     var retJson = $.cm(
         {
             ...
             pClassName: 'PHA.IP.Reason.Return',
 ...
 function InitHosp() {
     var hospComp = GenHospComp('BLC_ReasonForRefund');
