 ...
 *   panel
 * =================================================================
 * update: Huxt 2020-04-12
 * js:	   scripts/pha/plugins/easyui-portal/jquery.portal.plus.js
 */
(function($){
	/**
	...
	function initCss(_options){
		if (!$('#easyui-portal-style').length){
			$('head').append(
				...
				'.portal-column-left{padding-left:' + _options.paddingLeft + 'px;}' + // Huxt 2020-04-12, update 0 to paddingLeft
				'.portal-column-right{padding-right:'+ _options.paddingRight + 'px;}' + // Huxt 2020-04-12, update 0 to paddingRight
	...
	function setSize(target){
		...
		for(var i=0; i<columnWidths.length; i++){
			...
			if (i == columnWidths.length - 1){
				...
				w = width - leftWidth - (hasScroll == true ? opts.scrollWidth : 0); // Huxt 2020-04-12, update 18 to opts.scrollWidth
			}
			p._outerWidth(w);
	...
	$.fn.portal = function(options, param){
		...
		return this.each(function(){
			var newOptions = $.extend({}, $.fn.portal.defaults, $.fn.portal.parseOptions(this), options);
