 ...
 * 编写人:   dinghongying
 */
PHA_COM.App.Csp = "pha.prc.v2.report.ipmain.csp";
var EpisodeId="";
var LoadAdmId="";
...
function Query() {
    ...
    if (radioValue == "ComOrdDetail") {
        var raqObj = {
            raqName: "PHA_PRC_QueryIPComDataDetail.raq",
            raqParams: {
                stDate: StartDate,
                endDate: EndDate,            
                comNo: comNo ,
    ...
    } else if (radioValue == "ComAdmDetail") {
        var raqObj = {
            raqName: "PHA_PRC_QueryIPComAdmDataDetail.raq",
            raqParams: {
                stDate: StartDate,
                endDate: EndDate,            
                comNo: comNo ,
        ...
        var raqSrc=PRCPRINT.RaqPrint(raqObj)
	    $("iframe").attr("src",raqSrc);
    } else if (radioValue == "ComLocIndex") {
        var raqObj = {
            raqName: "PHA_PRC_QueryIPRationalData.raq",
            raqParams: {
                stDate: StartDate,
                endDate: EndDate,            
                comNo: comNo ,
