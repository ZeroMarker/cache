...
function SelectRowHandler()	{
	...
	var objtbl=document.getElementById('tDHCEQMaintPlanPart'); //得到表格   t+组件名称
	...
	var obj8=document.getElementById("FeeFlag")
	//!selectrow
...
{	
	...
	var sqlco=cspRunServerMethod(encmeth,"","",MaintPlanDR,FittingsDR,QuantityNum,PriceFee,TotalFee,Remark,FeeFlag)
...
function BUpdate_click()
{
	...
	var sqlco=cspRunServerMethod(encmeth,"","",RowID,MaintPlanDR,FittingsDR,QuantityNum,PriceFee,TotalFee,Remark,FeeFlag)
	if (sqlco!='0') {
		alertShow(t["04"]);
	return;	}
	//SetMaintFee();
