...
function DisplayAdmInfo()
{
	...
	var lnk="dhc.wmr.paadm.query.csp?"+"&Papmi="+cPapmi+"&AdmDate="+cAdmDate+"&AdmType="+cAdmType+"&MrType="+MrType+"&AdmTypeFlag="+AdmTypeFlag+"&WorkItem="+WorkItem+"&RequestType="+RequestType+"&AutoTransfer="+AutoTransfer+"&AutoRequest="+AutoRequest+"&MultiAdmit="+MultiAdmit+"&MRChange="+MRChange;
	lnk=lnk+"&CardNo="+getElementValue("CardNo",null);
