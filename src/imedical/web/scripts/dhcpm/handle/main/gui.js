...
function InitviewScreen(){
	...
	var DefaultDateRet=Document.SelectDefaultDate();
	//******************************Start****************************
	...
	obj.cboDemStatusStoreProxy.on('beforeload', function(objProxy, param){
			...
			param.Arg1 = 'HandleNeed';
			param.Arg2 = 'Improvement';
			
			param.ArgCnt = 2;
	});
	obj.cboDemStatusStore.load();
...
obj.chkActivePanel = new Ext.Panel({
	...
	obj.DtlDataGridPanel = new Ext.grid.GridPanel({
		...
		,columns: [
			...
			{header : "操作",width : 100,dataIndex : 'node',align : 'center'
			...
			, { header : '附件标志', width : 80, dataIndex : 'AdjunctFlag', sortable : true,hidden:true, align : 'center' }
