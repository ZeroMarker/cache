...
function BFind_Click()
{
	...
	val=val+GetVData();
	//alertShow("vData="+val);
	window.location.href="websys.default.csp?WEBSYS.TCOMPONENT=DHCEQAdjustDataList"+val;
}
...
function GetVData()
{
	...
	val=val+"^ReportFlagDR="+GetElementValue("ReportFlagDR");
	val=val+"^AdjustTypeDR="+GetElementValue("AdjustTypeDR");
