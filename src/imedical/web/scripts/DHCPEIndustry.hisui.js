...
function BSave_click(Type)
{
	...
	//alert(Str)
	var rtn=tkMakeServerCall("web.DHCPE.Industry","UpdateIndustry",ID,Str);
	var Arr=rtn.split("^");
	if (Arr[0]>0){
		BClear_click();
...
function BDelete_click()
{
	...
	var rtn=tkMakeServerCall("web.DHCPE.Industry","DeleteIndustry",RowId);
	if (rtn.split("^")[0]=="-1"){
...
function BClear_click()
{
	...
	$("#IndustryQueryTab").datagrid('load',{
			ClassName:"web.DHCPE.Industry",
			QueryName:"SearchIndustry",
		});	
} 
...
function InitIndustryDataGrid()
{
	$HUI.datagrid("#IndustryQueryTab",{
		url:$URL,
		fit : true,
		border : false,
		striped : true,
		...
		columns:[[
			...
			{field:'TDesc',width:'250',title:'行业'},
