...
function AddClickHandler(e){
	...
	var PutFrTime=GetValue("PutFrTime");
	var PutToDate=GetValue("PutToDate");
	var PutToTime=GetValue("PutToTime");
	...
	var InsertData=PutFrDate+"^"+PutFrTime+"^"+PutToDate+"^"+PutToTime+"^"+ReasonRowId+"^"+PutRemarks;	
	
	var obj=document.getElementById('InsertMethod');
	if (obj) {var encmeth=obj.value;}else{var encmeth=""}
	//alert("encmeth:"+encmeth);
	if (encmeth!=''){
		var obj=document.getElementById("ResRowId");
		if (obj){
			var ResRowId=obj.value;
...
function UpdateClickHandler(e){
	...
	try{
		...
		var UpdateData=RowId+"^"+PutFrDate+"^"+PutFrTime+"^"+PutToDate+"^"+PutToTime+"^"+ReasonRowId+"^"+PutRemarks;
