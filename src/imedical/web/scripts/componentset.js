...
$(document).ready(function (){
	...
	initLookUp();
		...
		//Modified By wy 20230216 3222412 UI页面改造
...
//	setItemRequire("Component",true)
	...
	//initComponentPanel()
	//initComponentData()
	initButton(); //Modified By wy 20230216 3222412 UI页面改造
	initButtonWidth();
	...
	//jQuery("#BSave").click(function(){SavegridData()});
...
function AddComponent()
{
	...
	var title="组件定义"
	var width="1300"
	var height="800"		//czf 1687337 2021-02-19
...
function fillData_OnClickRow(rowIndex, rowData)
{
	if (PreSelectedRowID!=rowData.TRowID)
	{
		...
		{
			disableElement("BSave",true)  //Modified By wy 20230216 3222412 UI页面改造
			disableElement("Delete",true)
		}
		else
		{
			disableElement("BSave",false)  //Modified By wy 20230216 3222412 UI页面改造
	...
	else
	{
		...
		if (GlobalObj.SysSetFlag=="Y")
		{
			$('#BSave').show();   //Modified By wy 20230216 3222412 UI页面改造
		}
		PreSelectedRowID=""
