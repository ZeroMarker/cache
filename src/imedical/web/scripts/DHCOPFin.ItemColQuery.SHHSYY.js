////DHCOPFin.ItemColQuery.SHHSYY.js
...
function InitialCAT()
{
	...
	var objtbl=document.getElementById("tDHCOPFin_ItemColQuery_SHHSYY");
...
function DelTabRow(){
	var TabObj=document.getElementById("tDHCOPFin_ItemColQuery_SHHSYY");
...
function PrintClickHandler(){
	try {
		...
		xlsheet.cells(4,4)=myary[0];
	   	...
	   	xlsheet.cells(xlsrow+2,7)=t['RoundSum']
	   	var myval=DHCWebD_GetObjValue("RoundSum");
	   	xlsheet.cells(xlsrow+2,8)=myval;
