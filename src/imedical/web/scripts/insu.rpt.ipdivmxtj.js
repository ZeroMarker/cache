/**
 * FileName: insu.rpt.ipdivmxtj.js
 * Anchor: DingSH ZYW
 * Date: 2020-03-19
 ...
 */
 var INSURPT_CONSTANT = {
	...
	IFRAME: {
		//定义报表URL+报表文件
		SRC: 'dhccpmrunqianreport.csp?reportName=InsuIPDivMXTJ.rpx'
	}
};
...
function scanReport() {
	...
	var url = INSURPT_CONSTANT.IFRAME.SRC + '&StDate=' + StDate + '&EndDate=' + EndDate+ '&InsuType=' + InsuType+ '&DivFlag=' + DivFlag ;
