/**
  ...
  *author:wang ying
  *Date:2011-11-27
  *中国医学科学院医学信息研究所绩效考核在系统指标数据excel文件上传功能
 */
var importExcel = function(){
  //var uploadUrl = "http://10.2.168.9:8080/uploadexcel/ImportExcelByIdServlet";
  var uploadUrl = "http://localhost:8080/uploadexcel/ImportExcelByIdServlet";
	var data2="";
	var freStore="";
