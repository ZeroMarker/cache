...
var importExcel = function(){
  ...
  //var uploadUrl = "http://192.168.102.79:8080/uploadexcel/jxbasedata";
  //var uploadUrl = "http://127.0.0.1:8080/uploadexcel/ImportExcelByIdServlet";
	var uploadUrl = dhcUrl+"/uploadexcel/ImportExcelByIdServlet";
	...
	var formPanel = new Ext.form.FormPanel({
		...
		items:[cycle,periodType,period,excelUpload,textArea]
	});
