...
var DeptAuditDs = new Ext.data.Store({
	...
	reader: new Ext.data.JsonReader({
		...
		totalProperty: 'results'
            ...
            'DSArowid','ssuser','ssusr_name','dschemDr','dsc_name'
...
var DeptAuditFilterItem = new Ext.SplitButton({
		...
		tooltip: '关键字所属类别',
		menu: {items: [
			new Ext.menu.CheckItem({ text: '自查名称',value: 'dscname',checked: false,group: 'DeptAuditFilter',checkHandler: onDeptAuditItemCheck }),
			new Ext.menu.CheckItem({ text: '用户名称',value: 'ssusrName',checked: false,group: 'DeptAuditFilter',checkHandler: onDeptAuditItemCheck })
		]}
});
