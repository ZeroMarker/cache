...
var addMenu = new Ext.menu.Menu({
    id: 'addMenu',
    items: [initButton, importButton,excelButton,addButton]
});
...
var JXBaseDataTab = new Ext.grid.EditorGridPanel({
	...
	//tbar:['考核期间:',periodField,'-','期间类型:',pType,'-',addMenu,'-',delButton1,'-',aduitButton,'-',CancelAduitButton],
	/* listeners : { 
       'render': function(){ 
