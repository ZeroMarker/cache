editFun = function(userDr,outDs,OutGrid,outPagingToolbar){
	...
	if(len < 1){
		...
		var editHandler = function(){
			...
			Ext.Ajax.request({
				url:'../csp/dhc.pa.interpersonexe.csp?action=edit&inDr='+userDr+'&remark='+encodeURIComponent(remark)+'&code='+code+'&active='+active+'&rowid='+rowid+'&interLocSetDr='+interLocSetDr+'&name='+encodeURIComponent(name),
				waitMsg:'添加中..',
