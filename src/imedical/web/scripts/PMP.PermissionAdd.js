...
function newAdd(){
	var lnk="websys.default.csp?WEBSYS.TCOMPONENT=PMP.PermissionAdd"
	window.location=lnk;
	}
...
function FindRetClick()
{
	...
	//if (obj) var incstkcatrowid=obj.value ;
	//var obj=document.getElementById("wardrowid")
	//if (obj) var wardrowid=obj.value ;
	//var lnk="websys.default.csp?WEBSYS.TCOMPONENT=dhcpha.phareturnquery&StartDate="+sd+"&EndDate="+ed+"&returnlocrowid"+returnlocrowid+
	//"&incirowid="+incirowid+"&incstkcatrowid="+incstkcatrowid+"&wardrowid="+wardrowid ;
