...
function BFind_Clicked()
{
	...
	window.location.href= 'websys.default.csp?WEBSYS.TCOMPONENT=DHCEQSubjectDetailsList'+val;
...
function BSaveExcel_Clicked()
{
	...
	try {
	    ...
	    var Template=TemplatePath+"DHCEQSubjectDetailsList.xls";
	    ...
	    for (var i=0;i<=Pages;i++)
	    {
	    	...
	    	for (var k=1;k<=OnePageRow;k++)
	    	{
		    	...
		    	xlsheet.cells(j,7)=OneDetailList[9];	//台帐数量
		    	xlsheet.cells(j,8)=OneDetailList[10];	//台帐总金额 
			}
