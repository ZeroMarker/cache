...
function InitAssRateWin() {
    ...
    obj.gridAssRate = $HUI.datagrid("#AssessRate",{
	    ...
	    columns: [[
			...
			{ field: 'CssdSendUser', title: '发放人', width: 100, align: 'center' },
            { field: 'CssdClean', title: '清洗时间', width: 150, align: 'center' },
			{ field: 'CssdCleanUser', title: '清洗人', width: 100, align: 'center' },
			{ field: 'CssdStril', title: '灭菌时间', width: 150, align: 'center' },
			{ field: 'CssdStrilUser', title: '灭菌人', width: 100, align: 'center' },
			{ field:'CssdBack',title:'回收时间',width:150,align:'center'},
			{ field: 'CssdBackUser', title: '回收人', width: 100, align: 'center' },
