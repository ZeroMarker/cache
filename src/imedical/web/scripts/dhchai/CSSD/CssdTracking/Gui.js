...
function InitAssRateWin(){
    ...
    obj.gridAssRate = $HUI.datagrid("#AssessRate",{
		...
		columns:[[
			...
			{ field: 'SendUser', title: '发放人', width: 100, align: 'center' },
			{field:'Clean',title:'清洗时间',width:170,align:'center'},
			{field:'CleanUser',title:'清洗人',width:100,align:'center'},
			{field:'Steril',title:'灭菌时间',width:170,align:'center'},
			{field:'SterilUser',title:'灭菌人',width:100,align:'center'},
			{field:'Back',title:'回收时间',width:170,align:'center'},
			{ field: 'BackUser', title: '回收人', width: 100, align: 'center' }
		]],
		toolbar:[
			    {
