function InitS190CtlAntBloWinEvent(obj){	
	...
	p_URL = 'dhccpmrunqianreport.csp?reportName=DHCHAI.STAT.S190CtlAntBlo.raq&aHospIDs='+"" +'&aDateFrom=' + "" +'&aDateTo='+ "";	
    ...
    $("#btnQuery").on('click', function(){
		...
		p_URL = 'dhccpmrunqianreport.csp?reportName=DHCHAI.STAT.S190CtlAntBlo.raq&aHospIDs='+aHospID +'&aDateFrom=' + DateFrom +'&aDateTo='+ DateTo+'&aUser='+User;	
		ReportFrame.src = p_URL;
	});
}
