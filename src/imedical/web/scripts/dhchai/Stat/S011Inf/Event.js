function InitS011InfWinEvent(obj){	
	...
	p_URL = 'dhccpmrunqianreport.csp?reportName=DHCHAI.STAT.S011Inf.raq&aHospIDs='+"" +'&aDateFrom=' + "" +'&aDateTo='+ "";	
    ...
    $("#btnQuery").on('click', function(){
		...
		p_URL = 'dhccpmrunqianreport.csp?reportName=DHCHAI.STAT.S011Inf.raq&aHospIDs='+aHospID +'&aDateFrom=' + DateFrom +'&aDateTo='+ DateTo;	
		ReportFrame.src = p_URL;
	});
}
