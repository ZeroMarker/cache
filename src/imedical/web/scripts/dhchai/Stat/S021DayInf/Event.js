function InitS021DayInfWinEvent(obj){	
	...
	p_URL = 'dhccpmrunqianreport.csp?reportName=DHCHAI.STAT.S021DayInf.raq&aHospIDs='+"" +'&aDateFrom=' + "" +'&aDateTo='+ "";	
    ...
    $("#btnQuery").on('click', function(){
		...
		p_URL = 'dhccpmrunqianreport.csp?reportName=DHCHAI.STAT.S021DayInf.raq&aHospIDs='+aHospID +'&aDateFrom=' + DateFrom +'&aDateTo='+ DateTo;	
		ReportFrame.src = p_URL;
	});
}
