function InitS040MRBInfWinEvent(obj){	
	...
	p_URL = 'dhccpmrunqianreport.csp?reportName=DHCHAI.STAT.S040MRBInf.raq&aHospIDs='+"" +'&aDateFrom=' + "" +'&aDateTo='+ "";	
    ...
    $("#btnQuery").on('click', function(){
		...
		p_URL = 'dhccpmrunqianreport.csp?reportName=DHCHAI.STAT.S040MRBInf.raq&aHospIDs='+aHospID +'&aDateFrom=' + DateFrom +'&aDateTo='+ DateTo;	
		ReportFrame.src = p_URL;
	});
}
