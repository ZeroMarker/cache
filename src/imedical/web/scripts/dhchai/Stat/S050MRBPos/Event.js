function InitS050MRBPosWinEvent(obj){	
	...
	p_URL = 'dhccpmrunqianreport.csp?reportName=DHCHAI.STAT.S050MRBPos.raq&aHospIDs='+"" +'&aDateFrom=' + "" +'&aDateTo='+ "";	
    ...
    $("#btnQuery").on('click', function(){
		...
		p_URL = 'dhccpmrunqianreport.csp?reportName=DHCHAI.STAT.S050MRBPos.raq&aHospIDs='+aHospID +'&aDateFrom=' + DateFrom +'&aDateTo='+ DateTo;	
		ReportFrame.src = p_URL;
	});
}
