...
$('#menudatagrid').datagrid({   
    ...
    columns:[[    
        ...
        formatter:function(value,row,index){return '<A onclick="window.open(&quot;dhceq.process.pictypeaccess.csp?&CurrentSourceType='+value+'&SourceType='+row.SourceType+'&quot;,&quot;_blank&quot;,&quot;toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes&quot;)" href="#"><img border=0 complete="complete" src="../images/websys/security.gif" /></A>';}
    	}          
    ]],
