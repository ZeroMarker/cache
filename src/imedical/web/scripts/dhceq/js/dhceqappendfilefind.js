...
function AppendFileview(value, metaData, record, rowIndex, colIndex, store){
			...
			else 
			{
				...
				var str ="<button  onclick='window.open(&quot;dhceq.process.appendfileview.csp?RowID="+record.data.TRowID+"&ToSwfFlag=Y&quot;,&quot_blank&quot,&quot;toolbar=no,location=no,directories=no,status=yes,menubar=no,scrollbars=yes,resizable=yes,copyhistory=yes&quot;)'><font color='#FF0000'>浏览</font></button>";   //add by zx 2017-08-09 BUG ZX0038
