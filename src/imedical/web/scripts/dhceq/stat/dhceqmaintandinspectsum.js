...
var GlobalObj = {
	...
	ClearData : function(vElementID)
	{
		...
		if (vElementID=="Status") {this.StatusDR = "";}
		if (vElementID=="UseLoc") {this.UseLocDR = "";}
		if (vElementID=="MeasureFlag") {this.MeasureFlagDR = "";}
...
function initMeasureFlagData()
{
	if (jQuery("#MeasureFlag").prop("type")!="hidden")
	{
		jQuery("#MeasureFlag").combobox({
			height: 24,
			multiple: false,
			editable: false,
			disabled: false,
			...
			onSelect: function() {GlobalObj.MeasureFlagDR=jQuery("#MeasureFlag").combobox("getValue");}
		});
	}
}
...
function BFind_Clicked()
{
	...
	var lnk="";
	lnk=lnk+"&vPlanDR="+GlobalObj.PlanDR;
	lnk=lnk+"&vSourceTypeDR="+GlobalObj.SourceTypeDR;
	lnk=lnk+"&vEquipDR="+GlobalObj.EquipDR;
	lnk=lnk+"&vEquipNo=";
	lnk=lnk+"&vEquipName=";
	lnk=lnk+"&vModelDR="+GlobalObj.ModelDR;
	lnk=lnk+"&vMaintUserDR="+GlobalObj.MaintUserDR;
	lnk=lnk+"&vMaintLocDR="+GlobalObj.MaintLocDR;
	lnk=lnk+"&vMaintTypeDR="+GlobalObj.MaintTypeDR;
	lnk=lnk+"&vStartDate="+GetJQueryDate('#StartDate');
	lnk=lnk+"&vEndDate="+GetJQueryDate('#EndDate');
	lnk=lnk+"&vStatusDR="+GlobalObj.StatusDR;
	lnk=lnk+"&vFromYear="+jQuery("#FromYear").val();
	lnk=lnk+"&vToYear="+jQuery("#ToYear").val();
	lnk=lnk+"&vUseLocDR="+GlobalObj.UseLocDR;
	lnk=lnk+"&vMeasureFlag="+GlobalObj.MeasureFlagDR;
