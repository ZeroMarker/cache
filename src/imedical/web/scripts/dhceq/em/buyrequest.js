...
function initDocument()
{
    ...
    var paramsFrom=[{"name":"Type","type":"2","value":""},{"name":"LocDesc","type":"1","value":"BRManageLocDR_CTLOCDesc"},{"name":"vgroupid","type":"2","value":""},{"name":"LocType","type":"2","value":""},{"name":"notUseFlag","type":"2","value":""},{"name":"ManageLocFlag","type":"2","value":"1"}];
...
function BSave_Clicked()
{
    ...
    //modified by ZY20230418 bug:3437616、3437615
    ...
    if (BRLHold10<0)
    {
        messageShow("","","","预算单价不能为负数，请修改!")
        return
    }
    var BRLRequestNum=getElementValue("BRLRequestNum")
    if (BRLRequestNum=="")
    {
        messageShow("","","","申请数量为空!")
        return
...
function setAnchorInfo(showFlag)
{
    if(showFlag==1)
    {
        //每次加载之前移除样式
        $("#Anchor").empty();
        //modified by ZY20230209 bug:3232106、3353000
        //调整顺序与界面一致
        var dataArr = [{"actionDesc":"申请单","anchorPoint":"requestpanel"},
                ...
                {"actionDesc":"经济预测","anchorPoint":"benefitpanel"},
