...
function initDocument()
{
	...
	//Modefied by zc0131 2023-03-03 输出列元素影藏 begin
	...
	$("#DHCEQInventoryList").datagrid("hideColumn", "IListInfo");
	$("#DHCEQInventoryList").datagrid("hideColumn", "ILPictrue");
	//Modefied by zc0131 2023-03-03 输出列元素影藏 end
	// MZY0151	2023-02-01
	if ((typeof(HISUIStyleCode)!="undefined")&&(HISUIStyleCode=="lite"))
	{
		jQuery("#menubtn-prt").attr("style","width:116px");
		jQuery("#northborder").css("border-color","#e2e2e2");	// MZY0157	2612989		2023-03-29
	}
};
