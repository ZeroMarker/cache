...
{	
	...
	if(PrintFlag==1)
	{
        ...
        if(PreviewRptFlag==1)
        { 
		fileName="DHCEQStoreMoveSPrint.raq&RowID="+SMRowID+"&EQTitle="+EQTitle+"&FromLoc="+FromLoc +"&ToLoc="+ToLoc+"&AckDate="+AckDate+"&StoreMoveNo="+StoreMoveNo+"&AckUser="+AckUser ; //Modified By QW20191022 BUG:QW0032 修改润乾打印id未定义
