...
function BFind_Click()
{
	...
	var lnk = "websys.default.csp?WEBSYS.TCOMPONENT=DHCOPBillQFPat&TMPJID="+TMPJID+"&EndDate="+EndDate+"&StDate="+StDate+"&StatFlag="+StatFlag;
 //   alert(lnk)
...
{	
	...
	var objtbl=document.getElementById("tDHCOPBillQFPat");
...
function PrintClickHandler()
{
	...
	//	xlsheet.cells(xlsRow+i,xlsCol+5+k)=t["HJ"];		k++;
		...
		//Other
		i++;
		xlsheet.cells(2,13)=t["ZBR"];
		xlsheet.cells(2,15)=session['LOGON.USERCODE'];
		//xlsheet.cells(xlsRow+i,xlsCol+9)=t["shr"];
		xlsheet.cells(2,17)=t["BT"];
		xlsheet.cells(2,19)=CurDate;
		/*
		i++;
