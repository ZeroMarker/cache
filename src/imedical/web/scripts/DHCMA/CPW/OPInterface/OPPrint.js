...
{
	var TemplatePath= $m({                  
		ClassName:"DHCMA.CPW.OPCPS.OPCPWPrintSrv",
	...
	var flg = tkMakeServerCall("DHCMA.CPW.OPCPS.OPCPWPrintSrv","PrintCPWInformedConsert","fillxlSheet",EpisodeID,session['DHCMA.CTLOCID'],session['DHCMA.HOSPID']);
	xlSheet.printout();
...
function PrintCPWToExcel(strMethodGetServer,strMethodGetData,strTemplateName,strArguments)
{
	...
	xlBook=xls.Workbooks.Add(FileName);
	xlSheet=xlBook.Worksheets.Item(1);
	var flg = tkMakeServerCall("DHCMA.CPW.OPCPS.OPCPWPrintSrv","PrintCPWImpl","fillxlSheet",EpisodeID);
	xlSheet.printout();
...
function PrintCPWQueryToExcel(strMethodGetServer,strMethodGetData,strTemplateName,strArguments,aEpisodeID)
{
	var TemplatePath= $m({                  
		ClassName:"DHCMA.CPW.OPCPS.OPCPWPrintSrv",
		MethodName:"GetTemplatePath"
	...
	xlBook=xls.Workbooks.Add(FileName);
	xlSheet=xlBook.Worksheets.Item(1);
	var flg = tkMakeServerCall("DHCMA.CPW.OPCPS.OPCPWPrintSrv","PrintCPWImpl","fillxlSheet",aEpisodeID);
	xlSheet.printout();
