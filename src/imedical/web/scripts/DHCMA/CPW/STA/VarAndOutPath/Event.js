...
function InitVarAndOutPathWinEvent(obj){
	// 默认加载报表文件
	ReportFrame = document.getElementById("reportFrame");
	p_URL = 'dhccpmrunqianreport.csp?reportName=DHCMA.CPW.STA.VarOutAnalysis-ByLoc.raq&aDateFrom=&aDateTo=&aLocID=&aHospID=&aLocType=';	
	...
	$("#btnQueryLoc").on('click',function(){
		...
		p_URL = 'dhccpmrunqianreport.csp?reportName=DHCMA.CPW.STA.VarOutAnalysis-ByLoc.raq&aDateFrom=' + DateFrom +'&aDateTo='+ DateTo +'&aLocID='+ LocID+'&aHospID='+aHospID+'&aSDID='+EntityID+'&aLocType='+LocType;	
		ReportFrame.src = p_URL;
	});
	$("#btnQuerySD").on('click',function(){
		...
		p_URL = 'dhccpmrunqianreport.csp?reportName=DHCMA.CPW.STA.VarOutAnalysis-BySD.raq&aDateFrom=' + DateFrom +'&aDateTo='+ DateTo +'&aLocID='+ LocID+'&aHospID='+aHospID+'&aSDID='+EntityID+'&aLocType='+LocType;	
		ReportFrame.src = p_URL;
	});
}