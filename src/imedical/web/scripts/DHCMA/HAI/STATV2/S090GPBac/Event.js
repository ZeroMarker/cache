function InitS090gpbacWinEvent(obj){
	obj.LoadEvent = function(args){
   	...
   	obj.LoadRep = function(){
		...
		p_URL = 'dhccpmrunqianreport.csp?reportName=DHCMA.HAI.STATV2.S090GPBac.raq&aHospIDs='+aHospID +'&aDateFrom=' + aDateFrom +'&aDateTo='+ aDateTo+'&aLocType='+aLocType+'&aQryCon='+aQrycon+'&aStatDimens='+aStatDimens+'&aLocIDs='+aLocIDs+'&aPath='+cspPath;		
		if(!ReportFrame.src){
    ...
    obj.echartLocInfRatio = function(runQuery){
   	...
   	obj.ShowEChaert1 = function(){
		...
		/*
		var dataInput 	= "ClassName=" + 'DHCHAI.STATV2.S090GNBac' + "&QueryName=" + 'QryPathogeny' + "&Arg1=" + aHospID + "&Arg2=" + aDateFrom + "&Arg3=" + aDateTo +"&Arg4="+aLocType+"&Arg5="+aQrycon+"&Arg6="+aStatDimens+"&Arg7="+aLocIDs+"&ArgCnt=" + 7;
		$.ajax({
			...
			error: function(XMLHttpRequest, textStatus, errorThrown){
				var tkclass="DHCHAI.STATV2.S090GNBac";
		...
		obj.myChart.showLoading();
		$cm({
			ClassName:'DHCHAI.STATV2.S090GNBac',
