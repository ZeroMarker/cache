function InitS171AntTheSubWinEvent(obj){	 
   	...
   	obj.LoadRep = function(){
		...
		p_URL = 'dhccpmrunqianreport.csp?reportName=DHCMA.HAI.STATV2.S171AntTheSub.raq&aHospIDs='+aHospID +'&aDateFrom=' + aDateFrom +'&aDateTo='+ aDateTo+'&aSubDateType='+aSubDateType+'&aSubHourType='+aSubHourType+'&aLocType='+aLocType+'&aQryCon='+aQryCon+'&aUseSubDateType='+aUseSubDateType+'&aStatDimens='+aStatDimens+'&aLocIDs='+aLocIDs+'&aLabSubType='+LabSubType+'&aPath='+cspPath;		
