function InitS420cssposinf1WinEvent(obj){
   	...
   	obj.LoadRep = function(){
		...
		p_URL = 'dhccpmrunqianreport.csp?reportName=DHCMA.HAI.STATV2.S420CssPosInf1.raq&aSurNumID='+SurNumID +'&aStaType='+aLocType+'&aInfType='+"0";
    ...
    obj.echartLocInfRatio = function(runQuery){
   	...
   	obj.ShowEChaert1 = function(){
		...
		var dataInput = "ClassName=" + 'DHCHAI.STATV2.S420CssPosInf' + "&QueryName=" + 'QryInfPosCSS' + "&Arg1=" + SurNumID + "&Arg2=" + aLocType + "&Arg3=" + "0" +"&ArgCnt=" + 3;
