function InitS420cssposinf1WinEvent(obj){
   	...
   	obj.LoadRep = function(){
		...
		p_URL = Append_Url('dhccpmrunqianreport.csp?reportName=DHCMA.HAI.STATV2.S420CssPosInf1.raq&aSurNumID='+SurNumID +'&aStaType='+aLocType+'&aInfType='+"0");	//+'&aQryCon='+aQryCon
		if(!ReportFrame.src){
