function InitS021DayInfWinEvent(obj){
	obj.numbers = "ALL";
   	...
   	obj.LoadRep = function(){
		...
		p_URL = 'dhccpmrunqianreport.csp?reportName=DHCMA.HAI.STATV2.S490EHAirTho.raq&aHospIDs='+aHospID +'&aDateFrom=' + DateFrom +'&aDateTo='+ DateTo +'&aMonitorLocID='+LocID;	
		if(!ReportFrame.src){
   	...
   	obj.ShowEChaert1 = function(){
		...
		$cm({
			ClassName:"DHCHAI.STATV2.S490EHAirTho",
			QueryName:"QryEHAirTho",		
			aHospIDs:HospID,
			aDateFrom:DateFrom, 
			aDateTo:DateTo, 
			aMonitorLocID:LocID,
