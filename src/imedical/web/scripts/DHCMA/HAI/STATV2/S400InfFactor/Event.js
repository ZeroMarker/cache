function InitS390InfPosfWinEvent(obj){
	obj.numbers = "ALL";
   	...
   	obj.LoadRep = function(){
		...
		p_URL = 'dhccpmrunqianreport.csp?reportName=DHCMA.HAI.STATV2.S400InfFactor.raq&aDateFrom=' + DateFrom +'&aDateTo='+ DateTo +'&aHospIDs='+aHospID +'&aLocIDs='+'' +'&aLocType='+ Statunit +'&aQryCon='+2+'&aIsNewborn='+ 1+'&aActive='+ 1;
		if(!ReportFrame.src){
   	...
   	obj.ShowEChaert1 = function(arrViewLoc,arrInfRatio){
		...
		var dataInput = "ClassName=" + 'DHCHAI.STATV2.S400InfFactor' + "&QueryName=" + 'QryInfFactor' + "&Arg1=" + DateFrom + "&Arg2=" + DateTo+  "&Arg3=" + HospID +"&Arg4=" + "" +"&Arg5=" + StaType+"&Arg6=" +2+"&ArgCnt=" + 6;
		$.ajax({
