function InitS180CtlAntSubWinEvent(obj){
   	...
   	obj.LoadRep = function(){
		...
		p_URL = 'dhccpmrunqianreport.csp?reportName=DHCMA.HAI.STATV2.S180CtlAntSub.raq&aHospIDs='+aHospID +'&aDateFrom=' + aDateFrom +'&aDateTo='+ aDateTo+'&aLocType='+aLocType+'&aQryCon='+aQryCon;	
		if(!ReportFrame.src){
	...
	obj.option1 = function(arrViewLoc,arrBfKSS2Cnt,arrBfKSS2Ratio,arrBfKSS3Cnt,arrBfKSS3Ratio,endnumber){
		var option1 = {
			title : {
				text: '住院患者限制/特殊使用级抗菌药物治疗前病原学送检人数统计图',
				textStyle:{
					fontSize:28
				},
				x:'center',
    ...
    obj.echartLocInfRatio = function(runQuery){
		...
		var arrBfKSS2Cnt 	= new Array();		//限制级治疗前送检人数
		var arrBfKSS2Ratio 	= new Array();
		var arrBfKSS3Cnt	= new Array();		//特殊级治疗前送检人数
   	...
   	obj.ShowEChaert1 = function(){
		...
		var aLocType = Common_CheckboxValue('chkStatunit');
		var aQryCon 	= $('#cboQryCon').combobox('getValue');
		var dataInput = "ClassName=" + 'DHCHAI.STATV2.S180CtlAntSub' + "&QueryName=" + 'QryCtlAntSub' + "&Arg1=" + aHospID + "&Arg2=" + aDateFrom + "&Arg3=" + aDateTo +"&Arg4="+aLocType+"&Arg5="+aQryCon+"&ArgCnt=" + 5;
		...
		$.ajax({
			...
			error: function(XMLHttpRequest, textStatus, errorThrown){
				var tkclass="DHCHAI.STATV2.S180CtlAntSub";
				var tkQuery="QryCtlAntSub";
