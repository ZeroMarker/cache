function InitS060DaymrbinfWinEvent(obj){
	obj.LoadEvent = function(args){
   	...
   	obj.LoadRep = function(){
		...
		p_URL = 'dhccpmrunqianreport.csp?reportName=DHCMA.HAI.STATV2.S060DayMRBInf.raq&aHospIDs='+aHospID +'&aDateFrom=' + aDateFrom +'&aDateTo='+ aDateTo+'&aLocType='+aLocType+'&aQryCon='+aQrycon+'&aStatDimens='+aStatDimens+'&aLocIDs='+aLocIDs+'&aPath='+cspPath;
		if(!ReportFrame.src){
    ...
    obj.echartLocInfRatio = function(runQuery){
   	...
   	obj.ShowEChaert1 = function(){
		...
		var aLocIDs 	= $('#cboLoc').combobox('getValues').join(',');	
		/*
		var dataInput 	= "ClassName=" + 'DHCHAI.STATV2.S060DayMRBInf' + "&QueryName=" + 'QryMRBInf' + "&Arg1=" + aHospID + "&Arg2=" + aDateFrom + "&Arg3=" + aDateTo +"&Arg4="+aLocType+"&Arg5="+aQrycon+"&Arg6="+aStatDimens+"&Arg7="+aLocIDs+"&ArgCnt=" + 7;
		...
		obj.myChart.showLoading();
		$cm({
			ClassName:'DHCHAI.STATV2.S060DayMRBInf',
			QueryName:'QryMRBInf',
			aHospIDs:aHospID,
			aDateFrom:aDateFrom,
			aDateTo:aDateTo,
