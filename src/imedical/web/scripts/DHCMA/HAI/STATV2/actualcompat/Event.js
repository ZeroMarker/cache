function InitS030InfPrefWinEvent(obj){
	obj.numbers = "ALL";
   	...
   	obj.LoadRep = function(){
		...
		p_URL = 'dhccpmrunqianreport.csp?reportName=DHCMA.HAI.STATV2.S420SHPosInf.raq&aDateFrom=' + DateFrom +'&aDateTo='+ DateTo +'&aHospIDs='+aHospID +'&aLocIDs='+aLocIDs +'&aLocType='+ Statunit +'&aQryCon=2'+'&aInfType=0'+'&aStatDimens='+aStatDimens+'&aPath='+cspPath;
