function InitInfTrendStatWinEvent(obj){
   	...
   	obj.LoadRep = function(flag){
		...
		p_URL = 'dhccpmrunqianreport.csp?reportName=DHCMA.HAI.STATV2.InfTrendStat.raq&aHospIDs='+aHospID +'&aDateFrom=' + aDateFrom +'&aDateTo='+ aDateTo+'&aStatUnit='+aStatUnit+'&aLocID='+aSubLocDr+'&aLocType='+aLocType+'&aPath='+cspPath;	
		if(!ReportFrame.src){
