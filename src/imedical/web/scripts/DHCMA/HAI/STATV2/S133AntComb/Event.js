function InitS133AntCombWinEvent(obj){
   	...
   	obj.LoadRep = function(){
		...
		p_URL = 'dhccpmrunqianreport.csp?reportName=DHCMA.HAI.STATV2.S133AntComb.raq&aHospIDs='+aHospID +'&aDateFrom=' + aDateFrom +'&aDateTo='+ aDateTo+'&aLocType='+aLocType+'&aQryCon='+aQryCon+'&aStatDimens='+aStatDimens+'&aLocIDs='+aLocIDs+'&aPath='+cspPath;	
		if(!ReportFrame.src){
    ...
    obj.echartLocInfRatio = function(runQuery){
		...
		obj.myChart4.setOption(obj.option4(arrViewLoc4, arrAntiComb4, arrUseAntiRatio, endnumber), true);
	}
   	obj.ShowEChaert = function(){
		...
		$cm({
			ClassName:"DHCHAI.STATV2.S133AntComb",
			QueryName:"QryOutPatAntComb",
			aHospIDs:aHospID, 
			aDateFrom:aDateFrom, 
			aDateTo:aDateTo, 
			aLocType:aLocType, 
