function InitS021DayInfWinEvent(obj){
   	...
   	obj.LoadRep = function(){
		...
		false);*/
		p_URL = 'dhccpmrunqianreport.csp?reportName=DHCMA.HAI.STATV2.S240AIncInfN.raq&aHospIDs='+aHospID +'&aDateFrom=' + DateFrom +'&aDateTo='+ DateTo +'&aStaType='+ Statunit +'&aQryCon='+ Qrycon+'&aOperCat='+OperCat;	
		if(!ReportFrame.src){
   	...
   	obj.ShowEChaert1 = function(){
		...
		var option1 = {
			...
			legend: {
				data:['Ⅰ类切口手术部位感染人次数','Ⅰ类切口手术部位感染率'],
				x: 'center',
				y: 30
			},
			grid:{
...
//		var dataInput = "ClassName=" + 'DHCHAI.STATV2.S240AIncInf' + "&QueryName=" + 'QryAIncInfN' + "&Arg1=" + HospID + "&Arg2=" + DateFrom + "&Arg3=" + DateTo+ "&Arg4=" + StaType+ "&Arg5=" + Qrycon+"&Arg6=" + OperCat+"&ArgCnt=" + 6;
//		$.ajax({
