function InitS390InfPosfWinEvent(obj){
	obj.numbers = "ALL";
   	...
   	obj.LoadRep = function(){
		...
		p_URL = 'dhccpmrunqianreport.csp?reportName=DHCMA.HAI.STATV2.S320UCInf.raq&aDateFrom=' + DateFrom +'&aDateTo='+ DateTo +'&aHospIDs='+aHospID+'&aLocIDs='+''+'&aLocType='+aLocType+'&aQryCon='+Qrycon+'&aTubeType='+'UC' ;
		if(!ReportFrame.src){
   	...
   	obj.ShowEChaert1 = function(){
		...
		var aLocType = Common_CheckboxValue('chkStatunit');
		var Qrycon = $('#aQryCon').combobox('getValue');
		var dataInput = "ClassName=" + 'DHCHAI.STATV2.S3TubeInf' + "&QueryName=" + 'QryTubeInf' + "&Arg1=" + DateFrom + "&Arg2=" + DateTo + "&Arg3=" + HospID+ "&Arg4=" + ''+ "&Arg5=" + aLocType+ "&Arg6=" + Qrycon+ "&Arg7=" + 'UC'+ "&ArgCnt=" + 7;
		$.ajax({
