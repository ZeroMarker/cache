function InitS412CssDiseaseWinEvent(obj){
   	...
   	obj.LoadRep = function(){
		...
		p_URL = Append_Url('dhccpmrunqianreport.csp?reportName=DHCMA.HAI.STATV2.S412CssDisease.raq&aSurNumID='+SurNumID +'&aStaType=' + aLocType) ;	
		if(!ReportFrame.src){
