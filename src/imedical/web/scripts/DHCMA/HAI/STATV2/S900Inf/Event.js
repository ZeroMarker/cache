function InitS900InfWinEvent(obj){
   	...
   	obj.LoadRep = function(){
		...
		p_URL = 'dhccpmrunqianreport.csp?reportName=DHCMA.HAI.STATV2.S900Inf.raq&aHospIDs='+aHospID +'&aDateFrom=' + aDateFrom +'&aDateTo='+ aDateTo+'&aLocType='+aLocType+'&aQryCon='+aQrycon;	
		if(!ReportFrame.src){
    ...
    obj.echartLocInfRatio = function(runQuery){
   	...
   	obj.ShowEChaert1 = function(){
		...
		var aLocType = Common_CheckboxValue('chkStatunit');
		var aQryCon =  $('#cboQryCon').combobox('getValue');
		var dataInput = "ClassName=" + 'DHCHAI.STATV2.S900Inf' + "&QueryName=" + 'QryS900Inf' + "&Arg1=" + aHospID + "&Arg2=" + aDateFrom + "&Arg3=" + aDateTo +"&Arg4="+aLocType+"&Arg5="+aQryCon+"&ArgCnt=" + 5;
		...
		$.ajax({
			...
			error: function(XMLHttpRequest, textStatus, errorThrown){
				var tkclass="DHCHAI.STATV2.S900Inf";
				var tkQuery="QryS900Inf";
