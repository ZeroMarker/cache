function InitS021DayInfWinEvent(obj){
	obj.numbers = "ALL";
   	...
   	obj.LoadRep = function(){
		...
		false);
		*/
		p_URL = 'dhccpmrunqianreport.csp?reportName=DHCMA.HAI.STATV2.S340BwGrpInf.raq&aDateFrom=' + DateFrom +'&aDateTo='+ DateTo +'&aHospIDs='+aHospID+'&aPath='+cspPath;	
		if(!ReportFrame.src){
	...
	obj.up=function(x,y){
   	...
   	obj.ShowEChaert1 = function(){
		...
		$cm({
			ClassName:'DHCHAI.STATV2.S340BwGrpInf',
	   ...
	   obj.echartLocInfRatio = function(runQuery){
			...
			for (var indRd = 0; indRd < arrRecord.length; indRd++){
				...
				//去掉全院、医院、科室组
				/*
				if ((rd["QrySDayInf"].indexOf('-A-')>-1)||(rd["QrySDayInf"].indexOf('-H-')>-1)||(rd["QrySDayInf"].indexOf('-G-')>-1)) {
