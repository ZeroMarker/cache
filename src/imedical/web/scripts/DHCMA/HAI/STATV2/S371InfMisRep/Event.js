function InitS371InfMisRepWinEvent(obj){
	obj.numbers = "ALL";
	...
	obj.up=function(x,y){
   	...
   	obj.LoadRep = function(){
		...
		p_URL = 'dhccpmrunqianreport.csp?reportName=DHCMA.HAI.STATV2.S371InfMisRep.raq&aHospIDs=' + aHospID +'&aDateFrom=' + aDateFrom +'&aDateTo='+ aDateTo+'&aLocType='+aLocType+'&aQryCon='+aQrycon+'&aStatDimens='+aStatDimens+'&aLocIDs='+aLocIDs+'&aPath='+cspPath;	
		if(!ReportFrame.src){
   	...
   	obj.ShowEChaert1 = function(){
		...
		$cm({
			ClassName:'DHCHAI.STATV2.S371InfMisRep',
			QueryName:'QryInfMisRepByDD',
			aHospIDs:aHospID,
			aDateFrom:aDateFrom,
			aDateTo:aDateTo,
			aLocType:aLocType,
