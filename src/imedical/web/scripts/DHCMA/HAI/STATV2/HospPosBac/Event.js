function InitHPosBacInfPreWinEvent(obj){
	obj.numbers = "ALL";
	...
	obj.LoadRep = function(){
		...
		p_URL = 'dhccpmrunqianreport.csp?reportName=DHCMA.HAI.STATV2.S450SHCSSPosBac.raq&aHospIDs='+aHospID +'&aDateFrom=' + aDateFrom +'&aDateTo='+ aDateTo+'&aStaType='+"E"+'&aInfType=1'+'&aPath='+cspPath;
		if(!ReportFrame.src){
 ...
 obj.echartLocInfRatio = function(runQuery){
    ...
    obj.echartLocInfRatio1 = function(runQuery){
		...
		for (var indRd = 0; indRd < arrRecord.length; indRd++){
			...
			if (len>=0){
				arrDiagCount[len]=arrDiagCount[len]+parseInt(rd["InfDiagCount"])
			}else{
