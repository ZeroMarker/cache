function InitS200FevBloSumWinEvent(obj){
   	...
   	obj.LoadRep = function(){
		...
		p_URL = 'dhccpmrunqianreport.csp?reportName=DHCMA.HAI.STATV2.S200FevBloSum.raq&aHospIDs='+aHospID +'&aDateFrom=' + aDateFrom +'&aDateTo='+ aDateTo+'&aLocType='+aLocType+'&aQryCon='+aQryCon;	
		if(!ReportFrame.src){
			...
			yAxis: [
				{
					...
					name: '血培养人数',
					min: 0,
					interval:Math.ceil(arrSubmitCnt[0]/10),
					axisLabel: {
						formatter: '{value} '
					}
				},
    ...
    obj.echartLocInfRatio = function(runQuery){
   	...
   	obj.ShowEChaert1 = function(){
		...
		var aLocType = Common_CheckboxValue('chkStatunit');
		var aQryCon 	= $('#cboQryCon').combobox('getValue');
		var dataInput = "ClassName=" + 'DHCHAI.STATV2.S200FevBloSum' + "&QueryName=" + 'QryFevBloSum' + "&Arg1=" + aHospID + "&Arg2=" + aDateFrom + "&Arg3=" + aDateTo +"&Arg4="+aLocType+"&Arg5="+aQryCon+"&ArgCnt=" + 5;
		...
		$.ajax({
			...
			error: function(XMLHttpRequest, textStatus, errorThrown){
				var tkclass="DHCHAI.STATV2.S200FevBloSum";
				var tkQuery="QryFevBloSum";
