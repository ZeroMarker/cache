function InitS420SHPosInf1WinEvent(obj){
   	...
   	obj.LoadRep = function(){
		...
		p_URL = 'dhccpmrunqianreport.csp?reportName=DHCMA.HAI.STATV2.S420SHPosInf1.raq&aHospIDs='+aHospID +'&aDateFrom=' + aDateFrom +'&aDateTo='+ aDateTo+'&aStaType='+aLocType+'&aInfType='+"0";	
		if(!ReportFrame.src){
	...
	obj.echartLocInfRatio = function(runQuery){
   	...
   	obj.ShowEChaert1 = function(){
		...
		var dataInput = "ClassName=" + 'DHCHAI.STATV2.S420SHPosInf' + "&QueryName=" + 'QryInfPosCSS' + "&Arg1=" + aHospID + "&Arg2=" + aDateFrom + "&Arg3=" + aDateTo +"&Arg4=" + aLocType+"&Arg5=" +"0"+"&ArgCnt=" + 5;
