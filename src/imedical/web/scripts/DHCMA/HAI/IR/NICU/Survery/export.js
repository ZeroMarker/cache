...
function ExportNICUData(aDate,aLocID,aType){	
    ...
    if (aType==1) {
		...
		var rData = [];	
		rData.push("合计",compute(DataArray,"AISItem1"),compute(DataArray,"AISItem2"),compute(DataArray,"AISItem3"),compute(DataArray,"AISItem4"),compute(DataArray,"AISItem5"),compute(DataArray,"AISItem6"),compute(DataArray,"AISItem7"),compute(DataArray,"AISItem8"),compute(DataArray,"AISItem9"),compute(DataArray,"AISItem10"),compute(DataArray,"AISItem11"),compute(DataArray,"AISItem12"),compute(DataArray,"AISItem13"),compute(DataArray,"AISItem14"),compute(DataArray,"AISItem15"),compute(DataArray,"AISItem16"),compute(DataArray,"AISItem17"),compute(DataArray,"AISItem18"),compute(DataArray,"AISItem19"),compute(DataArray,"AISItem20")) ;       
		newArr.push(rData);     
    	...
    	var rData=[];
    	rData.push("合计",compute(DataArray,"AISItem1"),compute(DataArray,"AISItem2"),compute(DataArray,"AISItem3"),compute(DataArray,"AISItem4"),compute(DataArray,"AISItem5"),compute(DataArray,"AISItem6"),compute(DataArray,"AISItem7"),compute(DataArray,"AISItem8"),compute(DataArray,"AISItem9"),compute(DataArray,"AISItem10"),compute(DataArray,"AISItem11"),compute(DataArray,"AISItem12"),compute(DataArray,"AISItem13"),compute(DataArray,"AISItem14"),compute(DataArray,"AISItem15"),compute(DataArray,"AISItem16"));       
		newArr.push(rData);
...
function toWeightHtml(newArr){
	...
	data.push('	<td style="'+thStyle+'" >中央血管导管数</td>');
...
//1.指定列求和
function compute(DataArray,colName) {
	var len = DataArray.length;
	var total=0;
	if (len>1){
		for (var ind=0; ind<len;ind++) {
            if (parseInt(DataArray[ind][colName]) > 0) {
                total = total + parseInt(DataArray[ind][colName]);
            }
		}	
    }
    return total
