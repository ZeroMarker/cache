...
function InitRepqryWin() {
    ...
    //NICU调查登记表
    obj.gridNICULogs = $HUI.datagrid("#gridNICULogs", {
        fit: true,
        title: 'NICU调查登记表',
        ...
        columns: [[
        	{
                field: 'RepStatus', title: '调查状态', width: 60,sortable:true,sorter:Sort_int,
			...
			{ field: 'PAAdmDate', title: '入院日期', width: 100,sortable:true,sorter:Sort_int},
			{ field: 'PADischDate', title: '出院日期', width: 100, sortable: true,sortable:true,sorter:Sort_int},
            {
            ...
            { field: 'AdmWardDesc', title: '就诊科别', width: 150,sortable:true,sorter:Sort_int},
			{ field: 'PAAdmBed', title: '床号', width: 80,sortable:true,sorter:Sort_int},
            { field: 'PatWeight', title: '体重(g)', width: 100,sortable:true,sorter:Sort_int},
            ...
            {
                field: 'IsPICC', title: '脐/中心静脉插管', width: 120,sortable:true,sorter:Sort_int,
                formatter: function (value, row, index) {
                    var rst = "";
                    if (value == "1") {
                        rst = '<span style="color:green">' + '新开' + '</span>';
            ...
            //{ field: 'RepStatus', title: '状态', width: 80,sortable:true,sorter:Sort_int},
