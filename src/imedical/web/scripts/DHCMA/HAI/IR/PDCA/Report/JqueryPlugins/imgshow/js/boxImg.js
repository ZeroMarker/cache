...
$("img[modal='zoomImg']").each(function () {
    $(this).on("click", function () {
        ...
        $("body").append("<div class=\"mask-layer\">" +
            ...
            "           <button class=\"mask-prev btn-default-styles\" style=\"float: left\">"+$g("上一张")+"</button>" +
            "           <button class=\"mask-out btn-default-styles\">"+$g("放大")+"</button>" +
            "           <button class=\"mask-in btn-default-styles\">"+$g("缩小")+"</button>" +
            "           <button class=\"mask-clockwise btn-default-styles\">"+$g("顺时针")+"</button>" +
            "           <button class=\"mask-counterclockwise btn-default-styles\">"+$g("逆时针")+"</button>" +
            "           <button class=\"mask-close btn-default-styles\">"+$g("关闭")+"</button>" +
            "           <button class=\"mask-next btn-default-styles\" style=\"float: right\">"+$g("下一张")+"</button>" +
            "       </div>" +
        ...
        var $this = $(this);
        var img_index = $this.attr("index"); //获取点击的索引值
        var num = img_index;
