...
function InitCCItmWarnWin(){
	...
	obj.gridCCItmWarn = $HUI.datagrid("#gridCCItmWarn",{
		...
		columns:[[
			...
			{field:'KeyWords',title:'关键词',width:200,sortable:true},
			{field:'IndNo',title:'排序码',width:200},
			{field:'Arg1',title:'参数1',width:100},
			{field:'Arg2',title:'参数2',width:100},
			{field:'Arg3',title:'参数3',width:300},
			{field:'Arg4',title:'参数4',width:100},
			{field:'Arg5',title:'参数5',width:100},
			{field:'IsActive',title:'是否有效',width:100,
				formatter: function(value,row,index){
					return (value == '1' ? '是' : '否');
				}
			},
			{field:'ActDate',title:'更新日期时间',width:300},
