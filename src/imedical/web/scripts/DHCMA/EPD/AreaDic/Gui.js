...
function  InitAreaDicWin(){
	...
	obj.gripAreaDic = $HUI.datagrid("#gridAreaDic",{
		...
		url:$URL,
		queryParams:{
			ClassName:"DHCMed.EPDService.AreaDicSrv",
	...
	function ComboToArea() {
		...
		var cbox = $HUI.combobox("#"+ItemCode, {
			...
			onShowPanel: function () {
				var url=$URL+"?ClassName=DHCMed.EPDService.AreaDicSrv&QueryName=QryAreaDic&ResultSetType=array&aParentID="+(lnkLocCmp != "1" ? $('#'+lnkLocCmp).combobox('getValue') : 1);
