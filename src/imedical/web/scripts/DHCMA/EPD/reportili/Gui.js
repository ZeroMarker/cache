function InitReportWin(){
	...
	obj.EpdInitAddressByLocalHospital = obj.LoadNotice("EpdInitAddressByLocalHospital", "");  
	//省市县乡联动
	obj.cboERCurrProvince = Common_ComboToAreaEpd("cboERCurrProvince","1");               // 省
	obj.cboERCurrCity = $HUI.combobox('#cboERCurrProvince', {
		onChange:function(newValue,oldValue){
			...
			obj.cboERCurrCity = Common_ComboToAreaEpd("cboERCurrCity","cboERCurrProvince");			  // 市
		}
	});
	obj.cboERCurrCounty = $HUI.combobox('#cboERCurrCity', {
		onChange:function(newValue,oldValue){
			...
			$('#cboERCurrTown').combobox('clear');
			$('#txtERCurrVillage').val('');
			obj.cboERCurrCounty = Common_ComboToAreaEpd("cboERCurrCounty","cboERCurrCity");            // 县
		}
	});
	...
	obj.cboERCurrTown = $HUI.combobox('#cboERCurrCounty', {
		onChange:function(newValue,oldValue){
			$('#cboERCurrTown').combobox('clear');
			$('#txtERCurrVillage').val('');
			obj.cboERCurrTown = Common_ComboToAreaEpd("cboERCurrTown","cboERCurrCounty");         // 乡
		}
	});
