...
function InitReportWin(){
	...
	obj.LoadListInfo = function() {	  //加载单选、多选列表          
     	obj.radZSXZList = Common_RadioToDic("radZSXZList","CRZSXZ",2);       //中暑性质
		obj.radZSZDList = Common_RadioToDic("radZSZDList","CRZSZD",7);       //中暑诊断
		obj.radZSZGList = Common_RadioToDic("radZSZGList","CRZSZG",3);       //中暑转归
	}
