...
function InitQueryWinEvent(obj){	
	...
	obj.LoadEvent = function(args){ 
		...
		$('#btnEdit').on('click', function(){
			var rd = obj.gridAnatomy.getSelected();
			obj.InitDialog(rd);
		});
		//删除
	...
	//单击选中事件
	obj.gridAnatomy_onSelect = function (){
		var rowData = obj.gridAnatomy.getSelected();
		...
		if (rowData["ID"] == obj.RecRowID) {
			...
			obj.gridAnatomy.clearSelections();  //清除选中行
		} else {
    ...
    //双击弹出编辑事件
	obj.gridAnatomy_onDbselect = function(rd){
		obj.InitDialog(rd);
	}
