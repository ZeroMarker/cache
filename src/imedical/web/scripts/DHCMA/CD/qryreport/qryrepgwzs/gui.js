...
function InitViewport(){
	...
	obj.gridRepInfo = $HUI.datagrid("#gridRepInfo",{
		...
		columns:[[
			...
			{title:'操作',width:45,field:'expander',align:'center',
				formatter: function(value,row,index){
					...
					if ((typeof HISUIStyleCode != 'undefined') && (HISUIStyleCode=="lite")){
						var btn = '<span href="#" class="icon icon-paper" onclick="objScreen.OpenReport(\'' + ReportID + '\',\'' + EpisodeID + '\')"></span>';
					}else{
			...
			{title: '中暑诊断', width: 120, field: 'ZSZD'},
			{title: '中暑性质', width: 80, field: 'ZSXZ'},
			...
			{title: '转归', width: 60, field: 'OutCome'},
			{title: '联系电话', width: 120, field: 'TelPhone'},
			{title: '证件号', width: 220, field: 'PersonalID',showTip:true},
