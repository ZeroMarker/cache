...
function InitViewport(){
	...
	obj.gridRepInfo = $HUI.datagrid("#gridRepInfo",{
		...
		columns:[[
			...
			{title: '填报科室', width: 100, field: 'RepLocDesc'}, 
			{title: '卡片编号', width: 100, field: 'KPBH'},          
			{title: '姓名', width: 100, field: 'PatName'},      
			{title: '性别', width: 50, field: 'PatSex'},           
			{title: '就学情况', width: 120, field: 'ChildSchool'},
			{title: '伤害发生时间', width: 180, field: 'HappenTime'},                
			{title: '伤害发生原因', width: 180, field: 'HappenResaon'},         
			{title: '伤害发生地点', width: 180, field: 'HappenPlace'},            
			{title: '伤害发生时活动', width: 180, field: 'HappenActivity'},        
			{title: '是否故意', width: 180, field: 'IsWillfully'},         
			{title: '伤者饮酒情况', width: 120, field: 'IsDrink'},     
