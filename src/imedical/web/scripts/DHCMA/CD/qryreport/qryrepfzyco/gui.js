...
function InitViewport(){
	...
	obj.gridRepInfo = $HUI.datagrid("#gridRepInfo",{
		...
		columns:[[
			...
			{title: '中毒诊断', width: 120, field: 'ZDZD'},        
			{title: '中毒原因', width: 100, field: 'ZDYY'},         
			{title: '主要症状', width: 150, field: 'ZYZZs',showTip:true},       
			{title: '救治措施', width: 220, field: 'JZCSs',showTip:true},      
			{title: '中毒场所', width: 100, field: 'ZDCS'},       
			{title: '中毒因素', width: 100, field: 'ZDYS'},       
			{title: '转归', width: 80, field: 'COZG'},         
			{title: '中毒日期', width: 120, field: 'COZDRQ'},      
			{title: '诊断日期', width: 120, field: 'ZDRQ'},        
			...
			{title: '职业', width: 220, field: 'Occupation',showTip:true},  
