...
function SelectRowHandler()	{
	...
	var objtbl=document.getElementById('tDHCEQSerContract'); //得到表格   t+组件名称
	...
	if (selectrow==SelectedRow){
		...
		DisableBElement("BDelete",true);
		return;}
	obj=document.getElementById("TRowIDz"+selectrow)
	var RowID=obj.value
	FillData(RowID);
	if (GetElementValue("ReadOnly")!=1)
	{
		InitPage(); //修改  By 20150827 HHM0011 事件灰化后必须重新初始化
...
function FillData(RowID)
{
	...
	SetElement("Provider",list[sort+13]); //修改 By 20150826  HHM0010
