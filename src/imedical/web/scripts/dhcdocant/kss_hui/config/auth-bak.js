...
$(function(){
		...
		if (!selected){
			if (docAuthNum == 3) {
				...
				*/
				...
				$("#i-auth-docdialog-add-hosp").simplecombobox("setValue", "");
			...
			$("#c-auth-docdialog-add-save").on('click', function(){
				if (docAuthNum == 1) {
					...
					var docLevel = $("#i-9docAuth-docLevel").simplecombobox('getValue')||"",
						doc = $("#i-9docAuth-doc").simplecombobox('getValue')||"";
					if ((!!!docLevel) || (!!!doc)) {
						layer.alert("医护级别和医生姓名不能为空！", {title:'提示',icon: 0}); 
						return false;
					};
	...
	$("#i-auth-docforbidden").on('click', function(){
		...
		var docdialogStr = "<div id='i-diag' class='c-auth-docdialog container'>" +
				...
				"</div>" +
				"<div class='row'>" +
					"<span class='c-span'>所属院区</span><input id='i-hosp' class='textbox' type='text' style='width:250px;'  />" +
				"</div>" +
				"<div class='row' style='text-align:center;'>" +
		...
		$("#saveForbidden").on("click", function() {
			...
			var hospId = $("#i-hosp").simplecombobox("getValue")||"";
			if ((sdate == "")||(edate == "")) {
	...
	window.reloadAuthGrid = function(notip) {
		notip = notip||"";
		var arg1="",arg2="",arg3="",
			arg4="",arg5="",arg6="",
			arg7="",arg8="",arg9="",
