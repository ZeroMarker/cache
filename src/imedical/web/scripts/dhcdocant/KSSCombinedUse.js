CombinedUse=function(EpisodeId,ParrAllInfo){
    ...
    var Curflag=false;
    debugger;
    var MaxNumObj=ExtTool.StaticServerObject("web.DHCAntCombined");
    var MaxNum=MaxNumObj.GetCombinedNumFormDAUP(this.EpisodeId,ParrAllInfo);
    var CurReaObj=ExtTool.StaticServerObject("web.DHCAntCombined");
    var CurRearet=CurReaObj.GetCombinedNumFormDAUP(this.EpisodeId,this.ParrAllInfo);
    if(CurRearet.split("|")[0]!=0){
        Curflag=true;
    }
    var ChrReaObj=ExtTool.StaticServerObject("web.DHCAntCombined");
...
Ext.extend(CombinedUse,Ext.Panel,{
    ...
    CloseWin:function(){
        ...
        var InsertObj=ExtTool.StaticServerObject("web.DHCAntCombined");
...
CombinedUseReason=function(EpisodeId,ParrAllInfo){
        ...
        this.CombinedReasonStore = new Ext.data.Store({
            ...
            [
                ...
                ,{name: 'desc', mapping: 'CURDesc'}
                ,{name: 'code', mapping: 'CURCode'}
                ,{name: 'Rowid', mapping: 'CurId'}
            ])
        });
        ...
        this.CombinedReasonProxy.on('beforeload', function(objProxy, param){
            param.ClassName = 'web.DHCAntCombined';
            param.QueryName = 'QryCombinedUseReason';
            //param.Arg1 = 1;  //this.UserReason.getRawValue();
            param.ArgCnt=0;
        },this);
        var ChkCurObj=ExtTool.StaticServerObject("web.DHCAntCombined");
      ...
      //-----------------------------!!!!!!!!!!!!!!!!!!!!!---------------------------------
        ...
        this.ChangeKssReasonStore=new Ext.data.Store({
                ...
                reader:new Ext.data.JsonReader({
                        ...
                        [
                                {name:'checked',mapping:'checked'},
                                {name:'Rowid',mapping:'ChrId'},
                                {name:'CHRDesc',mapping:'CHRDesc'}
                        ])  
        });
      ...
      var ChkChrObj=ExtTool.StaticServerObject("web.DHCAntCombined");
