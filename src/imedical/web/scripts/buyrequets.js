...
function BSubmit_Clicked()
{
	...
	if (BenefitFlag==1)
	{
		var jsonData=tkMakeServerCall("web.DHCEQ.EM.BUSBuyRequest","BenefitContrast", getElementValue("BRUseLocDR"), getElementValue("BRLEquipCatDR"),getElementValue("ECWorkLoadNum"));
		jsonData=JSON.parse(jsonData)
		if (jsonData.SQLCODE==0)
		{
			OptSubmit();
