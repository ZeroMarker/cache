/**
 * 调查问卷录入 dhcrm.questiondetailset.js
 * @Author   yupeng
 * @DateTime 2020-11-30
 */
    ...
    for (var i = 0; i < array.length; i++) {
        ...
        switch(detailType){
            ...
            case "DA":
                ...
                break;
            case "DT":
                valList=getTextVal(detailId); //多文本
                break;
            case "DN":
                valList=getNumVal(detailId); //多数值
                break;
            default:
