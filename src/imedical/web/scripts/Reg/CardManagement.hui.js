        ...
        [
            ...
            { field: 'CardNO', title: '卡号', width: 100 },
            {
                ...
                formatter: function(value, row, index) {
                    return "<a href='#'  style='display: inline-block;' onclick='GotoCardWindow(\"" + row["CardNO"] + "\")' >" + value + "</a>"
                }
            },
...
function RegReturnListTabDataGridLoad() {
    ...
    $.cm({
        ...
        QueryName: "PatientCardQuerySort",
        Name: $("#Name").val(),
        IDCardNo: "", //身份证号
        CardNo: $("#CardNo").val(),
        CardStatus: "N",
        ...
        RegNo: $("#RegNo").val(),
        Pagerows: PageLogicObj.m_CardListTabDataGrid.datagrid("options").pageSize,
        rows: 99999
    }, function(GridData) {
...
function ShowReportLossWin(text) {
    ...
    var Dialogwidth = "396"
    if (text == "补卡") { var Dialogwidth = 435 }
    createModalDialog("CardManager", text, "795", Dialogwidth, "icon-w-edit", "", $code, "");
}
...
function ShowExchangeWin(text) {
    ...
    src=('undefined'!==typeof websys_writeMWToken)?websys_writeMWToken(src):src;
    var $code = "<iframe width='100%' height='100%' scrolling='auto' frameborder='0' src='" + src + "'></iframe>";
    createModalDialog("CardManager", text, "790", "432", "icon-w-edit", "", $code, "");
}
...
function ShowCancelCardWin(text) {
    ...
    src=('undefined'!==typeof websys_writeMWToken)?websys_writeMWToken(src):src;
    var $code = "<iframe width='100%' height='100%' scrolling='auto' frameborder='0' src='" + src + "'></iframe>";
    createModalDialog("CardManager", text, "795", "475", "icon-w-edit", "", $code, "");
}
...
function GotoCardWindow(Cardno) {
    var src = "reg.cardmanagerquery.hui.csp?Cardno=" + Cardno
    src=('undefined'!==typeof websys_writeMWToken)?websys_writeMWToken(src):src;
    var $code = "<iframe width='100%' height='100%' scrolling='auto' frameborder='0' src='" + src + "'></iframe>";
    createModalDialog("Deposit", "卡管理", PageLogicObj.dw+80, PageLogicObj.dh, "", "", $code, "");

}
function SeachByRegNo() {
	if (ServerObj.RegNo=="") return ;
	if (typeof ServerObj.RegNo == "undefined") { return ; }
