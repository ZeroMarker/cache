    ...
    for (var i = 0; i < GirdData.length; i++) {
        ...
        if ((i + 1) % 5 == 0) {
			...
			$.cm({
				...
				UnsaveData:btoa(unescape(encodeURIComponent(UnsaveData))),	//转BASE64 基础平台可能过滤html
				type:'BEACON'
			});
            UnsaveData = "";
        }
    ...
    if (GlobalObj.CheckIPDepositMethod != "") {
        ...
        if (retDetail != 0) {
            ...
            if (retArray[4] == 'C') {
                ...
                if (retArray[5] == 'N') {
                    $.messager.alert("警告",$g(t['ExceedDeposit']) + AlertAmount);
                    return false;
                } else {
                    if (arcim != "") {
				        ...
				        (function(callBackFunExec){
					        new Promise(function(resolve,rejected){
							    ...
							    return new Promise(function(resolve,rejected){
									...
									// 后续ChangeFirstDayTimes里有调用 ChangeOrderFreqTimeDoseStr
