...
function InitItemGrid (id) {
	var columns = [[
        ...
        {field:'EZLPlan',title:'治疗方案',width:200},
	...
	var DurDataGrid = $HUI.datagrid("#"+id, {
		...
		detailFormatter:function(rowIndex, rowData){
			var result=""
			if (rowData.EZLPlan!="") {
				result="<div style='padding:5px 0px;'><label style='font-weight:bold;'>"+$g("治疗方案")+"：</label>"+rowData.EZLPlan+"</div>"
			}
			...
			if (result=="") {
				result="<div style='padding:10px 0px;'><label style='color:red;'>"+$g("请填写治疗方案、交班内容、接班内容！")+"<label></div>"
			}
			return result;
		},
		onUnselect:function(){
