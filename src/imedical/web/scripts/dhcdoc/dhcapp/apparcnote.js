...
function InitDetList(){
	...
	var tempEditor={
		...
		options: {
			valueField: "value",
			textField: "text",
			url: LINK_CSP+"?ClassName=web.DHCAPPNotItemTemp&MethodName=jsonNoteItemTemp&HospID="+window.parent.$HUI.combogrid('#_HospList').getValue(),  
	...
	var uniturl = LINK_CSP+"?ClassName=web.DHCAPPArcNote&MethodName=QueryAppArcNote&itmmastid="+itmmastid+"&HospID="+HospID;
