...
function initprintlist(){
	...
	var columns=[[
		...
		{field: 'ATPType', title: '类型', width: 80,
					   editor :{  
							type:'combobox',  
							options:{
		...
		{field: 'APTSex', title: '性别', width: 80,
		   editor :{  
				type:'combobox',  
				options:{
					valueField:'ID',
					textField:'Desc',
					data:[{"ID":"1","Desc":"男"},{"ID":"2","Desc":"女"},{"ID":"3","Desc":"未知性别"},{"ID":"4","Desc":"未说明性别"}] ,
					loadFilter: function(data){
						var data=[{"ID":"1","Desc":"男"},{"ID":"2","Desc":"女"},{"ID":"3","Desc":"未知性别"},{"ID":"4","Desc":"未说明性别"}] 
						return data;
					}
				  }
			  }
		},
		 {field: 'APTInfomation', title: '是否为知情同意书 ', width: 120,
					   editor : {
                            type : 'icheckbox',
                            options : {
                                on : 'Y',
