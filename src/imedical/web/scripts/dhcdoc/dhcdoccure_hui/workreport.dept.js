...
function ExportCureReport(){
	try{
		...
		var TemplatePath=ServerObj.PrintBath+"DHCDocCureWorkReportDept.xlsx";
	    ...
	    for(var i=1;i<=datacount;i++){
			...
			if(ret=="") return ;
			//DCARowId_"^"_ArcimDesc_"^"_UnitPrice_"^"_ChangeNums_"^"_OrdBillUOM_"^"_OrdPrices
			var arr=ret.split("^");
			xlsrow=xlsrow+1;
			var ArcimDesc=arr[1]
			var UnitPrice=arr[2]
