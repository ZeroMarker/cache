...
////////////////////////////////////////////////////////////////
	...
	var centertab =  new Ext.TabPanel({
                ...
                items:[{
                	title:"图片查找与录入",
					//html:"Welcome"
					html : "<iframe name='picture' src='dhceq.process.picture.csp?&CurrentSourceType="+CurrentSourceType+"&CurrentSourceID="+CurrentSourceID+"&EquipDR="+EquipDR+"&Status="+Status+"&ReadOnly="+ReadOnly+"&MWToken="+MWToken+"' width='100%' height='100%' frameborder='0' scrolling='auto'></iframe>"
                }]
		});
