/**
 * FileName: insu.rpt.ipdivmxgrpbypattypetj.js
 * Anchor: XS
 * Date: 2020-03-19
 * Description: 住院人员类别汇总表统计
 */
 var INSURPT_CONSTANT = {
	...
	IFRAME: {
		//定义报表URL+报表文件
		SRC: 'dhccpmrunqianreport.csp?reportName=InsuIPDivMXGrpByPatTypeTJ.rpx'
	}
};
...
function scanReport() {
	...
	var DivFlag="I"
    var HisAdmType="I"
    var InsuPatType=getValueById('cbInsuPatType') ;
    var InsuTypeDesc=$HUI.combobox("#cbInsuType").getText();
	var url = INSURPT_CONSTANT.IFRAME.SRC + '&StDate=' + StDate + '&EndDate=' + EndDate+ '&InsuType=' + InsuType+ '&DivFlag=' + DivFlag+ '&HisAdmType=' + HisAdmType + '&InsuPatType=' + InsuPatType+'&InsuTypeDesc=' + InsuTypeDesc ;
