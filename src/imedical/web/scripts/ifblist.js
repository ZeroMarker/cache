...
function initDHCEQIFBList()
{
	$HUI.datagrid("#tDHCEQIFBList",{   
		...
		//modify by lmm 2023-02-01 极简UI改造
		border:false,
	    fit:true,
	    singleSelect:true,
        ...
        {field:'IFBLVendor',title:'供应商',width:200,align:'center'},
        {field:'IFBLManuFactoryDR',title:'IFBLManuFactoryDR',width:50,hidden:true}, 
        {field:'IFBLManuFactory',title:'生产厂商',width:200,align:'center'},
        ...
        {field:'IFBLWinFlag',title:'中标标志',width:70,align:'center'}, 
        {field:'IFBLWinQty',title:'中标数量',width:80,align:'center'}, 
        {field:'IFBLCandidacy',title:'候选标志',width:80,align:'center'}, 
        {field:'IFBLCandidacySeq',title:'候选顺序',width:80,align:'center'}, 
        {field:'IFBLScore',title:'评分',width:50,align:'center'}, 
        {field:'IFBLRemark',title:'备注',width:150,align:'center'}, 
    	]],
