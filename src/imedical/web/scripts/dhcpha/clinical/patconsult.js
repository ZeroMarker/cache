...
//初始化界面默认信息         //wangxuejian 2016-09-09
function InitConsultDefault(){
	...
	$('#consTraArc').combobox('setValue','');  	//追踪建档
	$('#consResDept').combobox('setValue',''); 	//预约科别
	$('#consTipLimt').datebox('setValue',''); 	//提示期限
	$('#consTraWay').combobox('setValue','');  	//追踪方式
	$('#consAnsUser').combobox('setValue',''); 	//回答人员
	$('#consTraRes').combobox('setValue',''); 	//追踪结果
	$("#consultID").val(''); 					//咨询ID
...
function showModifyWin(index){
	...
	$('#consTraArc').combobox('setValue',rowData.consTraArc);  	  //追踪建档
	$('#consResDept').combobox('setValue',rowData.consResDept);   //预约科别
	$('#consResDept').combobox('setText',rowData.consResDeptDesc);   //预约科别
	$('#consTipLimt').datebox('setValue',rowData.consTipLimt); 	  //提示期限
	$('#consTraWay').combobox('setValue',rowData.consTraWay);  	  //追踪方式
	$('#consAnsUser').combobox('setValue',rowData.consAnsUser);   //回答人员
	$('#consTraRes').combobox('setValue',rowData.consTraRes); 	  //追踪结果
