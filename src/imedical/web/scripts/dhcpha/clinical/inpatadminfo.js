...
///初始化页面医嘱dagagrid
function InitPageOeGrid()
{
	//定义columns
	var columns=[[
	    {field:'priorty',title:'长临',width:40,align:'left'},
	    ...
	    {field:'ordtime',title:'开嘱时间',width:120,align:'left'},
	    {field:'execdate',title:'执行时间',width:120,align:'left'},
	    {field:'careprovdesc',title:'执行护士',width:60,align:'left'},
	    {field:'enddate',title:'停嘱时间',width:120,align:'left'},
	    {field:'purpose',title:'用药目的',width:90,align:'left',formatter:SetCellColor},
	    {field:'doctor',title:'开嘱医生',width:60,align:'left'},
	    {field:'orddept',title:'执行科室',width:120,align:'left'}
	]];
...
///dagagrid 取消选中事件
function datagriddelegate()
{
	$('.datagrid-body').delegate('tr', {
		'click' :function(){
            $('tr.datagrid-row-selected').removeClass('datagrid-row-selected');
    }})
}
