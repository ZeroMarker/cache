...
$(function(){
	...
	var cols=[[
		...
		{field:'bldone',title:'输血编号1',width:170},
	    {field:'bldtwo',title:'输血编号2',width:170},
	    {field:'bldthree',title:'输血编号3',width:170},
		{field:'bldfour',title:'输血编号4',width:170}
	]];
	//定义datagrid
      			...
      			url: url,
       			...
       			success: function(val){
	      			...
	      			if (bldrptArr[0]=="0") {
			 			...
			 			InitBldrptReport(bldrptID);//获取报告信息(获取编码信息)
	...
	$.ajax({
       ...
       success: function(val){
	      	 ...
	      	 //alert(bldrptDataList);
				...
				$('#bldrptWard').combobox('setValue',tmp[6]); //病人病区
...
function getBldrptPatInfo(patientID,EpisodeID)
{
	...
	$.ajax({
       ...
       success: function(val){
        ...
        $('#bldrptWard').combobox('setValue',tmp[12]);  //病区
