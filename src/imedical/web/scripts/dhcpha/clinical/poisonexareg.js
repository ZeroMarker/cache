...
function InitDetList(){
	...
	var columns=[[
		...
		{field:'srInQty',title:'数量',width:80},
		{field:'srBatNo',title:'批号',width:100},
		{field:'srExpDate',title:'效期',width:100},
		{field:'srManf',title:'生产企业',width:120},
		{field:'srVendor',title:'供货单位',width:120},
		{field:'srQuaCon',title:'质量情况',width:100},
		{field:'srExaRes',title:'验收结论',width:100},
		{field:'srExaUsr',title:'验收人',width:100},
		{field:'srIngUsr',title:'保管人',width:100}
	]];
...
function findPoiExaReg(){
	...
	$('#srDetList').datagrid({
		url:url+'?action=jsonPoisonExaReg',
		queryParams:{
			param : ListData}
	});
}
