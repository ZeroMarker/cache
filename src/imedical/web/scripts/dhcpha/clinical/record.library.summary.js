...
{
	$('#container').empty();
	var style = '<h2 class="first"><a class="more-history" href="#">'+patientName+'的药历时间轴</a></h2>';
	...
	for (var i=0;i<data.length;i++)
	{
		...
		$(content).attr({"chartItemType":data[i].chartItemType,"documentType":data[i].documentType,"status":data[i].status});           
