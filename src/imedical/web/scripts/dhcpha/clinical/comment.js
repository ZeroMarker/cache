...
jQuery.fn.rater	= function(options) {
	...
	var settings = {
		...
		title_format	: null,
		info_format	: null,
		image	: '../scripts/dhcpha/emr/lib/tool/comment/images/comment/stars.jpg',
		imageAll :'../scripts/dhcpha/emr/lib/tool/comment/images/comment/stars-all.gif',
		defaultTips :true,
		clickTips :true,
		width	: 24,
		height	: 24
	...
	//显示点击提示
	var clickTips= jQuery('<div class="rater-click-tips"><span>点击星星可以打分</span></div>');
