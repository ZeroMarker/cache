...
(function($) {
    ...
    $.fn.colorpicker = function(options) {
        ...
        function initColor(){
            $("body").append('<div id="colorpanel" style="position:absolute;z-index: 10;top: 10; display: none; "></div>');
			//var colorDiv = '<div id="colorpanel" style="position:absolute;display: none; "></div>';
            var colorTable = '';
            var colorValue = '';
            for(i=0;i<2;i++){
                for(j=0;j<6;j++){
