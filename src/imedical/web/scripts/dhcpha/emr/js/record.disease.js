...
function InitDiseaseTree()
{
	...
	innerHTMLstr = innerHTMLstr	+ '<div style="position:absolute;top:2px;width:158px;height:45px;">';
	...
	innerHTMLstr = innerHTMLstr	+ '<div style="position:absolute;top:45px;width:158px;height:446px;overflow:auto;border-top-style:solid;border-top-width:1px;border-top-color:#C8CAD0;"><ul id="diseasetree"></ul></div>';
	innerHTMLstr = innerHTMLstr	+ '</div>';
