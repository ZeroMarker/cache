...
{
	$('#layout-tools').append('<input type="image" src="../scripts/emr/lib/JQuery/themes/icons/reload.png" onclick="Refresh();" style="float:left;"/>');
	$('#layout-tools').append('<span onclick="Refresh();" style="width:25px;height:15px;cursor:hand;margin:0px 5px 0px 0px;">刷新</span>');
