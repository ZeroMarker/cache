...
$(function() {
    $('#dgChapter').datagrid({
        view: detailview,
        url: textCollector.urlTextCollector + '?action=GetChapter&usrID=' + userID + '&ctloc=' + userLocID,
        fitColumns: true,
        singleSelect: true,
        height: 'auto',
        columns: [
    ...
    $('#cboDisease').combobox({
        url: '../EMRservice.Ajax.textCollector.cls?action=GetDiseaseCategory&ctloc=' + userLocID,
        method: 'get',
        valueField: 'value',
        textField: 'text',
        groupField: 'group',
