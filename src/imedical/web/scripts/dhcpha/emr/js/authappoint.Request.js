	...
	items:[{
		...
		items: [{
			...
			items: [{
				...
				columnWidth: .2,
				layout: 'form',
				items: [{xtype: 'checkbox', hideLabel: true, id: 'save', boxLabel: '保存', checked: true, listeners:{'check': function(){checkauthor(this);}}},
					    {xtype: 'checkbox', hideLabel: true, id: 'delete', boxLabel: '删除', checked: true, listeners:{'check': function(){checkauthor(this);}}},]
			},{
				columnWidth: .2,
				layout: 'form',
				items: [{xtype: 'checkbox', hideLabel: true, id: 'print', boxLabel: '打印', checked: true, listeners:{'check': function(){checkauthor(this);}}},
					    {xtype: 'checkbox', hideLabel: true, id: 'view', boxLabel: '查看病历', checked: true, listeners:{'check': function(){checkauthor(this);}}}]
			},{
				columnWidth: .2,
				layout: 'form',
				items: [{xtype: 'checkbox', hideLabel: true, id: 'new', boxLabel: '创建病历', checked: true, listeners:{'check': function(){checkauthor(this);}}}]
			}]
		}]
	}],
	tbar: [{
