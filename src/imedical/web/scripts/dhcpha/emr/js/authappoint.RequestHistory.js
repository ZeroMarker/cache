function InitHistoryWindow()
{
	var store = new Ext.data.JsonStore({
		//url: '../EMRservice.Ajax.AuthAppoint.cls?Action=getHistory&EpisodeID=' + episodeID + '&RequestUserID=' + userID,
		url: '../EMRservice.Ajax.AuthAppoint.cls?Action=getHistory&RequestUserID=' + userID,
		root: 'Data',
	...
	function getUrl()
	{
		//var link = '../EMRservice.Ajax.AuthAppoint.cls?Action=getHistory&EpisodeID=' + episodeID + '&RequestUserID=' + userID;
