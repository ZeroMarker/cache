...
FindItmLog = function(orditm) {
   ...
   columns:[
        ...
        {header:'审核人',dataIndex:'audituser',width:80},
        {header:'审核结果',dataIndex:'result',width:100},       
        {header:'医生备注',dataIndex:'docadvice',width:150}, //原为医生反馈
        {header:'药师备注',dataIndex:'phnote',width:150},
        {header:'医生备注',dataIndex:'docnote',width:60,hidden:true},
        {header:'不合格警示值',dataIndex:'factor',width:60,hidden:true},
        {header:'药师建议',dataIndex:'advice',width:60,hidden:true},
