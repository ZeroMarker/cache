var ASARowId="",opId="",surgeonId="",assistantId="",scrubNurseId="",circulNurseId="",anaMethodId="",anaesthetistId=""
...
{   
   ...
   if(obj)obj.ondblclick=anaDoc_DubClick;
   var obj=document.getElementById("postOpCondList");
   if(obj)obj.ondblclick=postOpCond_DubClick;
   var obj=document.getElementById("operDocList");
   if(obj)obj.ondblclick=operDoc_DubClick;
...
var strPat=fromAge+"^"+toAge+"^"+sex+"^"+ASARowId+"^"+paadmType+"^"+fromPatWeight+"^"+toPatWeight+"^"+fromPatHeight+"^"+toPatHeight+"^"+ageFlag+"^"+postOpCondIdStr
//alert(strPat)
...
function anaDoc_DubClick()
{
  List_DublClick("anaDocList")
}
function postOpCond_DubClick()
{
  List_DublClick("postOpCondList")
}
function operDoc_DubClick()
{
  List_DublClick("operDocList")
}
function getLoc(str)
{
	var loc=str.split("^");
