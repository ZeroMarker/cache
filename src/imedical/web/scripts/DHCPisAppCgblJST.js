...
function BodyLoadHandler()
 {	
    ...
    */
    ...
    document.getElementById("POrditemDR").value=POrderValue
   	...
   	if (ComName=="") ComName="DHCPisAppCgblJST"
        	...
        	var returnWomInfoVal=cspRunServerMethod(enmeth,ttmrowid)
	     	...
	     	{   
		    	...
		    	if (item[0]!="")
		    	{
			    	...
			    	temp=cspRunServerMethod(enmeth,item[0])
		    	}
		    	
		    	document.getElementById("LastDate").value=temp
		    	//alert(document.getElementById("LastDate").value)
		    	
		    	if (item[1]=="Y") var endCata=1
		    	else var endCata=0
		    	document.getElementById("EndDate").checked=endCata
 ...
 function GetClinicRecord()
 {
	...
	tclinicrecord=tshoushu+"~"+timage+"~"+thuayan+"~"+tpathinfo+"~"+tyongyao
	//tclinicrecord=tshoushu+"$C(13,10)"+timage+"$C(13,10)"+thuayan+"$C(13,10)"+tpathinfo+"$C(13,10)"+tyongyao
 }
 ...
 function Refresh()
 {
    ...
    var lnk= "websys.default.csp?WEBSYS.TCOMPONENT="+ComponentName+"&EpisodeID="+Eposide+"&OEorditemID="+OEorditemID+"&TMrowid="+TMrowid+"&ComponentName="+ComponentName+"&Refresh="+Refresh
    location.href=lnk
    */
    
    var EposideA=document.getElementById("EpisodeID").value
    var ComponentNameA=document.getElementById("ComponentName").value 
    ...
    var OpeNameA=document.getElementById("OpeName").value
    var OperatorA=document.getElementById("Operator").value
    var YongyaoInfoA=document.getElementById("YongyaoInfo").value
    var OtherPathInfoA=document.getElementById("OtherPathInfo").value
    var HuayanInfoA=document.getElementById("HuayanInfo").value
    var CRImageInfoA=document.getElementById("CRImageInfo").value
    var OperationSeeA=document.getElementById("OperationSee").value
    var TumourSizeA=document.getElementById("TumourSize").value
    var TumourPositionA=document.getElementById("TumourPosition").value
    var memoA=document.getElementById("TumourMemo").value
    var TransPosA=document.getElementById("TransPos").value
    var lnk=""
    lnk= "websys.default.csp?WEBSYS.TCOMPONENT="+ComponentNameA
    lnk+="&EpisodeID="+EposideA
    lnk+="&OEorditemID="+OEorditemIDA
    lnk+="&TMrowid="+TMrowidA
    lnk+="&OpeName="+OpeNameA
    //lnk+="&Operator="+OperatorA
    lnk+="&OtherPathInfo="+OtherPathInfoA
    lnk+="&YongyaoInfo="+YongyaoInfoA
    lnk+="&HuayanInfo="+HuayanInfoA
    lnk+="&CRImageInfo="+CRImageInfoA
    lnk+="&OperationSee="+OperationSeeA
    lnk+="&TumourSize="+TumourSizeA
    lnk+="&TumourPosition="+TumourPositionA
    lnk+="&TumourMemo="+memoA
    lnk+="&TransPos="+TransPosA
    lnk+="&ComponentName="+ComponentNameA
...
function Print()
{
	...
	var Template="http://10.10.142.3/Dthealth/trak/med/Results/Template/"+"DHCPISCgbl.xls";
	...
	xlBook = xlApp.Workbooks.Add(Template);
 	xlsheet = xlBook.ActiveSheet;
	    	...
	    	xlsheet.cells(13,5).value=document.getElementById("TumourDate").value
	    	xlsheet.cells(13,11).value=document.getElementById("TumourPosition").value
	  	    xlsheet.cells(13,17).value=document.getElementById("TumourSize").value
	        xlsheet.cells(13,22).value=document.getElementById("TumourMemo").value
    		...
    		xlsheet.cells(14,4).value=zhuanyi
    		xlsheet.cells(14,8).value=document.getElementById("TransPos").value
    		var radioCure=document.getElementById("RadioCure").checked
    		var radioc=""
    		if (radioCure==true) 
    		{
    		...
    		else if (radioCure==false) 
    		{
   			...
   			xlsheet.cells(14,14).value=zhuanyi
    		var chemicalCure=document.getElementById("ChemicalCure").checked
    		var chemicalc=""
   		 	if (chemicalCure==true) 
    		{
	        ...
	        xlsheet.cells(14,17).value=chemicalc
	        
	        
	        xlsheet.cells(16,5).value=document.getElementById("LastDate").value
	        tjj=""
				var tjjobj=document.getElementById("EndDate")
				if(tjjobj.checked)
				{
			...
			xlsheet.cells(16,10).value=tjj
	        xlsheet.cells(16,13).value=document.getElementById("Tai").value
	        xlsheet.cells(16,15).value=document.getElementById("Chan").value
	        
	        
	        xlsheet.cells(19,2).value=document.getElementById("OperationSee").value
	        xlsheet.cells(22,2).value=document.getElementById("ClinicDiag").value
	        xlsheet.cells(24,2).value=document.getElementById("CRImageInfo").value
	        xlsheet.cells(26,2).value=document.getElementById("OtherPathInfo").value
	        xlsheet.cells(28,2).value=document.getElementById("YongyaoInfo").value
	        xlsheet.cells(30,2).value=document.getElementById("HuayanInfo").value
