...
function CommitEntryItems()
{
	...
	for(var i=0; i<EntryItemRows.length; i++){
		...
		if (ChangeData == "")
		{
			var ChangeData=EpisodeID + "^" + RuleID + "^" + EntryID + "^" + LocID + "^" + EmployeeID + "^" + SignUserID + "^" + Number + "^" + TriggerDate + "^" + Remark + "^" +  Action + "^" + InstanceId + "^" + EmrDocId+ "^" +Path;
		}
		else
		{
			var ChangeData=ChangeData+'&'+EpisodeID + "^" + RuleID + "^" + EntryID + "^" + LocID + "^" + EmployeeID + "^" + SignUserID + "^" + Number + "^" + TriggerDate + "^" + Remark + "^" +  Action + "^" + InstanceId + "^" + EmrDocId+ "^" +Path;
		}
...
function CreateFormPage(strPrintName, printDatagrid) {
	...
	tableString+='<tr style="text-align:center">'+ '\n<td>合计得分'+ '</td>'+'<td>'+ '</td>'+'<td>'+(100-sumPoints)+'</td>'+'<td>'+ '</td>'+'<td>'+ '</td>'+'<td>'+ '</td>'+'</tr>' 
	tableString+='<tr style="text-align:center">'+ '\n<td>病历等级'+ '</td>'+'<td>'+ '</td>'+'<td>'+ recordGrade+'</td>'+'<td>'+ '</td>'+'<td>'+ '</td>'+'<td>'+ '</td>'+'</tr>' 
	tableString+='<tr style="text-align:center">'+ '\n<td>病历检查者签名'+ '</td>'+'<td>'+ '</td>'+'<td>'+ '</td>'+'<td>'+ '</td>'+'<td>'+ '</td>'+'<td>'+ '</td>'+'</tr>' 
	tableString+='<tr style="text-align:center">'+ '\n<td>优缺点'+ '</td>'+'<td>'+ '</td>'+'<td>'+ '</td>'+'<td>'+ '</td>'+'<td>'+ '</td>'+'<td>'+ '</td>'+'</tr>' 
