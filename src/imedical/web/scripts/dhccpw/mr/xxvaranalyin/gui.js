			...
			,{
				...
				renderer : function(v, m, rd, r, c, s){
					...
					if (OutCount!=0) {
						...
						return " <a href='#' onclick='OutReasonSubLookUpHeader(1,\""+CPWID+"\",\""+obj.DateFrom+"\",\""+obj.DateTo+"\",\""+obj.LocID+"\",\""+obj.WardID+"\",\""+CPWDesc+"\")');'>&nbsp;查看&nbsp; </a>";
					}
				}
			}
			,{
				...
				renderer : function(v, m, rd, r, c, s){
					...
					if (VarCount!=0) {
						var CPWDesc = rd.get("CPWDesc");
						return " <a href='#' onclick='VarReasonSubLookUpHeader(1,\""+CPWID+"\",\""+obj.DateFrom+"\",\""+obj.DateTo+"\",\""+obj.LocID+"\",\""+obj.WardID+"\",\""+CPWDesc+"\")');'>&nbsp;查看&nbsp; </a>";
					}
				}
			}
		]
