...
{
		var obj = ExtTool.StaticServerObject("web.DHCCPW.MR.ClinPathWaysVarianceDtl");
		var ServerInfo=obj.GetServerInfo();
		var TemplatePath=GetWebConfig(ServerInfo).Path;
		var FileName=TemplatePath+"\\\\"+"DHCCPWVarianceDtl.xls";
		try {
		...
		var flg=obj.QryVarianceDtlToPrint("fillxlSheet",strArguments);
