			...
			,{
				...
				renderer : function(v, m, rd, r, c, s){
					...
					if (OutCount!=0) {
						...
						return " <a href='#' onclick='OutReasonSubLookUpHeader(1,\""+CPWID+"\",\""+obj.DateFrom+"\",\""+obj.DateTo+"\",\""+obj.LocID+"\",\""+obj.WardID+"\",\""+CPWDesc+"\")');'>&nbsp;出径原因分析&nbsp; </a>";
					}
				}
			}
			,{
				...
				renderer : function(v, m, rd, r, c, s){
					...
					if (VarCount!=0) {
						var CPWDesc = rd.get("CPWDesc");
						return " <a href='#' onclick='VarReasonSubLookUpHeader(1,\""+CPWID+"\",\""+obj.DateFrom+"\",\""+obj.DateTo+"\",\""+obj.LocID+"\",\""+obj.WardID+"\",\""+CPWDesc+"\")');'>&nbsp;变异原因分析&nbsp; </a>";
					}
				}
			}
		]
