...
Ext.dhcc.ExcelApp = function(){
	...
	this.SetCellsRowHeigthByRow=SetCellsRowHeigthByRow;
	...
	//add by cpj 2016-11-22 竖打打印增加
	this.SetRangeBordersLineStyleNew=SetRangeBordersLineStyleNew;
...
function SetCellsRowHeigthByRow(row,val)
{
	this.GetRange(row,1,row,1).RowHeight=val;
	return true;
}
...
// add by cpj 2016-11-22
function SetRangeBordersLineStyleNew(Row1,Col1,Row2,Col2,num,val)
{
	this.GetRange(Row1,Col1,Row2,Col2).Borders(num).LineStyle = val;
	return true;
}
