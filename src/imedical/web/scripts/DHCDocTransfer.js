...
function SetDocStr(DepRowId,MarkRowId)
{
	...
	if(objDoc)
	{
		var DocStr=cspRunServerMethod(objDoc,DepRowId);
	}
	//if(DocStr!="") 
	//{
...
function SelectAll_Click()
{
  ...
  var Objtbl=document.getElementById('tDHCDocTransfer');
...
function BtUpdate_Click()
{
	...
	/*if (RetString!="")
	{
		RetString=RetString+t['alert:failure']
		alert(RetString)
	}
	else
	{
