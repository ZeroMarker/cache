...
NAME: DHC.WMR.XTowItmTimeSlot.Qry.JS
...
function Query_click()
{
  ...
  cMrType=getElementValue("MrType");//modify by liuxuefeng 2010-02-19
	var obj=document.getElementById("cboFirstStatus");
	if (obj){
		var Idx=obj.options.selectedIndex;
		if (Idx>-1){
	...
	var lnk1="websys.default.csp?WEBSYS.TCOMPONENT=DHC.WMR.XTowItmTimeSlot.Stat"+"&DischargeCount="+temp[1]+"&VolumeCount="+temp[2]+"&AccordCount="+temp[3]+"&AveTimeSlot="+temp[4];
    parent.RPMiddle.location.href=lnk1;

	var lnk="websys.default.csp?WEBSYS.TCOMPONENT=DHC.WMR.XTowItmTimeSlot.List"+"&JIndex="+JIndex;
