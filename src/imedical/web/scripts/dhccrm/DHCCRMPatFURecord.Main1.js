...
function CreateButtonPanel()
{
	...
	if (FindFlag == "Y") {
		ButtonText = "播放";
		SaveDisabled=true;
		if (PlayName=="") RecordDisabled=true;
	}
	var buttonPanel=new Ext.Panel({
		height:30,
		region:'south',
		layout:'column',
		items:[{xtype:'panel',columnWidth:6/10},{
			xtype:'panel',
			items:[{
				xtype:'button',
				text:'保存',
...
function CreateMainPanelforfollowup()
{
	var buttonPanel=CreateButtonPanel();
	//var panelTitle='患者满意度调查';
	//if (PlanID!="") panelTitle="";
	var panelTitle="";
	panel=new Ext.Panel({
		//title:panelTitle,
		region: 'center',
