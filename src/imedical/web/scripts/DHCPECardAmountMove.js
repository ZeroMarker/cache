...
function BodyLoadHandler() {
	...
	//var obj=GetObj("SourceNo");
	//if (obj) obj.onkeydown=SourceNo_keydown;
	//var obj=GetObj("ToNo");
	//if (obj) obj.onkeydown=ToNo_keydown;
...
//function SourceNo_keydown()
//{
	//alert("Souce");
	//No_keydown("Source");
//}
//function ToNo_keydown()
//{
	//No_keydown("To");
//}
function No_keydown(Type,event)
{
	if (("9"==event.keyCode)||("13"==event.keyCode)) {
		No=GetValue(Type+"No");
		if (No=="") return false;
		var encmeth=GetValue("GetCardInfo");
		var DoType=GetValue(Type+"CardType");
