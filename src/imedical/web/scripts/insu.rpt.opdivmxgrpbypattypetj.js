/**
 * FileName: insu.rpt.opdivmxgrpbypattypetj.js
 * Anchor: YuanDC
 * Date: 2020-03-19
 ...
 */
 var INSURPT_CONSTANT = {
	...
	IFRAME: {
		//定义报表URL+报表文件
		SRC: 'dhccpmrunqianreport.csp?reportName=InsuOPDivMXGrpByPatTypeTJ.rpx'
	}
};
...
function scanReport() {
	...
	var url = INSURPT_CONSTANT.IFRAME.SRC + '&StDate=' + StDate + '&EndDate=' + EndDate+ '&InsuType=' + InsuType+ '&DivFlag=' + DivFlag+ '&HisAdmType=' + HisAdmType;
		url +='&InsuPatType=' + InsuPatType +'&InsuTypeDesc=' + InsuTypeDesc + '&HOSPID=' + INSURPT_CONSTANT.SESSION.HOSP_ROWID;
	$('#report').attr('src', url);
...
function InitInsuPatTypeCmb(OPIPFlag)
{
	var indexed=-1
