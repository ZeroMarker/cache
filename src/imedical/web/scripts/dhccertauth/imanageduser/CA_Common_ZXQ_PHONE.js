var ca_key = (function() {
	...
	function oGetCertInfoByUserCode(userCode, phoneNum) {
	    ...
	    usrSignatureInfo["identityID"] = ret.identityID;
	    usrSignatureInfo["certificate"] = ret.signCert;
	    usrSignatureInfo["certificateNo"] = ret.certNo;
	    usrSignatureInfo["CertificateSN"] = ret.certNo;
	...
	function oLoginForm(paraObj,callback,arr1,arr2) {
        ...
        if (judgeIsIE())
        {
            ...
            var rtnStr = window.showModalDialog("../csp/dhc.certauth.login.qrcode.csp?venderCode="+Const_Vender_Code+"&signType="+Const_Sign_Type+"&MWToken="+getMWToken(),para,
                            "dialogWidth:710px;dialogHeight:560px;toolbar=no;menubar:no;scrollbars:no;resizable:no;location:no;status:no;help:no;fullscreen=no");
        ...
        else
        {
            ...
            createModalDialog("loginQrcode","扫码页面",710,560,'loginQrcodeFrame',content,callback,arr1,arr2);        
        }
	}
