...
function CreateTree(patientTree) {
	var loader = new Ext.tree.TreeLoader({
		dataUrl: '../csp/dhc.nurse.ext.common.getdata.csp?className=Nur.QueryBroker&methodName=GetTreeNew&type=Method&ctlocDr=' + session['LOGON.CTLOCID'] + '&adm=' + EpisodeID
	});
