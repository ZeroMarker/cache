	...
	$("input[type=radio][id^='NurHeadBefPreventMeasures-']").each(function(){
		if ($(this).is(':checked')){
			...
			if (id=="NurHeadBefPreventMeasures-99890"){
				...
				$("input[type=checkbox][id^='NurHeadBefPreMeaReason-']").removeAttr("checked"); //发生前防范措施未落实的原因
				$("input[type=checkbox][id^='NurHeadBefPreMeaReason-']").attr("disabled",true); 
				$("#NurHeadBefPreMeaReason-99900").nextAll(".lable-input").val(""); //发生前防范措施未落实的原因 其他
