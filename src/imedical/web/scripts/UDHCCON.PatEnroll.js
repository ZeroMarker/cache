...
function ClearNullLookUp() {
	var DefaultCountryDesc = DHCWebD_GetObjValue("DefaultCountryDesc");
	if (DefaultCountryDesc.trim()=="") DHCWebD_SetObjValueB("DefaultCountryDR","");
	var DefaultProvinceDesc = DHCWebD_GetObjValue("DefaultProvinceDesc");
	if (DefaultProvinceDesc.trim()=="") DHCWebD_SetObjValueB("DefaultProvinceDR","");
	var DefaultCityDesc = DHCWebD_GetObjValue("DefaultCityDesc");
	if (DefaultCityDesc.trim()=="") DHCWebD_SetObjValueB("DefaultCityDR","");
	var DefaultNationDesc = DHCWebD_GetObjValue("DefaultNationDesc");
	if (DefaultNationDesc.trim()=="") DHCWebD_SetObjValueB("DefaultNationDR","");
	
}
function BuildStr(){
	///澶勭悊鏀惧ぇ闀滃厓绱犱负绌哄悗,涓嶆竻绌洪殣钘廟owid鍏冪礌鐨勬儏鍐?
	ClearNullLookUp();
...
function SetDefaultCountry(value)
{
	...
	DHCWebD_SetObjValueB("DefaultProvinceDesc","")
	DHCWebD_SetObjValueB("DefaultProvinceDR","")
	DHCWebD_SetObjValueB("DefaultCityDesc","")
	DHCWebD_SetObjValueB("DefaultCityDR","")
}
