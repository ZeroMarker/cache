...
function save(){
	...
	var code= htmlEncode(code);
	var desc= htmlEncode(desc);
	var optionValue= htmlEncode(optionValue);
	var optionValueDesc= htmlEncode(optionValueDesc);
	var RemarksSSS= htmlEncode($("#Remarks").val());
