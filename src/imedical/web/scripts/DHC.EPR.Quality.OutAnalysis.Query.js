...
function btnSearch_onClick() 
{
    ...
    var lnk = "websys.default.csp?WEBSYS.TCOMPONENT=DHC.EPR.Quality.OutAnalysis.List&ALocIDs=" + LocIDs + "&AStartDate=" + StartDate + "&AEndDate=" + EndDate + "&AEntryIDs=" + EntryIDs + "&AAnalysisFlag=" + AnalysisFlag;
...
function btnExport_onClick() 
{
    ...
    var flag = ExportDataToExcel("MethodGetServerInfo", "MethodGetAnalysisData", "DHCEPRQualityReport08.xls", cArguments);
}
...
function btnPrint_onClick() 
{
    ...
    var AnalysisFlag = getElementValue("AAnalysisFlag", null);
    var cArguments = LocIDs + "#" + StartDate + "#" + EndDate + "#" + EntryIDs + "#" + AnalysisFlag;
    var flag = PrintDataByExcel("MethodGetServerInfo", "MethodGetAnalysisData", "DHCEPRQualityReport08.xls", cArguments);
}
