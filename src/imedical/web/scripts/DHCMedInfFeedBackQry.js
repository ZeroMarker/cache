...
function Query_click() {
    ...
    if (cStatus=="") return;
    lnk="websys.default.csp?WEBSYS.TCOMPONENT=DHCMedInfFeedBackList" + "&DateFrom=" + cDateFrom + "&DateTo=" +cDateTo+ "&Dep=" +cDep+ "&Loc=" +cLoc+ "&Status=" +cStatus;
...
function AddStatus(){
	...
	var objDic=BASE_GetDictionary(s,"InfectionEvaluationStatus","Y");
	//alert(objDic.Count);
	var a=(new VBArray(objDic.Keys()));   
    for (i=0;i<objDic.Count;i++){
