...
function BClear_Click()
{
	...
	var lnk="websys.default.csp?WEBSYS.TCOMPONENT=UDHCJFOP.InvDetail&GroupDR="+groupId;
	document.location.href=lnk;
}
function Find_Click()
{
	...
	var lnk="websys.default.csp?WEBSYS.TCOMPONENT=UDHCJFOP.InvDetail&sUser="+Guser+"&uName="+escape(uName)+"&EndDate="+Enddate+"&EndTime="+EndTime+"&StDate="+StDate +"&StartTime=" +StTime+"&GroupDR="+groupId;
	//alert(lnk);
	document.location.href=lnk;
...
function IntDoc()
{
	...
	var objtbl=document.getElementById("tUDHCJFOP_InvDetail");
