...
editFun = function(dataStore,grid,pagingTool,parRef) {
	...
	var creSubDataSourceCB = new Ext.form.ComboBox({
		...
		//pageSize:10,
		minChars:1,
		valueNotFoundText:rowObj[0].get("creSubDataSource"),
		width:150,
		listWidth:150,
		triggerAction:'all',
	...
	var creSubPatTypeCB = new Ext.form.ComboBox({
		...
		//pageSize:10,
		minChars:1,
		valueNotFoundText:rowObj[0].get("creSubPatType"),
		width:150,
		listWidth:150,
		triggerAction:'all',
	...
	formPanel.on('afterlayout', function(panel, layout) {
			...
			creSubDataSourceCB.setValue(rowObj[0].get("creSubDataSource"));
			creSubPatTypeCB.setValue(rowObj[0].get("creSubPatType"));
			creSubPrePrtFlagField.setValue((rowObj[0].data['creSubPrePrtFlag'])=='Y'?true:false);
			creSubIncluAbortField.setValue((rowObj[0].data['creSubIncluAbort'])=='Y'?true:false);
		});
