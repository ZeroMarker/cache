OPReportCatDetailByLocFun = function(bdate, sdate) {
	...
	Ext.Ajax.request({
		url:'dhc.cs.autohisoutexe.csp?action=OPReportCatDetailByLocHead&stDate='+bdate+'&endDate='+sdate,
		waitMsg:'...',
		...
		success: function(result, request) {
			...
			var tmpStore = new Ext.data.Store({
				proxy:new Ext.data.HttpProxy({url:'dhc.cs.autohisoutexe.csp?action=OPReportCatDetailByLocJson&stDate='+bdate+'&endDate='+sdate, method:'GET'}),
