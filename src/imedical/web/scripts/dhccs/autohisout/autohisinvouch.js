autohisinvouchFun = function(grid, rowIndex, columnIndex, e, fieldVouchNO) {
	...
	//var fieldVouchNO = grid.getColumnModel().getDataIndex(11);
	var fieldDate = grid.getColumnModel().getDataIndex(1);
	...
	var vouchDetailST = new Ext.data.Store({
			proxy: new Ext.data.HttpProxy({url:'dhc.cs.autohisoutexe.csp?action=AutoHis&vouchNo='+fieldVouchNO}),
