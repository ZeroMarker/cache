autohisadmreasonFun = function(tmpDate) {
	...
	Ext.Ajax.request({
		url:'dhc.cs.autohisoutexe.csp?action=IPIncomeByAdmreasonHead&tmpDate='+tmpDate+'&inOut=DHCOPB0011',
		waitMsg:'...',
		...
		success: function(result, request) {
			...
			var tmpStore = new Ext.data.Store({
				proxy:new Ext.data.HttpProxy({url:'dhc.cs.autohisoutexe.csp?action=IPIncomeByAdmreasonJson&tmpDate='+tmpDate+'&inOut=DHCOPB0011', method:'GET'}),
