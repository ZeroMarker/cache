purchasestorageformFun = function(grid, rowIndex, columnIndex, e , busiType) {
	
	var busiTypeId = busiType.getValue();
	var busiTypeName = busiType.getRawValue();
	//alert(busiTypeName);
	...
	var fieldNO = grid.getColumnModel().getDataIndex(2);
