...
{
	var URL = "websys.default.csp?WEBSYS.TCOMPONENT=DHC.WMR.Exam.StaByProblem.List";
	URL += "&From=" + getElementValue("txtStartDate");
	URL += "&To=" + getElementValue("txtEndDate");
	URL += "&RuleID=" + getElementValue("cboRule");
	URL += "&Department=" + StringEncode(getElementValue("cboDepartment", document, true));
	URL += "&SubDepartment=" + StringEncode(getElementValue("cboLoc", document, true));
