...
var init = function(){
	...
	var DELETE_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.LAB.BTCollectPrompt&pClassMethod=DeleteData";
	var SAVE_ACTION_URL = "../csp/dhc.bdp.ext.entitydatatrans.csp?pClassName=web.DHCBL.LAB.BTCollectPrompt&pClassMethod=SaveEntity&pEntityName=web.Entity.LAB.BTCollectPrompt";
	...
	SearchFunLib=function(){
		...
		$('#mygrid').datagrid('load',  { 
			ClassName:"web.DHCBL.LAB.BTCollectPrompt",
			QueryName:"GetList",	
			'code':code,	
			'desc':desc,
	...
	{			
		...
		var flag = tkMakeServerCall("web.DHCBL.LAB.BTCollectPrompt","FormValidate",$("#RowID").val(),$("#Code").val(),$('#HospitalDR').combobox('getValue'));	
		if (flag==1)
		{
	...
	var columns =[[
				  ...
				  {field:'HospitalDR',title:'关联医院',width:70,sortable:true},
	...
	var mygrid = $HUI.datagrid("#mygrid",{
		...
		singleSelect:true,
		ClassTableName:'dbo.BTCollectPrompt',
		SQLTableName:'dbo.BT_CollectPrompt',
		idField:'RowID', 
