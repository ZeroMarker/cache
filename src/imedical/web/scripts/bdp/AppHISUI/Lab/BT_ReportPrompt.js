...
var init = function(){
	...
	var SAVE_ACTION_URL = "../csp/dhc.bdp.ext.entitydatatrans.csp?pClassName=web.DHCBL.LAB.BTReportPrompt&pClassMethod=SaveEntity&pEntityName=web.Entity.LAB.BTReportPrompt";
	...
	SearchFunLib=function(){
		...
		$('#mygrid').datagrid('load',  { 
			'ClassName':"web.DHCBL.LAB.BTReportPrompt",
			'QueryName':"GetList",
			'code': code,
			'desc': name
		});
	...
	{	
		...
		//var RowID=$("#RowID").val()
		var result= tkMakeServerCall("web.DHCBL.LAB.BTReportPrompt","FormValidate",id,Code,HospitalDR);	
		if(result==0){
	...
	DelData=function()
	{
		...
		$.messager.confirm('提示', '确定要删除所选的数据吗?', function(r){
			if (r){
				var datas = tkMakeServerCall("web.DHCBL.LAB.BTReportPrompt","DeleteData",rowid);
				var data = eval('('+datas+')');
	...
	var columns =[[  
				  ...
				  {field:'CName',title:'名称',width:200,sortable:true},
				  {field:'HospitalDR',title:'医院',width:200,sortable:true},
				  {field:'PmtDT',title:'提示详情',width:150,sortable:true},
				  {field:'Place',title:'位置',width:150,sortable:true},
	...
	var mygrid = $HUI.datagrid("#mygrid",{
		url:$URL,
		queryParams:{
			ClassName:"web.DHCBL.LAB.BTReportPrompt",         ///调用Query时
			QueryName:"GetList"
		},
		ClassTableName:'dbo.BTReportPrompt',
		SQLTableName:'dbo.BT_ReportPrompt',
		idField:'RowID',
		columns: columns,  //列信息
