...
var init = function(){
	...
	var SAVE_ACTION_URL = "../csp/dhc.bdp.ext.entitydatatrans.csp?pClassName=web.DHCBL.LAB.BTTestCodeSCode&pClassMethod=SaveEntity&pEntityName=web.Entity.LAB.BTTestCodeSCode";
	...
	SearchFunLib=function(){
		...
		$('#mygrid').datagrid('load',  { 
			'ClassName':"web.DHCBL.LAB.BTTestCodeSCode",
			'QueryName':"GetList",
			'code': code,
			'desc': desc
		});
	...
	{	
		...
		var result= tkMakeServerCall("web.DHCBL.LAB.BTTestCodeSCode","FormValidate",id,SCode);
		if(result==0){
	...
	DelData=function()
	{
		...
		$.messager.confirm('提示', '确定要删除所选的数据吗?', function(r){
			if (r){
				var datas = tkMakeServerCall("web.DHCBL.LAB.BTTestCodeSCode","DeleteData",rowid);
				var data = eval('('+datas+')');
	...
	var columns =[[  
				  ...
				  {field:'SCode',title:'代码',width:60,sortable:true},
				  {field:'TCName',title:'描述',width:150,sortable:true},
				  {field:'SpecimenType',title:'类型',width:100,sortable:true},
	...
	var mygrid = $HUI.datagrid("#mygrid",{
		url:$URL,
		queryParams:{
			ClassName:"web.DHCBL.LAB.BTTestCodeSCode",         ///调用Query时
			QueryName:"GetList"
		},
		ClassTableName:'dbo.BTTestCodeSCode',
		SQLTableName:'dbo.BT_TestCodeSCode',
		idField:'RowID',
		columns: columns,  //列信息
