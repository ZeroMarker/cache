...
var init = function(){
	...
	var SAVE_ACTION_URL = "../csp/dhc.bdp.ext.entitydatatrans.csp?pClassName=web.DHCBL.LAB.BTHospital&pClassMethod=SaveEntity&pEntityName=web.Entity.LAB.BTHospital";
	var DELETE_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.LAB.BTHospital&pClassMethod=DeleteData";
	...
	SearchFunLib=function(){
		...
		$('#mygrid').datagrid('load',  { 
			ClassName:"web.DHCBL.LAB.BTHospital",
			QueryName:"GetList",	
			'code':code,	
			'desc':desc
		});
	...
	{			
		...
		var flag = tkMakeServerCall("web.DHCBL.LAB.BTHospital","FormValidate",$("#RowID").val(),$("#Code").val());	
		if (flag==1)
		{
	...
	var columns =[[
				...
				{field:'CName',title:'名称',width:120,sortable:true},
				{field:'FullDesc',title:'全称',width:120,sortable:true},
	...
	var mygrid = $HUI.datagrid("#mygrid",{
		...
		singleSelect:true,
		ClassTableName:'dbo.BTHospital',
		SQLTableName:'dbo.BT_Hospital',
		idField:'RowID', 
