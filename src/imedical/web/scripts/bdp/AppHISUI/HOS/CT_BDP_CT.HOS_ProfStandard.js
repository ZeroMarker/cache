...
var init = function(){
   ...
   //搜索回车事件
    ...
    //失焦事件
     $('#PROFSDesc').bind('blur',function(){
          var PROFSDesc=$("#PROFSDesc").val()  
          var PYCode=tkMakeServerCall("web.DHCBL.BDP.FunLib","GetPYCODE",PROFSDesc) 
          var WBCode=tkMakeServerCall("web.DHCBL.BDP.FunLib","GetSWBCODE",PROFSDesc,1) 
          $("#PROFSPYCode").val(PYCode)
          $("#PROFSWBCode").val(WBCode)                                           
      });   
