...
var init = function(){
   ...
   //搜索回车事件
	...
	$("#btnDel").click(function (e) { 
	 ...
	 //失焦事件
     $('#PROFTYDesc').bind('blur',function(){
          var PROFTYDesc=$("#PROFTYDesc").val()  
          var PYCode=tkMakeServerCall("web.DHCBL.BDP.FunLib","GetPYCODE",PROFTYDesc) 
          var WBCode=tkMakeServerCall("web.DHCBL.BDP.FunLib","GetSWBCODE",PROFTYDesc,1) 
          $("#PROFTYPYCode").val(PYCode)
          $("#PROFTYWBCode").val(WBCode)                                           
      });		
