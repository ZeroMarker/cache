...
var init = function(){
   ...
   //搜索回车事件
    ...
    function ClearFunLib()
    {
     ...
     //失焦事件
     $('#OSCDesc').bind('blur',function(){
          var OSCDesc=$("#OSCDesc").val()  
          var PYCode=tkMakeServerCall("web.DHCBL.BDP.FunLib","GetPYCODE",OSCDesc) 
          var WBCode=tkMakeServerCall("web.DHCBL.BDP.FunLib","GetSWBCODE",OSCDesc,1) 
          $("#OSCPYCode").val(PYCode)
          $("#OSCWBCode").val(WBCode)                                           
      });
	...
	$('#HOSOrgFinCategory').bind('click', function(){
        ...
        var url="dhc.bdp.ct.hosorgfincategory.csp?SecCategoryParRef='+SecCategoryParRef+'";       
