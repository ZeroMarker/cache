...
var init = function(){
   ...
   //搜索回车事件
    ...
    function ClearFunLib()
    {
     ...
     //失焦事件
     $('#OCCUSCDesc').bind('blur',function(){
          var OCCUSCDesc=$("#OCCUSCDesc").val()  
          var PYCode=tkMakeServerCall("web.DHCBL.BDP.FunLib","GetPYCODE",OCCUSCDesc) 
          var WBCode=tkMakeServerCall("web.DHCBL.BDP.FunLib","GetSWBCODE",OCCUSCDesc,1) 
          $("#OCCUSCPYCode").val(PYCode)
          $("#OCCUSCWBCode").val(WBCode)                                           
      });
