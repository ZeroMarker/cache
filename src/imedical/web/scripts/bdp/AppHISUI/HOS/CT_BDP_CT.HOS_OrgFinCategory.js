...
var init = function(){
   ...
   //搜索回车事件
    ...
    function ClearFunLib()
    {
     ...
     //失焦事件
     $('#OFCDesc').bind('blur',function(){
          var OFCDesc=$("#OFCDesc").val()  
          var PYCode=tkMakeServerCall("web.DHCBL.BDP.FunLib","GetPYCODE",OFCDesc) 
          var WBCode=tkMakeServerCall("web.DHCBL.BDP.FunLib","GetSWBCODE",OFCDesc,1) 
          $("#OFCPYCode").val(PYCode)
          $("#OFCWBCode").val(WBCode)                                           
      });
