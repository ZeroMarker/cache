...
var init = function(){
   ...
   //搜索回车事件
	...
	//失焦事件
     $('#OPCDesc').bind('blur',function(){
          var OPCDesc=$("#OPCDesc").val()  
          var PYCode=tkMakeServerCall("web.DHCBL.BDP.FunLib","GetPYCODE",OPCDesc) 
          var WBCode=tkMakeServerCall("web.DHCBL.BDP.FunLib","GetSWBCODE",OPCDesc,1) 
          $("#OPCPYCode").val(PYCode)
          $("#OPCWBCode").val(WBCode)                                           
      });
	...
	$('#HOSOrgSecCategory').bind('click', function(){
        ...
        var url="dhc.bdp.ct.hosorgseccategory.csp?PriCategoryParRef='+PriCategoryParRef+'";       
