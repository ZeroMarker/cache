...
Ext.onReady(function() {
	var QUERY_ACTION_URL = "../csp/dhc.bdp.ext.querydatatrans.csp?pClassName=web.DHCBL.KB.DHCECGInteract&pClassQuery=GetList";
  	var OPEN_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.KB.DHCECGInteract&pClassMethod=OpenData";
	var SAVE_ACTION_URL = "../csp/dhc.bdp.ext.entitydatatrans.csp?pClassName=web.DHCBL.KB.DHCECGInteract&pClassMethod=SaveData&pEntityName=web.Entity.KB.DHCECGInteract";
	var UPDATE_ACTION_URL = "../csp/dhc.bdp.ext.entitydatatrans.csp?pClassName=web.DHCBL.KB.DHCECGInteract&pClassMethod=UpdateData&pEntityName=web.Entity.KB.DHCECGInteract";
	var DELETE_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.KB.DHCECGInteract&pClassMethod=DeleteData";
	...
	var TEXT_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.KB.DHCECGInteract&pClassMethod=GetText";
	...
	var mode = tkMakeServerCall("web.DHCBL.KB.DHCPHInstLabel","GetManageMode","ELECTInterEach");
   							...
   							Ext.Ajax.request({											
										...
										callback:function(options,success,response){
												    ...
												    var jsonData=Ext.util.JSON.decode(response.responseText);
						    				 		...
						    				 		//Ext.getCmp("PHINSTTextF").setValue("若近期服用了"+PDINTCatDesc+"，不允许检查此心电项目");
						  						 }
											}
								})	
   						}
                            ...
                            listeners : {
								'blur' : function(){
									if(Ext.getCmp("PDINTGenDrF").getValue()!=""){
										...
										//Ext.getCmp("PHINSTTextF").setValue("若近期服用了"+Ext.getCmp("PDINTGenDrF").getRawValue()+"，不允许检查此心电项目");
									}
