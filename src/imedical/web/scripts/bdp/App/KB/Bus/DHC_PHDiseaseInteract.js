...
Ext.onReady(function() {
	var QUERY_ACTION_URL = "../csp/dhc.bdp.ext.querydatatrans.csp?pClassName=web.DHCBL.KB.DHCPHDiseaseInteract&pClassQuery=GetList";
  	var OPEN_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.KB.DHCPHDiseaseInteract&pClassMethod=OpenData";
	...
	var mode = tkMakeServerCall("web.DHCBL.KB.DHCPHInstLabel","GetManageMode","InterEach");
	
	var genHidden=""    //通用名显示与否
   							...
   							Ext.Ajax.request({											
										...
										callback:function(options,success,response){
												    ...
												    var jsonData=Ext.util.JSON.decode(response.responseText);
						    				 		...
						    				 		Ext.getCmp("PHINSTTextF").setValue("本品与"+PDINTCatDesc+"合用时:");
						  						 }
											}
								})	
   						}
