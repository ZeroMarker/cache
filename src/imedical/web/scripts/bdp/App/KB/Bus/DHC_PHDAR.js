/// 名称:知识库业务表 - 不良反应 AdverseReactions
/// 编写者:基础平台组 - 谷雪萍
/// 编写日期:2014-12-5
document.write('<script type="text/javascript" src="../scripts/bdp/Framework/scripts/BDPComboBox.js"> </script>');

Ext.onReady(function() {
	var QUERY_ACTION_URL = "../csp/dhc.bdp.ext.querydatatrans.csp?pClassName=web.DHCBL.KB.DHCPHDAR&pClassQuery=GetList";
  	var OPEN_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.KB.DHCPHDAR&pClassMethod=OpenData";
	var SAVE_ACTION_URL = "../csp/dhc.bdp.ext.entitydatatrans.csp?pClassName=web.DHCBL.KB.DHCPHDAR&pClassMethod=SaveData&pEntityName=web.Entity.KB.DHCPHDAR";
	var UPDATE_ACTION_URL = "../csp/dhc.bdp.ext.entitydatatrans.csp?pClassName=web.DHCBL.KB.DHCPHDAR&pClassMethod=UpdateData&pEntityName=web.Entity.KB.DHCPHDAR";
	var DELETE_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.KB.DHCPHDAR&pClassMethod=DeleteData";
	var ORDER_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.KB.DHCPHDAR&pClassMethod=SaveOrder";
	var DRAG_ORDER_ACTION_URL="../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.KB.DHCPHDAR&pClassMethod=SaveDragOrder";
	...
	var formSearch = new Ext.form.FormPanel({
				...
				reader: new Ext.data.JsonReader({root:'list'},
		                             [
                                        ...
                                        /*{name: 'PDAICode',mapping:'PDAICode',type:'string'},
                                        {name: 'PDAIText',mapping:'PDAIText',type:'string'},*/
                                        {name: 'PDAIOrdNum',mapping:'PDAIOrdNum',type:'string'},                                       
				...
				items:[{
							...
							name : 'PDAICode',
							id:'PDAICodeF',
							readOnly : Ext.BDP.FunLib.Component.DisableFlag('PDAICodeF'),
   							style:Ext.BDP.FunLib.ReadonlyStyle(Ext.BDP.FunLib.Component.DisableFlag('PDAICodeF')),
							allowBlank : false,
							...
							name : 'PDAIText',
							id:'PDAITextF',
							readOnly : Ext.BDP.FunLib.Component.DisableFlag('PDAITextF'),
   							style:Ext.BDP.FunLib.ReadonlyStyle(Ext.BDP.FunLib.Component.DisableFlag('PDAITextF')),
							editable:false,
							allowBlank : false,
							enableKeyEvents : true,
							validationEvent : 'blur',
                            ...
                            listeners : {
								...
								'blur' : function(){
									if(Ext.getCmp("PHINSTTextF").getValue()==""){
										//Ext.getCmp("PHINSTTextF").setValue(Ext.getCmp("PDAITextF").getValue());
									}		
								}
							}	
						},{
							...
							name : 'PDAIOrdNum',
							id:'PDAIOrdNumF',
							readOnly : Ext.BDP.FunLib.Component.DisableFlag('PDAIOrdNumF'),
   							style:Ext.BDP.FunLib.ReadonlyStyle(Ext.BDP.FunLib.Component.DisableFlag('PDAIOrdNumF')),
							//allowBlank : false,
