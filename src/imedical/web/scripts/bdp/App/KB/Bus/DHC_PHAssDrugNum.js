...
Ext.onReady(function() {
	...
	var mode = tkMakeServerCall("web.DHCBL.KB.DHCPHInstLabel","GetManageMode","AssDrugNum");
	...
	var formSearch = new Ext.form.FormPanel({
				...
				reader: new Ext.data.JsonReader({root:'list'},
		                             [
                                        {name: 'PHADRowId',mapping:'PHADRowId',type:'string'},
                                        {name: 'PHADInstDr',mapping:'PHADInstDr',type:'string'},
                                        {name: 'PHADNum',mapping:'PHADNum',type:'string'},
				...
				items:[{
							fieldLabel : 'PHADRowId',
							hideLabel : 'True',
							hidden : true,
							name : 'PHADRowId'
						},{
							fieldLabel : 'PHADInstDr',
							hideLabel : 'True',
							hidden : true,
							name : 'PHADInstDr'
						},{
							...
							xtype:'numberfield',
							width:300,
							readOnly : Ext.BDP.FunLib.Component.DisableFlag('PHADNumF'),
   							style:Ext.BDP.FunLib.ReadonlyStyle(Ext.BDP.FunLib.Component.DisableFlag('PHADNumF')),
   							listeners : {
								'blur' : function(){
									var str=""
									if(Ext.getCmp("PHADNumF").getValue()!=""){
										str="辅助用药个数："+Ext.getCmp("PHADNumF").getValue()+";";
									}else{
										str="";
									}
