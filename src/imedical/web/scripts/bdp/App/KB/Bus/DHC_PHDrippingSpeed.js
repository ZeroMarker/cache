...
Ext.onReady(function() {
	var QUERY_ACTION_URL = "../csp/dhc.bdp.ext.querydatatrans.csp?pClassName=web.DHCBL.KB.DHCPHDrippingSpeed&pClassQuery=GetList";
  	var OPEN_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.KB.DHCPHDrippingSpeed&pClassMethod=OpenData";
	var SAVE_ACTION_URL = "../csp/dhc.bdp.ext.entitydatatrans.csp?pClassName=web.DHCBL.KB.DHCPHDrippingSpeed&pClassMethod=SaveData&pEntityName=web.Entity.KB.DHCPHDrippingSpeed";
	var UPDATE_ACTION_URL = "../csp/dhc.bdp.ext.entitydatatrans.csp?pClassName=web.DHCBL.KB.DHCPHDrippingSpeed&pClassMethod=UpdateData&pEntityName=web.Entity.KB.DHCPHDrippingSpeed";
	var DELETE_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.KB.DHCPHDrippingSpeed&pClassMethod=DeleteData";
	...
	var formSearch = new Ext.form.FormPanel({
				...
				reader: new Ext.data.JsonReader({root:'list'},
		                             [
                                        {name: 'DRSPRowId',mapping:'DRSPRowId',type:'string'},
                                        {name: 'DRSPInstDr',mapping:'DRSPInstDr',type:'string'},                                      
				...
				items:[{
							fieldLabel : 'DRSPRowId',
							hideLabel : 'True',
							hidden : true,
							name : 'DRSPRowId'
						},{
							fieldLabel : 'DRSPInstDr',
							hideLabel : 'True',
							hidden : true,
							name : 'DRSPInstDr'
						},{
