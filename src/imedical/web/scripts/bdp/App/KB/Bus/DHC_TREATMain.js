 ...
 */
 ...
 //全局变量
	var GlPGenDr ="" //治疗项目通用名ID
	var GlPPointer =""  //关联部位ID
	var GenDesc ="" //治疗项目名加剂型名
	
Ext.onReady(function(){

	
	/* 治疗项目通用名列表 */var DrugGeneric_URL = "../csp/dhc.bdp.ext.querydatatrans.csp?pClassName=web.DHCBL.KB.DHCBusMain&pClassQuery=GetInstrList"; 
	/* 治疗项目通用名列表 */var GetDrugBookList = "../csp/dhc.bdp.ext.querydatatrans.csp?pClassName=web.DHCBL.KB.DHCBusMain&pClassQuery=GetDrugBookList1";
...
//	    		obj.update(html);
	 ...
	 grid.on("rowdblclick",function(grid,rowIndex,e){  //双击功能
	 	...
	 	var countCheckIndic=0,countCheckContr=0
	 	var arrCheckIndic=[],arrCheckContr=[]
		...
		countInfo="适应证#"+countCheckIndic+"^禁忌证#"+countCheckContr
		loadMenu(menuArray,westpanel);
