/// 名称:知识库业务表 - 临床意义 AdverseReactions
/// 编写者:基础平台组 - 谷雪萍
/// 编写日期:2015-1-5
document.write('<script type="text/javascript" src="../scripts/bdp/Framework/scripts/BDPComboBox.js"> </script>');

Ext.onReady(function() {
	var QUERY_ACTION_URL = "../csp/dhc.bdp.ext.querydatatrans.csp?pClassName=web.DHCBL.KB.DHCLabClinical&pClassQuery=GetList";
  	var OPEN_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.KB.DHCLabClinical&pClassMethod=OpenData";
	var SAVE_ACTION_URL = "../csp/dhc.bdp.ext.entitydatatrans.csp?pClassName=web.DHCBL.KB.DHCLabClinical&pClassMethod=SaveData&pEntityName=web.Entity.KB.DHCLabClinical";
	var UPDATE_ACTION_URL = "../csp/dhc.bdp.ext.entitydatatrans.csp?pClassName=web.DHCBL.KB.DHCLabClinical&pClassMethod=UpdateData&pEntityName=web.Entity.KB.DHCLabClinical";
	var DELETE_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.KB.DHCLabClinical&pClassMethod=DeleteData";
	...
	var formSearch = new Ext.form.FormPanel({
				...
				reader: new Ext.data.JsonReader({root:'list'},
		                             [
                                        {name: 'LABCRowId',mapping:'LABCRowId',type:'string'},
                                        {name: 'LABCInstDr',mapping:'LABCInstDr',type:'string'},                                     
				...
				items:[{
							fieldLabel : 'LABCRowId',
							hideLabel : 'True',
							hidden : true,
							name : 'LABCRowId'
						},{
							fieldLabel : 'LABCInstDr',
							hideLabel : 'True',
							hidden : true,
							name : 'LABCInstDr'
						},{
