...
Ext.onReady(function() {
	var QUERY_ACTION_URL = "../csp/dhc.bdp.ext.querydatatrans.csp?pClassName=web.DHCBL.KB.DHCCheckDiseaseI&pClassQuery=GetList";
  	var OPEN_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.KB.DHCCheckDiseaseI&pClassMethod=OpenIndData";
	...
	var mode = tkMakeServerCall("web.DHCBL.KB.DHCPHInstLabel","GetManageMode","CheckIndic");
		...
		listeners : {
			'blur' : function(){
				if(Ext.getCmp("Key").getValue()!=""){
					text[2]="治疗手术:"+Ext.getCmp("Key").getValue()+";";
				}else{
					text[2]="";
				}
				//Ext.getCmp("PHINSTTextF").setValue(getStr(text));	
		...
		listeners : {
			'blur' : function(){
				if(Ext.getCmp("TextKey0").getValue()!=""){
					text[3]="症状体征:"+Ext.getCmp("TextKey0").getValue()+";";
				}else{
					text[3]="";
				}
				//Ext.getCmp("PHINSTTextF").setValue(getStr(text));	
				...
				if (!_record) {
		            ...
		            Ext.getCmp("form-save").getForm().load({
		                ...
		                success : function(form,action) {
							...
							if(Ext.getCmp("TextKey0").getValue()!=""){
								text[3]="病症体征:"+Ext.getCmp("TextKey0").getValue()+";";
							}
		                },
		                failure : function(form,action) {
