/// 名称: 单位对照
/// 描述: 包含单位表与his单位表对照功能，与已对照单位删除功能
/// 编写者: 基础数据平台组-丁亚男
/// 编写日期: 2018-08-01
var DELETE_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.KB.DHCPHUomContrast&pClassMethod=DeleteData";
var init=function()
{
   var columns =[[
   		{field:'PHEURowId',title:'PHEURowId',sortable:true,width:100,hidden:true},
        {field:'PHEUCode',title:'代码',sortable:true,width:100},
        {field:'PHEUDesc',title:'描述',sortable:true,width:100},
        {field:'PHEUActiveFlag',title:'启用',sortable:true,width:100,align:'center',formatter:ReturnFlagIcon},
        {field:'PHEUSysFlag',title:'系统标识',sortable:true,width:100,align:'center',formatter:ReturnFlagIcon}
        
    ]];
    var gengrid = $HUI.datagrid("#gengrid",{
        url:$URL,
        queryParams:{
            ClassName:"web.DHCBL.KB.DHCPHExtUom",
            QueryName:"GetList"
        },
        columns: columns,  //列信息
        ...
        onClickRow:function(index,row)
        {
	        $('#contrastgrid').datagrid('reload',  {
            	ClassName:"web.DHCBL.KB.DHCPHUomContrast",
            	QueryName:"GetList",
            	id:row.PHEURowId
    		});        	
        }		
	...
	$('#BatchContrast').click(function(e){
		var result= tkMakeServerCall("web.DHCBL.KB.DHCPHUomContrast","AutoContrastData");
    ...
    var hiscolumns =[[
	  {field:'CTUOMRowId',title:'PHCFRowId',width:150,sortable:true,hidden:true},
	  {field:'CTUOMCode',title:'代码',width:150,sortable:true},
	  {field:'CTUOMDesc',title:'中文描述',width:150,sortable:true},
	  {field:'CTUOMForeignDesc',title:'英文描述',width:150,sortable:true},
    ...
    conMethod=function()
    {
 		setTimeout(function(){
			...
			if(!record)
			{
				$.messager.alert('错误提示','请选择需要对照的单位！',"error");
            	return;
			}
			var ids=record.PHEURowId+'^'+hisRecord.CTUOMRowId;
			var data=tkMakeServerCall("web.DHCBL.KB.DHCPHUomContrast","SaveData",ids);
			var data=eval('('+data+')');
    ...
    //对照表
    var columns =[[
        {field:'PHUCTRowId',title:'PHUCTRowId',width:100,hidden:true,sortable:true},
        {field:'PHUCTUomCode',title:'代码',width:100,sortable:true},
        {field:'PHUCTUomDesc',title:'描述',width:100,sortable:true},
        {field:'PHUCTHisUomCode',title:'his代码',width:100,sortable:true},
        {field:'PHUCTHisUomDesc',title:'his描述',width:100,sortable:true},
