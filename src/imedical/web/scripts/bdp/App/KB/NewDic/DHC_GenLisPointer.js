...
var init = function(){
	...
	{		
		...
		{
			$.messager.alert('错误提示','检验通用名不能为空，请选择下拉列表里的值!',"error");
			return;
		}
		if (($('#GlPPointerF').combobox('getValue')==undefined)||($('#GlPPointerF').combobox('getValue')==""))
		{
			$.messager.alert('错误提示','检验标本不能为空，请选择下拉列表里的值!',"error");
			return;
		}
	...
	var columns =[[  
				  ...
				  {field:'Desc',title:'检验标本',width:150,sortable:true},
				  {field:'GlPPointer',title:'检验标本ID',width:150,sortable:true,hidden:true},
