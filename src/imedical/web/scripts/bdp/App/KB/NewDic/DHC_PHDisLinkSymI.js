...
* @Last Modified time: 2018-10-11 11:01:28
* @描述:诊断与症状建议用药或检查
*/
...
var init=function()
{
    ...
    var eastcolumns =[[
        ...
        {field:'SymDesc',title:'症状',sortable:true,width:100,
            formatter: function(value,row,index){
                return parrefDesc1;
            }  
        },
        {field:'LSYLinkDr',title:'症状id',sortable:true,width:100,hidden:true,editor:'validatebox'},
        {field:'LSYGenDrF',title:'通用名F',sortable:true,width:100,hidden:true,editor:'validatebox'},
        {field:'LSYGenDr',title:'通用名',sortable:true,width:100,editor:{
            type:'combobox',
            options:{
                ...
                onHidePanel:function(){
                    ...
                    var ed = $('#eastgrid').datagrid('getEditor', {index:editIndex,field:'LSYGenDrF'});
                    $(ed.target).val(val)
                }                   
            } 
        }},
        {field:'LSYFlag',title:'标志',sortable:true,width:100},
        {field:'LSYRowId',title:'rowid',sortable:true,width:100,hidden:true,editor:'validatebox'}      
    ]];
    var eastgrid = $HUI.datagrid("#eastgrid",{
        url:$URL,
        queryParams:{
            ClassName:"web.DHCBL.KB.DHCPHDisLinkSymI",
            QueryName:"GetList",
            parref:parref1
        },
    ...
    function AddData(){
        ...
        ClickFun('AddData')
        if (endEditing()){
            $('#eastgrid').datagrid('insertRow',{index:0,row:{LSYLinkDr:parref1}});
