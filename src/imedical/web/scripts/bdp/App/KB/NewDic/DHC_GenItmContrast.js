...
var init=function()
{
   var columns =[[
	...
	$('#BatchContrast').click(function(e){
		var result= tkMakeServerCall("web.DHCBL.KB.DHCGenItmContrast","AutoContrastItmData");
    ...
    var hiscolumns =[[
	  {field:'PHCGERowId',title:'PHCGERowId',width:150,sortable:true,hidden:true},
	  {field:'PHCGECode',title:'代码',width:150,sortable:true},
	  {field:'PHCGEName',title:'描述',width:250,sortable:true},
    ...
    conMethod=function()
    {
 		setTimeout(function(){
			...
			if(!record)
			{
				$.messager.alert('错误提示','请选择需要对照的药品通用名！',"error");
            	return;
			}
			var ids=record.PHEGRowId+'^'+hisRecord.PHCGERowId;
			var data=tkMakeServerCall("web.DHCBL.KB.DHCGenItmContrast","SaveData",ids);
			var data=eval('('+data+')');
