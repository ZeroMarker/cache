...
var init=function()
{
   var columns =[[
    ...
    var gengrid = $HUI.datagrid("#gengrid",{
        ...
        onClickRow:function(index,row)
        {
	        $('#contrastgrid').datagrid('reload',  {
            	ClassName:"web.DHCBL.KB.DHCPHFormContrast",
            	QueryName:"GetList",
            	id:row.PHEFRowId
    		});        	
        }		
	...
	$('#BatchContrast').click(function(e){
		var result= tkMakeServerCall("web.DHCBL.KB.DHCPHFormContrast","AutoContrastData");
    ...
    var hiscolumns =[[
	  {field:'PHCFRowId',title:'PHCFRowId',width:150,sortable:true,hidden:true},
	  {field:'PHCFCode',title:'代码',width:150,sortable:true},
	  {field:'PHCFDesc',title:'描述',width:250,sortable:true},
    ...
    conMethod=function()
    {
 		setTimeout(function(){
			...
			if(!record)
			{
				$.messager.alert('错误提示','请选择需要对照的剂型！',"error");
            	return;
			}
			var ids=record.PHEFRowId+'^'+hisRecord.PHCFRowId;
			var data=tkMakeServerCall("web.DHCBL.KB.DHCPHFormContrast","SaveData",ids);
			var data=eval('('+data+')');
    ...
    var columns =[[
        ...
        {field:'PHFCTFormCode',title:'代码',width:100,sortable:true},
        {field:'PHFCTFormDesc',title:'描述',width:100,sortable:true},
        {field:'PHFCTHisFormCode',title:'his代码',width:100,sortable:true},
        {field:'PHFCTHisFormDesc',title:'his描述',width:100,sortable:true},
        {field:'opt',title:'操作',width:50,align:'center',
			formatter:function(){  
