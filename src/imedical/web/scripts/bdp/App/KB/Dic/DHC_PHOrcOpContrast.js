...
var QUERY_ACTION_URL = "../csp/dhc.bdp.ext.querydatatrans.csp?pClassName=web.DHCBL.KB.DHCGenItmContrast&pClassQuery=GetOperList";
var QUERY_HIS_URL = "../csp/dhc.bdp.ext.querydatatrans.csp?pClassName=web.DHCBL.CT.Arcim&pClassQuery=GetDataForCmbOper1";
var QUERY_CONTRAST_URL = "../csp/dhc.bdp.ext.querydatatrans.csp?pClassName=web.DHCBL.KB.DHCPHOrcOpContrast&pClassQuery=GetList";
var SAVE_ACTION_URL = "../csp/dhc.bdp.ext.entitydatatrans.csp?pClassName=web.DHCBL.KB.DHCPHOrcOpContrast&pClassMethod=SaveData&pEntityName=web.Entity.KB.DHCPHOrcOpContrast";
	...
	var dsWestS = new Ext.data.Store({
		...
		reader : new Ext.data.JsonReader({
					...
					successProperty : 'success'
							...
							name : 'PHOCTOperCode',
							mapping : 'PHOCTOperCode',
							type : 'string'
						}, {
							name : 'PHOCTOperDesc',
							mapping : 'PHOCTOperDesc',
							type : 'string'
						}, {
							name : 'PHOCTHisOperCode',
							mapping : 'PHOCTHisOperCode',
							type : 'string'
						}, {
							name : 'PHOCTHisOperDesc',
							mapping : 'PHOCTHisOperDesc',
							type : 'string'
						},{
							name : 'PHOCTRowId',
							mapping : 'PHOCTRowId',
		...
		columns : [new Ext.grid.CheckboxSelectionModel(), // 单选列
				{
					header : '代码',
					sortable : true,
					dataIndex : 'PHOCTOperCode'
				}, {
					header : '描述',
					sortable : true,
					dataIndex : 'PHOCTOperDesc'
				}, {
					header : 'his代码',
					sortable : true,
					dataIndex : 'PHOCTHisOperCode'
				}, {
					header : 'his描述',
					sortable : true,
					dataIndex : 'PHOCTHisOperDesc'
				}, {
					header : '操作',
					dataIndex : 'PHOCTRowId',
					align:'center',
					renderer:function (){    
	 ...
	 gridCenter.on('cellclick', function (grid, rowIndex, columnIndex, e) {  
	 	...
	 	if(btn){
		 	if(gridWestN.getSelectionModel().getCount()!=0){
		 		...
		 		var hisrowid = gridCenter.getSelectionModel().getSelections()[0].get('OPERRowId');
