...
Ext.onReady(function() {
	...
	var QUERY_ACTION_URL = "../csp/dhc.bdp.ext.querydatatrans.csp?pClassName=web.DHCBL.KB.DHCGenLinkPointer&pClassQuery=GetLisList";
	...
	var BindingLis="../csp/dhc.bdp.ext.querydatatrans.csp?pClassName=web.DHCBL.KB.DHCPHExtGeneric&pClassQuery=GetDataForCmb1";
	...
	var WinFormAdd = new Ext.form.FormPanel({
				...
				items : [{
							...
							xtype : 'combo',
							fieldLabel : '<font color=red>*</font>检验通用名',
							name : 'GlPGenDr',
							id:'GlPGenDrF',
							hiddenName:'GlPGenDr',
							...
							xtype : 'multiSelect',
							fieldLabel : '<font color=red>*</font>检验标本',
							name : 'GlPPointer',
							id:'GlPPointerF',
							...
							store : new Ext.data.JsonStore({
								autoLoad : true,
								url : BindingLis + '&code=' + 'SPEC',
								//baseParams:{code:'SPEC'},
								root : 'data',
								totalProperty : 'total',
								idProperty : 'PHEGRowId',
								fields : ['PHEGRowId', 'PHEGDesc'],
	...
	function saveData(){
    			...
    			if (tempDesc=="") {
    				Ext.Msg.show({ title : '提示', msg : '检验标本不能为空!', minWidth : 200, icon : Ext.Msg.ERROR, buttons : Ext.Msg.OK });
          			return;
    			}
