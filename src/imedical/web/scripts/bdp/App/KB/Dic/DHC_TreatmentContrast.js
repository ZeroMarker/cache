/// 名称: 治疗项目与HIS对照
/// 描述: 包含治疗项目与his医嘱子类对照功能，与已对照医嘱子类删除功能
/// 编写者: 基础数据平台组-丁亚男
/// 编写日期: 2018-03-13
Ext.onReady(function(){
var QUERY_ACTION_URL = "../csp/dhc.bdp.ext.querydatatrans.csp?pClassName=web.DHCBL.KB.DHCGenItmContrast&pClassQuery=GetTreatmentList";
var QUERY_HIS_URL = "../csp/dhc.bdp.ext.querydatatrans.csp?pClassName=web.DHCBL.CT.Arcim&pClassQuery=GetTreatmentList";
