/// 名称: 检查部位对照
/// 描述: 包含检查部位表与his检查部位对照功能，与已对照检查部位删除功能
/// 编写者: 基础数据平台组-高姗姗
/// 编写日期: 2015-5-28
Ext.onReady(function(){
var QUERY_ACTION_URL = "../csp/dhc.bdp.ext.querydatatrans.csp?pClassName=web.DHCBL.KB.DHCPHExtPart&pClassQuery=GetList";
var QUERY_HIS_URL = "../csp/dhc.bdp.ext.querydatatrans.csp?pClassName=web.DHCBL.KB.DHCPHPartContrast&pClassQuery=GetHisList";
var QUERY_CONTRAST_URL = "../csp/dhc.bdp.ext.querydatatrans.csp?pClassName=web.DHCBL.KB.DHCPHPartContrast&pClassQuery=GetList";
var SAVE_ACTION_URL = "../csp/dhc.bdp.ext.entitydatatrans.csp?pClassName=web.DHCBL.KB.DHCPHPartContrast&pClassMethod=SaveData&pEntityName=web.Entity.KB.DHCPHPartContrast";
	...
	var dsWestS = new Ext.data.Store({
		...
		reader : new Ext.data.JsonReader({
					...
					successProperty : 'success'
							...
							name : 'PHEPPartCode',
							mapping : 'PHEPPartCode',
							type : 'string'
						}, {
							name : 'PHEPPartDesc',
							mapping : 'PHEPPartDesc',
							type : 'string'
						}, {
							name : 'PHEPHisPartCode',
							mapping : 'PHEPHisPartCode',
							type : 'string'
						}, {
							name : 'PHEPHisPartDesc',
							mapping : 'PHEPHisPartDesc',
							type : 'string'
						},{
							name : 'PHEPRowId',
							mapping : 'PHEPRowId',
		...
		columns : [new Ext.grid.CheckboxSelectionModel(), // 单选列
				{
					header : '代码',
					sortable : true,
					dataIndex : 'PHEPPartCode'
				}, {
					header : '描述',
					sortable : true,
					dataIndex : 'PHEPPartDesc'
				}, {
					header : 'his代码',
					sortable : true,
					dataIndex : 'PHEPHisPartCode'
				}, {
					header : 'his描述',
					sortable : true,
					dataIndex : 'PHEPHisPartDesc'
				}, {
					header : '操作',
					dataIndex : 'PHEPRowId',
					align:'center',
