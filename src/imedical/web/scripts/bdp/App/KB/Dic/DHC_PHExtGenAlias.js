				...
				items : [{
                            ...
                            validationEvent : 'blur',
                              validator : function(thisText){
	                            ...
	                            var id="";
	                            var gen=Ext.getCmp("PHEGAlGenDrF").getValue();
	...
	var win = new Ext.Window({
		...
		buttons : [{
			...
			handler : function() {
				...
				var tempCode = Ext.getCmp("PHEGAlGenDrF").getValue();
	...
	var btnSearch = new Ext.Button({
				...
				handler : function() {
					grid.getStore().baseParams={			
							gen : Ext.getCmp("PHEGAlGenDr").getValue(),
	...
	var tb = new Ext.Toolbar({
				...
				items : [
						...
						'通用名', {
							xtype : 'combo',
							id : 'PHEGAlGenDr',
							disabled : Ext.BDP.FunLib.Component.DisableFlag('PHEGAlGenDr'),
							triggerAction : 'all',// query
							queryParam : "desc",
							forceSelection : true,
							selectOnFocus : false,
