...
Ext.onReady(function() {
	...
	var QUERY_ACTION_URL = "../csp/dhc.bdp.ext.querydatatrans.csp?pClassName=web.DHCBL.KB.DHCSymptomFeild&pClassQuery=GetList";
	var SAVE_ACTION_URL = "../csp/dhc.bdp.ext.entitydatatrans.csp?pClassName=web.DHCBL.KB.DHCSymptomFeild&pClassMethod=SaveData&pEntityName=web.Entity.KB.DHCSymptomFeild";
	var OPEN_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.KB.DHCSymptomFeild&pClassMethod=OpenData";
	var DELETE_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.KB.DHCSymptomFeild&pClassMethod=DeleteData";
	...
	var WinForm = new Ext.form.FormPanel({
				...
				items : [{
                            ...
                            validator : function(thisText){
	                            ...
	                            var className =  "web.DHCBL.KB.DHCSymptomFeild";  //后台类名称
