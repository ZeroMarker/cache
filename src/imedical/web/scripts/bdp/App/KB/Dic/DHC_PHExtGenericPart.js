...
Ext.getParam = function(param) { 
    var params = Ext.urlDecode(unescape(location.search.substring(2))); 
    return param ? params[param] : params; 
};
var lib=Ext.getParam('lib');
Ext.onReady(function() {
	...
	var QUERY_ACTION_URL = "../csp/dhc.bdp.ext.querydatatrans.csp?pClassName=web.DHCBL.KB.DHCGenLinkPointer&pClassQuery=GetEvrPartList";
