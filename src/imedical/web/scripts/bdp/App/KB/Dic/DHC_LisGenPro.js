...
/*	var comboTreePanel = new Ext.tree.TreePanel({
						...
						},treeCombox, 
						{
					        ...
					        listeners:{
					        	'change':function(radiogroup,checked){
					        		//if(Ext.getCmp("LGPOTFlagF").getValue().inputValue=="TS"){
						        	//if(checked.inputValue=="TS"){
	...
	var win = new Ext.Window({
		...
		buttons : [{
			...
			handler : function() {
				var tempCode = Ext.getCmp("LGPGenDrF").getValue();
	...
	var btnSearch = new Ext.Button({
				...
				handler : function() {
					grid.getStore().baseParams={			
							gen : Ext.getCmp("LGPGenDr").getValue(),
	...
	var tb = new Ext.Toolbar({
				...
				items : [
						...
						'通用名', {
							xtype : 'combo',
							id : 'LGPGenDr',
							disabled : Ext.BDP.FunLib.Component.DisableFlag('LGPGenDr'),
							triggerAction : 'all',// query
							queryParam : "desc",
							forceSelection : true,
							selectOnFocus : false,
