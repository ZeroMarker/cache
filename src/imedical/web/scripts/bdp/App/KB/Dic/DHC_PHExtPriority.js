...
Ext.onReady(function() {
	...
	var SAVE_ACTION_URL = "../csp/dhc.bdp.ext.entitydatatrans.csp?pClassName=web.DHCBL.KB.DHCPHExtPriority&pClassMethod=SaveData&pEntityName=web.Entity.KB.DHCPHExtPriority";
	var OPEN_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.KB.DHCPHExtPriority&pClassMethod=OpenData";
	var DELETE_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.KB.DHCPHExtPriority&pClassMethod=DeleteData";
	...
	var WinForm = new Ext.form.FormPanel({
        		...
        		reader: new Ext.data.JsonReader({root:'data'},
                        [{name: 'PHEPRowId',mapping:'PHEPRowId',type:'string'},
                         ...
                         {name: 'PHEPPriority',mapping:'PHEPPriority',type:'string'}
                   ]),
				defaults : {
					anchor : '92%',
					border : false
				...
				items : [{
							...
							name : 'PHEPCode',
							id:'PHEPCode',
   							readOnly : Ext.BDP.FunLib.Component.DisableFlag('PHEPCode'),
   							style:Ext.BDP.FunLib.ReadonlyStyle(Ext.BDP.FunLib.Component.DisableFlag('PHEPCode')),
							allowBlank : false,
                            ...
                            validator : function(thisText){
	                            ...
	                            var className =  "web.DHCBL.KB.DHCPHExtPriority";  //后台类名称
							...
							name : 'PHEPDesc',
							id:'PHEPDesc',
   							readOnly : Ext.BDP.FunLib.Component.DisableFlag('PHEPDesc'),
   							style:Ext.BDP.FunLib.ReadonlyStyle(Ext.BDP.FunLib.Component.DisableFlag('PHEPDesc')),
							allowBlank : false,
							validationEvent : 'blur',
                            validator : function(thisText){
	                            if(thisText==""){ //当文本框里的内容为空的时候不用此验证
							...
							name : 'PHEPPriority',
							id:'PHEPPriority',
   							readOnly : Ext.BDP.FunLib.Component.DisableFlag('PHEPPriority'),
   							style:Ext.BDP.FunLib.ReadonlyStyle(Ext.BDP.FunLib.Component.DisableFlag('PHEPPriority'))
						}]
			});
	...
	var win = new Ext.Window({
		...
		buttons : [{
			...
			handler : function() {
				var tempCode = Ext.getCmp("PHEPCode").getValue();
				var tempDesc = Ext.getCmp("PHEPDesc").getValue();
				if (tempCode=="") {
