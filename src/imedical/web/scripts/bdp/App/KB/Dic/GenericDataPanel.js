Ext.namespace("Ext.KB.Component");
Ext.namespace("Ext.KB.Component.tree");
 ...
 */
Ext.KB.Component.tree.TreeLoaderStore = Ext.extend(Ext.data.Store,{
	/**
	 * 加载数据源的数据对象，是树结构的loader
	 * @type  Ext.KB.Component.tree.TreePagingLoader
	 */
	loader : null,
	/**
	 * 树的根节点，最顶的节点
	 * @type Ext.KB.Component.tree.AsyncTreeNode
	 */
	rootNode : null,
	
	constructor : function(config){
	 	Ext.KB.Component.tree.TreeLoaderStore.superclass.constructor.call(this);
...
/**
 * @class Ext.KB.Component.tree.TreePagingLoader
 * @extends Ext.tree.TreeLoader
 * @author 2013-6-6 by 李森
 * 说明：
 * 		用于tree分页加载
 */
Ext.KB.Component.tree.TreePagingLoader = Ext.extend(Ext.tree.TreeLoader,{
...
/**
 * @class Ext.KB.Component.tree.AsyncTreeNode
 * @extends Ext.tree.AsyncTreeNode
 * @author 2013-6-6 by 李森
 * 说明：
 * 		根节点定义
 */
Ext.KB.Component.tree.AsyncTreeNode = Ext.extend(Ext.tree.AsyncTreeNode, {
	expand : function(deep, anim, callback, scope){
        ...
        Ext.KB.Component.tree.AsyncTreeNode.superclass.expand.call(this, deep, anim, callback, scope);
    }
});

/**
 * @class Ext.KB.Component.tree.TreePanel
 ...
 */
Ext.KB.Component.tree.TreePanel = Ext.extend(Ext.tree.TreePanel, {
	/**
	 * 方法说明：
	 * 		1、loadAuthorizeTree(); //重新加载授权后的树
	 */
	//**************方法说明(以上)************************************//
	...
	initComponent : function(){
        Ext.KB.Component.tree.TreePanel.superclass.initComponent.call(this);
		
        this.root = new Ext.KB.Component.tree.AsyncTreeNode({
	         id:"menuTreeRoot",
	         text: '数据',
	         expanded :true,
	         draggable:false
	    });
	    this.loader = new Ext.KB.Component.tree.TreePagingLoader({
        ...
        var l = this.loader;
        if(!l){
            l = new Ext.KB.Component.tree.TreePagingLoader({
                dataUrl: this.dataUrl,
                requestMethod: this.requestMethod
            });
        }else if(Ext.isObject(l) && !l.load){
            l = new Ext.KB.Component.tree.TreePagingLoader(l);
        }
        this.loader = l;
        this.nodeHash = {};
        /**用于分页的store*/
        this.store = new Ext.KB.Component.tree.TreeLoaderStore({
			rootNode : this.root,
			loader : this.loader
		});
		/**搜索工具条*/
...
Ext.reg('bdptreepanel', Ext.KB.Component.tree.TreePanel);

/**
 * @class Ext.KB.Component.GenericDataPanel
 * @extends Ext.Panel
 */
Ext.KB.Component.GenericDataPanel = Ext.extend(Ext.Panel, {
	layout:'border',
	dataUrl : '',
	ObjectType : '',
	ObjectReference : '',
	...
	initComponent : function(){
        Ext.KB.Component.GenericDataPanel.superclass.initComponent.call(this);
        
        this.myTree = new Ext.KB.Component.tree.TreePanel({
		        region : "center",
