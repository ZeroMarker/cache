...
var init = function(){
	...
	var mygrid = $HUI.datagrid("#mygrid",{
		url:$URL,
		queryParams:{
			ClassName:"web.DHCBL.KB.DHCPHMustDrug",
			QueryName:"GetList",
			TypeDr : "",
			GenDr: GenDr,
	...
	///关联液体
	var pronameObj = $HUI.combobox("#PHMDAssDrugDrF",{ 
		url:$URL+"?ClassName=web.DHCBL.KB.DHCPHProName&QueryName=GetDataForCmb1&ResultSetType=array",
		valueField:'PHNRowId',
		textField:'PHNDesc'
	});
	///必用药品名称
	var promame1Obj = $HUI.combobox("#PHMDMustDrugDrF",{ 
		url:$URL+"?ClassName=web.DHCBL.KB.DHCPHProName&QueryName=GetDataForCmb1&ResultSetType=array",
		valueField:'PHNRowId',
		textField:'PHNDesc'
	});
	///限定
	var relationObj = $HUI.combobox("#PHMDRelationF",{
		valueField:'id',
		textField:'text',
		data:[
			{id:'>',text:'大于'},
	...
	///单位
	var uomObj = $HUI.combobox("#PHMDMustUomDrF",{ 
