...
InitLeftTree=function(desc)
{
	...
	$('#LeftTree').datagrid({ 
		...
		onLoadSuccess:function(data){
			var row = $("#LeftTree").datagrid("getSelected");   //如果之前有选中行
...
function addTab(title, myhref){
	/*if ($('#righttabs').tabs('exists', title)){
		...
		/*if (title=="适应证")
		{
			var url = "../csp/dhc.bdp.kb.dhclabdiseaseind.csp"+"?GlPGenDr="+GlPGenDr + "&GlPPointer="+ GlPPointer+ "&GlPPointerType="+ GlPPointerType;
		}
		else if(title=="禁忌证")
		{
			var url = "../csp/dhc.bdp.kb.dhclabdiseasecon.csp"+"?GlPGenDr="+GlPGenDr + "&GlPPointer="+ GlPPointer+ "&GlPPointerType="+ GlPPointerType;
		}	
		else if(title=="临床意义")
		{
			var url = "../csp/dhc.bdp.kb.dhclabclinical.csp"+"?GlPGenDr="+GlPGenDr + "&GlPPointer="+ GlPPointer+ "&GlPPointerType="+ GlPPointerType;
		}
		else if(title=="注意事项")
		{
			var url = "../csp/dhc.bdp.kb.dhclabmha.csp"+"?GlPGenDr="+GlPGenDr + "&GlPPointer="+ GlPPointer+ "&GlPPointerType="+ GlPPointerType;
		}

		else if(title=="相互作用")
		{
			var url = "../csp/dhc.bdp.kb.dhclabdiseaseinteract.csp"+"?GlPGenDr="+GlPGenDr + "&GlPPointer="+ GlPPointer+ "&GlPPointerType="+ GlPPointerType;
		}
		else if(title=="检验结果辅助诊断")
		{
			var url = "../csp/dhc.bdp.kb.dhcphlibresultdiag.csp"+"?GlPGenDr="+GlPGenDr + "&GlPPointer="+ GlPPointer+ "&GlPPointerType="+ GlPPointerType;
		}
		else
		{
			var url = myhref + parm;
