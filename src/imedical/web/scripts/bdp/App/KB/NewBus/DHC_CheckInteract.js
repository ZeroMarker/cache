...
var SAVE_ACTION_URL = "../csp/dhc.bdp.ext.entitydatatrans.csp?pClassName=web.DHCBL.KB.DHCCheckInteract&pClassMethod=SaveData&pEntityName=web.Entity.KB.DHCCheckInteract";
var UPDATE_ACTION_URL = "../csp/dhc.bdp.ext.entitydatatrans.csp?pClassName=web.DHCBL.KB.DHCCheckInteract&pClassMethod=UpdateData&pEntityName=web.Entity.KB.DHCCheckInteract";
var DELETE_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.KB.DHCCheckInteract&pClassMethod=DeleteData";
...
var init = function(){
	var mode=""
	//var QUERY_ACTION_URL = "../csp/dhc.bdp.ext.querydatatrans.csp?pClassName=web.DHCBL.KB.DHCCheckInteract&pClassQuery=GetList";
	var myColumns =[[  
	...
	var mygrid = $HUI.datagrid("#mygrid",{
		url:$URL,
		queryParams:{
			ClassName:"web.DHCBL.KB.DHCCheckInteract",
			QueryName:"GetList",
			TypeDr : "",
			GenDr: GenDr,
	...
	function ClickMyGrid(rowIndex, rowData)
	{
		...
		if (record){
			...
			$.cm({
				...
				MethodName:"OpenECGInteractData",
				id:InstId
			},function(jsonData){
