...
function InitGenList()
{
	...
	var gencolumns =[[  
				  {field:'PHEGDesc',title:'手术项目',width:180},
...
function InitLeftTree(desc)
{
	...
	var leftclumns=[[ 
				  {field:'text',title:'',width:'145',
					...
					styler: function(value,row,index){
						if (row._parentId==""){
							//return 'padding-left:5px;';  //#40a2de
						}
					}
				  }, 
				  //{field:'libdr',title:'libdr',hidden:true}, 
...
function addTab(title, myhref){
	/*if ($('#righttabs').tabs('exists', title)){
		...
		/*if (title=="高危提醒")
		{
			var url = "../csp/dhc.bdp.kb.dhcoperremind.csp"+"?GlPGenDr="+GlPGenDr + "&GlPPointer="+ GlPPointer+ "&GlPPointerType="+ GlPPointerType;
		}
		else
		{
			var url = myhref + parm;
...
ReturnFlagIcon = function(value)
{
	...
	switch(value)
	{
	  ...
	  case "高危提醒": //"高危提醒"
	  returnValue = "<img src='../scripts/bdp/Framework/imgs/KB/gwtx.png' style='border: 0px'><span style='font-size:16px'>"+"【高危提醒】"+"</span>";
	  break;
	  case "术前检验":  //"术前检验"
	  returnValue = "<img src='../scripts/bdp/Framework/imgs/KB/zysx.png' style='border: 0px'><span style='font-size:16px'>"+"【术前检验】"+"</span>";
	  break;		  
	  case "术前检验质控":  //"术前检验质控"
	  returnValue = "<img src='../scripts/bdp/Framework/imgs/KB/xhzy.png' style='border: 0px'><span style='font-size:16px'>"+"【术前检验质控】"+"</span>";
	  break;
	  case "术前检查":  //"术前检查"
	  returnValue = "<img src='../scripts/bdp/Framework/imgs/KB/lcyy.png' style='border: 0px'><span style='font-size:16px'>"+"【术前检查】"+"</span>";
	  break;
	  case "术前检查质控":  //"术前检查质控"
	  returnValue = "<img src='../scripts/bdp/Framework/imgs/KB/fzzd.png' style='border: 0px'><span style='font-size:16px'>"+"【术前检查质控】"+"</span>";
	  break;
	  default:  //"其他"
