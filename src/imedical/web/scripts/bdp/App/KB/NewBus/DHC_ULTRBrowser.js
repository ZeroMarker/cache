...
function InitGenList()
{
	...
	var gencolumns =[[  
				  {field:'PHEGDesc',title:'超声项目',width:180},
...
function addTab(title, myhref){
	/*if ($('#righttabs').tabs('exists', title)){
		...
		/*if (title=="适应证")
		{
			var url = "../csp/dhc.bdp.kb.dhccheckdiseaseind.csp"+"?GlPGenDr="+GlPGenDr + "&GlPPointer="+ GlPPointer+ "&GlPPointerType="+ GlPPointerType;
		}
		else if(title=="禁忌证")
		{
			var url = "../csp/dhc.bdp.kb.dhccheckdiseasecon.csp"+"?GlPGenDr="+GlPGenDr + "&GlPPointer="+ GlPPointer+ "&GlPPointerType="+ GlPPointerType;
		}	
		else if(title=="不良反应")
		{
			var url = "../csp/dhc.bdp.kb.dhccheckar.csp"+"?GlPGenDr="+GlPGenDr + "&GlPPointer="+ GlPPointer+ "&GlPPointerType="+ GlPPointerType;
		}
		else if(title=="注意事项")
		{
			var url = "../csp/dhc.bdp.kb.dhccheckmha.csp"+"?GlPGenDr="+GlPGenDr + "&GlPPointer="+ GlPPointer+ "&GlPPointerType="+ GlPPointerType;
		}
		else
		{
			var url = myhref + parm;
