...
Ext.onReady(function() {
		...
		//收费类型  User.DHCItmAddionInfo-->User.DHCItmChargeType
		 var DHCItmChargeType_QUERY_ACTION_URL="../csp/dhc.bdp.ext.querydatatrans.csp?pClassName=web.DHCBL.CT.INCItmTar&pClassQuery=GetDataForChgType";
		//// 账单组查询数据
		...
		var ItemCat_ACTION_URL = "../csp/dhc.bdp.ext.querydatatrans.csp?pClassName=web.DHCBL.CT.ARCItemCat&pClassQuery=GetDataForCmb1";
	 	///药物查找ARCIM_PHCDF_DR
		//var GetDrugList_ACTION_URL = "../csp/dhc.bdp.ext.querydatatrans.csp?pClassName=web.DHCBL.CT.INCItmTar&pClassQuery=GetDrugList";
		...
		var DrugInfoStoreUrl = "../csp/dhc.bdp.ext.querydatatrans.csp?pClassName=web.DHCBL.CT.INCItmTar&pClassQuery=GetARCIMList";
		//单位TARIUOM
		...
		var AliasStoreUrl = "../csp/dhc.bdp.ext.querydatatrans.csp?pClassName=web.DHCBL.CT.INCItmTar&pClassQuery=GetAlias";
		var Alias_SAVE_ACTION_URL = "../csp/dhc.bdp.ext.entitydatatrans.csp?pClassName=web.DHCBL.CT.INCItmTar&pClassMethod=SaveTaritemAliasEntity&pEntityName=web.Entity.CT.DHCTarItemAlias";
		var ALIAS_DELETE_ACTION_URL= "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.CT.INCItmTar&pClassMethod=DeleteTarAlias";
		var PriceStoreUrl = "../csp/dhc.bdp.ext.querydatatrans.csp?pClassName=web.DHCBL.CT.INCItmTar&pClassQuery=FindTarPrice";
	 	var Price_SAVE_ACTION_URL = "../csp/dhc.bdp.ext.entitydatatrans.csp?pClassName=web.DHCBL.CT.INCItmTar&pClassMethod=SaveTarItemPriceEntity&pEntityName=web.Entity.CT.DHCTarItemPrice";
		//患者费别TPPatInsType
		...
		var OPEN_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.CT.INCItmTar&pClassMethod=OpenData";
    	var SAVE_ACTION_URL = "../csp/dhc.bdp.ext.entitydatatrans.csp?pClassName=web.DHCBL.CT.INCItmTar&pClassMethod=SaveTariEntity&pEntityName=web.Entity.CT.DHCTarItem1";
...
//============================查询条件=========================================================================	
	...
	Ext.apply(Ext.form.VTypes, {										   
	   ...
	   var rowid =tkMakeServerCall("web.DHCBL.CT.INCItmTar","GetChgTypeID","加成收费");
...
*/	    
		...
		var UpdateDate = new Ext.BDP.FunLib.Component.BaseComboBox({
							fieldLabel : '修改时间',
							id : 'UpdateDate',
							mode : 'local',
	...
	var DrugInfoToolbar = new Ext.PagingToolbar({
		...
		var ClearBT = new Ext.Toolbar.Button({
			...
			handler : function() {
				...
				/*DrugInfoToolbar.updateInfo();
              DrugInfoToolbar.afterTextEl.el.innerHTML = String.format("共 {0} 页", 1);
              DrugInfoToolbar.first.setDisabled(true);
              DrugInfoToolbar.prev.setDisabled(true);
              DrugInfoToolbar.next.setDisabled(true);
              DrugInfoToolbar.last.setDisabled(true);
              DrugInfoToolbar.loading.disable();*/
...
var AliasGrid = new Ext.grid.GridPanel({
		...
		buttons : [{
			...
			handler : function() { 
				...
				if((TPStartDate!="")&&(TPStartDate!=null)){
					if(TPStartDate<new Date().format(BDPDateFormat)){
	...
	*/
	...
	var DVTPPatInsType = new Ext.BDP.Component.form.ComboBox({
							fieldLabel : '患者费别',
		 					pageSize : Ext.BDP.FunLib.PageSize.Combo,
							emptyText:'',
							id:'DVTPPatInsType1',
							listWidth : 250,
							hiddenName : 'DVTPPatInsType',
							store : new Ext.data.Store({
										proxy : new Ext.data.HttpProxy({ url : PACAdmReason_QUERY_ACTION_URL }),
										reader : new Ext.data.JsonReader({
										totalProperty : 'total',
	...
	var DV_OPEN_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.CT.INCItmTar&pClassMethod=GetDefaultValue";
   	var DV_SAVE_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.CT.INCItmTar&pClassMethod=SaveDefaultValue";
	...
	var DVWinForm = new Ext.FormPanel({
				...
				waitMsgTarget : true,
       			reader: new Ext.data.JsonReader({root:'list'},
                                        [{name: 'DVTARISubCate',mapping:'DVTARISubCate'},
                                         ...
                                         {name: 'DVTPPatInsType',mapping:'DVTPPatInsType'}
                                        ]),
				defaults : {
					anchor : '85%',
					bosrder : false
				...
				//defaultType : 'textfield',
				items : [DVTARISubCate, DVTARIAcctCate,DVTARIInpatCate,DVTARIOutpatCate,DVTARIEMCCate,DVTARIMCNew,DVTPPatInsType]	  //DVTARIMRCate,
	});
...
var DHCTarItemPanel = new Ext.form.FormPanel({
	...
	items : [{
			...
			items : [{
						...
						xtype:'fieldset',
						defaults: {width:155},
						items : [TARICode,TARIInsuName,TARIUOM,TARISubCate,TARIInpatCate,TARIEMCCate,TARIChargeBasis,TARIStartDate,TARIEndDate,TARIRowId,OLTRowId]  //,TARIPrice,TARIAlterPrice2]
					},{
						columnWidth : 0.5,
						xtype:'fieldset',
						defaults: {width:155},
						items : [TARIDesc,TARIExternalCode,TARIActiveFlag,TARIAcctCate,TARIOutpatCate,TARIMCNew,TARISpecialFlag,TARIEngName,ARCIMRowId,OLTARCIMDR]  //,TariExpPrintName,TARIAlterPrice1,TARIMRCate
					}]
	...
	///点击grid某一单元格时
     ...
     var ADD_OPEN_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.CT.INCItmTar&pClassMethod=AddOpenData";
        	...
        	else   ///清空所有数据 并获取添加时默认值
        	{
            	...
            	Ext.getCmp("TARIPanel").getForm().load( {
                	...
                	//waitMsg : '正在载入数据...',
                		...
                		Ext.getCmp('TARIDesc').setValue(_record.get('ARCIMDesc')); //北京同仁医院  "【"+ +"】"
		...
		var HisListTab = new Ext.form.FormPanel({
			...
			items:[{
				...
				items : [{ 				
	            	...
	            	xtype: 'fieldset',
	            	defaults: {anchor : '85%'},
	            	items: [ARCIM_Code,ARCIM_Desc,ALIAS_Text,ARCIM_ChargeLinkFlag,UpdateDate] //INFO_ChargeType
				}, {
					columnWidth: 0.45,
	            	xtype: 'fieldset',
	            	defaults: {anchor : '85%'},
