...
Ext.onReady(function() {
	...
	var AliasGrid = new Ext.BDP.grid.AliasEditorGridPanel({
		TableN : "ORC_ReasonOTNotAvail"
	});
	Ext.BLANK_IMAGE_URL = '../scripts_lib/ext3.2.1/resources/images/default/s.gif';
	
	var ACTION_URL = "../csp/dhc.bdp.ext.querydatatrans.csp?pClassName=web.DHCBL.CT.ORCReasonOTNotAvail&pClassQuery=GetList";
	var OPEN_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.CT.ORCReasonOTNotAvail&pClassMethod=OpenData";
	var SAVE_ACTION_URL = "../csp/dhc.bdp.ext.entitydatatrans.csp?pClassName=web.DHCBL.CT.ORCReasonOTNotAvail&pClassMethod=SaveEntity&pEntityName=web.Entity.CT.ORCReasonOTNotAvail";
	var DELETE_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.CT.ORCReasonOTNotAvail&pClassMethod=DeleteData";
	
	var pagesize = Ext.BDP.FunLib.PageSize.Main;
	/********排序*******/
    Ext.BDP.FunLib.SortTableName = "User.ORCReasonOTNotAvail";
    var btnSort = Ext.BDP.FunLib.SortBtn;
    //-----------------翻译开始--------//	
	Ext.BDP.FunLib.TableName="ORC_ReasonOTNotAvail"
	...
	var WinForm = new Ext.FormPanel({
				...
				items : [{
							...
							id:'RNAVCode',
							maxLength:15,
							//disabled : Ext.BDP.FunLib.Component.DisableFlag('RNAVCode'),
							readOnly : Ext.BDP.FunLib.Component.DisableFlag('RNAVCode'),
							style:Ext.BDP.FunLib.ReadonlyStyle(Ext.BDP.FunLib.Component.DisableFlag('RNAVCode')),
							name : 'RNAVCode',
							allowBlank:false,
                            ...
                            validator : function(thisText){
	                            ...
	                            var className =  "web.DHCBL.CT.ORCReasonOTNotAvail";
							...
							id:'RNAVDesc',
							maxLength:220,
							//disabled : Ext.BDP.FunLib.Component.DisableFlag('RNAVDesc'),
							readOnly : Ext.BDP.FunLib.Component.DisableFlag('RNAVDesc'),
							style:Ext.BDP.FunLib.ReadonlyStyle(Ext.BDP.FunLib.Component.DisableFlag('RNAVDesc')),
							name : 'RNAVDesc',
							allowBlank:false,
							validationEvent : 'blur',
							enableKeyEvents:true, 
    ...
    var loadFormData = function(grid) {
        ...
        if (!_record) {
            ...
            WinForm.form.load( {
                url : OPEN_ACTION_URL + '&id='+ _record.get('RNAVRowId'),
                //waitMsg : '正在载入数据...',
                success : function(form,action) {
