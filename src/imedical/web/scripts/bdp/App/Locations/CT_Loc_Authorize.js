...
Ext.onReady(function() {
    ...
    Ext.QuickTips.init();
	var Tree_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.Authorize.CTLocAut&pClassMethod=GetTreeJson";
	var myTree = new Ext.BDP.Component.DataAutPanel({
        ...
        isCascade : true,   //级联
        AutClass : "web.DHCBL.Authorize.CTLocAut", //获取授权数据类名称
