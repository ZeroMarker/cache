   ...
   if (gridBedTypeFee.selModel.hasSelection()) {
    ...
    var ds = new Ext.data.Store({
                ...
                reader : new Ext.data.JsonReader({
                            ...
                            name: 'BEDTPIMomBedTypeDR',
                            mapping:'BEDTPIMomBedTypeDR',
                            type:'string'
                        }    
                    ]) 
            });
                                        ...
                                        Ext.Msg.show({
                                            ...
                                            fn : function(btn) {
                                                 ...
                                                 params : {
															...
															hospid:Ext.getCmp("hidden_HOSPDR").getValue() ,
                                                            start : startIndex,
                                                            limit : limit
                                                           }
                                                       });
    ...
    var BEDTPIARCIMDR =new Ext.BDP.Component.form.ComboBox({    
 	...
 	///床位费时制
   var BEDTPIFeeTime =new Ext.BDP.Component.form.ComboBox({    
        fieldLabel: "床位费时制",
        name: 'BEDTPIFeeTime',
        id:'BEDTPIFeeTimeF',
        disabled : Ext.BDP.FunLib.Component.DisableFlag('BEDTPIFeeTimeF'),
        hiddenName:'BEDTPIFeeTime',//不能与id相同
        forceSelection: true,
        queryParam:"desc",
        triggerAction : 'all',
        selectOnFocus:false,
    ...
    var BEDTPIMomBedTypeDR =new Ext.BDP.Component.form.ComboBox({    
        fieldLabel: "母亲床位类型",
        name: 'BEDTPIMomBedTypeDR',
        id:'BEDTPIMomBedTypeDRF',
        disabled : Ext.BDP.FunLib.Component.DisableFlag('BEDTPIMomBedTypeDRF'),
        hiddenName:'BEDTPIMomBedTypeDR',//不能与id相同
        forceSelection: true,
        queryParam:"desc",
        triggerAction : 'all',
        selectOnFocus:false,
        ...
        store:new Ext.data.JsonStore({
            url:BedType_ACTION_URL,
            root: 'data',
            totalProperty: 'total',
            idProperty: 'BEDTPRowId',
            fields:['BEDTPRowId','BEDTPDesc'],
            remoteSort: true,
            sortInfo: {field: 'BEDTPRowId', direction: 'ASC'}
        }),
		listeners:{
			'beforequery': function(e){
				this.store.baseParams = {
    ...
    var WinForm = new Ext.form.FormPanel({
                ...
                items : [{
                        ...
                        }, 
						{
						   ...
						   hideLabel : 'True',
						   hidden : true
						},BEDTPIFeeType,BEDTPIARCIMDR,BEDTPIFeeTime,BEDTPIAdmReasonDR,
						{
								fieldLabel : '开始年龄',
								xtype:'numberfield',
								id:'BEDTPIStartAge',
						...
						DateFromText,DateToText,BEDTPIMomBedTypeDR
    ...
    var winBedTypeFee = new Ext.Window({
        ...
        listeners : {
            'show' : function() {
                ...
                if (rows[0].get('BEDTPCode')=="MATERNALBABY")
				{
					Ext.getCmp('BEDTPIMomBedTypeDRF').enable();
				}
				else
				{
					Ext.getCmp('BEDTPIMomBedTypeDRF').disable();
				}
            },
            "hide" : function(){
                            ...
                            new Ext.Button({ iconCls : 'icon-refresh',
                                                ...
                                                handler : function() {
                                                  Ext.getCmp("TextFeeType").reset();                        //-----------将输入框清空
                                                    ...
                                                    var gsm = Ext.getCmp("grid").getSelectionModel();// 获取选择列
                                                    var rows = gsm.getSelections();// 根据选择列获取到所有的行
                                                    gridBedTypeFee.getStore().baseParams={ ParRef: rows[0].get('BEDTPRowId'),hospid:Ext.getCmp("hidden_HOSPDR").getValue() };
