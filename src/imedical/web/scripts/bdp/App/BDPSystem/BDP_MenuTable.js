...
Ext.onReady(function(){
	...
	var EXECUTABLE_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.BDP.BDPMenuConstract&pClassMethod=GetExecutableTreeJson";	
	...
	var AutCode =""
	var url = "dhc.bdp.ext.default.csp?extfilename=/App/BDPSystem/BDPMenuTable_Contrast";
    ...
    var addtab = function(node){
	    	...
	    	if (obj){
	    		...
	    		var AutCode = node.attributes.myCode;
				var url1 = "dhc.bdp.ext.default.csp?extfilename=/App/BDPSystem/BDPMenuTable_Contrast"+"&ObjectType="+ObjectType+"&ObjectReference="+ObjectReference+"&AutCode="+AutCode;
				if ('undefined'!==typeof websys_getMWToken)
				{
