 ...
 * @Title: 基础数据平台-菜单授权
 * @Author: 蔡昊哲 DHC-BDP
 * @Description: 用于用户、科室、安全组的菜单授权。
 * @Created on 2013-5-6
 * @Updated on 2013-5-14 by lisen
 * @LastUpdated on 2013-5-31 by chz(修复BUG)
 */

    var htmlurl = "../scripts/bdp/AppHelp/BDPSystem/BDPAuthorize_Menu/BDPAuthorize_Menu.htm";
	document.write('<script type="text/javascript" src="../scripts/bdp/Framework/scripts/HtmlHelp.js"> </script>');
	
/**----------------------------------调用附属JS--------------------------------------**/		
	var BDPMenuJS = '../scripts/bdp/App/BDPSystem/BDPMenuAuthorize.js';		//菜单授权部分
