...
Ext.onReady(function() {
    ...
    Ext.QuickTips.init();
	var Tree_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.Authorize.INCStkBin&pClassMethod=GetTreeJson";
	...
	var myTree = new Ext.BDP.Component.DataAutPanel({
		        ...
		        AutClass : "web.DHCBL.Authorize.INCStkBin", //获取授权数据类名称
