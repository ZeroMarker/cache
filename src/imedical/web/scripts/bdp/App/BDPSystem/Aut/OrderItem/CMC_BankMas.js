...
Ext.onReady(function() {
    ...
    Ext.QuickTips.init();
	var Tree_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.Authorize.CMCBankMas&pClassMethod=GetTreeJson";
	...
	var myTree = new Ext.BDP.Component.DataAutPanel({
		        ...
		        AutClass : "web.DHCBL.Authorize.CMCBankMas", //获取授权数据类名称
