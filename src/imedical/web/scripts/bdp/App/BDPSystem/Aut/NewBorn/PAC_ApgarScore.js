 ...
 * @Title: 基础数据平台-基础数据
 * @Author: 孙凤超 DHC-BDP
 * @Description: 用于新生儿评分（阿氏评分)的数据授权维护。
...
Ext.onReady(function() {
    ...
    Ext.QuickTips.init();
	var Tree_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.Authorize.PACApgarScore&pClassMethod=GetTreeJson";
	...
	var myTree = new Ext.BDP.Component.DataAutPanel({
		        ...
		        AutClass : "web.DHCBL.Authorize.PACApgarScore", //获取授权数据类名称
