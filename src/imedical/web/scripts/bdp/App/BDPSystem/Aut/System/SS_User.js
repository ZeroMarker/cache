...
Ext.onReady(function() {
    ...
    Ext.QuickTips.init();
	var Tree_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.Authorize.SSUser&pClassMethod=GetTreeJson";
	var pagesize = 10;
	...
	var myTree = new Ext.BDP.Component.DataAutPanel({
        ...
        isCascade : true,   //级联
        AutClass : "web.DHCBL.Authorize.SSUser", //获取授权数据类名称
