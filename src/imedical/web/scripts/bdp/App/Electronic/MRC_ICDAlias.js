...
Ext.BDP.grid.AliasEditorGridPanel = Ext.extend(Ext.grid.EditorGridPanel,{
	...
	ALIAS_QUERY_ACTION_URL : "../csp/dhc.bdp.ext.querydatatrans.csp?pClassName=web.DHCBL.CT.MRCICDAlias&pClassQuery=GetList",
	ALIAS_DELETE_ACTION_URL : "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.CT.MRCICDAlias&pClassMethod=DeleteData",
	ALIAS_SAVE_ACTION_URL : "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.CT.MRCICDAlias&pClassMethod=SaveAll",
    ...
    validate : function(ed, value, startValue){
    	...
    	for(var i=0; i<this.store.getCount(); i++){
    		...
    		if(tmpRec.data["ALIASText"]==value){
    			...
    			this.store.getAt(i).data["ALIASText"].reset();
    			break;
    		}
    	}
    	return ;
