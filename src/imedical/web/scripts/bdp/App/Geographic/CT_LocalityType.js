...
Ext.onReady(function() {
    ...
    /// 调用街道/乡镇的后台类方法
	//var QUERY_ACTION_URL = "../csp/dhc.bdp.ext.querydatatrans.csp?pClassName=web.DHCBL.CT.CTLocalityType&pClassQuery=GetList"; 
	var QUERY_ACTION_URL ="../csp/dhc.bdp.ext.jsondatatrans.csp?pClassName=web.DHCBL.CT.CTLocalityType&pClassMethod=GetList";
    var SAVE_ACTION_URL = "../csp/dhc.bdp.ext.entitydatatrans.csp?pClassName=web.DHCBL.CT.CTLocalityType&pClassMethod=SaveEntity&pEntityName=web.Entity.CT.CTLocalityType";
	var OPEN_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.CT.CTLocalityType&pClassMethod=OpenData";
	var DELETE_ACTION_URL = "../csp/dhc.bdp.ext.datatrans.csp?pClassName=web.DHCBL.CT.CTLocalityType&pClassMethod=DeleteData";
	/// 城市区域
	...
	var combopage=Ext.BDP.FunLib.PageSize.Combo  
     ...
     var AliasGrid = new Ext.BDP.grid.AliasEditorGridPanel({
      TableN : "CT_LocalityType"
  });
	 Ext.BDP.FunLib.TableName="CT_LocalityType"
     ...
     /*************************************排序*********************************/
    Ext.BDP.FunLib.SortTableName = "User.CTLocalityType";
	...
	var WinForm = new Ext.form.FormPanel({
				...
				items : [{
                            ...
                            validator : function(thisText){
	                            ...
	                            var className =  "web.DHCBL.CT.CTLocalityType";  
  ...
  Ext.BDP.AddTabpanelFun(tabs,Ext.BDP.FunLib.TableName);
	 ...
	 var btnSearch = new Ext.Button({
				...
				handler : function() {
					grid.getStore().baseParams={			
							...
							cityareacode : Ext.getCmp("TextLOCTYPENationalCode").getValue()
					};
					grid.getStore().load({
						params : {
							start : 0,
	...
	var btnRefresh = new Ext.Button({
				...
				handler : function() {
					...
					Ext.getCmp("TextLOCTYPENationalCode").reset();
					grid.getStore().baseParams={};
					grid.getStore().load({
							params : {
								    	 start : 0,
	...
	var tb = new Ext.Toolbar({
				...
				items : ['代码', {
						...
						'所属区域',{
							...
							id :'TextLOCTYPENationalCode',
							disabled : Ext.BDP.FunLib.Component.DisableFlag('TextLOCTYPENationalCode'),
							store : new Ext.data.Store({
										autoLoad: true,
										proxy : new Ext.data.HttpProxy({ url : CITYAREA_QUERY_ACTION }),
										reader : new Ext.data.JsonReader({
    ...
    Ext.BDP.AddColumnFun(grid,"CT_LocalityType",GridCM);  
