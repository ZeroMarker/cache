...
Ext.BDP.Component.tree.TreePanel = Ext.extend(Ext.tree.TreePanel, {
			...
			this.tbar = new Ext.Toolbar({
					items : [{
						...
						handler : function(){
							...
							if(this.AutCode=="CT_CarPrvTp"){
					    		Ext.getCmp('TextInternalType').setValue('');
					    	}
					    	if(this.AutCode=="SS_User"){
					    		Ext.getCmp('DefDeptDR').setValue('');
					    		Ext.getCmp('SSGRP').setValue('');
					    		Ext.getCmp('careprovtype').setValue('');
					    	}
					    	if(this.AutCode=="CT_CareProv"){
					    		Ext.getCmp('CarePrvTp').setValue('');
					    	    Ext.getCmp('ActiveFlag').setValue('');
					    	}
					    	if(this.AutCode=="CT_Loc"){
					    		Ext.getCmp('LOCType').setValue('');
					    		Ext.getCmp('DepDR').setValue('');
					    	}
					    	if(this.AutCode=="CT_PayMode"){
					    		Ext.getCmp('TextGrpCode').setValue('');
					    	}
					    	if(this.AutCode=="OEC_OrderCategory"){
					    		Ext.getCmp('OCGRPRowId').setValue('');
					    	}
					    	if(this.AutCode=="ARC_ItemCat"){
					    		Ext.getCmp('OrderType').setValue('');
					    		Ext.getCmp('ordcatText').setValue('');
					    	}
					    	if(this.AutCode=="PAC_OutcomeOfPregnancy"){
					    		Ext.getCmp('OutcomeType').setValue('');
					    	}
							if(this.AutCode=="PAC_EpisodeSubType"){
					    		Ext.getCmp('AdmType').setValue('');
					    	}
					    	if(this.AutCode=="PAC_AdmSource"){
					    		Ext.getCmp('EpisodeType').setValue('');
					    	}
					    	if(this.AutCode=="CT_Country"){
					    		Ext.getCmp('active').setValue('');
					    	}
					    	if(this.AutCode=="CT_Province"){
					    		Ext.getCmp('regiondr').setValue('');
					    	}
					    	if(this.AutCode=="CT_City"){
					    		Ext.getCmp('provincedr').setValue('');
					    	}
					    	if(this.AutCode=="CT_CityArea"){
					    		Ext.getCmp('citydr').setValue('');
					    	}
					    	if(this.AutCode=="MRC_AllType"){
					    		Ext.getCmp('TagDescription').setValue('');
					    	}
					    	if(this.AutCode=="ORC_Operation"){
					    		Ext.getCmp("TextICD9").reset();
					    		Ext.getCmp("TextICD10").reset();
					    	}
					    	if(this.AutCode=="MRC_ICDDx"){
					    		Ext.getCmp("TextICD10").reset();
					    	}
					    	if(this.AutCode=="PHC_Instruc"){
					    		Ext.getCmp('ForeignDesc').reset();
					    	}
					    	if(this.AutCode=="PHC_Freq"){
    ...
    doQuery : function(){
    	...
    	if(this.AutCode=="CT_CarPrvTp"){
    		var v=Ext.getCmp('TreeSearchText').getValue()+"^"+Ext.getCmp('TextInternalType').getValue();
    	}
    	else if(this.AutCode=="SS_User"){
    		var v=Ext.getCmp('TreeSearchText').getValue()+"^"+Ext.getCmp('DefDeptDR').getValue()+"^"+Ext.getCmp('SSGRP').getValue()+"^"+Ext.getCmp('careprovtype').getValue();
    	}
    	else if(this.AutCode=="CT_CareProv"){
    		var v=Ext.getCmp('TreeSearchText').getValue()+"^"+Ext.getCmp('CarePrvTp').getValue()+"^"+Ext.getCmp('ActiveFlag').getValue();
    	}
    	else if(this.AutCode=="CT_Loc"){
    		var v=Ext.getCmp('TreeSearchText').getValue()+"^"+Ext.getCmp('LOCType').getValue()+"^"+Ext.getCmp('DepDR').getValue();
    	}
    	else if(this.AutCode=="CT_PayMode"){
    		var v=Ext.getCmp('TreeSearchText').getValue()+"^"+Ext.getCmp('TextGrpCode').getValue();
    	}
    	else if(this.AutCode=="OEC_OrderCategory"){
    		var v=Ext.getCmp('TreeSearchText').getValue()+"^"+Ext.getCmp('OCGRPRowId').getValue();
    	}
    	else if(this.AutCode=="ARC_ItemCat"){
    		var v=Ext.getCmp('TreeSearchText').getValue()+"^"+Ext.getCmp('OrderType').getValue()+"^"+Ext.getCmp('ordcatText').getValue();
    	}
    	else if(this.AutCode=="PAC_OutcomeOfPregnancy"){
    		var v=Ext.getCmp('TreeSearchText').getValue()+"^"+Ext.getCmp('OutcomeType').getValue();
    	}
    	else if(this.AutCode=="PAC_EpisodeSubType"){
    		 var v=Ext.getCmp('TreeSearchText').getValue()+"^"+Ext.getCmp('AdmType').getValue();
    	}
    	else if(this.AutCode=="PAC_AdmSource"){
    		 var v=Ext.getCmp('TreeSearchText').getValue()+"^"+Ext.getCmp('EpisodeType').getValue();
    	}
    	else if(this.AutCode=="CT_Country"){
    		 var v=Ext.getCmp('TreeSearchText').getValue()+"^"+Ext.getCmp('active').getValue();
		}
		else if(this.AutCode=="CT_Province"){
    		 var v=Ext.getCmp('TreeSearchText').getValue()+"^"+Ext.getCmp('regiondr').getValue();
		}
		else if(this.AutCode=="CT_City"){
    		 var v=Ext.getCmp('TreeSearchText').getValue()+"^"+Ext.getCmp('provincedr').getValue();
		}
		else if(this.AutCode=="CT_CityArea"){
    		 var v=Ext.getCmp('TreeSearchText').getValue()+"^"+Ext.getCmp('citydr').getValue();
		}
		else if(this.AutCode=="MRC_AllType"){
    		 var v=Ext.getCmp('TreeSearchText').getValue()+"^"+Ext.getCmp('TagDescription').getValue();
		}
		else if(this.AutCode=="ORC_Operation"){
    		 var v=Ext.getCmp('TreeSearchText').getValue()+"^"+Ext.getCmp('TextICD10').getValue()+"^"+Ext.getCmp('TextICD9').getValue();
		}
		else if(this.AutCode=="MRC_ICDDx"){
    		 var v=Ext.getCmp('TreeSearchText').getValue()+"^"+Ext.getCmp('TextICD10').getValue();
		}
		else if(this.AutCode=="PHC_Instruc"){
    		 var v=Ext.getCmp('TreeSearchText').getValue()+"^"+Ext.getCmp('ForeignDesc').getValue();
		}
		else if(this.AutCode=="PHC_Freq"){
    		 var v=Ext.getCmp('TreeSearchText').getValue()+"^"+Ext.getCmp('TextDesc2').getValue()+"^"+Ext.getCmp('TextFactor').getValue();
		}
    ...
    saveAuthorizeData : function(){
		...
		if(AutJson!=""){
				...
				var flagLimited = DataAut.limited;
				arrTrue = DataAut.IDS;
				var flag;
		...
		str = "["+str+"]";
		var strAut = "{limited:" + flagLimited + ",IDS:" + str + "}";
		//保存改动后的数据
		rtn = tkMakeServerCall(this.saveAutClass,this.saveAutMethod,this.ObjectType,this.ObjectReference,strAut,this.AutCode);
		var rtn = rtn.replace(/\r\n/g,"");
		...
		Ext.Ajax.request({
			url: this.saveAutURL,
			params: {ObjectType:this.ObjectType,ObjectReference:this.ObjectReference,Data:str},
...
Ext.BDP.Component.DataAutPanel = Ext.extend(Ext.Panel, {
						...
						items:[{
					            ...
					            listeners : {
					            	'afterrender' : function(com){
					            		...
					            		var domRadioLable3 = Ext.getCmp('radioLimit2').getEl().dom.parentNode.lastChild;
					            		...
					            		domRadioLable3.setAttribute('ext:qtip','仅可以访问该角色登录科室的数据。');
					            		...
					            		var AutJson = tkMakeServerCall(this.AutClass,this.getAutMethod,this.ObjectType,this.ObjectReference,this.AutCode);
										if(AutJson!=""){
											//增加转换，以让Ext解析器能正常识别。
											//AutJson = AutJson.replace(/:/ig,":'");
											//AutJson = AutJson.replace(/}/ig,"'}");
											
											var AutData = Ext.decode(AutJson);
											var flagLimited = AutData.limited;
											...
											if(flagLimited=='2'){ //登录角色医院 默认
												Ext.getCmp('radioLimit2').setValue(true);
   ...
   radioOnCheck : function(com, checked){
		...
		if(AutJson!=""){
			...
			var AutData = Ext.decode(AutJson);
			var flagLimited = AutData.limited;
			if(typeof(flagLimited)=='undefined'){ //没有受限节点limited
				var strIDS = AutJson;
			}else{
				var strIDS = Ext.encode(AutData.IDS);
			}
		}else{
			var strIDS = "[]";
		}
            ...
            if (flagLimited!=lmd)   //radio发生改变
            {
                ...
                if(changedflag==1)  
                {
                    if(com.id!='radioLimit4'){   //非未授权状态
                        var str = "{limited:" + lmd + ",IDS:" + strIDS + "}";
						str = str.replace(/\"/g, "");
						//保存改动后的数据
						var rtn = tkMakeServerCall(this.AutClass,this.saveAutMethod,this.ObjectType,this.ObjectReference,str,this.AutCode);
    ...
    setShowState : function(v){
    	...
    	{
    		comShowState.setText('<img style="width:12px;height:12px;" src="'+ Ext.BDP.FunLib.Path.URL_Icon +'stop.png" />'
    						+ '<font style="color:red;">仅可以访问该角色登录科室的数据。</font>');
    	}
    	if(v=='3'){
