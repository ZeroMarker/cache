...
///	Creator:  sunfengchao/chenying 徐 凯
///	CreateDate: 2018-04-04 2021.10-22
URL_Icon = "../scripts/bdp/Framework/icons/";   //图标基本路径 
var init = function(){
	...
	function searchData(){
        ...
        var OperateType= $('#OperateTypeD').combobox('getValue');
         ...
         $('#mygrid').datagrid('load', {
	        ClassName:"web.DHCBL.MKB.MKBDataChangeLog",
            QueryName:"GetList",
            fuzzyserch:fuzzyserch,
            classname:ClassName,
    ...
    { 
         ...
         var date=tkMakeServerCall("web.DHCBL.MKB.MKBDataChangeLog","GetDefaultDate");
	...
	$HUI.combobox("#OperateTypeD",{
      ...
      function Viewlogdetail()
     {
            ...
            {    
                ...
                {  
                    var link="dhc.bdp.mkb.mkbdatachangelogwin.csp?actiontype=datadetail&id="+rows.ID;
     ...
     $("#btnloglife").click(function (e) { 
         var rows = $("#mygrid").datagrid("getSelected"); 
            ...
            {   
              ...
              var link="dhc.bdp.mkb.mkbdatachangelogwin.csp?actiontype=timeline&ClassN="+ClassNameDesc  +"&OBJDESC="+objrowid+"&ObjectDesc="+objdesc;
              if ('undefined'!==typeof websys_getMWToken){
                    link += "&MWToken="+websys_getMWToken()
                }
      ...
      var columns =[[  
                  ...
                  {field:'OperateType',title:'操作类型',width:80,
	                  formatter:function(v,row,index){
                                if(v=='U'){return "<img src='"+URL_Icon +"update.gif''>"+"   修改";}
                                if(v=='D'){return "<img src='"+URL_Icon +"delete.gif''>"+"   删除";}
                                if(v=='A'){return "<img src='"+URL_Icon +"add.gif''>"+"   添加";}
						}}, 
    ...
    $('#mygrid').datagrid({ 
            ...
            queryParams:{
        		...
        		page: 1,
        		rows: 100}, 
            ClassTableName:'User.MKBDataChangeLog',
			SQLTableName:'MKB_DataChangeLog',
            idField:'ID',
            dataType: 'json',
            fixRowNumber:true, //行号 自适应宽度
