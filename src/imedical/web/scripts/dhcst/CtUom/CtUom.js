...
var CtUomGrid="";
//配置数据源
var CtUomGridUrl = 'dhcst.ctuomaction.csp';
...
var CTUomStore = new Ext.data.Store({
	proxy : new Ext.data.HttpProxy({url : 'dhcst.drugutil.csp?actiontype=CTUom',method:'POST'}),
	reader : new Ext.data.JsonReader({
		totalProperty : "results",
		root : 'rows'
	}, ['Description', 'RowId'])
...
//	ds.proxy=new Ext.data.HttpProxy({url : 'dhcst.drugutil.csp?actiontype=CTUom&start=0&limit=999&CTUomDesc='+Ext.getCmp('CtUomCon').getRawValue(),method:'GET'});
//});
...
//配置数据源
var CtUomConFacGridUrl = 'dhcst.ctuomaction.csp';
