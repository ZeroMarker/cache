...
function menuOperation(value,row,index)
 {
	...
	var url='dhceqcsysgroupmenu.csp?'+str;
	if ('function'==typeof websys_getMWToken){		//czf 2023-02-14 token启用参数传递
		url += "&MWToken="+websys_getMWToken()
	}
	var btn='<A onclick="window.open(&quot;'+url+'&quot;)" href="#"><img border=0 complete="complete" src="../scripts/dhceq/easyui/themes/icons/detail.png" /></A>' /// Modfied by zc 2015-07-27 ZC0026 
	return btn;
 }
