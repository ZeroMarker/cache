...
function btnFind_onclick()
{
	...
	var lnk="websys.default.csp?WEBSYS.TCOMPONENT=DHC.WMR.Quality.QryMRQuality.List" + "&ExamRule=" +  ExamRule + "&AdmLoc=" + Loc + "&AdmWard=" + Ward + "&AdmDoc=" + Doc + "&DateFrom=" + DateFrom + "&DateTo=" + DateTo;
