        ...
        if(this.fireEvent('beforeedit', this, rowIndex) !== false){
            ...
            for(var i = 0, len = cm.getColumnCount(); i < len; i++){
               ...
               //add by wz .2014-1-20
                ...
                //if (colID=="RptCfg_RowID") RowidValue=val;
                if ((colID=="RptCfg_Code" || colID=="DatasetCfg_Code") && val!=""){
                	if(this.items.items[i].disabled!='undefine') 
                		this.items.items[i].disable();
                }else if ((colID=="RptCfg_Code" || colID=="DatasetCfg_Code") && val==""){
                	if(typeof(this.items.items[i].disabled)!='undefined') 
                		this.items.items[i].enable() ;
                }
            }
