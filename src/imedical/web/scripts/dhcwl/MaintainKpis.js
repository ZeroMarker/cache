...
Ext.onReady(function(){
	...
	dhcwl_mkpi_taskGroupWin=new dhcwl.mkpi.MaintainKpiTasksGroup();
	...
	dhcwl_mkpi_maintain.mainTabs.add(dhcwl_mkpi_taskGroupWin.getTaskPanel());
	...
	dhcwl_mkpi_moduleManager=new dhcwl.mkpi.KpiModuleManager();
	dhcwl_mkpi_maintain.mainTabs.add(dhcwl_mkpi_moduleManager.getModuleManagerPanel());
	//dhcwl_mkpi_maintain.mainTabs.add(new dhcwl.mkpi.KpiModuleManager().getModuleManagerPanel());
	...
	dhcwl_mkpi_maintain.mainTabs.add(new dhcwl.mkpi.SysCfg().GetSysCfgPanel());
