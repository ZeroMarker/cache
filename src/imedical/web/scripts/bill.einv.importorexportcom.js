///bill.einv.importorexportcom.js
var xlApp=null;
var xlBook=null;
var xlsheet=null;
...
function ExcelImport(GlobalDataFlg, UserDr, ClassName, MethodName, ExtStrPam){
	//打开导入的Excel数据
	try {
	...
	try{
		ExcelImportDo(GlobalDataFlg, UserDr, ClassName, MethodName, xlsheet, 2, rows, columns, sucRowNums, errRowNums, ExtStrPam);
	}
	catch(e){
...
function ExcelImportDo(GlobalDataFlg, UserDr, ClassName, MethodName, xlsheet, rowIndex, allrows, allcols, sucnums, errnums, ExtStrPam){
	var rtnRowIndex=0;
	var nextRowIndex=0;
