...
function btnSearch_onClick() 
{
    ...
    var lnk = "websys.default.csp?WEBSYS.TCOMPONENT=DHC.EPR.Quality.VetoReport.List&ALocIDs=" + LocIDs + "&AStartDate=" + StartDate + "&AEndDate=" + EndDate + "&ARuleCodes=" + RuleCodes + "&AIsMultiSummary=" + IsMultiSummary;
...
function btnExport_onClick()
{
    ...
    var flag = ExportDataToExcel("MethodGetServerInfo","MethodGetVetoData","DHCEPRQualityReport02.xls",cArguments);
}
...
function btnPrint_onClick()
{
    ...
    var RuleCodes = getElementValue("ARuleCodes", null);
    var cArguments = LocIDs+"#"+StartDate+"#"+EndDate+"#"+RuleCodes
    var flag = PrintDataByExcel("MethodGetServerInfo","MethodGetVetoData","DHCEPRQualityReport02.xls",cArguments);
}
