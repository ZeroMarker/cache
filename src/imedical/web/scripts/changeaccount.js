...
function initCAAffixDescS()
{
    ...
    $HUI.combogrid('#CAAffixDescS',{   
        ...
        columns:[[
            ...
            {field:'TRowID',title:'全选',width:10},
            {field:'TName',title:'名称',width:150},
            {field:'TProvider',title:'供应商',width:150},
            {field:'TOtherInfo',title:'其他信息',width:150},
