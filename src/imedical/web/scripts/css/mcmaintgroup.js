...
function maintgroupDataGrid_OnClickRow()  
{
     ...
     {     
        ...
        {	
	     ...
	     $('#EquipType').combogrid('setValues',selected.TEquipTypeDR.split(","))//add by zyq 2023-02-06
...
function initdatagridData(){
 ...
 $HUI.datagrid("#maintgroupdatagrid",{   
    ...
    columns:[[
        ...
        {field:'TEquipType',title:'设备类组',width:100,align:'center'},//add by zyq 2023-02-06
        {field:'TEquipTypeDR',title:'EquipTypeDR',width:100,align:'center',hidden:true},
    ...
    pageList:[15,30,45,60,75]   
		...
		$HUI.combogrid('#EquipType',{   //add by zyq 2023-02-07 
	    url:$URL, 
	    queryParams:{
...
/// 新增AddGridData方法
	...
	if (checkMustItemNull()) return
     var MaintGroupInfo="^"+getElementValue("Code")+"^"+getElementValue("Desc")+"^"+getElementValue("Remark")+"^"+getElementValue("UserDR")+"^"+getElementValue("InvalidFlag")+"^"+getElementValue("ManageLocDR")+"^"+$("#EquipType").combobox("getValues")//modify by zyq 2023-02-06
    $.ajax({
...
{
	 if (checkMustItemNull()) return
    	   var MaintGroupInfo=getElementValue("RowID")+"^"+getElementValue("Code")+"^"+getElementValue("Desc")+"^"+getElementValue("Remark")+"^"+getElementValue("UserDR")+"^"+getElementValue("InvalidFlag")+"^"+getElementValue("ManageLocDR")+"^"+$("#EquipType").combobox("getValues")//modify by zyq 2023-02-06
    $.ajax({
            url :"dhceq.jquery.method.csp",
            type:"POST",
            data:{
...
function CleareElement()
{
	...
	setElement("EquipType","")//add by zyq 2023-02-06
}
