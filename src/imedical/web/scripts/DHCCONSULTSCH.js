...
function PrescriptQuery() {
	...
	var Days = 15;
	var PatientID = tkMakeServerCall("User.DHCConsultation", "getPatientID", EpisodeID)
	var presurl = "websys.default.csp?WEBSYS.TCOMPONENT=UDHCPrescriptQueryCM&EpisodeID=" + EpisodeID + "&Days=" + Days + "&mradm=" + mradm + "&loc=" + session['LOGON.CTLOCID']+"&PatientID="+PatientID;
	var window = new Ext.Window({
		title: '中草药处方查询',
		width: 900,
		height: 450,
