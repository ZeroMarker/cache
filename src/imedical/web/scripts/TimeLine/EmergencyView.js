...
function BuildLinkData(record, cateCode,param, gridCellIndex) {
    ...
    //临床评估
        ...
        */
        ...
        return CreateAlingLabel(record.Summary, gridCellIndex);
    }
    else if (cateCode == "10") {
        linkPath += "?" + record.Parameters;
        var summary = record.Summary;
