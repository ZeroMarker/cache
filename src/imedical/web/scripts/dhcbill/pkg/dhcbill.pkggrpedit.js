/**
 * 套餐组维护查询界面JS
 * FileName:dhcbill.pkggrpedit.js
 * DingSH 2019-08-30
 * 版本：V1.0
 * hisui版本:0.1.0
 */
...
function initPkgGrpList() {
	    var loadSuccess = false;
	   
 PkgGrpL= $HUI.datagrid("#pkgGrpList", {
		fit: true,
		striped: true,
		//title: '套餐组列表',
		iconCls: 'icon-paper',
		...
		pagination:true,
		toolbar: '#tToolBar',
		columns: [[ {field: 'PkgG1', title: '套餐组代码', width: 180,
		        editor:{
			        type: 'text',
			        options: {
						 	isKeyupChange: true,
		           ...
		           {field: 'PkgG2', title: '套餐组名称', width: 240,
		             editor:{
			        type: 'text',
			        options: {
						 	isKeyupChange: true,
					...
					{field: 'PkgG3', title: '有效标志', width: 100,
					...
					{field: 'PkgG4', title: '增加日期', width: 100},
					{field: 'PkgG5', title: '增加时间', width: 80},
					{field: 'PkgG6', title: '增加人', width: 100},
					{field: 'PkgG7', title: '修改时间', width: 180},
					{field: 'PkgG8', title: '修改人', width: 100}
				 ]],
		data:[{"PkgG1":"CJ001","PkgG2":"产检套餐","PkgG3":"有效","PkgG4":"2019-08-08","PkgG5":"14:07:56","PkgG6":"DempGrp","PkgG7":"","PkgG8":""},
		      {"PkgG1":"TJ002","PkgG2":"体检套餐","PkgG3":"有效","PkgG4":"2019-08-08","PkgG5":"15:07:56","PkgG6":"DempGrp","PkgG7":"2018-08-09 13:39:00","PkgG8":"Casheir"},
		      {"PkgG1":"VP001","PkgG2":"VIP套餐","PkgG3":"有效","PkgG4":"2019-08-08","PkgG5":"16:07:56","PkgG6":"DempGrp","PkgG7":"","PkgG8":""}
		      ],					
...
function onBeginEditHandler(index, row) {
	var ed = PkgGrpL.getEditor({index: index, field: "PkgG4"});
	if (ed) {
...
function onEndEditHandler(index, row) {
	var ed = PkgGrpL.getEditor({index: index, field: "PkgG2"});
	if (ed) {
		//row.OPOrdItemDesc = $(ed.target).combogrid("getText");
	}
	var ed = PkgGrpL.getEditor({index: index, field: "PkgG3"});
	if (ed) {
...
function InitInsuTypeCmb() {
	...
	$.cm({
		...
		$HUI.combobox("#InsuType").loadData(data);
	});
}
...
function InitInLocRecDg()
{
	...
	$HUI.datagrid("#locrecdg",{
		...
		columns:[[
			...
			{field:'TInsuTypeDesc',title:'医保类型',width:80,align:'center'},
