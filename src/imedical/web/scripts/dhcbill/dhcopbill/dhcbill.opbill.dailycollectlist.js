...
$(function () {
	...
	var columns = [{field: 'ck', checkbox: true},
				   ...
				   {title: '预交金总金额', field: 'TAccPreSum', align: 'right', width: 110},
				   {title: '预交金收款张数', field: 'TNorAccPreNum', width: 110},
				   {title: '预交金收款金额', field: 'TNorAccPreSum', align: 'right', width: 110},
				   {title: '预交金退费张数', field: 'TRefAccPreNum', width: 110},
				   {title: '预交金退费金额', field: 'TRefAccPreSum', align: 'right', width: 110},
				   {title: '发票总张数', field: 'TInvNum', width: 90},
				   {title: '发票总金额', field: 'TInvSum', align: 'right', width: 90},
				   {title: '发票总号段', field: 'TInvNoStr', width: 200, showTip: true},
				   {title: '作废发票张数', field: 'TParkInvNum', width: 100},
				   {title: '作废发票金额', field: 'TParkInvSum', align: 'right', width: 100},
...
function configClick(){
	var url = "websys.query.customisecolumn.csp?CONTEXT=Kweb.DHCOPBillDailyCollect:FindDailyCollect&PREFID=0&PAGENAME=" + page;
	websys_showModal({
		url: url,
		title: '导出配置',
...
/**
* tangzf 2022-10-27
* 通用配置--是否需要预接收   通用配置-门诊收费系统-日报汇总->是否预接收日报
*/
function isNeedPreReceive() {
	...
	var data = $.cm({
		...
		RelaCode: "OPCHRG.OPCshrDRptSum.SFHXRB",
		SourceData: "",
		TgtData: "",
		HospId: GV.hospDR,
		Date: ""
