/**
 * FileName: dhcipbillpatcostinquriy.js
 * Anchor: ZhYW
 * Date: 2018-06-27
 * Description: 科室费用查询
 */
...
$(function () {
	getPatInfoByAdm(GlobalObj.episodeId); //dhcbill.inpatient.banner.csp
	initQueryMenu();
	initOrdItmList();
	initOEItmList();
	initTabs();
...
function initOEItmList() {
	$HUI.datagrid('#oeItmList', {
		...
		pageSize: 15,
		pageList: [15, 20, 25, 30],
		toolbar: [], //为了datagrid距其title有间距
		data: [],
		columns: [[{field: 'TordPrior', title: '医嘱类型', width: 80},
				   {field: 'DateExecuted', title: '执行时间', width: 160},
				   {field: 'Tdoctor', title: '开医嘱人', width: 80},
				   {field: 'OrderStatus', title: '状态', width: 80},
				   {field: 'ctpcp', title: '处理人', width: 80},
				   {field: 'OeoreLoc', title: '开单科室', width: 100},
