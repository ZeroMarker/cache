...
function BodyLoadHandler(){
	...
	if (categoryobj)
	{
		...
		var ARCOSordCat=Ordertable.childNodes[0].childNodes[0].childNodes[1];	
		if (categorywidth!="")
		{
	...
	if (Codeobj)
	{
		...
		var ARCOSCode=Ordertable.childNodes[0].childNodes[0].childNodes[3];
	...
	if (Descobj)
	{
		...
		var ARCOSDesc=document.getElementById("3");
		if (DescWidth!="")
		{
	...
	if (Aliasobj)
	{
		...
		var ARCOSAlias=document.getElementById("10");
	...
	if (csubobj) {
		...
		var ARCOSOrdSubCat=Ordertable.childNodes[0].childNodes[0].childNodes[2];
		if (csuWidth!="")
		{
