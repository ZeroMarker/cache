...
依据平台订单入库
*/
var ImpBySciPoFN = function(Fn) {
	$HUI.dialog('#ImportBySCIPoWin', { width: gWinWidth, height: gWinHeight }).open();
	...
	function SCIPoIngrSave() {
		...
		var Main = JSON.stringify(addSessionParams({ RecLoc: RecLoc, ApcvmDr: Vendor, IngrTypeId: IngrTypeId }));
