var init = function () {
	var panels = [
		{id:'p1',title:'待办列表',height:140,collapsible:true,closable:true,content:"<div><ul id='todolist' style='padding-left:20px'></ul></div>"},
		{id:'p2',title:'供应商资质过期提醒',height:300,collapsible:true,closable:true,content:"<div><ul id='vexp' style='padding-left:20px'></ul></div>"},
	...
	function fillPanel(){
		$.cm({
			...
			if(jsonData.vexpcount>0){
				 $.tmpl(tmplv,jsonData.vexp).appendTo( "#vexp" );
			}
