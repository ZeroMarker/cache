...
(function (global, factory) {
  ...
  var events = {
    bind: function bind() {
      ...
      addListener(viewer, EVENT_DBLCLICK, this.onDblClick = this.dblclick.bind(this));
    ...
    unbind: function unbind() {
      ...
      removeListener(viewer, EVENT_DBLCLICK, this.onDblClick);
  ...
  var methods = {
    ...
    destroy: function destroy() {
      ...
      if (!options.inline) {
        removeListener(element, EVENT_DBLCLICK, this.onStart);
      }
    ...
    createClass(Viewer, [{
      ...
      value: function init() {
        ...
        if (options.inline) {
          ...
          addListener(element, EVENT_DBLCLICK, this.onStart = function (_ref) {
            var target = _ref.target;
