...
function PrintDocument(PrintNum,IndirPrint,TaskName,Title,Head,Foot,Cols,DetailData) {
	...
	var PageHeight=930; //不加单位,默认0.1mm
	...
	/*页尾*/
	LODOP.ADD_PRINT_TEXT(330,1,750,30,Foot);
	LODOP.SET_PRINT_STYLEA(0,"ItemType",1);
	...
	var FootStyleWeight="bold"  //合计行属性（字体加粗normal/bold）
	for (var j = 0; j < colslen; j++){  //循环列
		if(j==1){
			strTableFootP+="<th "+nowrap+" style='border-left:1px solid gray;border-top:1px solid gray;font-size:"+FootFontsize+";font-weight:"+FootStyleWeight+";'><font>本页行数:</font></th>";
			strTableFootT+="<th "+nowrap+" style='border-left:1px solid gray;border-top:1px solid gray;font-size:"+FootFontsize+";font-weight:"+FootStyleWeight+";'><font>总行数:</font></th>";
		}
		else if(j==2){
			strTableFootP+="<th "+nowrap+" style='border-left:1px solid gray;border-top:1px solid gray;font-size:"+FootFontsize+";font-weight:"+FootStyleWeight+";' align='right' tdata='SubCount' format='#'>###</th>";
			strTableFootT+="<th "+nowrap+" style='border-left:1px solid gray;border-top:1px solid gray;font-size:"+FootFontsize+";font-weight:"+FootStyleWeight+";' align='right' tdata='AllCount' format='#'>###</th>";
		}
		else if(Cols[j].sum=="Y"){
			strTableFootP+="<th "+nowrap+" style='border-left:1px solid gray;border-top:1px solid gray;font-size:"+FootFontsize+";font-weight:"+FootStyleWeight+";' align='"+Cols[j].align+"' tdata='SubSum' format='"+Cols[j].format+"'>###</th>";
			strTableFootT+="<th "+nowrap+" style='border-left:1px solid gray;border-top:1px solid gray;font-size:"+FootFontsize+";font-weight:"+FootStyleWeight+";' align='"+Cols[j].align+"' tdata='AllSum' format='"+Cols[j].format+"'>###</th>";
		}
		else{
