...
function GetMaxCode(){
	...
	$UI.linkbutton('#ChoiMaxCodeBT',{
		onClick:function(){
			...
			var StkCat=$('#MaxStkCat').lookup('getValue');
			var StkCatDesc=$('#MaxStkCat').lookup('getText');
	...
	$('#MaxStkGrp').stkscgcombotree({
		onSelect:function(node){
			$('#MaxStkCat').lookup('setValue', '');
			$('#MaxStkCat').lookup('setText', '');
		}
	});
