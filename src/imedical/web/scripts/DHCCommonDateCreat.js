...
//------------------ 样式定义 ---------------------------// 
//功能按钮同样样式 
var s_tiannet_turn_base = "height:16px;font-size:9pt;color:blue;border:0 solid #CCCCCC;cursor:hand;background-color:#ADFF2F;"; 
//翻年、月等的按钮 
...
//日期选择控件体的样式 
var s_tiannet_body = "width:150;background-color:#F0FFFF;display:none;z-index:9998;position:absolute;" + 
...
//字体样式 
var s_tiannet_font = "color:#272727;font-size:9pt;cursor:hand;"; 
//链接的样式 
...
//输出一条横线 
document.write('<tr><td align="right" colspan="10"><div style="'+s_tiannet_line+'"></div></td></tr>'); 
