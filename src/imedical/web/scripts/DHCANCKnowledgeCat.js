...
function BADD_click(){
	...
	var obj=document.getElementById('RepOperKnowledgeCat')
	if(obj) var Rerencmeth=obj.value;
	var repflag=cspRunServerMethod(Rerencmeth,NANCKCCode,NANCKCDesc)
	if(repflag=="Y"){
		alert(t['03'])
		 return;
		}
	var obj=document.getElementById('InsertOperKnowledgeCat')
	if(obj) var encmeth=obj.value;

    if (cspRunServerMethod(encmeth,NANCKCCode,NANCKCDesc)!='0')
		{alert(t['baulk']);
		return;}	
	try {		   
	    alert(t['succeed']);
...
function BUpdate_click(){
	...
	var obj=document.getElementById('UpdateOperKnowledgeCat')
	if(obj) var encmeth=obj.value;
	if (cspRunServerMethod(encmeth,NANCKCRowId,NANCKCCode,NANCKCDesc)!='0')
		{alert(t['baulk']);
		return;}	
	try {		   
	    alert(t['succeed']);
...
function BDelete_click(){
	...
	var obj=document.getElementById('DeleteOperKnowledgeCat')
	if(obj) var encmeth=obj.value;
