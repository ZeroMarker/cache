...
var admdepobj=document.getElementById('COMMUuser1');
...
function Update_click()
{
    ...
    var str=PmpRowidValue+"^"+XQmokuaiValue+"^"+XQzhuangtaiValue+"^"+XQkaifaValue+"^"+PredictTimeValue+"^"+XQchuliguochengValue+"^"+XQzhuangtaiIDValue+"^"+XQmokuaiIDValue+"^"+userId;
    var obj=document.getElementById("lingshi");
    strvalue=obj.value;
    if(strvalue==str){
	    alert(t["8"]);
