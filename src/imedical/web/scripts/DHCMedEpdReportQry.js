...
function BodyLoadHandler() {
	...
	var obj=document.getElementById("btnExcel");//Modified By LiYang 2008-09-28
...
function Query_click() {
    ...
    var cDisease=gGetObjValue("txtDisease");
    if (cStatus==""||cPlace=="") return;
	lnk="websys.default.csp?WEBSYS.TCOMPONENT=DHCMedEpdReportList" + "&DateFrom=" + cDateFrom + "&DateTo=" +cDateTo+ "&Dep=" +cDep+ "&CtLoc=" +cLoc+ "&Status=" +cStatus+ "&Place=" +cPlace+"&Disease=" + cDisease;
...
function btnExcel_click()
{
	...
	var arryResult = QueryTool.RunQuery("web.DHCMedEpidRep","QueryReport",cDateFrom,cDateTo,cDep,cLoc,cStatus,cPlace,cDisease);
	QueryTool.CreateExcelFile(arryResult);
}	
