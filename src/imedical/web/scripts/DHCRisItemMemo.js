...
function Update_click()
{
    ...
    var Info=SelRowid+"^"+ArcItemRowid+"^"+Memo;
...
function Query_click()
{
	...
	location.href="websys.default.csp?WEBSYS.TCOMPONENT=DHCRisItemMemo"+"&Info="+Info;
}
...
function SelectRowHandler()
{
	...
	var objtbl=document.getElementById('tDHCRisItemMemo');
	...
	if (SeleRowidObj)
	{
	    ...
	    var value=cspRunServerMethod(GetMemobyRowidFun,SelRowid);
	    var Memo=ReplaceInfo(value);  
	}
...
{
	var SetDHCRBMemoFun=document.getElementById("SetDHCRBMemoFun").value;
	var value=cspRunServerMethod(SetDHCRBMemoFun,Info,OperateCode);
	if (value!="0")
	{  
	     if(OperateCode=="I")
	     {
	...
	{   
	    ClearData();
		var lnk= "websys.default.csp?WEBSYS.TCOMPONENT=DHCRisItemMemo";
   		location.href=lnk;
