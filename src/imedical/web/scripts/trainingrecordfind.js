...
{ 	initLookUp();
	...
	initButtonWidth();
	//jQuery('#BAdd').on("click", BAdd_Clicked);		MZY0149	3127286		2023-01-09	注释
	defindTitleStyle();
	initDHCEQEquipList();	
...
//add by hyy 2022-1008 2772683 lookupHandle中type为5时调用，返回字符串
function getParam(ID)
{	
	var SourceTypeDRID=Number(getElementValue("SourceTypeDR"))+1;
	SourceTypeDRID = SourceTypeDRID+"";
	if (ID=="EquipTypeDR"){return SourceTypeDRID}
}
