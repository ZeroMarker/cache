...
function setSelectValue(elementID,rowData)
{
    ...
    //modified by wy 2020-9-25 1526393 下拉选择框改变刷新列表下拉
...
function BPrint_Clicked()
{
	...
	if(PrintFlag==1)
	{
        ...
        if(PreviewRptFlag==0)
        { 
        fileName="{DHCEQDisuseRequestPrint.raq(RequestNo="+RequestNo+";RequestLoc="+RequestLoc+";RequestDate="+RequestDate+";UseLoc="+UseLoc+";EquipType="+EquipType+";UseLocCode="+UseLocCode+";HOSPDESC="+HOSPDESC+";EQTitle="+EQTitle+")}"; 
