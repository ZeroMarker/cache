...
this.imgMin = "U814P346T1D1076F6DT20070725145920.gif";
this.imgMax = "U814P346T1D1076F352DT20070725145920.gif";
} 
...
create : function (){
   ...
   sBtn.style.cssText='position:absolute;\
        ...
        height:15px;\
        \
        background-image:url("U814P346T1D1076F6DT20070725145920.gif");';
   ...
   btn.style.cssText='position:absolute;\
        ...
        height:15px;\
        \
        background-image:url("U814P346T1D1076F354DT20070725152720.gif");';
