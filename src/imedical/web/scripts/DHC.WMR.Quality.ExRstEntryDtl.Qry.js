...
function btnFind_onclick()
{
	...
	var lnk="websys.default.csp?WEBSYS.TCOMPONENT=DHC.WMR.Quality.ExRstEntryDtl.List" + "&DateFrom=" + DateFrom + "&DateTo=" + DateTo + "&ExamRule=" +  ExamRule + "&IsActive=Y&ExamType=" + ExamType + "&Loc=" + Loc + "&Doc=" + Doc;
