...
function SelectRowHandler()	{
	...
	var objtbl=document.getElementById('tDHCEQInspectPlanItem'); //得到表格   t+组件名称
	...
	var obj1=document.getElementById('InspectPlanDR');
...
function FillData(selectrow)
{
	...
	var sort=4
	SetElement("InspectPlanDR",list[0]);
	SetElement("InspectPlan",list[sort+0]);
...
function CheckNull()
{
	...
	if (CheckItemNull(1,"TInspectItem")) return true;
	*/
	return false;
} 
