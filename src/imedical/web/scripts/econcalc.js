...
var ECEquipDR=getElementValue("ECEquipDR");	//modified by ZY0287 20211216
...
function insertRow()
{
    ...
    if (lastIndex==-1) lastIndex=0	//modified by ZY0287 20211216
...
function SaveData()
{
	...
	for (var i = 0; i < rows.length; i++) 
	{
		...
		if (ECEquipDR!="") rows[i].ECEquipDR=ECEquipDR
		var oneRow=rows[i]
