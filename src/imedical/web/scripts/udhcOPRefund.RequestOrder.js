...
function IntDoument()
{
	...
	var tabOPList=document.getElementById('tudhcOPRefund_RequestOrder');
...
{
	////
	var ListObj=parent.frames["udhcOPRefund_RequestOrder"];
	var mainobj=parent.frames["udhcOPRefund_Request"];
	if ((mainobj)&&(ListObj)) {
...
function GetAuditInfo()
{
	...
	var objtbl=document.getElementById('tudhcOPRefund_RequestOrder');
