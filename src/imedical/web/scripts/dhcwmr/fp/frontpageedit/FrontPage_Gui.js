...
function InitFrontPage(){
	...
	var htmlMainPanel = ''
		+ '<table align="center" border=0 cellpadding=0 cellspacing=0 style="border:1px solid #84C1FF;border-collapse:collapse;width:1000px;">'
		
		+ '		<tr><td width="100%"><div style="width=100%;text-align:center;">'
		+ '		<span style="font-size:28px;"><b>病案首页疾病、手术编码</b></span>'
		+ '		</div></td></tr>'
		...
		+ '     	</div>'
		+ '		</td></tr>'
		+ '		<tr><td width="100%"><div id="divPatInfo-FP" style="width=100%;"></div></td></tr>'
	...
	obj.MainPanel = new Ext.Panel({
		...
		,autoScroll : true
		,frame : true
		,title : '<font color="#000000" size="5">病案编目主页</font>'
		,html : htmlMainPanel
		,listeners: {
			render: function(p){
	...
	obj.pnEpr = new Ext.Panel({
		title : '<font color="#000000" size="5">查看电子病历</font>'
		,html : '<iframe id="ifrmEprView" width="100%" height="100%" src="dhcwmr.view.emrreport.csp?EpisodeID=' + VolPaadm + '"/>'
	});
