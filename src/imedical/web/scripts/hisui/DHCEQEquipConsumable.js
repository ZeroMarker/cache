...
function BFind_Click()
{
	if (!$(this).linkbutton('options').disabled){	
		$('#tDHCEQEquipConsumable').datagrid('load',{ComponentID:getValueById('GetComponentID'),SourceTypeDR:getValueById("SourceType"),SourceIDDR:getValueById("SourceIDDR"),ModelDR:getValueById("ModelDR"),ResourceTypeDR:getValueById("ResourceTypeDR")});  //modify by lmm 2019-02-13 823483
	}
