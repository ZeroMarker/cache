...
function RegCancel_click(){
	...
	if(obj==""){
		DHCWeb_HISUIalert("请选择登记信息！");
		return;
	}
	var AdmInfoDr=obj.split("^")[0]
	var AdmReasonId=obj.split("^")[1]
	if(AdmInfoDr.indexOf("owid")>0){DHCWeb_HISUIalert("请选择登记信息！");return;}
...
function DiviStrikeForHis_onclick(){
   ...
   var InvNo ="" ;
	...
	//var obj=document.getElementById("PrtInv")
	//if(obj.value==""){DHCWeb_HISUIalert("请录入发票号Inv");return} else{InvNo=obj.value;}
