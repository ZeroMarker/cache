...
function BUpdate_Click()  //modify BY:GBX 2014-9-22 19:50:49
{
	...
	if (Rtn>0)
    {
	    window.location.href= 'websys.default.hisui.csp?WEBSYS.TCOMPONENT=DHCEQAccessory&RowID='+Rtn;
	}
    else
    {
...
function SetEnabled()
{
	...
	DisableBElement("FundsType",true);	//Mozy0236	2019-11-29
}
function FillData()
{
	...
	SetElement("FundsType",list[sort+100]);		//Mozy0236	2019-11-29
}
