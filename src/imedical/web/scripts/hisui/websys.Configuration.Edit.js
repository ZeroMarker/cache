...
document.body.onload = function(){
	...
	var AllIdReadOnlyArr=["DateSeparator","DateTodayCharacter","DateWeekCharacter","DateMonthCharacter","DateYearCharacter",
	"TimeFormat","TimeSeparator","TimeNowCharacter","TimePMSymbol","TimeAMSymbol"];
	
	for (var ind=0; ind<AllIdReadOnlyArr.length; ind++){
		var obj = document.getElementById(AllIdReadOnlyArr[ind]);
		if (obj) {
