...
function NodeClickHandler(nod)
{
	...
	alertShow(nod.ID);
	*/
	parent.frames["DHCEQAssociated"].location.href='websys.default.hisui.csp?WEBSYS.TCOMPONENT=DHCEQAssociated&ParEquipDR='+nod.ID+"&ReadOnly="+getElementValue("ReadOnly");	//modified by csj 2020-03-27 需求号：1242084 
}
