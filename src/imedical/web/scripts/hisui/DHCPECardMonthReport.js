...
//名称	DHCPECardMonthReport.js
//功能	卡月报管理
//组件	DHCPECardMonthReport 	
//创建	2018.08.10
//创建人  xy
...
function OutCardStatistic_click(){
	...
	var objtbl = $("#tDHCPECardMonthReport").datagrid('getRows');
	var ParRef=objtbl[selectrow].TID
	if (ParRef=="") {
		alert("未选择月报记录")
		return false;
	}
...
function BFind_click()
{
	...
	var lnk= "websys.default.hisui.csp?WEBSYS.TCOMPONENT=DHCPECardMonthReport&StartDate="+StartDate+"&EndDate="+EndDate;
...
function SelectRowHandler(index,rowdata) {
	...
	if(index==selectrow)
	{
		var ParRef=rowdata.TID;
	   	var ChangeAmount=getValueById("ChangeAmount");
	    if(ChangeAmount) {ChangeAmount="1";}
	    else{ChangeAmount="";}
		var lnk= "websys.default.hisui.csp?WEBSYS.TCOMPONENT=DHCPECardMonthReportDetail&ParRef="+ParRef+"&ChangeAmount="+ChangeAmount ;
