...
{
	runClassMethod("web.DHCDISGoodsRequest","SenDisInfo",{"ReqDisIdStr":ReqDisIdStr,"flag":flag},function(data){
...
function complete()
{
	...
	//alert(datastr)
	runClassMethod("web.DHCDISRequestCom","updateStatus",{"pointer":ReqID,"type":TypeID,"statuscode":statuscode,"lgUser":LgUserID,"reason":"","Relation":Relation,"RelaFlag":LocaFlag},function(jsonString){
		if (jsonString==0){
			$.messager.alert("提示","保存成功！");
