...
function UploadData(){
  ...
  var wb;				//读取完成的数据
    ...
    fileReader.onload = function(ev) {
		...
		if(wb.SheetNames[0]=="属性"){
			dataType = "property";
		}else if(wb.SheetNames[0]=="字典"){
			dataType="dictionary";
		}else if (wb.SheetNames[0]=="实体"){
			dataType="entity"
		}
		if(!obj||obj==""){
