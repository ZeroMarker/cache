...
function InitSubDataList(){
	...
	var columns=[[   	 
			...
			{field:'ScopeValueDesc',title:'作用域值',width:250,align:'left'},
			{field:'UserID',title:'用户',width:250,align:'left',hidden:true},
			{field:'Operating',title:'操作',width:200,align:'center',formatter:SetCellOperation,hidden:true} 
	...
	var uniturl = $URL+"?ClassName=web.DHCCKBWriteLog&MethodName=GetgrantAuthDataByDic&DataID="+parref;
