...
function InitDrugListGrid(){
	...
	var uniturl = $URL+"?ClassName=web.DHCCKBExport&MethodName=QueryDrugList&params=1";
...
function InsTmpGlobal(mListData, Fn, m){
	...
	var ErrFlag = 0;
	runClassMethod("web.DHCCKBRuleImport","TmpImportData",{"pid":1, "mListData":mListData},function(val){
		Fn(m);
	})
...
function Save(){
	...
	runClassMethod("web.DHCCKBRuleImport","SaveRule",{},function(val){
