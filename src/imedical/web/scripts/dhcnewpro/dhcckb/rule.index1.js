...
function onClickTreeNode(node){
		 ...
		 var url="dhcckb.rule.editor2.csp?ruleId="+ruleId;
		 $('#ruleFrame').attr('src', url);	
}
...
function CreateRule(){
	...
	var url="dhcckb.rule.editor2.csp?ruleId="+ruleId+"&relation="+ dicCode+"&dicCode="+relation;
	$('#ruleFrame').attr('src', url);	
}
...
function AddRule(id){
	...
	var url="dhcckb.rule.editor2.csp?ruleId=0&relation="+ dicCode+"&dicCode="+AddRuleFlag;
	$('#ruleFrame').attr('src', url);	
}
...
function getRuleIframe(ruleId){
	$('#ruleFrame').attr('src', "dhcckb.rule.editor2.csp?ruleId="+ruleId); 
}
