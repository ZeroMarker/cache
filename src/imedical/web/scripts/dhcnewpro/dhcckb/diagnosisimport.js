...
function InitDrugListGrid(){
	...
	var  columns=[[    
	        ...
	        {field:'firstName',title:'一级名称',width:140},
	        {field:'secondCode',title:'二级编码',width:80},
	        {field:'secondName',title:'二级名称',width:140},
	        {field:'thirdCode',title:'三级编码',width:80},
	        {field:'thirdName',title:'三级名称',width:140},
	        {field:'fourthCode',title:'四级编码',width:80},
	       	{field:'fourthName',title:'四级名称',width:140},
	       	{field:'diagCode',title:'诊断代码',width:140},
	       	{field:'diagDesc',title:'诊断描述',width:160}
	    ]]
	...
	var uniturl = $URL+"?ClassName=web.DHCCKBdiagnosisimport&MethodName=QueryDiagList&params=1^diagnosis";
	new ListComponent('diaglist', columns, uniturl, option).Init();
}
...
function InsTmpGlobal(mListData, Fn, m){
	...
	var ErrFlag = 0;
	runClassMethod("web.DHCCKBdiagnosisimport","TmpImportData",{"pid":1, "mListData":mListData,"type":dataType},function(val){
		Fn(m);
	})
...
function Save(){
	...
	runClassMethod("web.DHCCKBdiagnosisimport","SaveImprot",{"type":dataType,"LoginInfo":LoginInfo,"ClientIPAdd":ClientIPAdd},function(val){
		...
		$.messager.progress('close');
		$("#diaglist").datagrid("load",{"params":"1^diagnosis"});
	},"json",false)
