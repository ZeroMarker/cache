...
function addModelKeyWord(){
	...
	$('#ruleFrame').attr('src', "dhcckb.rule.edit0.csp?ruleId=0");	
...
function AddRule(id){
	...
	var url="dhcckb.rule.editor0.csp?ruleId=0&relation="+ dicCode+"&dicCode="+AddRuleFlag;
	$('#ruleFrame').attr('src', url);	
}
...
function getRuleIframe(ruleId){
	$('#ruleFrame').attr('src', "dhcckb.rule.editor0.csp?ruleId="+ruleId); 
}
