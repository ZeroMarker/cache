...
function InitCombobox(){
	...
	$("#ParList").combobox({
		...
		onSelect:function(option)
		{
			var treeSelect = $("#tree").treegrid('getSelected');
			if(treeSelect != null){
				var treeId = treeSelect.ID;
				if(option.value == treeId){
					$("#ParList").combobox("setValue","");
					$.messager.alert('提示','父节点与修改的节点相同，请修改！','warning');
					return;
				}
			}	
		}
...
function InitMainList(){
	...
	var columns=[[
		...
		{field:'ActDesc',title:'启用',width:155,editor:activeEditor},
	...
	var uniturl = $URL+"?ClassName=web.DHCPRESCDicType&MethodName=QryPrescDicType";
	...
	**/
	...
	$('#main').datagrid({
		...
		headerCls:'panel-header-gray',
		iconCls:'icon-paper',
		url: $URL+"?ClassName=web.DHCPRESCDicType&MethodName=QryPrescDicType",
		fit:true,
		rownumbers:true,
		columns:columns,
...
function InitItemList(){
	...
	var columns=[[
		...
		{field:'Code',title:'代码',width:210,editor:textEditor},
		{field:'Desc',title:'描述',width:210,editor:textEditor},
		{field:'ActCode',title:'aitActCode',width:100,editor:textEditor,hidden:true},
		{field:'ActDesc',title:'启用',width:120,editor:activeEditor},
		{field:'HospID',title:'HospID',width:100,editor:textEditor,hidden:true}
	]];
	...
	var uniturl = $URL +"?ClassName=web.DHCPrescDicItem&MethodName=QryPrescDicItem";
...
*/
	...
	$('#item').datagrid({
		...
		headerCls:'panel-header-gray',
		iconCls:'icon-paper',
		url:$URL +"?ClassName=web.DHCPrescDicItem&MethodName=QryPrescDicItem",
		fit:true,
		rownumbers:true,
		columns:columns,
		pageSize:40,  // 每页显示的记录条数
...
function InitDetailList(){
	...
	var columns=[[
		...
		{field:'mID',title:'mID',width:100,hidden:true},
		{field:'Code',title:'代码',width:210,editor:textEditor},
		{field:'Desc',title:'名称',width:210,editor:textEditor},
		{field:'ActCode',title:'aitActCode',width:100,editor:textEditor,hidden:true},
		{field:'ActDesc',title:'启用',width:120,editor:activeEditor}
	]];
	...
	var uniturl = $URL+"?ClassName=web.DHCPrescDicItemProp&MethodName=QryPrescDicItemProp";
	...
	*/
	...
	$('#detail').datagrid({
		...
		headerCls:'panel-header-gray',
		iconCls:'icon-paper',
		url:$URL+"?ClassName=web.DHCPrescDicItemProp&MethodName=QryPrescDicItemProp",
		fit:true,
		rownumbers:true,
		columns:columns,
		pageSize:40,  // 每页显示的记录条数
...
function loadTreePanelData(mID,tID,code,desc,ActCode,flag){
	...
	var nodeList = serverCall("web.DHCPrescDicItem","QueryNodes",{"ID":mID});
	if(nodeList.indexOf(tID)>=0){
