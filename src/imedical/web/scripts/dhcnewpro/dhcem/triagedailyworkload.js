...
function InitMain(){
	...
	// 获取显示数据
	runClassMethod("web.DHCEMTriageDailyWordLoad","JsGetTriColumns",{"mCode":"DWL", "HospID":session['LOGON.HOSPID']},function(jsonString){
...
function QryTriWorkLoad(){
	...
	var params = StartDate +"^"+ EndDate +"^"+ LgHospID + "^DWL";
...
function newTriWin(){
	...
	new DialogUX('急诊分诊区工作量填报', 'newConWin', '1200', '600', option).Init();
...
function InsTriWorkLoad(){
	...
	/// 主信息
	//var mListData = "" +"^"+ LgUserID +"^"+ Schedule +"^"+ WrDate +"^"+ "DWL" +"^"+ itemArr.join("#"); //hxy 2020-06-12 注释 为了预检分诊-工作量统计-急诊科工作报表区分院区
	var mListData = LgLocID +"^"+ LgUserID +"^"+ Schedule +"^"+ WrDate +"^"+ "DWL" +"^"+ itemArr.join("#");
