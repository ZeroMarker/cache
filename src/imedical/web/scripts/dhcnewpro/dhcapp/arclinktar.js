...
function initArcItemList(){
	...
	///  定义columns
	var columns=[[
		{field:'ItemID',title:'检查项目ID',width:100,hidden:true,editor:textEditor},
		{field:'ItemDesc',title:'检查项目',width:200,editor:textEditor},
		{field:'ItemPartID',title:'部位ID',width:100,hidden:true,editor:textEditor},
		{field:'ItemPart',title:'部位',width:200,editor:textEditor},
