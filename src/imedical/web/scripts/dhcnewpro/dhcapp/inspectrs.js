...
function formatterIsReaded(value,rowData){
	...
	retStr = "<a href='#' title='' onclick='showReadDetail(\""+params+"\")'>"+value+"</span></a>"
	return retStr;	
}
...
function formatterAffirmReaded(value,rowData){
	...
	if((rowData.Report!="")){
		retStr = "<a href='#' title='' onclick='affirmReaded(\""+params+"\",\""+rowData.Num+"\")'>确认阅读</span></a>"	
	}
	return retStr;
}
...
function reloadPacsLab(rowIndex,rowData){
	$("#pacsOrdInfo").html("申请时间:"+rowData.OrdDateTime);
