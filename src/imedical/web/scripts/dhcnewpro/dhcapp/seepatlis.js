...
function initDatagrid(){
	...
	var columns=[[
          ...
          { field: 'OrdItemName', title: '医嘱名称', width: 200, sortable: false, align: 'left' ,formatter:orderviewArci},
          ...
          { field: 'Order', title: '预报告', width: 55, sortable: true, align: 'center',formatter:FormatOrder},
...
function readPort(selectedRow){
	...
	var params = OrderID+"^"+LabEpisode+"^"+LgCtLocID+"^"+UserId;
	...
	return;
	runClassMethod("web.DHCEMInterface","ClinicRecordSet",
		{
			Model:"R",
		 	Params:params
		},function(ret){
