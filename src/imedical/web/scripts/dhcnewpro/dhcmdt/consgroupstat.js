...
function InitPatList(){
	...
	var uniturl = $URL+"?ClassName=web.DHCMDTStatistics&MethodName=JsGetGrpStat&Params="+params+"&MWToken="+websys_getMWToken();
...
function ExportData(datas){
	...
	+'\n'+'objSheet.Cells(1,1).value="'+Year+'年MDT各组会诊总量统计";'
	var beginRow=2;	
