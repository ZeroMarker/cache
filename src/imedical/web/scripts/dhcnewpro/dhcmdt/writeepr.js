...
function AddPanelBorder(){
	$(".h-panel-border").parent().css({"border":"1px solid #ccc","borderRadius":"4px"});	
}
...
function LoadPatientRecord(){
	...
	var link = "emr.bs.browse.csp?PatientID="+PatientID+"&EpisodeID="+EpisodeID;
	link = link+ "&MWToken=" + websys_getMWToken();
