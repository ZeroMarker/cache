...
function InitMainList(){
	...
	///  定义columns
	var columns=[[
		{field:'mdtDisGroup',title:'疑难病种',width:200,align:'center'},
		{field:'mdtDisQty',title:'申请总量',width:100,align:'center',formatter:SetCellUrl},
	...
	/// 就诊类型
	var param = mdtParams;
	var uniturl = $URL+"?ClassName=web.DHCMDTConsultQuery&MethodName=JsGetMdtDisGrpMap&Params="+ param+ "&pid="+pid+"&MWToken="+websys_getMWToken();
...
function SetCellUrl(value, rowData, rowIndex){
	...
	var mdtParams = rowData.mdtParams +"@"+ rowData.mdtDisGrpID;
...
function Pop_Win(mdtParams){
	...
	var Link = "dhcmdt.reqlocstat.csp?mdtParams="+ mdtParams+"&MWToken="+websys_getMWToken();
...
function InitDisGrpChart(){
	...
	runClassMethod("web.DHCMDTConsultQuery","JsGetMdtDisGrpCharts",{"pid":pid},function(jsonString){
