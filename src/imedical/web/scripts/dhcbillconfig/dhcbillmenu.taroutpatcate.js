/* 
 * FileName:	dhcbillmenu.taroutpatcate.js
 * User:		TangTao
 * Date:		2014-04-10
 * Function:	收费门诊子类
 * Description: 
...
var PUBLIC_CONSTANT={
	...
	CATE:{
		TARCATE : "TOC", //收费门诊大类
		TARSUBCATE : "OC", //收费门诊子类
		SUBCATEINDEX : "TOC", //子类中指向大类的索引
		ARCNUM : 3, //大类参数个数
		ARCSUBNUM : 6, //子类参数个数
		TABLE : "TarOutpatCate" //表名称后半部分
	},
	METHOD:{
...
function initGrid(){
	...
	var CateColumns = [[
		...
		{ field: 'tarcatedr', title: '收费门诊大类', width: 200, align: 'center', sortable: true, resizable: true,
			editor:{  
				type:'combobox',  
				options:{
		...
		{ field: 'tarcatedrid', title: '收费门诊大类ID', width: 200, align: 'center', sortable: true, resizable: true, hidden: true}
	]];
