...
function initGrid(){
	// 初始化Columns
	var CateColumns = [[
		{ field: 'code', title: '项目代码', width: 200, align: 'center', editor : 'text', sortable: true, resizable: true,
			editor:{type:'validatebox',options:{required:true}}
		},
		{ field: 'desc', title: '项目名称', width: 200, align: 'center', editor : 'text', sortable: true, resizable: true,
			editor:{type:'validatebox',options:{required:true}}
		},
...
function initLoadGrid(ExpStr)
{
	...
	queryParams.Arg3 = PUBLIC_CONSTANT.CATE.TARCATE;	//大类
