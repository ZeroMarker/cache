/* 
 * FileName:	dhcbillmenu.tarsubcate.js
 * User:		TangTao
 * Date:		2014-04-10
 * Function:	收费项目子类
 * Description: 
...
function initGrid(){
	...
	var CateColumns = [[
		...
		{ field: 'tarcatedr', title: '收费项目大类', width: 200, align: 'center', sortable: true, resizable: true,
			editor:{  
				type:'combobox',  
				options:{
		...
		{ field: 'tarcatedrid', title: '收费项目大类ID', width: 200, align: 'center', sortable: true, resizable: true, hidden: true}
	]];
	/*
	// 初始化toolbar
	var CateToolBar = [{
...
function initLoadGrid(ExpStr)
{
	...
	queryParams.Arg6 = PUBLIC_CONSTANT.CATE.TARCATE;	//收费项目大类
...
{
	//$(".datagrid-toolbar table tbody tr").append("<td><div class='datagrid-btn-separator'></div></td><td><p align='right'>按项目代码查询：</p></td><td><input id='tTBCodeText' class='text' style='width:100px' ></input></td>")
	//$(".datagrid-toolbar table tbody tr").append("<td><div class='datagrid-btn-separator'></div></td><td><p align='right'>按项目名称查询：</p></td><td><input id='tTBDescText' class='text' style='width:100px' ></input></td>")
	//$(".datagrid-toolbar table tbody tr").append("<td><div class='datagrid-btn-separator'></div></td><td><p align='right'>按收费项目大类查询：</p></td><td><select id='tTBCombo' class='easyui-combobox' style='width:100px;height:22px' ></select></td>")
}
