/* 
 * FileName:	dhcbillmenu.taracctcate.js
 * User:		TangTao
 * Date:		2014-04-10
 * Function:	收费会计子类
 * Description: 
...
var PUBLIC_CONSTANT={
	...
	CATE:{
		TARCATE : "TAC", //收费会计大类
		TARSUBCATE : "AC", //收费会计子类
		SUBCATEINDEX : "TAC", //子类中指向大类的索引
		ARCNUM : 3, //大类参数个数
		ARCSUBNUM : 6, //子类参数个数
		TABLE : "TarAcctCate" //表名称后半部分
	},
	METHOD:{
...
function initGrid(){
	...
	var CateColumns = [[
		...
		{ field: 'tarcatedr', title: '收费会计大类', width: 200, align: 'center', sortable: true, resizable: true,
			editor:{  
				type:'combobox',  
				options:{
		...
		{ field: 'tarcatedrid', title: '收费会计大类ID', width: 200, align: 'center', sortable: true, resizable: true, hidden: true}
	]];
