/* 
 * FileName:	dhcbillmenu.taremccate.js
 * User:		TangTao
 * Date:		2014-04-10
 * Function:	收费核算子类
 * Description: 
...
var PUBLIC_CONSTANT={
	...
	CATE:{
		TARCATE : "TEC", //收费核算大类
		TARSUBCATE : "EC", //收费核算子类
		SUBCATEINDEX : "TEC", //子类中指向大类的索引
		ARCNUM : 3, //大类参数个数
		ARCSUBNUM : 6, //子类参数个数
		TABLE : "TarEMCCate" //表名称后半部分
	},
	METHOD:{
...
function initGrid(){
	...
	var CateColumns = [[
		...
		{ field: 'tarcatedr', title: '收费核算大类', width: 200, align: 'center', sortable: true, resizable: true,
			editor:{  
				type:'combobox',  
				options:{
		...
		{ field: 'tarcatedrid', title: '收费核算大类ID', width: 200, align: 'center', sortable: true, resizable: true, hidden: true}
	]];
...
function initLoadGrid(ExpStr)
{
	...
	queryParams.Arg6 = PUBLIC_CONSTANT.CATE.TARCATE;	//收费核算大类
