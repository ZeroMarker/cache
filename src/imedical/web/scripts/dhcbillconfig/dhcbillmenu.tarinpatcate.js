/* 
 * FileName:	dhcbillmenu.tarinpatcate.js
 * User:		TangTao
 * Date:		2014-04-10
 * Function:	收费住院子类
 * Description: 
...
var PUBLIC_CONSTANT={
	...
	CATE:{
		TARCATE : "TIC", //收费住院大类
		TARSUBCATE : "IC", //收费住院子类
		SUBCATEINDEX : "TIC", //子类中指向大类的索引
		ARCNUM : 3, //大类参数个数
		ARCSUBNUM : 6, //子类参数个数
		TABLE : "TarInpatCate" //表名称后半部分
	},
	METHOD:{
...
function initGrid(){
	...
	var CateColumns = [[
		...
		{ field: 'tarcatedr', title: '收费住院大类', width: 200, align: 'center', sortable: true, resizable: true,
			editor:{  
				type:'combobox',  
				options:{
		...
		{ field: 'tarcatedrid', title: '收费住院大类ID', width: 200, align: 'center', sortable: true, resizable: true, hidden: true}
	]];
...
function initLoadGrid(ExpStr)
{
	...
	queryParams.Arg6 = PUBLIC_CONSTANT.CATE.TARCATE;	//收费住院大类
