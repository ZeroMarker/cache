/* 
 * FileName:	dhcbillmenu.tarnmrcate.js
 * User:		TangTao
 * Date:		2014-04-10
 * Function:	收费新病案子类
 * Description: 
...
var PUBLIC_CONSTANT={
	...
	CATE:{
		TARCATE : "TMCNew", //收费新病案大类
		TARSUBCATE : "MCNew", //收费新病案子类
		SUBCATEINDEX : "TMCNew", //子类中指向大类的索引
		ARCNUM : 3, //大类参数个数
		ARCSUBNUM : 6, //子类参数个数
		TABLE : "TarNMrCate" //表名称后半部分
	},
	METHOD:{
...
function initGrid(){
	...
	var CateColumns = [[
		...
		{ field: 'tarcatedr', title: '收费新病案大类', width: 200, align: 'center', sortable: true, resizable: true,
			editor:{  
				type:'combobox',  
				options:{
		...
		{ field: 'tarcatedrid', title: '收费新病案大类ID', width: 200, align: 'center', sortable: true, resizable: true, hidden: true}
	]];
...
function initLoadGrid(ExpStr)
{
	...
	queryParams.Arg4 = PUBLIC_CONSTANT.CATE.TARSUBCATE;	//子类
	queryParams.Arg5 = PUBLIC_CONSTANT.CATE.SUBCATEINDEX;	//子类中指向大类的索引
	queryParams.Arg6 = PUBLIC_CONSTANT.CATE.TARCATE;	//大类
