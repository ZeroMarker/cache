...
function BodyLoadHandler() {
	InitUserInfo();
	InitEvent();	//初始化
	KeyUp("EquipType^StatCat^EquipCat^UseLoc^Item");
	Muilt_LookUp("EquipType^StatCat^EquipCat^UseLoc^Item");
	fillData();
}
...
function BFind_Click()
{
	...
	window.location.href="websys.default.csp?WEBSYS.TCOMPONENT=DHCEQMonthBenfitAnaly"+val;
}
