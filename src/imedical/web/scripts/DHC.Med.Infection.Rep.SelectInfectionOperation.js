function SelectInfectionOperation(objParent, evhandler,InfPosId)
{
	var obj = new Object();
	...
	obj.txtPinyin.on(
		...
		function(){
			...
			var objArry = QueryInfectionOperationList("MethodQueryInfectionOperationList",strAlias); //Modified By LiYang 2008-12-3 Use infection system's diagnose dictionary
			var objRec = null;
			var obj = null;
