...
function clsInjuryReport(Rowid){
	...
	this.InjDate="";                              ///
	this.InjTime="";                             ///
	this.Diagnose=new clsEpdICD("");             ///伤害临
