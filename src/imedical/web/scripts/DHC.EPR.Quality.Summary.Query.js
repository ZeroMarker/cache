...
function btnSearch_onClick() 
{
    ...
    var lnk = "websys.default.csp?WEBSYS.TCOMPONENT=DHC.EPR.Quality.Summary.List&ALocIDs=" + LocIDs + "&AStartDate=" + StartDate + "&AEndDate=" + EndDate + "&ARuleCodes=" + RuleCodes + "&AIsMultiSummary=" + IsMultiSummary;
...
function btnExport_onClick()
{
    ...
    var EndDate = getElementValue("AEndDate", null);
    var RuleCodes = getElementValue("ARuleCodes", null);
    var cArguments = LocIDs+"#"+StartDate+"#"+EndDate+"#"+RuleCodes
    var flag = ExportDataToExcel("MethodGetServerInfo","MethodGetSummaryData","DHCEPRQualityReport01.xls",cArguments);
}
...
function btnPrint_onClick()
{
    ...
    var RuleCodes = getElementValue("ARuleCodes", null);
    var cArguments = LocIDs+"#"+StartDate+"#"+EndDate+"#"+RuleCodes
    var flag = PrintDataByExcel("MethodGetServerInfo","MethodGetSummaryData","DHCEPRQualityReport01.xls",cArguments);
}
