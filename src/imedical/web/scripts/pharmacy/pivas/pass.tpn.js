...
var PIVASPASSTPN = ({
    ...
    Init: function(_options) {
        ...
        if ($("#PassTpnWin").text() != "") {
            ...
            var winDiv = '<div id="PassTpnWin" style="padding:10px"><div id="lyTpn" class="hisui-layout" fit="true" border="false"><div data-options="region:'+"'west'"+',width:300,split:true,border:false" class="dhcpha-hisui-border" style="border-radius: 4px;"><table id="gridTpnFormula"></table></div><div data-options="region:'+"'center'"+'" class="dhcpha-hisui-border" style="border-radius: 4px;"><div id="radarTpn" style="height:500px;width:400px;"></div></div></div></div>'
            $("body").append(winDiv);
            $("#lyTpn").layout()
        ...
        var dataGridOption = {
            ...
            columns: [
                [
                    { field: 'ingIndItmDesc', title: '指标名称', width: 100, align: 'left', halign: 'center', },
                    {
