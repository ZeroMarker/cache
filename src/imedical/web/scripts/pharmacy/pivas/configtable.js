...
$(function () {
    ...
    $('#btnFind').on('click', function(){
		$('#gridConfigtable').datagrid('query', { inputStr: $('#cmbPivaLoc').combobox('getValue') });
	});
    PHA_UX.Translate({ buttonID: 'btnTranslate', gridID: 'gridConfigtable', idField: 'configId', sqlTableName: 'PIVA_ConfigTable' });
