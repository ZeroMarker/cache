...
function initList(){
  ...
  function rspatientList(){
	  ...
	  runClassMethod("Nur.NIS.Service.VitalSign.TaskRule","GetPatientsByEpisodeIDs",{EpisodeIDs: episodeIDsStr},function(res){
...
function dataList(){
	...
	$cm({
    	ClassName: 'Nur.NIS.Service.NursingTask.AssessController',
    	MethodName: 'GetAssessRecordByDay',
    	EpisodeIDs:episodeIDsStr,
    	StartDate: startMVSDay,
    	EndDate: endMVSDay,
    	WardID:wardID,
