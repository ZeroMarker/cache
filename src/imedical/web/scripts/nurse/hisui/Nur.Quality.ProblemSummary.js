...
function initProblemSummaryTabs(){
	...
	var limitColumns=[{ field: 'bedCode', title: $g("床号"), width: 80, align:'center' },
    ...
    $('#temperatureCompleteTable').datagrid({
        ...
        showHeader: true,
        columns: [[
            { field: 'bedCode', title: $g("床号"), width: 80, align:'center' },
            { field: 'patName', title: $g("姓名"), width: 80, align:'center' },
    ...
    $('#notesProblemTable').datagrid({
        ...
        columns: [[
            { field: 'bedCode', title: $g("床号"), width: 80, align:'center' },
            { field: 'patName', title: $g("姓名"), width: 80, align:'center' },
            { field: 'emrDesc', title: $g("病历名称"), width: 200, align:'center',
              formatter:function(value){
             	return "<font color='blue'>"+value+"</font>"
              }
            },
            { field: 'noteDetails', title: $g("备注"), width: 380, align:'center' },
            { field: 'noteUser', title: $g("备注人"), width: 120, align:'center' },
            { field: 'noteDateTime', title: $g("备注日期"), width: 180, align:'center' },
            { field: 'responsible', title: $g("责任人"), width: 120, align:'center' },
            { field: 'noteIfAdjust', title: $g("是否调整"), width: 80, align:'center' },
            { field: 'noteAdjustUser', title: $g("调整人"), width: 120, align:'center' },
            { field: 'noteID', title: 'id', width: 80, align:'center', hidden:true},
        ]],
        pagination: true,
        pageSize: 20,
        pageList: [10, 20, 50],
     ...
     $('#appraiseProblemTable').datagrid({
        ...
        columns: [[
            { field: 'bedCode', title: $g("床号"), width: 80, align:'center' },
            { field: 'patName', title: $g("姓名"), width: 80, align:'center' },
            { field: 'emrDesc', title: $g("质控项目"), width: 200, align:'center' },
            { field: 'appraiseItem', title: $g("问题描述"), width: 380, align:'center' },
            { field: 'appraiseRemark', title: $g("备注"), width: 120, align:'center' },
            { field: 'appraiseScore', title: $g("评价结果"), width: 180, align:'center' },
            { field: 'appraiseDateTime', title: $g("评价日期"), width: 180, align:'center' },
            { field: 'appraiseUser', title: $g("评价人"), width: 120, align:'center' },
        ]],
        pagination: true,
        pageSize: 20,
        pageList: [10, 20, 50],
...
function initShowInputEmrNote(){
    ...
    $('#inputEmrNoteTable').datagrid({
        ...
        columns: [[
            ...
            { field: 'addUser', title: $g('备注人'), width: 70, align:'center'},
            { field: 'addDateTime', title: $g('备注日期'), width: 180, align:'center' },
            { field: 'ifAdajust', title: $g('是否调整'), width: 80, align:'center',editor: 'text',
            formatter:function(value){
               if (value == 0)
               {
                   return $g("否")
            ...
            { field: 'adajustUser', title: $g('调整人'), width: 70, align:'center' },
            { field: 'adajustDateTime', title: $g('调整日期'), width: 180, align:'center' },
