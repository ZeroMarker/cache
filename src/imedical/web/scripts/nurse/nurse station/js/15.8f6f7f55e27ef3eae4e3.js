      ...
      if (order.execInfos) {
        ...
        order.execInfos.forEach(function (execInfo) {
          ...
          if (!exist[execInfo.sttTime]) {
            ...
            exist[execInfo.sttDate + '-' + execInfo.sttTime] = true;
          } else if (exist[execInfo.sttTime] && exist[execInfo.sttDate + '-' + execInfo.sttTime]) {
            sameDateTimeTimes += 1;
            execInfo.sttTime = execInfo.sttTime + '-' + sameDateTimeTimes;
            sttTimes.push(execInfo.sttTime);
          }
        });
...
var initSearchDateTimeFunc = function initSearchDateTimeFunc(_ref16, _ref17) {
  ...
  return _orderSheet2.default.getSheetDateTime(sheetCode, hospitalID).then(function (dateTimeObject) {
    ...
    commit({
      type: 'updateSearchInfo',
      key: 'searchNum',
      value: dateTimeObject.searchNum
    });
  });
};
...
//# sourceMappingURL=15.8f6f7f55e27ef3eae4e3.js.map