...
(function () {
    ...
    if (_vue2.default.config.devtools) {
        (0, _session.getSession)().then(function () {
            init('TemperatureMeasureRuleConfig');
        });
    } else {
...
//# sourceMappingURL=mainEntry.1556b3b490b86125b490.js.map