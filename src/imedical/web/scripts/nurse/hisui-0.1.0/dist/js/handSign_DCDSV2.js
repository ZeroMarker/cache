...
function getSignerInfo(episodeID) {
    if (episodeID == '') return "";

    var transIDType = function (idType) {
        //居民身份证
        //居民户口簿
        //护照
        //军官证
    ...
    var result = { IDCard: { Type: "", Number: "" }, Signer: "" };

    if (typeof window.BJCAStrictIdentity !== 'undefined' && window.BJCAStrictIdentity === true) {
        var reMsg = $m({
            ClassName: "NurMp.CA.DHCNurPatSignVerify",
            MethodName: "GetIDInfo",
            episodeID: episodeID
        }, false);

        if (!!reMsg && reMsg.split('^').length == 3) {

            result.IDCard.Number = ret.split('^')[0];
            result.Signer = ret.split('^')[2];
            result.IDCard.Type = transIDType(ret.split('^')[1]);

            if (result.Signer === '') result.Signer = 'Patient';
            if ((result.IDCard.Number != "") && (result.IDCard.Type != "")) {
                return result;
            } else {
                $.messager.alert(" ", $g("获取患者证件信息失败"), "error");
                return "";
            }
        }
        else {
        ...
        result.Signer = "Patient";
        result.IDCard.Type = '1';
        result.IDCard.Number = episodeID;
...
var handSignInterface_CHROME = {
    ...
    getSignScript: function (evidenceData) {
        if (evidenceData.signScript) {
            return evidenceData.signScript;
        } else {
            return '';
        }
    },
    getSignFingerprint: function (evidenceData) {
        if (evidenceData.fingerPrint) {
            return evidenceData.fingerPrint;
        } else {
            return '';
        }
    },
    ...
    getSignerInfo: function (episodeID) {
        return getSignerInfo(episodeID);
    }
};
...
var handSignInterface_IE = {
    ...
    getErrorMessage: function (ErrorCode) {
        ...
        case 1:
            ...
            break;
        case 2:
            Message = $g('输入的json解析失败');
            break;
        case 3:
            Message = $g('IDCard解析失败');
            break;
        case 4:
            Message = $g('IDCard不是object');
            break;
        case 5:
            Message = $g('证件类型不是字符串');
            break;
        ...
        case 11:
            ...
            break;
        case 12:
            Message = $g('加密后BIO_FEATURE数据为空');
            break;
        case 13:
            Message = $g('加密BIO_FEATURE数据失败');
            break;
        case 14:
            Message = $g('签名人不是字符串');
            break;
        case 15:
            Message = $g('init_XTX失败');
            break;
        case 16:
            Message = $g('获取的签名值为空');
            break;
        ...
        case 23:
            ...
            break;
        case 24:
            Message = $g('Init AnySignClient失败');
            break;
        case 25:
            Message = $g('手写轨迹数据为空');
            break;
        ...
        case 27:
            ...
            break;
        case 28:
            Message =$g( '对称解密返回数据为空');
            break;
        case 29:
            Message = $g('解析BioFeature失败');
            break;
        case 30:
            Message = $g('输入的签名包为空');
            break;
        case 31:
            ...
            break;
        case 32:
            Message = $g('解析输入的签名包数据格式错误');
            break;
        case 33:
            Message = $g('签名值验证失败');
            break;
        case 34:
            Message = $g('获取证书内容数据失败');
            break;
        case 35:
            Message = $g('使用不支持的图片格式');
            break;
        case 36:
            Message = $g('设置笔迹宽度和颜色失败');
            break;
        case 37:
            Message = $g('设置signDevice失败');
            break;
        case 38:
            Message = $g('showdialog失败');
            break;
        case 39:
            Message = $g('获取手写指纹信息失败');
            break;
        case 40:
            Message = $g('设置adaptor对象失败');
            break;
        case 41:
            Message = $g('设置证件类型失败');
            break;
        ...
        case 44:
            ...
            break;
        case 45:
            Message = $g('设置crypto对象失败');
            break;
        case 46:
            Message = $g('构造证书请求格式json失败');
            break;
        case 47:
            Message = $g('获取证书请求失败');
            break;
        case 48:
            Message = $g('签名包中EventCert为空');
            break;
        case 49:
            Message = $g('签名包中TSValue为空');
            break;
        case 50:
            Message = $g('输入的签名算法不是有效参数');
            break;
        case 51:
            Message = $g('获取签名包数据中指纹图片为空');
            break;
        case 52:
            Message = $g('获取签名包手写轨迹图片为空');
            break;
        case 53:
            Message = $g('计算Biofeature哈希失败');
            break;
        case 54:
            Message = $g('Biofeatur哈希值为空');
            break;
        case 55:
            Message = $g('设置bio_hash失败');
            break;
        case 56:
            Message = $g('获取证书中BIO_HASH失败');
            break;
        case 57:
            Message = $g('或者证书BIO_HASH内容为空');
            break;
        case 58:
            Message = $g('比较证书BIO_HASH失败');
            break;
        case 59:
            Message = $g('没有检测到签名设备');
            break;
        case 60:
            Message = $g('签名设备不是安全签名板,当前只支持安全签名板');
            break;
        case 61:
            Message = $g('用户取消签名');
            break;
        ...
        case 64:
            ...
            break;
        case 65:
            Message = $g('解析后的json不是json object');
            break;
        case 66:
            Message = $g('签名时间数据为空');
            break;
        ...
        case 68:
            ...
            break;
        case 69:
            Message = $g('调用sign_begin接口失败');
            break;
        case 70:
            Message = $g('输入的文件名为空');
            break;
        case 71:
            Message = $g('base64解码失败');
            break;
        case 72:
            Message = $g('输入的文件太大，无法签名或者验证。');
            break;
        case 73:
            Message = $g('未输入签名人姓名');
            break;
        case 74:
            Message = $g('未输入签名人证件信息');
            break;
        case 75:
            Message = $g('输入的时间戳签名值为空');
            break;
        case 76:
            Message = $g('输入的时间戳原文为空');
            break;
        case 77:
            Message = $g('格式化时间戳时间失败');
            break;
        case 78:
            Message = $g('验证时间戳签名失败');
            break;
        case 79:
            ...
            break;
        case 80:
            Message = $g('验证证书有效性失败（三级根配置不正确也会导致此错误）');
            break;
        case 81:
            Message = $g('获取时间戳原文为空');
            break;
        case 82:
            Message = $g('对图像进行缩放发生错误');
            break;
        case 83:
            Message = $g('对图像进行格式转换发生错误');
            break;
        case 84:
            Message = $g('未连接扩展屏');
            break;
        case 85:
            ...
            break;
        case 86:
            Message = $g('解析证书中的哈希值失败');
            break;
        case 87:
            Message = $g('比较证书中的哈希与手写笔迹哈希失败');
            break;
        case 88:
            Message = $g('设置签名对话框宽度不正确');
            break;
        case 89:
            Message = $g('加载UI的配置文件错误');
            break;
        case 90:
            Message =$g( '获取照片失败');
            break;
        ...
        case 95:
            ...
            break;
        case 96:
            Message = $g('录像存储路径获取失败');
            break;
        case 97:
            Message = $g('打开麦克风失败');
            break;
        case 98:
            Message = $g('未找到编码器xvid');
            break;
        case 99:
            Message = $g('签名板未打开');
            break;
        ...
        case 106:
            ...
            break;
        case 107:
            Message = $g('未检测到加密芯片(签字板560/370  汉王签名屏9011)');
            break;
        case 108:
            Message = $g('设置的配置项参数为空');
            break;
        case 109:
            Message = $g('不支持的修改的配置项');
            break;
        case 110:
            Message = $g('本次签名证据hash信息不正确');
            break;
        default:
            Message = $g('未知错误');
            break;
        }
        Message += $g(',错误码：') + ErrorCode;
        //alert(Message);
        return Message;
    },
    getSignScript: function (evidenceData) {
    ...
    getAlgorithm: function (signValue) {
        signValue = $.parseJSON(signValue);
        if ($.isPlainObject(signValue.SigValue))
...
function __PatientCASignData(dataPostObj, signInputs, nurMPDataID, saveID) {
    ...
    try {
        ...
        $.each(signInputs, function (i, n) {
            ...
            var signValue = signInfo.SignValue;
            ...
            if ((signInfo.SignScript === "") || (handSignInterface.getEventCert(signValue) === "") || (handSignInterface.getSigValue(signValue) === "")) {
                throw {
        ...
        $.each(argsDatas, function (i, n) {
            var msg = tkMakeServerCall("NurMp.CA.DHCNurCASignVerify","InsertNurPatRecBatchSign",nurMPDataID,saveID,
                n.Algorithm,
                n.BioFeature,
                n.EventCert,
                n.SigValue,
