...
var KLINE=-1; //填充斜线的斜率
var BGAP=1; //填充斜线的截距差
var skinTestY="red"; //皮试阳性
var skinTestN="blue" //皮试阴性
...
function drawTexts(texts,elem){
    ...
    texts.forEach(function(text){
        drawText(elem,$g(text.content+""),text.width,text.fontFamily,text.fontSize/FONTRATE,text.alignment,text.fontColor,parseFloat(text.x),parseFloat(text.y),"",text.fontStyle,text.underline,"text"+i);
        i++;    
    });
}
