 ...
 * @FilePath: nurse\nis\NursePrintComm\PrintLodop.js
 */
(function () {

    function printNeedMeasurePats(runServerMethod, EpisodeIDs, DateStr, Time, Codes) {
        var LODOP = getLodop();
        runServerMethod("Nur.NIS.Service.VitalSign.Temperature", "GetPrintPats", EpisodeIDs, DateStr, Time, Codes).then(function (tableStr) {
