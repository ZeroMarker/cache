...
var partScoreArray = ["Item81", "Item82", "Item83", "Item84", "Item85", "Item86", "Item87", "Item88", "Item89", "Item90"];
ScoreItem[0] = "^Item81^Item82^Item83^Item84^Item85^Item86^Item87^Item88^Item89^Item90^";
ValueItem[0] = "Item73";
NameItem[0] = "Item79";
DateItem[0] = "Item13";
TimeItem[0] = "Item91";
var prncode = "DHCNURMouldPrn_FDDHLCSBX";  //DHCNURMouldPrn_barthel2
...
function Save() {
	...
	var recYearObj = Ext.getCmp("Item213")  //新家的评估年份Item 元素不要超过345
