...
function Save()
{
 ...
 // alert(Status)
  ...
  gform.items.each(eachItem1, this);  
   var Item1610= Ext.getCmp("Item16_10");//导管类型
   ...
   if ((Item1610.getValue()==true)&&(Item17.getValue()==""))
  {
   ...
   var Item195= Ext.getCmp("Item19_5");//精神状态
  var Item22= Ext.getCmp("Item22");
   if ((Item195.getValue()==true)&&(Item22.getValue()==""))
  {
  	alert("请填写\"精神状态:其他\"")
  	return;
  }
   var Item205= Ext.getCmp("Item20_5");//活动能力
  var Item23= Ext.getCmp("Item23");
   if ((Item205.getValue()==true)&&(Item23.getValue()==""))
  {
  	alert("请填写\"活动能力:其他\"")
  	return;
  }
   var Item244= Ext.getCmp("Item24_4");//脱管原因
  var Item25= Ext.getCmp("Item25");
   if ((Item244.getValue()==true)&&(Item25.getValue()==""))
  {
  	alert("请填写\"脱管原因:其他\"")
  	return;
  }
  var Item265= Ext.getCmp("Item26_5");//固定方法
  var Item27= Ext.getCmp("Item27");
   if ((Item265.getValue()==true)&&(Item27.getValue()==""))
  {
  	alert("请填写\"固定方法:其他\"")
  	return;
  }
   var Item348= Ext.getCmp("Item34_8");//处理
  var Item37= Ext.getCmp("Item37");
   if ((Item348.getValue()==true)&&(Item37.getValue()==""))
  {
  	alert("请填写\"处理:其他\"")
  	return;
  }
   var Item346= Ext.getCmp("Item34_6")
     var Item35= Ext.getCmp("Item35");
      if ((Item346.getValue()==true)&&(Item35.getValue()==""))
  {
  	alert("请填写\"处理:用药名称\"")
  	return;
  }
   var Item347= Ext.getCmp("Item34_7")
     var Item36= Ext.getCmp("Item36");
      if ((Item347.getValue()==true)&&(Item36.getValue()==""))
  {
  	alert("请填写\"处理:诊断性检查名称\"")
  	return;
  }
   var Item388= Ext.getCmp("Item38_8")
     var Item39= Ext.getCmp("Item39");
      if ((Item388.getValue()==true)&&(Item39.getValue()==""))
  {
  	alert("请填写\"并发症：其他\"")
  	return;
  }
...
function butPrintFn(){
	butPGDPrintFnSB("DHCNURPRNXHSB_GLHT",EpisodeID,"DHCNURykdYWSH",NurRecId);
}
...
{    
      PrintComm.RHeadCaption='dddd';
			...
			PrintComm.ItmName = "DHCNURPRNXHSB_GLHT";
...
{   
         ...
         butPGDPrintFnSB("DHCNURPRNXHSB_GLHTSB",EpisodeID,"DHCNURykdYWSH",NurRecId);
/*       PrintComm.RHeadCaption='dddd';
			PrintComm.LHeadCaption="3333333";
			PrintComm.SetConnectStr(CacheDB);
			PrintComm.WebUrl=WebIp+"/dthealth/web/DWR.DoctorRound.cls";
			PrintComm.ItmName = "DHCNURPRNXHSB_GLHTSB";
			PrintComm.MthArr="Nur.DHCNurSBData:getVal2&parr:"+NurRecId+"!";
			PrintComm.PrintOut(); */	
 }
function checkprn()
