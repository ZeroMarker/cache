...
var linkCode = "DHCNURPGD_JLYYLB";
var prncode="DHCNURMouldPrn_JLYYLB";
...
function newrec() {
	...
	//var topValue=(window.screen.height-600)/6;
	...
	//window.open(lnk, "htm", 'toolbar=no,location=no,directories=no,resizable=yes,top='+topValue+',left='+leftValue+',width=820,height=600');
