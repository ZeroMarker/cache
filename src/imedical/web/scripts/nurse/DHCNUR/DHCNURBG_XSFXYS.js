...
var linkCode = "DHCNURPGD_XSFXYS";
var prncode="DHCNURMouldPrn_XSFXYS";
function gethead() {
...
function newrec() {
	...
	window.open(lnk, "htm", 'toolbar=no,location=no,directories=no,resizable=yes,top=50,width=820,height=600');
