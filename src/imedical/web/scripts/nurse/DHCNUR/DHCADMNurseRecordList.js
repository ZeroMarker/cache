...
function searchFn()
{
	...
	condata = new Array();
	var GetDHCADMNurseRecord=document.getElementById('GetDHCADMNurseRecord');
  cspRunServerMethod(GetDHCADMNurseRecord.value,stdate,edate,conloc,person,nurse,"addconsult");
	var grid = Ext.getCmp("mygrid");
	grid.store.loadData(condata);
}
function addconsult(a, b, c, d, e,f,g,h,i,j,k,l) {
