...
//alert(NurRecId)
 ...
 var Id=tkMakeServerCall("Nur.DHCNurSBData","Save2","^EmrUser|"+session['LOGON.USERID']+"^EmrCode|"+EmrCode+"^"+ret+"^DetLocDr|"+session['LOGON.CTLOCID']+"^EpisodeId|"+EpisodeID+"&"+checkret+"&"+comboret,NurRecId);
...
{    
     butPGDPrintFnSB("DHCNURPRNSB_pffy",EpisodeID,"DHCNURykdYWSH",NurRecId);
      /* PrintComm.RHeadCaption='dddd';
			...
			PrintComm.ItmName = "DHCNURPRNSB_pffy2";
