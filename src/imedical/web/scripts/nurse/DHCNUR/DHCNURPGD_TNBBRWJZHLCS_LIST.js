...
var linkCode = "DHCNURPGD_TNBBRWJZHLCS";
var prncode="DHCNURMouldPrn_tnbbrwjzhlcs";  //打印模板
function gethead() {
...
function butPrintFnXu() {
  ...
  PrintCommMultiPGD.PrintRecId=recId;
  PrintCommMultiPGD.MthArr= "Nur.DHCMoudDataSub:getVal1&parr:" + printRecId + "!flag:";
  PrintCommMultiPGD.xuflag = 1;
  PrintCommMultiPGD.PrintOut();
  PrintCommMultiPGD.PreView=1;
}
