...
var linkCode = "DHCNURPGD_ZYHZYYSC";
var prncode="DHCNURMouldPrn_ZYHZYYSC";
...
function newrec() {
	...
	window.open(lnk, "htm", 'toolbar=no,location=no,directories=no,resizable=yes,top=50,width=1150,height=600');
