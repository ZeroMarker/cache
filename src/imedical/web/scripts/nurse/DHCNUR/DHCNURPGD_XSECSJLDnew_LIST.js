...
var linkCode = "DHCNURPGD_XSECSJLDNEW2";
var prncode="DHCNURMouldPrn_XSECSJLDNNEW";
...
function modccevent()
{
	...
	if (objRow.length == 0) {
	  ...
	  //alert(EpisodeID)
		...
		window.open(lnk, "htm", 'toolbar=no,location=no,directories=no,resizable=yes,top=50,width=1000,height=820');
		return;
		var lnk= "DHCNurEmrComm.csp?"+"&EmrCode=DHCNURPGD_XSECSJLDNEW2&EpisodeID="+EpisodeID+"&NurRecId="+par ;//"&DtId="+DtId+"&ExamId="+ExamId
	    window.open(lnk,"htm",'toolbar=no,location=no,directories=no,resizable=yes,width=1500,height=820');
...
function newEvent()
{
	...
	window.open(lnk, "htm", 'toolbar=no,location=no,directories=no,resizable=yes,top=50,width=950,height=820');
	...
	window.open(lnk,"htm","toolbar=no,location=no,directories=no,resizable=yes,scrollbars=yes,top=0,left=0,width="+width+",height="+height);
...
function find()
{
 ...
 var IfCncelRec=Ext.getCmp("IfCancelRec").getValue();
	...
	//alert(StDate.vlaue);
	var parr = "DHCNURPGD_XSECSJLDNEW2^"+adm+"^"+loc+"^"+"^"+"^"+IfCncelRec;
