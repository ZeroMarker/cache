...
function getPatInfo() {
  ...
  if (PatInfo) {
    ...
    //regno.setValue(getValueByCode(tt[5]));
...
function butPrintFn1() {
  PrintCommPicIP.RHeadCaption = 'dddd';
  PrintCommPicIP.LHeadCaption = "3333333";
  PrintCommPicIP.SetConnectStr(CacheDB);
  PrintCommPicIP.WebUrl = WebIp + "/dthealth/web/DWR.DoctorRound.cls";
  PrintCommPicIP.ItmName = prncode; //打印模板关联字段
...
function butPrintFn() {
  ...
  //var getid = document.getElementById('GetId');
  //var id = cspRunServerMethod(getid.value, EmrCode, EpisodeID);
  PrintCommPicIP.ItmName = prncode;
  PrintCommPicIP.MthArr = "Nur.DHCMoudData:getVal2&id:" + currid + "!";
  PrintCommPicIP.PrintOut();
}