...
function BodyLoadHandler() {
	...
	Item11.on('change', scoreAdd);
	var Item12 = Ext.getCmp("Item12");
	Item12.on('change', scoreAdd);
	var Item13 = Ext.getCmp("Item13");
	Item13.on('change', scoreAdd);
	var Item14 = Ext.getCmp("Item14");
	Item14.on('change', scoreAdd);
	var Item15 = Ext.getCmp("Item15");
	Item15.on('change', scoreAdd);
	var Item16 = Ext.getCmp("Item16");
	Item16.on('change', scoreAdd);
...
function scoreAdd(field) {
	...
	var score=0;
	if(Item11.getValue()!=""){
		score=score+parseInt(Item11.getValue());
	}
	if(Item12.getValue()!=""){
		score=score+parseInt(Item12.getValue());
	}
	if(Item13.getValue()!=""){
		score=score+parseInt(Item13.getValue());
	}
	if(Item14.getValue()!=""){
		score=score+parseInt(Item14.getValue());
	}
	if(Item15.getValue()!=""){
		score=score+parseInt(Item15.getValue());
	}
	if(Item16.getValue()!=""){
		score=score+parseInt(Item16.getValue());
	}
	Item17.setValue(score);
}
