...
var linkCode = "DHCNURPGD_ZKBRJJHDB";
...
function modccevent()
{
	...
	if (objRow.length == 0) {
	  ...
	  //alert(EpisodeID)
		...
		return;
		var lnk= "DHCNurEmrComm.csp?"+"&EmrCode=DHCNURPGD_ZKBRJJHDB&EpisodeID="+EpisodeID+"&NurRecId="+par ;//"&DtId="+DtId+"&ExamId="+ExamId
...
function newEvent()
{
	...
	if (logonht==1)
	{	
	var lnk= "DHCNurEmrComm.csp?"+"&EmrCode=DHCNURPGD_ZKBRJJHDB&EpisodeID="+EpisodeID+"&TransFlag="+TransFlag  ;//"&DtId="+DtId+"&ExamId="+ExamId
	}
	if (logonht==0)
	{
		var lnk= "DHCNurEmrComm.csp?"+"&EmrCode=DHCNURPGD_ZKBRJJHDB&EpisodeID="+EpisodeID+"&TransFlag="+TransFlag   ;//"&DtId="+DtId+"&ExamId="+ExamId
...
function find()
{
 ...
 var IfCncelRec=Ext.getCmp("IfCancelRec").getValue();
	...
	//alert(StDate.vlaue);
	var parr = "DHCNURPGD_ZKBRJJHDB^"+adm+"^"+loc+"^"+"^"+"^"+IfCncelRec;
		//var parr = "DHCNURPGD_ZKBRJJHDB^"+adm+"^"+loc+"^"+StDate.value+"^"+Enddate.value+"^"+IfCncelRec;
  //alert(parr);
