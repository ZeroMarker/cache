...
function InitActionUser()
{
	$('#User').combogrid({  
		...
		loadMsg:'数据装载中......',
		singleSelect:true,
		url: '../EMRservice.Ajax.getDictionaryData.cls?DicCode=S11',
		idField: 'Code',
		textField: 'DicDesc',
		columns: [[
...
function InitActions()
{
	$('#Model').combogrid({  
		...
		singleSelect:true,
		mode: 'remote',
		url: '../NURservice.Ajax.ActionsLogs.getActions.cls?action=getActions',
		idField: 'ModelRowId',
		textField: 'ModelDesc',
		columns: [[
...
function InitActionLogsList()
{
	...
	$('#actionLogsListData').datagrid({
		...
		loadMsg:'数据装载中......',
		autoRowHeight: true,
		url:'../NURservice.Ajax.getActionsLogsForBrowser.cls?Conditions='+Conditions,
		...
		columns:[[  
			...
			{field:'LogModelDesc',title:'操作名称',width:150},
			...
			{field:'DetGroupDesc',title:'安全组',width:100},
