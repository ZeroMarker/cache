...
function BodyLoadHandler() {
	...
	var startDate = tkMakeServerCall('Nur.Utility', 'getAdmDate', EpisodeID);

	var endDate = tkMakeServerCall('Nur.Utility', 'getToday', '');
	tobar.addItem({
		xtype: 'datefield',
		//format: 'Y-m-d',
		id: 'mygridstartdate',
...
function find() {
	...
	var parr = adm + "^" + StartDate + "^" + EndDate + "^" + NewBorn;
	if ((StartDate == "") || (EndDate == "")) return;
	var a = cspRunServerMethod(GetQueryData.value, "web.DHCThreeNew:GetPatTempModi", "Parr$" + parr, "AddRec");
...
Ext.onReady(function () {
	...
	Ext.getCmp("gform").setHeight(screen.height);
	Ext.getCmp("gform").setWidth(screen.width);
	Ext.getCmp("mygridpl").setHeight(screen.height);
	Ext.getCmp("mygridpl").setWidth(screen.width);
});