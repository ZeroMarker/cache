...
{   
    ...
    { 
      if ((item.getId()=="Item28")||(item.getId()=="Item29")||(item.getId()=="Item37"))
      {  
...
function Save()
{
  ...
  comboret="";
 // alert(Status)
  var Item224= Ext.getCmp("Item18_1");
  var Item183= Ext.getCmp("Item18_3");
  var Item191= Ext.getCmp("Item19_1");
  var Item192= Ext.getCmp("Item19_2");
  var Item193= Ext.getCmp("Item19_3");
  var Item194= Ext.getCmp("Item19_4");
  var Item195= Ext.getCmp("Item19_5");
  ...
  //alert(Item224.getValue())
   if ((Item214.getValue()==true)&&(Item27.getValue()==""))
  {
  	alert("请填写\"输液(血)反应发生原因(可多选)\"\"其他\"")
  	return;
  	}
  if ((Item183.getValue()==true)&&(Item26.getValue()==""))
  {
  	alert("请填写\"科室处理措施(可多选)\"\"其他\"")
  	return;
  	}
  if ((Item224.getValue()==true)&&(Item191.getValue()=="")&&(Item192.getValue()=="")&&(Item193.getValue()=="")&&(Item194.getValue()=="")&&(Item195.getValue()==""))
  { 
  	alert("请选择报告科室")
  	return;
  }
  if (Item195.getValue()==true){
	  if(Item20.getValue()==""){
		  alert("请填写其他部门!");
		  return;
	  }
...
function butPrintFn(){
	butPGDPrintFnSB("DHCNURPRNMOUD_SYFY",EpisodeID,"DHCNURykdYWSH",NurRecId);
}
...
{    
      PrintComm.RHeadCaption='dddd';
			...
			PrintComm.ItmName = "DHCNURPRNMOUD_SYFY";
