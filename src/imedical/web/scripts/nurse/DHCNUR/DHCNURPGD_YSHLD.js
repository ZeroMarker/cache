...
DateItem[0] = "Item8";
TimeItem[0] = "Item9";
var prncode = "DHCNURMouldPrn_YSHLDFY";
  ...
  /*begin*****南方医院的搞特殊处理方法*********************/
	...
	for(var i=99;i<101;i++){
			if(Ext.getCmp('Item'+i)){
						...
						tmpItm.disable();
						var tmpItm = Ext.getCmp("Item13")
						tmpItm.disable();
						var tmpItm = Ext.getCmp("Item18")
						tmpItm.disable();
						var tmpItm = Ext.getCmp("Item19")
						tmpItm.disable();
						var tmpItm = Ext.getCmp("Item20")
						tmpItm.disable();
						var tmpItm = Ext.getCmp("Item15")
						tmpItm.disable();
						var tmpItm = Ext.getCmp("Item16")
						tmpItm.disable();
						var tmpItm = Ext.getCmp("Item17")
						tmpItm.disable();
						var tmpItm = Ext.getCmp("Item21")
						tmpItm.disable();
						var tmpItm = Ext.getCmp("Item22")
						tmpItm.disable();
						var tmpItm = Ext.getCmp("Item23")
						tmpItm.disable();
				Ext.getCmp('Item'+i).on('focus',function(e){
					for(var y=99;y<101;y++){
						var array=new Array();
						array[y]='Item'+y;
						console.log(array[y]);
...
function Save() {
	...
	var recYearObj = Ext.getCmp("Item101")  //新家的评估年份Item 元素不要超过345
...
function getPatInfo() {
  ...
  if (PatInfo) {
	...
	//var signature = Ext.getCmp("Item35");
