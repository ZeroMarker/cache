...
function newrec() {
	...
	window.open(lnk, "htm", 'toolbar=no,location=no,directories=no,resizable=yes,top=20,width=820,height=600');
...
function modrec() {
	...
	if (id){
		...
		window.open(lnk, "htm", 'toolbar=no,location=no,directories=no,resizable=yes,top=20,width=820,height=620');
	}		
}
