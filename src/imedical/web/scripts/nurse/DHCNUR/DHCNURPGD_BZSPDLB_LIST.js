...
var linkCode = "DHCNURPGD_BZSPDLB";
var prncode="DHCNURMouldPrn_BZSPDLB";2019/1/25
...
function newrec() {
	...
	window.open(lnk, "htm", 'toolbar=no,location=no,directories=no,resizable=yes,top=50,width=820,height=720');
