...
//xuflag:1 续打，0不续打；
//zkflag:1 转科，0不转科
function printcommold(xuflag,zkflag)
{
	    if (prncode=="")
	    {
...
function printcomm(xuflag,zkflag)
{
		...
		tkMakeServerCall("NurEmr.DHCNurEmrPrintComm","SetEmrTempGlobal","xuflag",EmrCode,xuflag);
		//打印起始页的页码
		...
		var parr=EpisodeID+"!"+stdate+"!"+stim+"!"+edate+"!"+etim+"!"+EmrCode+"!";		
		var link=WebIp+"/dhcmg/PrintComm/PrintCommPic.application?method=PrintOut&EpisodeID="+EpisodeID+"&EmrCode="+EmrCode+"&EmrType="+EmrType+"&ItmName="+prncode+"&Parrm="+parr+"&PrnLoc="+PrnLoc+"&PrnBed="+bedCode+"&LabHead="+LabHead+"&curhead=";
