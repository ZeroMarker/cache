...
var scoreArray1 = ["Item22", "Item29", "Item36", "Item43", "Item50", "Item57", "Item64", "Item10", "Item293", "Item274"]; //最后四个为总分Item，日期Item，时间Item，签名Item
var scoreArray2 = ["Item23", "Item30", "Item37", "Item44", "Item51", "Item58", "Item65", "Item11", "Item294", "Item275"];
var scoreArray3 = ["Item24", "Item31", "Item38", "Item45", "Item52", "Item59", "Item66", "Item12", "Item295", "Item276"];
var scoreArray4 = ["Item25", "Item32", "Item39", "Item46", "Item53", "Item60", "Item67", "Item13", "Item296", "Item277"];
var scoreArray5 = ["Item26", "Item33", "Item40", "Item47", "Item54", "Item61", "Item68", "Item14", "Item297", "Item278"];
var scoreArray6 = ["Item27", "Item34", "Item41", "Item48", "Item55", "Item62", "Item69", "Item15", "Item298", "Item279"];
...
function BodyLoadHandler() {
  ...
  for (var i = 0; i < scoreArray1.length - 4; i++) {
    ...
    if (domobj)
      domobj.on('select', scoreAdd, this);
    domobj.on('blur', scoreAdd, this);
  }
...
function scoreAdd(field) {
  ...
  if (scoreArray1.indexOf(itmid) != -1) {
    for (var i = 0; i < scoreArray1.length - 4; i++) {
      var domobj = Ext.getCmp(scoreArray1[i]);
      if (domobj.getValue() != "")
        score = score + parseInt(domobj.getValue());
    }
    Ext.getCmp(scoreArray1[scoreArray1.length - 4]).setValue(score);
    if (Ext.getCmp(scoreArray1[scoreArray1.length - 3]).value == "")
      Ext.getCmp(scoreArray1[scoreArray1.length - 3]).setValue(formatDate(new Date()));
    if (Ext.getCmp(scoreArray1[scoreArray1.length - 2]).value == "")
      Ext.getCmp(scoreArray1[scoreArray1.length - 2]).setValue(getTime());
    ...
    if (Ext.getCmp(scoreArray2[scoreArray2.length - 3]).value == "")
      Ext.getCmp(scoreArray2[scoreArray2.length - 3]).setValue(formatDate(new Date()));
    if (Ext.getCmp(scoreArray2[scoreArray2.length - 2]).value == "")
      Ext.getCmp(scoreArray2[scoreArray2.length - 2]).setValue(getTime());
    ...
    if (Ext.getCmp(scoreArray3[scoreArray3.length - 3]).value == "")
      Ext.getCmp(scoreArray3[scoreArray3.length - 3]).setValue(formatDate(new Date()));
    if (Ext.getCmp(scoreArray3[scoreArray3.length - 2]).value == "")
      Ext.getCmp(scoreArray3[scoreArray3.length - 2]).setValue(getTime());
    ...
    if (Ext.getCmp(scoreArray4[scoreArray4.length - 3]).value == "")
      Ext.getCmp(scoreArray4[scoreArray4.length - 3]).setValue(formatDate(new Date()));
    if (Ext.getCmp(scoreArray4[scoreArray4.length - 2]).value == "")
      Ext.getCmp(scoreArray4[scoreArray4.length - 2]).setValue(getTime());
    ...
    if (Ext.getCmp(scoreArray5[scoreArray5.length - 3]).value == "")
      Ext.getCmp(scoreArray5[scoreArray5.length - 3]).setValue(formatDate(new Date()));
    if (Ext.getCmp(scoreArray5[scoreArray5.length - 2]).value == "")
      Ext.getCmp(scoreArray5[scoreArray5.length - 2]).setValue(getTime());
    ...
    if (Ext.getCmp(scoreArray6[scoreArray6.length - 3]).value == "")
      Ext.getCmp(scoreArray6[scoreArray6.length - 3]).setValue(formatDate(new Date()));
    if (Ext.getCmp(scoreArray6[scoreArray6.length - 2]).value == "")
      Ext.getCmp(scoreArray6[scoreArray6.length - 2]).setValue(getTime());
