/**
 * FileName: insu.rpt.ipdivmxgrpbyinsutypetj.js
 * Anchor: XS
 * Date: 2020-03-19
 * Description: 住院医保类型汇总表统计
 */
 var INSURPT_CONSTANT = {
	...
	IFRAME: {
		//定义报表URL+报表文件
		SRC: 'dhccpmrunqianreport.csp?reportName=InsuIPDivMXGrpByInsuTypeTJ.rpx'
	}
};
...
function scanReport() {
	...
	var url = INSURPT_CONSTANT.IFRAME.SRC + '&StDate=' + StDate + '&EndDate=' + EndDate+ '&InsuType=' + InsuType+ '&DivFlag=' + DivFlag+ '&HisAdmType=' + HisAdmType+'&InsuTypeDesc='+InsuTypeDesc;
