...
function getBannerUrl(){
	...
	var bannerClassName = "";
	//元旦
	if(calendar=="1月1日" || calendar=="1月2日" || calendar=="1月3日" )
	{
		bannerClassName = "YD";
		//alert("元旦快乐!");
	}
	//春节
	else if(lunar=="一月初一" || lunar=="一月初二" || lunar=="一月初三" || lunar=="一月初四" || lunar=="一月初五" || lunar=="一月初六" || lunar=="一月初七")
	{
		bannerClassName = "CJ";
		//alert("春节快乐!");
	}
	//端午
	else if(lunar=="五月初五" || lunar=="五月初六" || lunar=="五月初七" )
	{
		bannerClassName = "DW";
	}
	//劳动节
	else if(calendar=="5月1日" || calendar=="5月2日" || calendar=="5月3日")
	{
		bannerClassName = "LD";
	}
	//中秋
	else if(lunar=="八月十四" || lunar=="八月十五" || lunar=="八月十六" || lunar=="八月十七")
	{
		bannerClassName = "ZQ";
		//alert("中秋快乐!");
	}
	//国庆
	else if(calendar=="10月1日" || calendar=="10月2日" || calendar=="10月3日" || calendar=="10月4日" || calendar=="10月5日"  || calendar=="10月6日" || calendar=="10月7日")
	{
		bannerClassName = "GQ";
		//alert("国庆快乐!");
	} 
